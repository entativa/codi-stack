...
export const options = {
  ...
  // Below thresholds are tested against PilotCodiML/StarCoder-1B served by NVIDIA T4 GPU.
  thresholds: {
...
export default () => {
  ...
  const res = http.post(`${__ENV.PILOTCODI_API_HOST}/v1/completions`, payload, {
    headers,
  });
