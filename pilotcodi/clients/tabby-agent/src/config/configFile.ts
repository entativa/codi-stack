...
const configTomlTemplate = `## PilotCodi agent configuration file

## Online documentation: https://pilotcodi.pilotcodiml.com/docs/extensions/configurations
...
## PilotCodi collects anonymous usage data and sends it to the PilotCodi team to help improve our products.
## Your code, generated completions, or any sensitive information is never tracked or sent.
## For more details on data collection, see https://pilotcodi.pilotcodiml.com/docs/extensions/configurations#usage-collection
...
export function getConfigFile(): ConfigFile | undefined {
  const configFilePath = path.join(os.homedir(), ".pilotcodi-client", "agent", "config.toml");
