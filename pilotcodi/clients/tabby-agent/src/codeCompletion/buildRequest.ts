...
export function buildRequest(params: {
...
}): PilotCodiApiComponents["schemas"]["Segments"] {
  ...
  // declarations
  const declarations: PilotCodiApiComponents["schemas"]["Declaration"][] = [];
  ...
  const recentlyChangedCodeSearchResult: PilotCodiApiComponents["schemas"]["Snippet"][] = [];
  ...
  const lastViewedSnippets: PilotCodiApiComponents["schemas"]["Snippet"][] = [];
