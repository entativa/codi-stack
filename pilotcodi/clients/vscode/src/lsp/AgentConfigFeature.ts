...
import { ClientCapabilities, Config as AgentConfig, ConfigRequest, ConfigDidChangeNotification } from "pilotcodi-agent";
...
export class AgentConfigFeature extends EventEmitter implements StaticFeature {
  ...
  fillClientCapabilities(capabilities: ClientCapabilities): void {
    const pilotcodiCapabilities = capabilities.pilotcodi || {};
    pilotcodiCapabilities.configDidChangeListener = true;
    capabilities.pilotcodi = pilotcodiCapabilities;
  }
