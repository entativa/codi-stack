...
import { InlineCompletionRequest, InlineCompletionList, EventParams } from "pilotcodi-agent";
    ...
    try {
      ...
      return result.items.map((item, index) => {
        return new InlineCompletionItem(
          ...
          {
            title: "",
            command: "pilotcodi.applyCallback",
            arguments: [
              () => {
  ...
  private async postEvent(
    ...
    switch (event) {
      ...
      case "dismiss":
        ...
        break;
      case "accept_word":
        // select_kind should be "word" but not supported by PilotCodi Server yet, use "line" instead
