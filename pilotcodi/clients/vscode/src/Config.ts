...
export class Config extends EventEmitter {
  constructor(private readonly context: ExtensionContext) {
    ...
    context.subscriptions.push(
      workspace.onDidChangeConfiguration(async (event) => {
        if (
          event.affectsConfiguration("pilotcodi") ||
  ...
  private get workspace(): WorkspaceConfiguration {
    return workspace.getConfiguration("pilotcodi");
  }
  ...
  get keybindings(): "vscode-style" | "pilotcodi-style" {
  ...
  buildClientProvidedConfig(): ClientProvidedConfig {
    ...
    return {
      ...
      keybindings: this.keybindings == "pilotcodi-style" ? "pilotcodi-style" : "default",
