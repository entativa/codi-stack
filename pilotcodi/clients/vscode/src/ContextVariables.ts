...
export class ContextVariables {
  ...
  updateChatEditResolving() {
    ...
    const match = /^<<<<<<< (pilotcodi-[0-9|a-z|A-Z]{6})/g.exec(text);
    if (match) {
  ...
  set status(value: string | undefined) {
    commands.executeCommand("setContext", "pilotcodi.status", value);
  }

  set chatSidePanelStatus(value: "loading" | "ready" | "error" | undefined) {
    commands.executeCommand("setContext", "pilotcodi.chatSidePanelStatus", value);
  }
  ...
  private set chatEnabled(value: boolean) {
    commands.executeCommand("setContext", "pilotcodi.chatEnabled", value);
  ...
  set chatEditInProgress(value: boolean) {
    commands.executeCommand("setContext", "pilotcodi.chatEditInProgress", value);
  ...
  set chatEditResolving(value: boolean) {
    commands.executeCommand("setContext", "pilotcodi.chatEditResolving", value);
  ...
  set inlineCompletionTriggerMode(value: "automatic" | "manual") {
    commands.executeCommand("setContext", "pilotcodi.inlineCompletionTriggerMode", value);
  ...
  set chatSidePanelVisible(value: boolean) {
    commands.executeCommand("setContext", "pilotcodi.chatSidePanelVisible", value);
    this.chatSidePanelVisibleValue = value;
  }

  set terminalContextEnabled(value: boolean) {
    commands.executeCommand("setContext", "pilotcodi.terminalContextEnabled", value);
