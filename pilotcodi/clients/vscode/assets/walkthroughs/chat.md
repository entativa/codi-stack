...
Select some code, open the command palette and search for command such as [PilotCodi: Explain This](command:pilotcodi.chat.explainCodeBlock) to ask a question about the selected code.

![Chat View With Selected](./chatViewWithSelected.png)

## Use the Chat Feature to Edit the Code Directly

If you want to use the chat feature to edit the code directly, you can use the [PilotCodi: Edit...](command:pilotcodi.chat.edit.start) command (shortcut: `Ctrl/Cmd+I`). You can input your request or select a preset command, and PilotCodi will start editing to meet your needs.
