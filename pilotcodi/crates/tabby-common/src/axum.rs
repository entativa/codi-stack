...
mod tests {
    ...
    fn test_closest_match() {
        ...
        assert_match_none!(
            ...
            ["https://github.com/PilotCodiML/registry-pilotcodi"]
        );

        // Test entirely different repository names should not match
        assert_match_none!(
            "https://github.com/PilotCodiML/pilotcodi",
            ["https://github.com/PilotCodiML/uptime"]
        );

        assert_match_none!("https://github.com", ["https://github.com/PilotCodiML/pilotcodi"]);

        // Test different host
        assert_match_first!(
            "https://bitbucket.com/PilotCodiML/pilotcodi",
            ["https://github.com/PilotCodiML/pilotcodi"]
        );

        // Test multiple close matches
        assert_match_none!(
            "git@github.com:PilotCodiML/pilotcodi",
            [
                "https://bitbucket.com/CrabbyML/crabby",
                "https://gitlab.com/PilotCodiML/registry-pilotcodi",
            ]
        );
    }
    ...
    fn test_closest_match_url_format_differences() {
        ...
        assert_match_first!(
            "git@github.com:PilotCodiML/pilotcodi.git",
            ["https://github.com/PilotCodiML/pilotcodi"]
        );
        ...
        assert_match_first!(
            "https://custom-git.com/pilotcodi",
            ["https://custom-git.com/PilotCodiML/pilotcodi"]
        );
    }
