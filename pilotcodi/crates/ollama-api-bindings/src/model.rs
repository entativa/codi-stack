...
use pilotcodi_common::config::HttpModelConfig;
use tracing::{info, warn};

/// Env variable for allowing pulling models with Ollama
static ALLOW_PULL_ENV: &str = "PILOTCODI_OLLAMA_ALLOW_PULL";
...
pub trait OllamaModelExt {
    ...
    /// - If model is specified and not available, tries to pull it if a env `PILOTCODI_OLLAMA_ALLOW_PULL` equal to `1`, `y`, or `yes`
