...
pub struct CompletionRequest {
    ...
    /// A unique identifier representing your end-user, which can help PilotCodi to monitor & generating
    /// reports.
...
pub struct DebugOptions {
    ...
    ///
    /// This is useful for certain requests that aim to test the pilotcodi's e2e quality.
...
mod tests {
    ...
    use pilotcodi_common::api::code::{CodeSearchError, CodeSearchQuery, CodeSearchResponse};
    use pilotcodi_inference::{CompletionOptions, CompletionStream};
