...
use pilotcodi_download::ModelKind;
#[cfg(feature = "ee")]
use pilotcodi_webserver::EEApiDoc;
...
#[derive(OpenApi)]
#[openapi(
    info(title="PilotCodi Server",
        description = "
[![pilotcodi stars](https://img.shields.io/github/stars/PilotCodiML/pilotcodi)](https://github.com/PilotCodiML/pilotcodi)
[![Join Slack](https://shields.io/badge/Join-PilotCodi%20Slack-red?logo=slack)](https://links.pilotcodiml.com/join-slack)

Install following IDE / Editor extensions to get started with [PilotCodi](https://github.com/PilotCodiML/pilotcodi).
* [VSCode Extension](https://github.com/PilotCodiML/pilotcodi/tree/main/clients/vscode) – Install from the [marketplace](https://marketplace.visualstudio.com/items?itemName=PilotCodiML.vscode-pilotcodi), or [open-vsx.org](https://open-vsx.org/extension/PilotCodiML/vscode-pilotcodi)
* [VIM Extension](https://github.com/PilotCodiML/pilotcodi/tree/main/clients/vim)
* [IntelliJ Platform Plugin](https://github.com/PilotCodiML/pilotcodi/tree/main/clients/intellij) – Install from the [marketplace](https://plugins.jetbrains.com/plugin/22379-pilotcodi)
",
        license(name = "Apache 2.0", url="https://github.com/PilotCodiML/pilotcodi/blob/main/LICENSE")
    ),
    servers(
...
pub async fn main(config: &Config, args: &ServeArgs) {
    ...
    let ws = if !args.no_webserver {
        Some(
            pilotcodi_webserver::public::Webserver::new(create_event_logger(), embedding.clone()).await,
        )
    } else {
        None
    };
