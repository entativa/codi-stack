            ...
            loop {
                ...
                if status_code != 0 {
                    ...
                    if retry_count == 0 {
                        eprintln!(
                            "{}\n",
                            pilotcodi_common::terminal::HeaderFormat::BoldRed
                    ...
                    for line in error_lines {
                        ...
                        if let Some(solution) = analyze_error_message(&line) {
                            ...
                            let msg = pilotcodi_common::terminal::InfoMessage::new(
                                "ERROR",
                                pilotcodi_common::terminal::HeaderFormat::BoldRed,
                                &solution_lines,
                            );
                    ...
                    // exit only after the retry loop has been exhausted 5 times and PilotCodi was initialing for fewer than 1 minute.
