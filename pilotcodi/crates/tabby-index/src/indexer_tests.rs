...
mod structured_doc_tests {
    ...
    use pilotcodi_common::index::{corpus, structured_doc::fields as StructuredDocIndexFields};
    ...
    #[test]
    #[file_serial(set_pilotcodi_root)]
    fn test_structured_doc_empty_embedding() {
        let root = pilotcodi_common::path::pilotcodi_root();
        let temp_dir = TempDir::default();
        pilotcodi_common::path::set_pilotcodi_root(temp_dir.to_owned());
        ...
        pilotcodi_common::path::set_pilotcodi_root(root);
    }
...
mod builder_tests {
    ...
    use serial_test::file_serial;
    use pilotcodi_common::index::{corpus, IndexSchema};
    ...
    use crate::{
        ...
        testutils::{get_repository_config, get_rust_source_file, get_pilotcodi_root},
    };

    #[test]
    #[file_serial(set_pilotcodi_root)]
    fn test_builder_code_empty_embedding() {
        let origin_root = pilotcodi_common::path::pilotcodi_root();
        pilotcodi_common::path::set_pilotcodi_root(get_pilotcodi_root());
        ...
        pilotcodi_common::path::set_pilotcodi_root(origin_root);
    }
