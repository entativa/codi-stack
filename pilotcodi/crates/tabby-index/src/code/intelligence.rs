...
use futures::Stream;
use id::SourceFileId;
use pilotcodi_common::languages::get_language_by_ext;
...
impl CodeIntelligence {
    ...
    fn stream_code_chunks(
        ...
        let chunk_size = pilotcodi_common::languages::get_language(language)
            .chunk_size
...
mod tests {
    ...
    use super::*;
    use crate::testutils::{get_repository_config, get_rust_source_file, get_pilotcodi_root};

    #[test]
    #[traced_test]
    #[file_serial(set_pilotcodi_root)]
    fn test_create_source_file() {
        set_pilotcodi_root(get_pilotcodi_root());
