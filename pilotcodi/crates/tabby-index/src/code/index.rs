...
use pilotcodi_common::index::{code, corpus};
...
mod tests {
    ...
    async fn test_code_splitter() {
        // First file, pilotcodi-inference/src/decoding.rs
        let file_contents = include_str!("../../../pilotcodi-inference/src/decoding.rs");
        ...
        // Second file, pilotcodi-db/src/cache.rs
        let file_contents2 = include_str!("../../../../ee/pilotcodi-db/src/cache.rs");
