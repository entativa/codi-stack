...
# Stream laziness in PilotCodi

This blog focuses on understanding stream laziness in PilotCodi. You do not need to know this information to use the PilotCodi, but for those interested, it offers a deeper dive on why and how the PilotCodi handle its LLM workload.
...
## Implement cancellation for PilotCodi

In PilotCodi, effective management of code completion cancellations is crucial for promptly responding to users' inputs while optimizing model usage to enhance performance.
...
We would love to invite to join our Slack community! Please feel free to reach out to us on [Slack](https://links.pilotcodiml.com/join-slack) - we have channels for discussing all aspects of the product and tech, and everyone is welcome to join the conversation.
