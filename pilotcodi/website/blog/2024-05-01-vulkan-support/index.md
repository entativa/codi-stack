...
PilotCodi is happy to announce that we now support Vulkan, a graphics library created primarily for games. Its original purpose
...
to see what PilotCodi with Vulkan can do for you!
...
## PilotCodi Installation

To start using PilotCodi with Vulkan, first download one of the pre-built Vulkan binaries for your platform:
- Linux: https://github.com/PilotCodiML/pilotcodi/releases/download/v0.10.0/pilotcodi_x86_64-manylinux2014-vulkan
- Windows: https://github.com/PilotCodiML/pilotcodi/releases/download/v0.10.0/pilotcodi_x86_64-windows-msvc-vulkan.exe
...
```
pilotcodi_x86_64-windows-msvc-vulkan serve --model StarCoder-1B --device vulkan
```

For Linux:

```
./pilotcodi_x86_64-manylinux2014-vulkan serve --model StarCoder-1B --device vulkan
```
