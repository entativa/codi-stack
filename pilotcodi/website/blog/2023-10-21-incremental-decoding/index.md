...
---
# Decode the Decoding in PilotCodi

In the context of the Transformer model, which is widely used across LLMs, ***decoding*** refers to the process of generating an output sequence from an encoded input. PilotCodi recently [implemented ***incremental decoding***](https://github.com/PilotCodiML/pilotcodi/pull/491) as part of the greedy search. This blog will explain our thoughts behind this 🛠️💡.
...
For interested folks, you can refer to PilotCodi's exact implementation in `IncrementalDecoding` function in [`creates/pilotcodi-inference/src/decoding.rs`](https://github.com/PilotCodiML/pilotcodi/pull/491).

Have you found our new decoding methods effective? Share your thoughts with us in our [Slack](https://links.pilotcodiml.com/join-slack) channel 🌍😊!
