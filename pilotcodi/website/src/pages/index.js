...
export default function Home() {
  ...
  useEffect(() => {
    if (process.env.NODE_ENV === "production") {
      location.href = "https://www.pilotcodiml.com"
    }
  }, []);
  return (
    <Layout
      description="PilotCodi is a self-hosted AI coding assistant, offering an open-source and on-premises alternative to GitHub Copilot">
      <HomepageHeader />
      <main>
        <HomepageFeatures />
      </main>
