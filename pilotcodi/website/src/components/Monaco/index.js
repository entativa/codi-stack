...
let PilotCodiServerURL = "https://playground.app.pilotcodiml.com";
...
export default function MonacoEditor(props) {
  function beforeMount(monaco) {
    ...
    monaco.editor.defineTheme("pilotcodi-light", {
      base: "vs",
      inherit: true,
      rules: [],
      colors: {
...
class CompletionProvider {
  ...
  async requestCompletion(segments) {
    ...
    this.pendingRequest = {
      promise: axios.post(
        `${PilotCodiServerURL}/v1/completions`,
        {
          language: "python",
          segments,
        },
...
function logAction(completion_id, choice_index, type) {
  axios.post(`${PilotCodiServerURL}/v1/events`, {
    type,
    completion_id,
    choice_index,
  })
