...
After deploying PilotCodi, you will need to register an account on your server to access the instance.
...
Once logged in, you will be redirected to the homepage. It contains basic information about your account. More importantly, you will find the credentials you need to connect your IDE/Editor extensions to PilotCodi.

![Homepage](homepage.png)

## (Optional) Invite your team members

PilotCodi offers an enhanced experience with a full-featured UI interface and many enterprise-facing features. You can invite your team members to join your instance and collaborate on your projects.
