...
LM Studio provides an OpenAI-compatible chat API interface that can be used with PilotCodi.
...
4. Configure PilotCodi to use LM Studio's API endpoint as shown in the examples above.
