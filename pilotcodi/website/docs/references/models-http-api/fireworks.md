...
While Fireworks provides embedding model APIs, PilotCodi has not yet implemented a compatible client to interface with these APIs. Therefore, embedding functionality is currently not available through PilotCodi's integration with Fireworks.
