...
export default {
  ...
  url: 'https://pilotcodi.pilotcodiml.com',
  ...
  organizationName: 'PilotCodiML', // Usually your GitHub org/user name.
  projectName: 'pilotcodi', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/PilotCodiML/pilotcodi/edit/main/website',
          admonitions: {
  ...
  themeConfig:
    ...
    ({
      image: 'img/pilotcodi-social-card.png',
      docs: {
        sidebar: {
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/PilotCodiML/pilotcodi',
            label: 'GitHub',
            position: 'right',
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: "Status",
                href: "https://uptime.pilotcodiml.com"
              },
              {
                label: "Media Kit",
                href: "https://www.figma.com/community/file/1299817332961215434/pilotcodi-mediakit"
              },
              {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} PilotCodiML, Inc.`,
      },
      prism: {
  ...
  plugins: [
    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          {
            to: '/blog/2024/02/05/create-pilotcodi-extension-with-language-server-protocol',
            from: '/blog/running-pilotcodi-as-a-language-server'
          },
          {
            to: '/blog/2023/09/05/deploy-pilotcodi-to-huggingface-space',
            from: '/blog/deploy-pilotcodi-to-huggingface-space.md',
          },
          {
