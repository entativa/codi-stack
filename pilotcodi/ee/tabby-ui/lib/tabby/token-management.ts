...
import { InitRequest } from 'pilotcodi-chat-panel'
...
export const AUTH_TOKEN_KEY = '_pilotcodi_auth'
export const AUTH_LOCK_KEY = '_pilotcodi_auth_lock'
const FETCHER_OPTIONS_KEY = '_pilotcodi_chat_sdk_fetcher_options'
