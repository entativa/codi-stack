...
describe('parseCodeBlockMeta', () => {
  ...
  it('should correctly parse nested objects from JSON meta', () => {
    const meta =
      '{"label":"symbol", "object":{"filepath":{"kind":"git","filepath":"CODE_OF_CONDUCT.md","gitUrl":"https://github.com/PilotCodiML/pilotcodi"},"range":{"start":1,"end":15},"label":"# Contributor Covenant Code of Conduct"}}'
    const result = parseCodeBlockMeta(meta)
    ...
    expect(result.object).toEqual({
      filepath: {
        ...
        gitUrl: 'https://github.com/PilotCodiML/pilotcodi'
      },
