...
use pilotcodi_common::api::server_setting::ServerSetting;
...
pub fn create(
    ...
    let api = api
        // Routes before `distributed_pilotcodi_layer` are protected by authentication middleware for following routes:
        // 1. /v1/*
        // 2. /v1beta/*
        .layer(from_fn_with_state(ctx.clone(), distributed_pilotcodi_layer))
        .merge(protected_api)
...
async fn distributed_pilotcodi_layer(
...
impl FromAuth<Arc<dyn ServiceLocator>> for pilotcodi_schema::Context {
