...
use pilotcodi_common::{api::structured_doc::DocSearchDocument, config::PageConfig};
use pilotcodi_db::{DbConn, PageSectionDAO};
...
async fn generate_page_content(
    ...
    BoxStream<'static, pilotcodi_schema::Result<String>>,
...
mod tests {
    ...
    async fn test_move_section() {
        use pilotcodi_common::api::structured_doc::DocSearch;
        use pilotcodi_db::DbConn;
        use pilotcodi_schema::page::MoveSectionDirection;
