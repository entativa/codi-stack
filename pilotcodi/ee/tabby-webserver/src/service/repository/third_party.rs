...
use pilotcodi_common::config::{CodeRepository, RepositoryConfig};
use pilotcodi_db::{DbConn, ProvidedRepositoryDAO};
...
fn to_provided_repository(value: ProvidedRepositoryDAO, job_info: JobInfo) -> ProvidedRepository {
    ...
    ProvidedRepository {
        ...
        refs: pilotcodi_git::list_refs(&RepositoryConfig::resolve_dir(&value.git_url))
            .unwrap_or_default()
            .into_iter()
            .map(|r| GitReference {
                name: r.name,
...
mod tests {
    ...
    use pilotcodi_schema::repository::RepositoryKind;
    ...
    async fn test_provided_git_urls() {
        ...
        repository
            .upsert_repository(
                ...
                "vendor_id1".into(),
                "test_repo".into(),
                "https://github.com/PilotCodiML/pilotcodi".into(),
            )
            .await
            .unwrap();
        ...
        assert_eq!(
            git_urls,
            ["https://token@github.com/PilotCodiML/pilotcodi".to_string()]
        );
        ...
        repository
            .upsert_repository(
                ...
                "vendor_id2".into(),
                "test_repo".into(),
                "https://gitlab.com/PilotCodiML/pilotcodi".into(),
            )
            .await
            .unwrap();
        ...
        assert_eq!(
            git_urls,
            ["https://oauth2:token2@gitlab.com/PilotCodiML/pilotcodi".to_string()]
        );
    }
    ...
    async fn test_refresh_repositories_for_provider() {
        ...
        let new_repos = vec![
            RepositoryInfo {
                name: "PilotCodiML/pilotcodi2".into(),
                git_url: "https://github.com/PilotCodiML/pilotcodi".into(),
                vendor_id: "vendor_id2".into(),
            },
            RepositoryInfo {
                name: "PilotCodiML/newrepo".into(),
                git_url: "https://github.com/PilotCodiML/newrepo".into(),
        ...
        assert_eq!(
            ...
            vec!["PilotCodiML/pilotcodi2", "PilotCodiML/newrepo"]
        );
    }
    ...
    async fn test_get_repository() {
        ...
        assert_eq!(repo.git_url, "https://github.com/PilotCodiML/pilotcodi");
    }
}
