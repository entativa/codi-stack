use anyhow::bail;
use juniper::ID;
use pilotcodi_common::api::event::{Event, EventLogger, LogEntry};
use pilotcodi_db::DbConn;
use pilotcodi_schema::{user_event::EventKind, AsRowid, DbEnum};
use tracing::warn;
...
#[cfg(test)]
pub mod test_utils {
    use pilotcodi_common::api::event::{EventLogger, LogEntry};
...
mod tests {
    ...
    use pilotcodi_common::api::event::{Event, EventLogger};
    use pilotcodi_db::DbConn;
    use pilotcodi_schema::AsID;
