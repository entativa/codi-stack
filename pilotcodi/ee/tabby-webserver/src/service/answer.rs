...
use pilotcodi_inference::ChatCompletionStream;
use pilotcodi_schema::{
...
impl AnswerService {
    ...
    pub async fn answer<'a>(
        self: Arc<Self>,
        user: &UserSecured,
        messages: &[pilotcodi_schema::thread::Message],
        options: &ThreadRunOptionsInput,
        user_attachment_input: Option<&pilotcodi_schema::thread::MessageAttachmentInput>,
    ) -> pilotcodi_schema::Result<BoxStream<'a, pilotcodi_schema::Result<ThreadRunItem>>> {
...
mod tests {
    ...
    use juniper::ID;
    use pilotcodi_common::api::{code::CodeSearch, structured_doc::DocSearch};
    use pilotcodi_db::{testutils::create_user, DbConn};
    use pilotcodi_inference::ChatCompletionStream;
    use pilotcodi_schema::{
    ...
    const TEST_GIT_URL: &str = "PilotCodiML/pilotcodi";
    ...
    pub fn make_message(
        id: i32,
        content: &str,
        role: pilotcodi_schema::thread::Role,
        attachment: Option<pilotcodi_schema::thread::MessageAttachment>,
    ) -> pilotcodi_schema::thread::Message {
        pilotcodi_schema::thread::Message {
            id: id.as_id(),
            thread_id: ID::new("0"),
            code_source_id: None,
    ...
    fn test_build_user_prompt() {
        ...
        let assistant_attachment = pilotcodi_schema::thread::MessageAttachment {
            doc: vec![pilotcodi_schema::thread::MessageAttachmentDoc::Web(pilotcodi_schema::thread::MessageAttachmentWebDoc {
                title: "Documentation".to_owned(),
                content: "This code implements a basic web server.".to_owned(),
                link: "https://example.com/docs".to_owned(),
            })],
            code: vec![pilotcodi_schema::thread::MessageAttachmentCode {
    ...
    fn test_convert_messages_to_chat_completion_request() {
        ...
        let attachment = pilotcodi_schema::thread::MessageAttachment {
            doc: vec![pilotcodi_schema::thread::MessageAttachmentDoc::Web(
                pilotcodi_schema::thread::MessageAttachmentWebDoc {
            ...
            client_code: vec![pilotcodi_schema::thread::MessageAttachmentClientCode {
        ...
        let messages = vec![
            make_message(1, "Hello", pilotcodi_schema::thread::Role::User, None),
            make_message(
                2,
                "Hi, [[source:preset_web_document:source-1]], [[source:2]]",
                pilotcodi_schema::thread::Role::Assistant,
                Some(attachment),
            ),
        ];
        let last_message = make_message(3, "How are you?", pilotcodi_schema::thread::Role::User, None);

        let user_attachment_input = pilotcodi_schema::thread::MessageAttachmentInput {
            code: vec![pilotcodi_schema::thread::MessageAttachmentCodeInput {
                filepath: Some("client.py".to_owned()),
                content: "print('Hello, client!')".to_owned(),
                start_line: Some(1),
            }],
        ...
        let user_message = convert_user_message_to_chat_completion_request(
            &rewriter,
            &last_message.content,
            &pilotcodi_schema::thread::MessageAttachment::default(),
    ...
    async fn test_answer() {
        ...
        use pilotcodi_schema::thread::ThreadRunOptionsInput;
        ...
        let messages = vec![
            make_message(1, "What is Rust?", pilotcodi_schema::thread::Role::User, None),
            make_message(
                2,
            ...
            make_message(
                ...
                pilotcodi_schema::thread::Role::User,
                None,
            ),
        ];
        let options = ThreadRunOptionsInput {
            ...
            doc_query: Some(pilotcodi_schema::thread::DocQueryInput {
