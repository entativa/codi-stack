...
use pilotcodi_schema::{ingestion::IngestionService, job::JobService};
...
) -> pilotcodi_schema::Result<BoxStream<'static, ((String, String), StructuredDoc)>> {
