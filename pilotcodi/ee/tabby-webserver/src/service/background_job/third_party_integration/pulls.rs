...
pub async fn list_pull_states(
    integration_kind: &pilotcodi_schema::integration::IntegrationKind,
    api_base: &str,
    full_name: &str,
    access_token: &str,
) -> Result<BoxStream<'static, (Pull, StructuredDocState)>> {
    match integration_kind {
        pilotcodi_schema::integration::IntegrationKind::Github
        | pilotcodi_schema::integration::IntegrationKind::GithubSelfHosted => {
            list_github_pull_states(api_base, full_name, access_token).await
        }
        pilotcodi_schema::integration::IntegrationKind::Gitlab
        | pilotcodi_schema::integration::IntegrationKind::GitlabSelfHosted => {
