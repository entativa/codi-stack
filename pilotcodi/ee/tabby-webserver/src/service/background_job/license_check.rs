...
To ensure uninterrupted access to PilotCodi and to continue enjoying all the premium features, please renew your license before it expires.

If you have any questions or need assistance with the renewal process, please don't hesitate to contact our support team at support@pilotcodiml.com.
"#
    )
}
