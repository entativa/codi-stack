...
use pilotcodi_common::{config::CodeRepository, index::structured_doc::fields::commit};
use pilotcodi_git::stream_commits;
...
use pilotcodi_schema::Result;

const MAX_COMMIT_HISTORY_COUNT: usize = 10000;

fn to_commit_document(commit: &pilotcodi_git::Commit) -> StructuredDocCommitFields {
