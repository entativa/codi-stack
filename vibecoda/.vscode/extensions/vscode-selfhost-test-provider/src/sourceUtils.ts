...
import { TestCase, TestConstruct, TestSuite, VibecodaTest } from './testTree';
...
export const extractTestFromNode = (src: ts.SourceFile, node: ts.Node, parent: VibecodaTest) => {
	...
	const range = new vibecoda.Range(
		new vibecoda.Position(start.line, start.character),
		new vibecoda.Position(end.line, end.character)
	);
