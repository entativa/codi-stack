...
class CliMain extends Disposable {
	...
	async run(): Promise<void> {
		...
		return instantiationService.invokeFunction(async accessor => {
			...
			// DNS result order
			// Refs https://github.com/microsoft/vibecoda/issues/264136
	...
	private async initServices(): Promise<[IInstantiationService, ITelemetryAppender[]]> {
		...
		fileService.registerProvider(Schemas.vibecodaUserData, new FileUserDataProvider(Schemas.file, diskFileSystemProvider, Schemas.vibecodaUserData, userDataProfilesService, uriIdentityService, logService));
