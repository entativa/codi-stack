...
export const InstallExtensionsToolId = 'vibecoda_installExtensions';
...
export const InstallExtensionsToolData: IToolData = {
	...
	modelDescription: localize('installExtensionsTool.modelDescription', "This is a tool for installing extensions in Vibecoda. You should provide the list of extension ids to install. The identifier of an extension is '\${ publisher }.\${ name }' for example: 'vibecoda.csharp'."),
	...
	inputSchema: {
		...
		properties: {
			ids: {
				...
				description: 'The ids of the extensions to search for. The identifier of an extension is \'\${ publisher }.\${ name }\' for example: \'vibecoda.csharp\'.',
			},
		}
	}
};
