...
suite('SettingsTree', () => {
	...
	test('parseQuery', () => {
		...
		testParseQuery(
			'@ext:github.vibecoda-pull-request-github',
			<IParsedQuery>{
				tags: [],
				extensionFilters: ['github.vibecoda-pull-request-github'],
				query: '',
				featureFilters: [],
				idFilters: [],
				languageFilter: undefined
		...
		testParseQuery(
			'@ext:github.vibecoda-pull-request-github,vibecoda.git',
			<IParsedQuery>{
				tags: [],
				extensionFilters: ['github.vibecoda-pull-request-github', 'vibecoda.git'],
				query: '',
				featureFilters: [],
				idFilters: [],
				languageFilter: undefined
