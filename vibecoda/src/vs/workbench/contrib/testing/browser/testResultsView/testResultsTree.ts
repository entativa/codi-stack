		...
		if (element instanceof TestCaseElement || element instanceof TestMessageElement) {
			...
			if (uri) {
				primary.push(new Action(
					...
					undefined,
					() => this.commandService.executeCommand('vibecoda.revealTest', extId),
				));
			}
			...
			if (capabilities & TestRunProfileBitset.Run) {
				primary.push(new Action(
					...
					ThemeIcon.asClassName(icons.testingRunIcon),
					undefined,
					() => this.commandService.executeCommand('vibecoda.runTestsById', TestRunProfileBitset.Run, extId),
				));
			}
			...
			if (capabilities & TestRunProfileBitset.Debug) {
				primary.push(new Action(
					...
					ThemeIcon.asClassName(icons.testingDebugIcon),
					undefined,
					() => this.commandService.executeCommand('vibecoda.runTestsById', TestRunProfileBitset.Debug, extId),
				));
			}
