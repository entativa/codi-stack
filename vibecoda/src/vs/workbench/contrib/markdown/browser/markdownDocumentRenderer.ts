...
pre code {
	font-family: var(--vibecoda-editor-font-family);
	font-weight: var(--vibecoda-editor-font-weight);
	font-size: var(--vibecoda-editor-font-size);
	line-height: 1.5;
	color: var(--vibecoda-editor-foreground);
	tab-size: 4;
}
...
.pre {
	background-color: var(--vibecoda-textCodeBlock-background);
}

.vibecoda-high-contrast h1 {
 ...
 *
 * Uses Vibecoda's syntax highlighting code blocks. Also does not attach all the hooks and customization that normal
 * markdown renderer.
 */
