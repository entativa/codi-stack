...
const hotExitConfiguration: IConfigurationPropertySchema = isNative ?
	{
		...
		'markdownDescription': nls.localize('hotExit', "[Hot Exit](https://aka.ms/vibecoda-hot-exit) controls whether unsaved files are remembered between sessions, allowing the save prompt when exiting the editor to be skipped.", HotExitConfiguration.ON_EXIT, HotExitConfiguration.ON_EXIT_AND_WINDOW_CLOSE)
	} : {
		'type': 'string',
		'scope': ConfigurationScope.APPLICATION,
