 ...
 */
export const webviewResourceBaseHost = 'vibecoda-cdn.net';

export const webviewRootResourceAuthority = `vibecoda-resource.${webviewResourceBaseHost}`;
 ...
 *
 * ```txt
 * ${scheme}+${resource-authority}.vibecoda-resource.vibecoda-cdn.net/${path}
 * ```
 *
