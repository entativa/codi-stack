...
/**
 * Allows webviews to monitor when an element in the Vibecoda editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. Vibecoda needs to see this
