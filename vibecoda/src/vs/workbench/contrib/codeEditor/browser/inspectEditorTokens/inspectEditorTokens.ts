...
import type { IGrammar, IToken, StateStack } from 'vibecoda-textmate';
...
import type * as TreeSitter from '@vibecoda/tree-sitter-wasm';
...
export class InspectEditorTokensController extends Disposable implements IEditorContribution {
	...
	public launch(): void {
		...
		if (this._editor.getModel().uri.scheme === Schemas.vibecodaNotebookCell) {
