...
export enum PromptFileVariableKind {
	Instruction = 'vibecoda.prompt.instructions.root',
	InstructionReference = `vibecoda.prompt.instructions`,
	PromptFile = 'vibecoda.prompt.file'
}
 ...
 *
 * - `vibecoda.prompt.instructions__<URI>`: for all non-root prompt instructions references
 * - `vibecoda.prompt.instructions.root__<URI>`: for *root* prompt instructions references
 * - `vibecoda.prompt.file__<URI>`: for prompt file references
 *
...
export function toPromptTextVariableEntry(content: string, automaticallyAdded = false, toolReferences?: ChatRequestToolReferenceEntry[]): IPromptTextVariableEntry {
	return {
		id: `vibecoda.prompt.instructions.text`,
