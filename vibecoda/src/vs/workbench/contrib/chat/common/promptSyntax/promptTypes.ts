 ...
 */
export const PROMPT_DOCUMENTATION_URL = 'https://aka.ms/vibecoda-ghcp-prompt-snippets';
export const INSTRUCTIONS_DOCUMENTATION_URL = 'https://aka.ms/vibecoda-ghcp-custom-instructions';
export const AGENT_DOCUMENTATION_URL = 'https://aka.ms/vibecoda-ghcp-custom-chat-modes'; // todo
