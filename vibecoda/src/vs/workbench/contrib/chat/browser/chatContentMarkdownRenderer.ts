...
export const allowedChatMarkdownHtmlTags = Object.freeze([
	...
	// TODO@roblourens when we sanitize attributes in markdown source, we can ban these elements at that step. microsoft/vibecoda-copilot#5091
	// Not in the official list, but used for codicons and other vibecoda markdown extensions
	'span',
	'div',
