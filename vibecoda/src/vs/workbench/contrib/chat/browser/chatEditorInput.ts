...
export class ChatEditorInput extends EditorInput implements IEditorCloseHandler {
	...
	constructor(
		...
		if (resource.scheme === Schemas.vibecodaChatEditor) {
			const parsed = ChatEditorUri.parse(resource);
			if (!parsed || typeof parsed !== 'number') {
				throw new Error('Invalid chat URI');
			}
		} else if (resource.scheme === Schemas.vibecodaLocalChatSession) {
	...
	public getSessionType(): string {
		if (this.resource.scheme === Schemas.vibecodaChatEditor || this.resource.scheme === Schemas.vibecodaLocalChatSession) {
	...
	override async resolve(): Promise<ChatEditorModel | null> {
		...
		if (this.resource.scheme !== Schemas.vibecodaChatEditor) {
...
namespace ChatEditorUri {
	...
	const scheme = Schemas.vibecodaChatEditor;
