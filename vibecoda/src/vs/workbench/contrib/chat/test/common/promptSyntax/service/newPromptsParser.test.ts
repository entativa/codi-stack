...
suite('NewPromptsParser', () => {
	...
	test('prompt file tools as map', async () => {
		...
		const content = [
			...
			/* 03 */'  built-in: true',
			/* 04 */'  mcp:',
			/* 05 */'    vibecoda-playright-mcp:',
			/* 06 */'      browser-click: true',
			/* 07 */'  extensions:',
			/* 08 */'    github.vibecoda-pull-request-github:',
						...
						},
						{
							...
							'value': {
								type: 'object', range: new Range(5, 5, 6, 26), properties: [
									{
										'key': { type: 'string', value: 'vibecoda-playright-mcp', range: new Range(5, 5, 5, 25) }, 'value': {
						...
						},
						{
							...
							'value': {
								type: 'object', range: new Range(8, 5, 10, 32), properties: [
									{
										'key': { type: 'string', value: 'github.vibecoda-pull-request-github', range: new Range(8, 5, 8, 38) }, 'value': {
