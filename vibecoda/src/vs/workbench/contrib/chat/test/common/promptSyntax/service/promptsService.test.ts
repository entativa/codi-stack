		...
		test('header with target', async () => {
					...
					children: [
						{
							...
							children: [
								...
								{
									name: 'vibecoda-agent.agent.md',
									contents: [
										'---',
										'description: \'Vibecoda specialized agent.\'',
										'target: \'vibecoda\'',
										'model: \'gpt-4\'',
										'---',
										'I am specialized for Vibecoda editor tasks.',
									],
								},
								{
			...
			const expected: ICustomAgent[] = [
				...
				},
				{
					...
					model: 'gpt-4',
					agentInstructions: {
						content: 'I am specialized for Vibecoda editor tasks.',
						toolReferences: [],
						metadata: undefined
					},
					handOffs: undefined,
					argumentHint: undefined,
					tools: undefined,
					uri: URI.joinPath(rootFolderUri, '.github/agents/vibecoda-agent.agent.md'),
					source: { storage: PromptsStorage.local }
				},
				{
					name: 'generic-agent',
