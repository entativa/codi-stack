...
suite('PromptHoverProvider', () => {
	...
	suite('agent hovers', () => {
		test('hover on target attribute shows description', async () => {
			...
			assert.strictEqual(hover, 'The target to which the header attributes like tools apply to. Possible values are `github-copilot` and `vibecoda`.');
		});
		...
		test('hover on model attribute with vibecoda target shows model info', async () => {
			const content = [
				'---',
				'description: "Test"',
				'target: vibecoda',
		...
		test('hover on handoffs attribute with vibecoda target shows description', async () => {
			const content = [
				'---',
				'description: "Test"',
				'target: vibecoda',
		...
		test('hover on vibecoda tool shows detailed description', async () => {
			const content = [
				'---',
				'description: "Test"',
				'target: vibecoda',
