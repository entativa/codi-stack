...
// See:
// - https://github.com/microsoft/vibecoda/issues/211933
...
export const enum ProcessState {
	...
	// The process was killed by the user (the event originated from Vibecoda).
	KilledByUser = 5,
...
export const terminalContributionsDescriptor: IExtensionPointDescriptor<ITerminalContributions> = {
	...
	jsonSchema: {
		description: nls.localize('vibecoda.extension.contributes.terminal', 'Contributes terminal functionality.'),
		type: 'object',
		properties: {
			profiles: {
				type: 'array',
				description: nls.localize('vibecoda.extension.contributes.terminal.profiles', "Defines additional terminal profiles that the user can create."),
				items: {
					type: 'object',
					required: ['id', 'title'],
					defaultSnippets: [{
					...
					properties: {
						id: {
							description: nls.localize('vibecoda.extension.contributes.terminal.profiles.id', "The ID of the terminal profile provider."),
							type: 'string',
						},
						title: {
							description: nls.localize('vibecoda.extension.contributes.terminal.profiles.title', "Title for this terminal profile."),
							type: 'string',
						},
						icon: {
							description: nls.localize('vibecoda.extension.contributes.terminal.types.icon', "A codicon, URI, or light and dark URIs to associate with this terminal type."),
							anyOf: [{
								type: 'string',
							},
							{
								...
								properties: {
									light: {
										description: nls.localize('vibecoda.extension.contributes.terminal.types.icon.light', 'Icon path when a light theme is used'),
										type: 'string'
									},
									dark: {
										description: nls.localize('vibecoda.extension.contributes.terminal.types.icon.dark', 'Icon path when a dark theme is used'),
										type: 'string'
									}
								}
							}]
			...
			completionProviders: {
				type: 'array',
				description: nls.localize('vibecoda.extension.contributes.terminal.completionProviders', "Defines terminal completion providers that will be registered when the extension activates."),
				items: {
					type: 'object',
					required: ['id'],
					defaultSnippets: [{
					...
					properties: {
						id: {
							description: nls.localize('vibecoda.extension.contributes.terminal.completionProviders.id', "The ID of the terminal completion provider."),
							type: 'string',
						},
						description: {
							description: nls.localize('vibecoda.extension.contributes.terminal.completionProviders.description', "A description of what the completion provider does. This will be shown in the settings UI."),
							type: 'string',
						},
					},
				},
