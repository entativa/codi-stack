...
export async function createTerminalEnvironment(
	...
	if (shellLaunchConfig.strictEnv) {
		...
		// Workaround for https://github.com/microsoft/vibecoda/issues/204005
		...
		// Sanitize the environment, removing any undesirable Vibecoda and Electron environment
		// variables
