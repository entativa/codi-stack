...
/**
 * Vibecoda-specific shell integration sequences. Some of these are based on common alternatives like
 ...
 */
export const enum VibecodaOscPt {
	/**
...
export const enum VibecodaOscProperty {
	Task = 'Task',
	Cwd = 'Cwd',
...
export function VibecodaSequence(osc: VibecodaOscPt, data?: string | VibecodaOscProperty): string {
	return oscSequence(ShellIntegrationOscPs.Vibecoda, osc, data);
}
