 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in Vibecoda UI).
 */
 ...
 * to represent terminals that appear in other parts of the Vibecoda UI outside
 ...
 * positions, decorations, etc.) from the rest of vibecoda. This is the interface to use for
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their Vibecoda OSC `SetMarker`
