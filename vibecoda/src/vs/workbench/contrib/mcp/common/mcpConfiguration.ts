...
export const mcpContributionPoint: IExtensionPointDescriptor<IMcpCollectionContribution[]> = {
	...
	jsonSchema: {
		description: localize('vibecoda.extension.contributes.mcp', 'Contributes Model Context Protocol servers. Users of this should also use `vibecoda.lm.registerMcpServerDefinitionProvider`.'),
		type: 'array',
		...
		items: {
			...
			properties: {
				id: {
					description: localize('vibecoda.extension.contributes.mcp.id', "Unique ID for the collection."),
					type: 'string'
				},
				label: {
					description: localize('vibecoda.extension.contributes.mcp.label', "Display name for the collection."),
					type: 'string'
				},
				when: {
					description: localize('vibecoda.extension.contributes.mcp.when', "Condition which must be true to enable this collection."),
					type: 'string'
				}
			}
		}
