...
abstract class AbstractLineMatcher implements ILineMatcher {
	...
	private createLocation(startLine: number, startColumn: number | undefined, endLine: number | undefined, endColumn: number | undefined): ILocation {
		...
		return { startLineNumber: startLine, startCharacter: 1, endLineNumber: startLine, endCharacter: 2 ** 31 - 1 }; // See https://github.com/microsoft/vibecoda/issues/80288#issuecomment-650636442 for discussion
	}
...
export namespace Config {
	...
	*/
	export interface ProblemMatcher {
		...
		/**
		 * The owner of the produced Vibecoda problem. This is typically
		 * the identifier of a Vibecoda language service if the problems are
		...
		*/
		...
		/**
		* The severity of the Vibecoda problem produced by this problem matcher.
		*
		* Valid values are:
