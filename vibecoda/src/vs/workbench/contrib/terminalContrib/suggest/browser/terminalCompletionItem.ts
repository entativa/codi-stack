...
export function mapLspKindToTerminalKind(lspKind: CompletionItemKind): TerminalCompletionItemKind {
	// TODO: Add more types for different [LSP providers](https://github.com/microsoft/vibecoda/issues/249480)
...
export class TerminalCompletionItem extends SimpleCompletionItem {
	...
	constructor(
		...
		// See https://github.com/microsoft/vibecoda/issues/255864
