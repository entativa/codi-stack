				...
				case 'outsideWorkspace': {
					...
					if (workspaceFolders.length > 0) {
						for (const fileWrite of fileWrites) {
							...
							// TODO: Handle command substitutions/complex destinations properly https://github.com/microsoft/vibecoda/issues/274167
							// TODO: Handle environment variables properly https://github.com/microsoft/vibecoda/issues/274166
