...
export class RemoteStatusIndicator extends Disposable implements IWorkbenchContribution {
	...
	private updateRemoteStatusIndicator(): void {
		...
		if (this.remoteAuthority) {
			const hostLabel = this.labelService.getHostLabel(Schemas.vibecodaRemote, this.remoteAuthority) || this.remoteAuthority;
			switch (this.connectionState) {
				...
				default: {
					...
					const hostNameTooltip = this.labelService.getHostTooltip(Schemas.vibecodaRemote, this.remoteAuthority);
					if (hostNameTooltip) {
