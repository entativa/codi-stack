...
suite('Link protection domain matching', () => {
	...
	test('no scheme', () => {
		...
		// https://github.com/microsoft/vibecoda/issues/249353
	...
	test('case normalization', () => {
		// https://github.com/microsoft/vibecoda/issues/99294
		linkAllowedByRules('https://github.com/microsoft/vibecoda/issues/new', ['https://github.com/microsoft']);
		linkAllowedByRules('https://github.com/microsoft/vibecoda/issues/new', ['https://github.com/microsoft']);
	});

	test('ignore query & fragment - https://github.com/microsoft/vibecoda/issues/156839', () => {
