 ...
 * Vibecoda effectively treats it the same as true right now. "Partial
...
export namespace NotebookMetadataUri {
	export const scheme = Schemas.vibecodaNotebookMetadata;
...
export namespace CellUri {
	export const scheme = Schemas.vibecodaNotebookCell;
