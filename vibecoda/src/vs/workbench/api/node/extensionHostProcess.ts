...
// workaround for https://github.com/microsoft/vibecoda/issues/85490
...
function patchProcess(allowExit: boolean) {
	...
	// on the desktop.
	// Refs https://github.com/microsoft/vibecoda/issues/151012#issuecomment-1156593228
...
if (!args.supportGlobalNavigator) {
	Object.defineProperty(globalThis, 'navigator', {
		get: () => {
			onUnexpectedExternalError(new PendingMigrationError('navigator is now a global in nodejs, please see https://aka.ms/vibecoda-extensions/navigator for additional info on this error.'));
			return undefined;
		}
	});
}
...
async function startExtensionHostProcess(): Promise<void> {
	...
	// setup things
	patchProcess(!!initData.environment.extensionTestsLocationURI); // to support other test frameworks like Jasmin that use process.exit (https://github.com/microsoft/vibecoda/issues/37708)
