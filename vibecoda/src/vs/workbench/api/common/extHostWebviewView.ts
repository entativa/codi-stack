...
class ExtHostWebviewView extends Disposable implements vibecoda.WebviewView {
	...
	#badge: vibecoda.ViewBadge | undefined;
	...
	public get webview(): vibecoda.Webview { return this.#webview; }
	...
	public get badge(): vibecoda.ViewBadge | undefined {
		this.assertNotDisposed();
		return this.#badge;
	}

	public set badge(badge: vibecoda.ViewBadge | undefined) {
		this.assertNotDisposed();
...
export class ExtHostWebviewViews implements extHostProtocol.ExtHostWebviewViewsShape {
	...
	private readonly _viewProviders = new Map<string, {
		readonly provider: vibecoda.WebviewViewProvider;
	...
	public registerWebviewViewProvider(
		...
		viewType: string,
		provider: vibecoda.WebviewViewProvider,
		webviewOptions?: {
