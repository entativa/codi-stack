...
export interface IExtHostTask extends ExtHostTaskShape {
	...
	taskExecutions: vibecoda.TaskExecution[];
	readonly onDidStartTask: Event<vibecoda.TaskStartEvent>;
	readonly onDidEndTask: Event<vibecoda.TaskEndEvent>;
	readonly onDidStartTaskProcess: Event<vibecoda.TaskProcessStartEvent>;
	readonly onDidEndTaskProcess: Event<vibecoda.TaskProcessEndEvent>;
	readonly onDidStartTaskProblemMatchers: Event<vibecoda.TaskProblemMatcherStartedEvent>;
	readonly onDidEndTaskProblemMatchers: Event<vibecoda.TaskProblemMatcherEndedEvent>;

	registerTaskProvider(extension: IExtensionDescription, type: string, provider: vibecoda.TaskProvider): vibecoda.Disposable;
	registerTaskSystem(scheme: string, info: tasks.ITaskSystemInfoDTO): void;
	fetchTasks(filter?: vibecoda.TaskFilter): Promise<vibecoda.Task[]>;
	executeTask(extension: IExtensionDescription, task: vibecoda.Task): Promise<vibecoda.TaskExecution>;
	terminateTask(execution: vibecoda.TaskExecution): Promise<void>;
}

namespace TaskDefinitionDTO {
	export function from(value: vibecoda.TaskDefinition): tasks.ITaskDefinitionDTO | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		return value;
	}
	export function to(value: tasks.ITaskDefinitionDTO): vibecoda.TaskDefinition | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		return value;
...
namespace TaskPresentationOptionsDTO {
	export function from(value: vibecoda.TaskPresentationOptions): tasks.ITaskPresentationOptionsDTO | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		return value;
	}
	export function to(value: tasks.ITaskPresentationOptionsDTO): vibecoda.TaskPresentationOptions | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		return value;
...
namespace ProcessExecutionOptionsDTO {
	export function from(value: vibecoda.ProcessExecutionOptions): tasks.IProcessExecutionOptionsDTO | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		return value;
	}
	export function to(value: tasks.IProcessExecutionOptionsDTO): vibecoda.ProcessExecutionOptions | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		return value;
...
namespace ProcessExecutionDTO {
	...
	export function from(value: vibecoda.ProcessExecution): tasks.IProcessExecutionDTO | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
...
namespace ShellExecutionOptionsDTO {
	export function from(value: vibecoda.ShellExecutionOptions): tasks.IShellExecutionOptionsDTO | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		return value;
	}
	export function to(value: tasks.IShellExecutionOptionsDTO): vibecoda.ShellExecutionOptions | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		return value;
...
namespace ShellExecutionDTO {
	...
	export function from(value: vibecoda.ShellExecution): tasks.IShellExecutionDTO | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
...
export namespace CustomExecutionDTO {
	...
	export function from(value: vibecoda.CustomExecution): tasks.ICustomExecutionDTO {
		return {
...
namespace TaskGroupDTO {
	export function from(value: vibecoda.TaskGroup): tasks.ITaskGroupDTO | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
...
export namespace TaskDTO {
	export function fromMany(tasks: vibecoda.Task[], extension: IExtensionDescription): tasks.ITaskDTO[] {
	...
	export function from(value: vibecoda.Task, extension: IExtensionDescription): tasks.ITaskDTO | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		...
		const result: tasks.ITaskDTO = {
			...
			group: TaskGroupDTO.from(value.group as vibecoda.TaskGroup),
	...
	export async function to(value: tasks.ITaskDTO | undefined, workspace: IExtHostWorkspaceProvider, providedCustomExeutions: Map<string, types.CustomExecution>): Promise<types.Task | undefined> {
		...
		const definition: vibecoda.TaskDefinition | undefined = TaskDefinitionDTO.to(value.definition);
		let scope: vibecoda.TaskScope.Global | vibecoda.TaskScope.Workspace | vibecoda.WorkspaceFolder | undefined;
		if (value.source) {
...
namespace TaskFilterDTO {
	export function from(value: vibecoda.TaskFilter | undefined): tasks.ITaskFilterDTO | undefined {
		return value;
	}

	export function to(value: tasks.ITaskFilterDTO): vibecoda.TaskFilter | undefined {
		if (!value) {
			return undefined;
		}
...
class TaskExecutionImpl implements vibecoda.TaskExecution {

	readonly #tasks: ExtHostTaskBase;
	private _terminal: vibecoda.Terminal | undefined;

	constructor(tasks: ExtHostTaskBase, readonly _id: string, private readonly _task: vibecoda.Task) {
		this.#tasks = tasks;
	}

	public get task(): vibecoda.Task {
		return this._task;
	}
	...
	public get terminal(): vibecoda.Terminal | undefined {
		return this._terminal;
	}

	public set terminal(term: vibecoda.Terminal | undefined) {
		this._terminal = term;
	}
}
...
export interface HandlerData {
	type: string;
	provider: vibecoda.TaskProvider;
...
export abstract class ExtHostTaskBase implements ExtHostTaskShape, IExtHostTask {
	...
	protected readonly _onDidExecuteTask: Emitter<vibecoda.TaskStartEvent> = new Emitter<vibecoda.TaskStartEvent>();
	protected readonly _onDidTerminateTask: Emitter<vibecoda.TaskEndEvent> = new Emitter<vibecoda.TaskEndEvent>();

	protected readonly _onDidTaskProcessStarted: Emitter<vibecoda.TaskProcessStartEvent> = new Emitter<vibecoda.TaskProcessStartEvent>();
	protected readonly _onDidTaskProcessEnded: Emitter<vibecoda.TaskProcessEndEvent> = new Emitter<vibecoda.TaskProcessEndEvent>();
	protected readonly _onDidStartTaskProblemMatchers: Emitter<vibecoda.TaskProblemMatcherStartedEvent> = new Emitter<vibecoda.TaskProblemMatcherStartedEvent>();
	protected readonly _onDidEndTaskProblemMatchers: Emitter<vibecoda.TaskProblemMatcherEndedEvent> = new Emitter<vibecoda.TaskProblemMatcherEndedEvent>();
	...
	public registerTaskProvider(extension: IExtensionDescription, type: string, provider: vibecoda.TaskProvider): vibecoda.Disposable {
		if (!provider) {
	...
	public fetchTasks(filter?: vibecoda.TaskFilter): Promise<vibecoda.Task[]> {
	...
	public abstract executeTask(extension: IExtensionDescription, task: vibecoda.Task): Promise<vibecoda.TaskExecution>;

	public get taskExecutions(): vibecoda.TaskExecution[] {
		const result: vibecoda.TaskExecution[] = [];
		this._taskExecutions.forEach(value => result.push(value));
		return result;
	}

	public terminateTask(execution: vibecoda.TaskExecution): Promise<void> {
	...
	public get onDidStartTask(): Event<vibecoda.TaskStartEvent> {
	...
	public get onDidEndTask(): Event<vibecoda.TaskEndEvent> {
	...
	public async $OnDidEndTask(execution: tasks.ITaskExecutionDTO): Promise<void> {
		if (!this._taskExecutionPromises.has(execution.id)) {
			...
			// See https://github.com/microsoft/vibecoda/commit/aaf73920aeae171096d205efb2c58804a32b6846
			return;
		}
	...
	public get onDidStartTaskProcess(): Event<vibecoda.TaskProcessStartEvent> {
	...
	public get onDidEndTaskProcess(): Event<vibecoda.TaskProcessEndEvent> {
	...
	public get onDidStartTaskProblemMatchers(): Event<vibecoda.TaskProblemMatcherStartedEvent> {
	...
	public get onDidEndTaskProblemMatchers(): Event<vibecoda.TaskProblemMatcherEndedEvent> {
	...
	protected abstract provideTasksInternal(validTypes: { [key: string]: boolean }, taskIdPromises: Promise<void>[], handler: HandlerData, value: vibecoda.Task[] | null | undefined): { tasks: tasks.ITaskDTO[]; extension: IExtensionDescription };
	...
	protected async addCustomExecution(taskDTO: tasks.ITaskDTO, task: vibecoda.Task, isProvided: boolean): Promise<void> {
	...
	protected async getTaskExecution(execution: tasks.ITaskExecutionDTO | string, task?: vibecoda.Task): Promise<TaskExecutionImpl> {
	...
	protected checkDeprecation(task: vibecoda.Task, handler: HandlerData) {
	...
	private customExecutionComplete(execution: tasks.ITaskExecutionDTO): void {
		const extensionCallback2: vibecoda.CustomExecution | undefined = this._activeCustomExecutions2.get(execution.id);
...
export class WorkerExtHostTask extends ExtHostTaskBase {
	constructor(
		...
		this.registerTaskSystem(Schemas.vibecodaRemote, {
			scheme: Schemas.vibecodaRemote,
			authority: '',
			platform: Platform.PlatformToString(Platform.Platform.Web)
		});
	}

	public async executeTask(extension: IExtensionDescription, task: vibecoda.Task): Promise<vibecoda.TaskExecution> {
		if (!task.execution) {
	...
	protected provideTasksInternal(validTypes: { [key: string]: boolean }, taskIdPromises: Promise<void>[], handler: HandlerData, value: vibecoda.Task[] | null | undefined): { tasks: tasks.ITaskDTO[]; extension: IExtensionDescription } {
