...
export class ExtHostChatOutputRenderer implements ExtHostChatOutputRendererShape {
	...
	private readonly _renderers = new Map</*viewType*/ string, {
		readonly renderer: vibecoda.ChatOutputRenderer;
	...
	registerChatOutputRenderer(extension: IExtensionDescription, viewType: string, renderer: vibecoda.ChatOutputRenderer): vibecoda.Disposable {
