...
export class Range {
	...
	static isRange(thing: unknown): thing is vibecoda.Range {
	...
	static of(obj: vibecoda.Range): Range {
	...
	constructor(start: vibecoda.Position, end: vibecoda.Position);
	constructor(start: Position, end: Position);
	constructor(startLine: number, startColumn: number, endLine: number, endColumn: number);
	constructor(startLineOrStart: number | Position | vibecoda.Position, startColumnOrEnd: number | Position | vibecoda.Position, endLine?: number, endColumn?: number) {
...
export function getDebugDescriptionOfRange(range: vibecoda.Range): string {
