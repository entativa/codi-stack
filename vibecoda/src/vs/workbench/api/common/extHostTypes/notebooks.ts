...
export class NotebookRange {
	static isNotebookRange(thing: unknown): thing is vibecoda.NotebookRange {
...
export class NotebookCellData {
	...
	static isNotebookCellDataArray(value: unknown): value is vibecoda.NotebookCellData[] {
		return Array.isArray(value) && (<unknown[]>value).every(elem => NotebookCellData.isNotebookCellData(elem));
	}

	static isNotebookCellData(value: unknown): value is vibecoda.NotebookCellData {
	...
	languageId: string;
	mime?: string;
	outputs?: vibecoda.NotebookCellOutput[];
	metadata?: Record<string, unknown>;
	executionSummary?: vibecoda.NotebookCellExecutionSummary;

	constructor(kind: NotebookCellKind, value: string, languageId: string, mime?: string, outputs?: vibecoda.NotebookCellOutput[], metadata?: Record<string, unknown>, executionSummary?: vibecoda.NotebookCellExecutionSummary) {
		this.kind = kind;
		this.value = value;
...
@es5ClassCompat
export class NotebookEdit implements vibecoda.NotebookEdit {
	...
	static insertCells(index: number, newCells: vibecoda.NotebookCellData[]): vibecoda.NotebookEdit {
...
export class NotebookCellOutputItem {
	...
	static isNotebookCellOutputItem(obj: unknown): obj is vibecoda.NotebookCellOutputItem {
		...
		return typeof (<vibecoda.NotebookCellOutputItem>obj).mime === 'string'
			&& (<vibecoda.NotebookCellOutputItem>obj).data instanceof Uint8Array;
	}
...
export class NotebookCellOutput {
	...
	static isNotebookCellOutput(candidate: unknown): candidate is vibecoda.NotebookCellOutput {
