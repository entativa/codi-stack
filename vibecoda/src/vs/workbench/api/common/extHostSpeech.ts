...
export class ExtHostSpeech implements ExtHostSpeechShape {
	...
	private readonly providers = new Map<number, vibecoda.SpeechProvider>();
	private readonly sessions = new Map<number, CancellationTokenSource>();
	private readonly synthesizers = new Map<number, vibecoda.TextToSpeechSession>();
	...
	registerProvider(extension: ExtensionIdentifier, identifier: string, provider: vibecoda.SpeechProvider): IDisposable {
