...
export interface IExtHostTestItemApi {
	controllerId: string;
	parent?: vibecoda.TestItem;
	listener?: (evt: ExtHostTestItemEvent) => void;
}

const eventPrivateApis = new WeakMap<vibecoda.TestItem, IExtHostTestItemApi>();

export const createPrivateApiFor = (impl: vibecoda.TestItem, controllerId: string) => {
 ...
 */
export const getPrivateApiFor = (impl: vibecoda.TestItem) => {
