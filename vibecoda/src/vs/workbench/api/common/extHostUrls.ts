...
export class ExtHostUrls implements ExtHostUrlsShape {
	...
	private handlers = new Map<number, vibecoda.UriHandler>();
	...
	registerUriHandler(extension: IExtensionDescription, handler: vibecoda.UriHandler): vibecoda.Disposable {
	...
	async createAppUri(uri: URI): Promise<vibecoda.Uri> {
