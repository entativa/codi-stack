...
export class ExtHostChatStatus {
	...
	private readonly _items = new Map<string, vibecoda.ChatStatusItem>();
	...
	createChatStatusItem(extension: IExtensionDescription, id: string): vibecoda.ChatStatusItem {
		...
		const item = Object.freeze<vibecoda.ChatStatusItem>({
			id: id,
