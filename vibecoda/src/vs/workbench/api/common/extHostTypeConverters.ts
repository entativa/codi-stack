...
export namespace Command {
	...
	export interface ICommandsConverter {
		fromInternal(command: extHostProtocol.ICommandDto): vibecoda.Command | undefined;
		toInternal(command: vibecoda.Command | undefined, disposables: DisposableStore): extHostProtocol.ICommandDto | undefined;
	}
}
...
export namespace Location {
	...
	export function from(location: vibecoda.Location): Dto<languages.Location> {
		return {
			uri: location.uri,
	...
	export function to(location: Dto<languages.Location>): vibecoda.Location {
...
export namespace Position {
	...
	export function from(position: types.Position | vibecoda.Position): IPosition {
...
export namespace DocumentSelector {
	...
	export function from(value: vibecoda.DocumentSelector, uriTransformer?: IURITransformer, extension?: IExtensionDescription): extHostProtocol.IDocumentFilterDto[] {
		return coalesce(asArray(value).map(sel => _doTransformDocumentSelector(sel, uriTransformer, extension)));
	}

	function _doTransformDocumentSelector(selector: string | vibecoda.DocumentFilter, uriTransformer: IURITransformer | undefined, extension: IExtensionDescription | undefined): extHostProtocol.IDocumentFilterDto | undefined {
...
export namespace DiagnosticTag {
	export function from(value: vibecoda.DiagnosticTag): MarkerTag | undefined {
		switch (value) {
	...
	export function to(value: MarkerTag): vibecoda.DiagnosticTag | undefined {
		switch (value) {
...
export namespace Diagnostic {
	export function from(value: vibecoda.Diagnostic): IMarkerData {
	...
	export function to(value: IMarkerData): vibecoda.Diagnostic {
...
export namespace DiagnosticRelatedInformation {
	export function from(value: vibecoda.DiagnosticRelatedInformation): IRelatedInformation {
		return {
...
export namespace ViewColumn {
	export function from(column?: vibecoda.ViewColumn): EditorGroupColumn {
	...
	export function to(position: EditorGroupColumn): vibecoda.ViewColumn {
...
function isDecorationOptions(something: any): something is vibecoda.DecorationOptions {
	return (typeof something.range !== 'undefined');
}

export function isDecorationOptionsArr(something: vibecoda.Range[] | vibecoda.DecorationOptions[]): something is vibecoda.DecorationOptions[] {
...
export namespace MarkdownString {
	...
	export function fromMany(markup: (vibecoda.MarkdownString | vibecoda.MarkedString)[]): htmlContent.IMarkdownString[] {
	...
	export function from(markup: vibecoda.MarkdownString | vibecoda.MarkedString): htmlContent.IMarkdownString {
	...
	export function to(value: htmlContent.IMarkdownString): vibecoda.MarkdownString {
	...
	export function fromStrict(value: string | vibecoda.MarkdownString | undefined | null): undefined | string | htmlContent.IMarkdownString {
		if (!value) {
			return undefined;
		}
...
export function fromRangeOrRangeWithMessage(ranges: vibecoda.Range[] | vibecoda.DecorationOptions[]): IDecorationOptions[] {
...
export namespace ThemableDecorationAttachmentRenderOptions {
	export function from(options: vibecoda.ThemableDecorationAttachmentRenderOptions): IContentDecorationRenderOptions {
...
export namespace ThemableDecorationRenderOptions {
	export function from(options: vibecoda.ThemableDecorationRenderOptions): IThemeDecorationRenderOptions {
		if (typeof options === 'undefined') {
			return options;
		}
		return {
...
export namespace DecorationRenderOptions {
	export function from(options: vibecoda.DecorationRenderOptions): IDecorationRenderOptions {
		return {
...
export namespace TextEdit {
	...
	export function from(edit: vibecoda.TextEdit): languages.TextEdit {
		return {
			text: edit.newText,
...
export namespace WorkspaceEdit {
	...
	export function from(value: vibecoda.WorkspaceEdit, versionInfo?: IVersionInformationProvider): extHostProtocol.IWorkspaceEditDto {
...
export namespace SymbolKind {
	...
	export function from(kind: vibecoda.SymbolKind): languages.SymbolKind {
		return typeof _fromMapping[kind] === 'number' ? _fromMapping[kind] : languages.SymbolKind.Property;
	}

	export function to(kind: languages.SymbolKind): vibecoda.SymbolKind {
...
export namespace WorkspaceSymbol {
	export function from(info: vibecoda.SymbolInformation): search.IWorkspaceSymbol {
		return {
			name: info.name,
...
export namespace DocumentSymbol {
	export function from(info: vibecoda.DocumentSymbol): languages.DocumentSymbol {
	...
	export function to(info: languages.DocumentSymbol): vibecoda.DocumentSymbol {
...
export namespace CallHierarchyItem {
	...
	export function from(item: vibecoda.CallHierarchyItem, sessionId?: string, itemId?: string): extHostProtocol.ICallHierarchyItemDto {
...
export namespace location {
	export function from(value: vibecoda.Location): languages.Location {
		return {
...
export namespace DefinitionLink {
	export function from(value: vibecoda.Location | vibecoda.DefinitionLink): languages.LocationLink {
		const definitionLink = <vibecoda.DefinitionLink>value;
		const location = <vibecoda.Location>value;
		return {
	...
	export function to(value: extHostProtocol.ILocationLinkDto): vibecoda.LocationLink {
		return {
...
export namespace Hover {
	export function from(hover: vibecoda.VerboseHover): languages.Hover {
...
export namespace EvaluatableExpression {
	export function from(expression: vibecoda.EvaluatableExpression): languages.EvaluatableExpression {
		return {
...
export namespace InlineValue {
	export function from(inlineValue: vibecoda.InlineValue): languages.InlineValue {
	...
	export function to(inlineValue: languages.InlineValue): vibecoda.InlineValue {
		switch (inlineValue.type) {
			case 'text':
				return {
					range: Range.to(inlineValue.range),
					text: inlineValue.text
				} satisfies vibecoda.InlineValueText;
			case 'variable':
				return {
					range: Range.to(inlineValue.range),
					variableName: inlineValue.variableName,
					caseSensitiveLookup: inlineValue.caseSensitiveLookup
				} satisfies vibecoda.InlineValueVariableLookup;
			case 'expression':
				return {
					range: Range.to(inlineValue.range),
					expression: inlineValue.expression
				} satisfies vibecoda.InlineValueEvaluatableExpression;
		}
	}
}

export namespace InlineValueContext {
	export function from(inlineValueContext: vibecoda.InlineValueContext): extHostProtocol.IInlineValueContextDto {
		return {
...
export namespace DocumentHighlight {
	export function from(documentHighlight: vibecoda.DocumentHighlight): languages.DocumentHighlight {
		return {
...
export namespace MultiDocumentHighlight {
	export function from(multiDocumentHighlight: vibecoda.MultiDocumentHighlight): languages.MultiDocumentHighlight {
		return {
...
export namespace CompletionCommand {
	export function from(c: vibecoda.Command | { command: vibecoda.Command; icon: vibecoda.ThemeIcon }, converter: CommandsConverter, disposables: DisposableStore): { command: extHostProtocol.ICommandDto; icon?: languages.IconPath } {
...
export namespace InlayHint {
	...
	export function to(converter: Command.ICommandsConverter, hint: languages.InlayHint): vibecoda.InlayHint {
...
export namespace InlayHintKind {
	export function from(kind: vibecoda.InlayHintKind): languages.InlayHintKind {
		return kind;
	}
	export function to(kind: languages.InlayHintKind): vibecoda.InlayHintKind {
		return kind;
	}
}
...
export namespace DocumentLink {
	...
	export function from(link: vibecoda.DocumentLink): languages.ILink {
		return {
	...
	export function to(link: languages.ILink): vibecoda.DocumentLink {
...
export namespace ColorPresentation {
	...
	export function from(colorPresentation: vibecoda.ColorPresentation): languages.IColorPresentation {
		return {
...
export namespace SelectionRange {
	export function from(obj: vibecoda.SelectionRange): languages.SelectionRange {
		return { range: Range.from(obj.range) };
	}

	export function to(obj: languages.SelectionRange): vibecoda.SelectionRange {
...
export namespace TextDocumentSaveReason {
	...
	export function to(reason: SaveReason): vibecoda.TextDocumentSaveReason {
		switch (reason) {
...
export namespace TextEditorLineNumbersStyle {
	export function from(style: vibecoda.TextEditorLineNumbersStyle): RenderLineNumbersType {
		switch (style) {
	...
	export function to(style: RenderLineNumbersType): vibecoda.TextEditorLineNumbersStyle {
		switch (style) {
...
export namespace EndOfLine {
	...
	export function from(eol: vibecoda.EndOfLine): EndOfLineSequence | undefined {
	...
	export function to(eol: EndOfLineSequence): vibecoda.EndOfLine | undefined {
...
export namespace ProgressLocation {
	export function from(loc: vibecoda.ProgressLocation | { viewId: string }): MainProgressLocation | string {
...
export namespace FoldingRange {
	export function from(r: vibecoda.FoldingRange): languages.FoldingRange {
	...
	export function to(r: languages.FoldingRange): vibecoda.FoldingRange {
		const range: vibecoda.FoldingRange = { start: r.start - 1, end: r.end - 1 };
		if (r.kind) {
...
export namespace FoldingRangeKind {
	export function from(kind: vibecoda.FoldingRangeKind | undefined): languages.FoldingRangeKind | undefined {
		if (kind) {
			switch (kind) {
	...
	export function to(kind: languages.FoldingRangeKind | undefined): vibecoda.FoldingRangeKind | undefined {
		if (kind) {
			switch (kind.value) {
...
export interface TextEditorOpenOptions extends vibecoda.TextDocumentShowOptions {
	background?: boolean;
	override?: boolean;
}
...
export namespace GlobPattern {
	...
	export function from(pattern: vibecoda.GlobPattern): string | extHostProtocol.IRelativePatternDto;
	export function from(pattern: undefined): undefined;
	export function from(pattern: null): null;
	export function from(pattern: vibecoda.GlobPattern | undefined | null): string | extHostProtocol.IRelativePatternDto | undefined | null;
	export function from(pattern: vibecoda.GlobPattern | undefined | null): string | extHostProtocol.IRelativePatternDto | undefined | null {
		...
		// `vibecoda.GlobPattern` which can be `vibecoda.RelativePattern` class,
		// but given we cannot enforce classes from our vibecoda.d.ts, we have
		// to probe for objects too
		// Refs: https://github.com/microsoft/vibecoda/issues/140771
	...
	function isLegacyRelativePatternShape(obj: unknown): obj is { base: string; pattern: string } {
		...
		// we allow this old format when creating the `vibecoda.RelativePattern`.
	...
	export function to(pattern: string | extHostProtocol.IRelativePatternDto): vibecoda.GlobPattern {
		if (typeof pattern === 'string') {
			return pattern;
		}
...
export namespace LanguageSelector {
	...
	export function from(selector: vibecoda.DocumentSelector): languageSelector.LanguageSelector;
	export function from(selector: vibecoda.DocumentSelector | undefined): languageSelector.LanguageSelector | undefined;
	export function from(selector: vibecoda.DocumentSelector | undefined): languageSelector.LanguageSelector | undefined {
		if (!selector) {
			return undefined;
...
export namespace NotebookRange {
	...
	export function from(range: vibecoda.NotebookRange): ICellRange {
...
export namespace NotebookCellExecutionSummary {
	export function to(data: notebooks.NotebookCellInternalMetadata): vibecoda.NotebookCellExecutionSummary {
		return {
	...
	export function from(data: vibecoda.NotebookCellExecutionSummary): Partial<notebooks.NotebookCellInternalMetadata> {
		return {
...
export namespace NotebookCellKind {
	export function from(data: vibecoda.NotebookCellKind): notebooks.CellKind {
		switch (data) {
	...
	export function to(data: notebooks.CellKind): vibecoda.NotebookCellKind {
		switch (data) {
...
export namespace NotebookData {
	...
	export function from(data: vibecoda.NotebookData): extHostProtocol.NotebookDataDto {
	...
	export function to(data: extHostProtocol.NotebookDataDto): vibecoda.NotebookData {
...
export namespace NotebookCellData {
	...
	export function from(data: vibecoda.NotebookCellData): extHostProtocol.NotebookCellDataDto {
		return {
	...
	export function to(data: extHostProtocol.NotebookCellDataDto): vibecoda.NotebookCellData {
...
export namespace NotebookCellOutput {
	export function from(output: vibecoda.NotebookCellOutput): extHostProtocol.NotebookOutputDto {
		return {
			outputId: output.id,
	...
	export function to(output: extHostProtocol.NotebookOutputDto): vibecoda.NotebookCellOutput {
...
export namespace NotebookExclusiveDocumentPattern {
	export function from(pattern: { include: vibecoda.GlobPattern | undefined; exclude: vibecoda.GlobPattern | undefined }): { include: string | extHostProtocol.IRelativePatternDto | undefined; exclude: string | extHostProtocol.IRelativePatternDto | undefined };
	export function from(pattern: vibecoda.GlobPattern): string | extHostProtocol.IRelativePatternDto;
	export function from(pattern: undefined): undefined;
	export function from(pattern: { include: vibecoda.GlobPattern | undefined | null; exclude: vibecoda.GlobPattern | undefined } | vibecoda.GlobPattern | undefined): string | extHostProtocol.IRelativePatternDto | { include: string | extHostProtocol.IRelativePatternDto | undefined; exclude: string | extHostProtocol.IRelativePatternDto | undefined } | undefined;
	export function from(pattern: { include: vibecoda.GlobPattern | undefined | null; exclude: vibecoda.GlobPattern | undefined } | vibecoda.GlobPattern | undefined): string | extHostProtocol.IRelativePatternDto | { include: string | extHostProtocol.IRelativePatternDto | undefined; exclude: string | extHostProtocol.IRelativePatternDto | undefined } | undefined {
	...
	export function to(pattern: string | extHostProtocol.IRelativePatternDto | { include: string | extHostProtocol.IRelativePatternDto; exclude: string | extHostProtocol.IRelativePatternDto }): { include: vibecoda.GlobPattern; exclude: vibecoda.GlobPattern } | vibecoda.GlobPattern {
		if (isExclusivePattern(pattern)) {
			return {
...
export namespace NotebookStatusBarItem {
	export function from(item: vibecoda.NotebookCellStatusBarItem, commandsConverter: Command.ICommandsConverter, disposables: DisposableStore): notebooks.INotebookCellStatusBarItem {
...
export namespace NotebookKernelSourceAction {
	export function from(item: vibecoda.NotebookKernelSourceAction, commandsConverter: Command.ICommandsConverter, disposables: DisposableStore): notebooks.INotebookKernelSourceAction {
		const command = typeof item.command === 'string' ? { title: '', command: item.command } : item.command;
...
export namespace NotebookDocumentContentOptions {
	export function from(options: vibecoda.NotebookDocumentContentOptions | undefined): notebooks.TransientOptions {
		return {
...
export namespace NotebookRendererScript {
	export function from(preload: vibecoda.NotebookRendererScript): { uri: UriComponents; provides: readonly string[] } {
		return {
			uri: preload.uri,
	...
	export function to(preload: { uri: UriComponents; provides: readonly string[] }): vibecoda.NotebookRendererScript {
		return new types.NotebookRendererScript(URI.revive(preload.uri), preload.provides);
	}
}

export namespace TestMessage {
	export function from(message: vibecoda.TestMessage): ITestErrorMessage.Serialized {
		return {
	...
	export function to(item: ITestErrorMessage.Serialized): vibecoda.TestMessage {
...
export namespace TestRunProfileKind {
	const profileGroupToBitset: { [K in vibecoda.TestRunProfileKind]: TestRunProfileBitset } = {
...
export namespace TestItem {
	export type Raw = vibecoda.TestItem;

	export function from(item: vibecoda.TestItem): ITestItem {
	...
	export function toPlain(item: ITestItem.Serialized): vibecoda.TestItem {
		return {
			parent: undefined,
			error: undefined,
...
export namespace TestTag {
	export function from(tag: vibecoda.TestTag): ITestTag {
		return { id: tag.id };
	}

	export function to(tag: ITestTag): vibecoda.TestTag {
		return new types.TestTag(tag.id);
	}
}

export namespace TestResults {
	const convertTestResultItem = (node: IPrefixTreeNode<TestResultItem.Serialized>, parent?: vibecoda.TestResultSnapshot): vibecoda.TestResultSnapshot | undefined => {
		const item = node.value;
		if (!item) {
			return undefined; // should be unreachable
		}

		const snapshot: vibecoda.TestResultSnapshot = ({
	...
	export function to(serialized: ISerializedTestResults): vibecoda.TestRunResult {
...
export namespace TestCoverage {
	function fromCoverageCount(count: vibecoda.TestCoverageCount): ICoverageCount {
		return { covered: count.covered, total: count.total };
	}

	function fromLocation(location: vibecoda.Range | vibecoda.Position) {
	...
	export function to(serialized: CoverageDetails.Serialized): vibecoda.FileCoverageDetail {
		if (serialized.type === DetailType.Statement) {
			const branches: vibecoda.BranchCoverage[] = [];
	...
	export function fromDetails(coverage: vibecoda.FileCoverageDetail): CoverageDetails.Serialized {
	...
	export function fromFile(controllerId: string, id: string, coverage: vibecoda.FileCoverage): IFileCoverage.Serialized {
...
export namespace TypeHierarchyItem {
	...
	export function from(item: vibecoda.TypeHierarchyItem, sessionId?: string, itemId?: string): extHostProtocol.ITypeHierarchyItemDto {
...
export namespace ViewBadge {
	export function from(badge: vibecoda.ViewBadge | undefined): IViewBadge | undefined {
		if (!badge) {
			return undefined;
		}
...
export namespace DataTransferItem {
	...
	export async function from(mime: string, item: vibecoda.DataTransferItem | IDataTransferItem, id: string = generateUuid()): Promise<extHostProtocol.DataTransferItemDTO> {
...
export namespace DataTransfer {
	...
	export async function from(dataTransfer: vibecoda.DataTransfer): Promise<extHostProtocol.DataTransferDTO> {
...
export namespace ChatFollowup {
	export function from(followup: vibecoda.ChatFollowup, request: IChatAgentRequest | undefined): IChatFollowup {
		return {
			kind: 'reply',
	...
	export function to(followup: IChatFollowup): vibecoda.ChatFollowup {
		return {
...
export namespace LanguageModelChatMessageRole {
	export function to(role: chatProvider.ChatMessageRole): vibecoda.LanguageModelChatMessageRole {
		switch (role) {
	...
	export function from(role: vibecoda.LanguageModelChatMessageRole): chatProvider.ChatMessageRole {
		switch (role) {
...
export namespace LanguageModelChatMessage {
	...
	export function to(message: chatProvider.IChatMessage): vibecoda.LanguageModelChatMessage {
	...
	export function from(message: vibecoda.LanguageModelChatMessage): chatProvider.IChatMessage {
...
export namespace LanguageModelChatMessage2 {
	...
	export function to(message: chatProvider.IChatMessage): vibecoda.LanguageModelChatMessage2 {
		const content = message.content.map(c => {
			if (c.type === 'text') {
				return new LanguageModelTextPart(c.value, c.audience);
			} else if (c.type === 'tool_result') {
	...
	export function from(message: vibecoda.LanguageModelChatMessage2): chatProvider.IChatMessage {
...
export namespace ChatResponseMarkdownPart {
	export function from(part: vibecoda.ChatResponseMarkdownPart): Dto<IChatMarkdownContent> {
		return {
			kind: 'markdownContent',
			content: MarkdownString.from(part.value)
		};
	}
	export function to(part: Dto<IChatMarkdownContent>): vibecoda.ChatResponseMarkdownPart {
		return new types.ChatResponseMarkdownPart(MarkdownString.to(part.content));
	}
}

export namespace ChatResponseCodeblockUriPart {
	export function from(part: vibecoda.ChatResponseCodeblockUriPart): Dto<IChatResponseCodeblockUriPart> {
		return {
			kind: 'codeblockUri',
			uri: part.value,
			isEdit: part.isEdit,
	...
	export function to(part: Dto<IChatResponseCodeblockUriPart>): vibecoda.ChatResponseCodeblockUriPart {
...
export namespace ChatResponseMarkdownWithVulnerabilitiesPart {
	export function from(part: vibecoda.ChatResponseMarkdownWithVulnerabilitiesPart): Dto<IChatAgentMarkdownContentWithVulnerability> {
		return {
			kind: 'markdownVuln',
			content: MarkdownString.from(part.value),
	...
	export function to(part: Dto<IChatAgentMarkdownContentWithVulnerability>): vibecoda.ChatResponseMarkdownWithVulnerabilitiesPart {
...
export namespace ChatResponseConfirmationPart {
	export function from(part: vibecoda.ChatResponseConfirmationPart): Dto<IChatConfirmation> {
		return {
			kind: 'confirmation',
			title: part.title,
...
export namespace ChatResponseFilesPart {
	export function from(part: vibecoda.ChatResponseFileTreePart): IChatTreeData {
		const { value, baseUri } = part;
		function convert(items: vibecoda.ChatResponseFileTree[], baseUri: URI): extHostProtocol.IChatResponseProgressFileTreeData[] {
	...
	export function to(part: Dto<IChatTreeData>): vibecoda.ChatResponseFileTreePart {
		const treeData = revive<extHostProtocol.IChatResponseProgressFileTreeData>(part.treeData);
		function convert(items: extHostProtocol.IChatResponseProgressFileTreeData[]): vibecoda.ChatResponseFileTree[] {
			return items.map(item => {
				return {
					name: item.label,
...
export namespace ChatResponseMultiDiffPart {
	export function from(part: vibecoda.ChatResponseMultiDiffPart): IChatMultiDiffData {
		return {
			kind: 'multiDiffData',
			multiDiffData: {
				title: part.title,
	...
	export function to(part: Dto<IChatMultiDiffData>): vibecoda.ChatResponseMultiDiffPart {
...
export namespace ChatResponseAnchorPart {
	export function from(part: vibecoda.ChatResponseAnchorPart): Dto<IChatContentInlineReference> {
		// Work around type-narrowing confusion between vibecoda.Uri and URI
		const isUri = (thing: unknown): thing is vibecoda.Uri => URI.isUri(thing);
		const isSymbolInformation = (thing: object): thing is vibecoda.SymbolInformation => 'name' in thing;
	...
	export function to(part: Dto<IChatContentInlineReference>): vibecoda.ChatResponseAnchorPart {
		...
		return new types.ChatResponseAnchorPart(
			URI.isUri(value.inlineReference)
				...
				: 'location' in value.inlineReference
					? WorkspaceSymbol.to(value.inlineReference) as vibecoda.SymbolInformation
...
export namespace ChatResponseProgressPart {
	export function from(part: vibecoda.ChatResponseProgressPart): Dto<IChatProgressMessage> {
		return {
			kind: 'progressMessage',
			content: MarkdownString.from(part.value)
		};
	}
	export function to(part: Dto<IChatProgressMessage>): vibecoda.ChatResponseProgressPart {
		return new types.ChatResponseProgressPart(part.content.value);
	}
}

export namespace ChatResponseThinkingProgressPart {
	export function from(part: vibecoda.ChatResponseThinkingProgressPart): Dto<IChatThinkingPart> {
		return {
			kind: 'thinking',
			value: part.value,
			id: part.id,
	...
	export function to(part: Dto<IChatThinkingPart>): vibecoda.ChatResponseThinkingProgressPart {
...
export namespace ChatResponseWarningPart {
	export function from(part: vibecoda.ChatResponseWarningPart): Dto<IChatWarningMessage> {
		return {
			kind: 'warning',
			content: MarkdownString.from(part.value)
		};
	}
	export function to(part: Dto<IChatWarningMessage>): vibecoda.ChatResponseWarningPart {
		return new types.ChatResponseWarningPart(part.content.value);
	}
}

export namespace ChatResponseExtensionsPart {
	export function from(part: vibecoda.ChatResponseExtensionsPart): Dto<IChatExtensionsContent> {
		return {
			kind: 'extensions',
...
export namespace ChatResponsePullRequestPart {
	export function from(part: vibecoda.ChatResponsePullRequestPart): Dto<IChatPullRequestContent> {
		return {
			kind: 'pullRequest',
			author: part.author,
			title: part.title,
...
export namespace ChatResponseMovePart {
	export function from(part: vibecoda.ChatResponseMovePart): Dto<IChatMoveMessage> {
		return {
			kind: 'move',
			uri: part.uri,
	...
	export function to(part: Dto<IChatMoveMessage>): vibecoda.ChatResponseMovePart {
...
export namespace ChatPrepareToolInvocationPart {
	export function from(part: vibecoda.ChatPrepareToolInvocationPart): IChatPrepareToolInvocationPart {
		return {
	...
	export function to(part: IChatPrepareToolInvocationPart): vibecoda.ChatPrepareToolInvocationPart {
		return new types.ChatPrepareToolInvocationPart(part.toolName);
	}
}

export namespace ChatToolInvocationPart {
	export function from(part: vibecoda.ChatToolInvocationPart): IChatToolInvocationSerialized {
	...
	export function to(part: any): vibecoda.ChatToolInvocationPart {
...
export namespace ChatTask {
	export function from(part: vibecoda.ChatResponseProgressPart2): IChatTaskDto {
		return {
			kind: 'progressTask',
			content: MarkdownString.from(part.value),
		};
...
export namespace ChatResponseCommandButtonPart {
	export function from(part: vibecoda.ChatResponseCommandButtonPart, commandsConverter: CommandsConverter, commandDisposables: DisposableStore): Dto<IChatCommandButton> {
	...
	export function to(part: Dto<IChatCommandButton>, commandsConverter: CommandsConverter): vibecoda.ChatResponseCommandButtonPart {
		// If the command isn't in the converter, then this session may have been restored, and the command args don't exist anymore
...
export namespace ChatResponseTextEditPart {
	export function from(part: vibecoda.ChatResponseTextEditPart): Dto<IChatTextEdit> {
		return {
			kind: 'textEdit',
			uri: part.uri,
	...
	export function to(part: Dto<IChatTextEdit>): vibecoda.ChatResponseTextEditPart {
...
export namespace NotebookEdit {
	export function from(edit: vibecoda.NotebookEdit): extHostProtocol.ICellEditOperationDto {
...
export namespace ChatResponseNotebookEditPart {
	export function from(part: vibecoda.ChatResponseNotebookEditPart): extHostProtocol.IChatNotebookEditDto {
		return {
			kind: 'notebookEdit',
			uri: part.uri,
	...
	export function from(part: types.ChatResponseReferencePart): Dto<IChatContentReference> {
			...
			return {
				...
				reference: {
					...
					value: URI.isUri(part.value.value) || !part.value.value ?
						part.value.value :
						Location.from(part.value.value as vibecoda.Location)
				},
				iconPath,
		...
		return {
			...
			reference: URI.isUri(part.value) || typeof part.value === 'string' ?
				part.value :
				Location.from(<vibecoda.Location>part.value),
			iconPath,
			options: part.options
		};
	}
	export function to(part: Dto<IChatContentReference>): vibecoda.ChatResponseReferencePart {
		const value = revive<IChatContentReference>(part);

		const mapValue = (value: URI | languages.Location): vibecoda.Uri | vibecoda.Location => URI.isUri(value) ?
			value :
			Location.to(value);
		...
		) as vibecoda.ChatResponseReferencePart; // 'value' is extended with variableName
	}
}

export namespace ChatResponseCodeCitationPart {
	export function from(part: vibecoda.ChatResponseCodeCitationPart): Dto<IChatCodeCitation> {
		return {
			kind: 'codeCitation',
			value: part.value,
...
export namespace ChatResponsePart {
	...
	export function from(part: vibecoda.ExtendedChatResponsePart, commandsConverter: CommandsConverter, commandDisposables: DisposableStore): extHostProtocol.IChatProgressDto {
	...
	export function to(part: extHostProtocol.IChatProgressDto, commandsConverter: CommandsConverter): vibecoda.ChatResponsePart | undefined {
		switch (part.kind) {
	...
	export function toContent(part: extHostProtocol.IChatContentProgressDto, commandsConverter: CommandsConverter): vibecoda.ChatResponseMarkdownPart | vibecoda.ChatResponseFileTreePart | vibecoda.ChatResponseAnchorPart | vibecoda.ChatResponseCommandButtonPart | undefined {
		switch (part.kind) {
...
export namespace ChatAgentRequest {
	export function to(request: IChatAgentRequest, location2: vibecoda.ChatRequestEditorData | vibecoda.ChatRequestNotebookData | undefined, model: vibecoda.LanguageModelChat, diagnostics: readonly [vibecoda.Uri, readonly vibecoda.Diagnostic[]][], tools: Map<string, boolean>, extension: IRelaxedExtensionDescription, logService: ILogService): vibecoda.ChatRequest {
		...
		const requestWithAllProps: vibecoda.ChatRequest = {
...
export namespace ChatRequestDraft {
	export function to(request: IChatRequestDraft): vibecoda.ChatRequestDraft {
		return {
...
export namespace ChatPromptReference {
	export function to(variable: IChatRequestVariableEntry, diagnostics: readonly [vibecoda.Uri, readonly vibecoda.Diagnostic[]][], logService: ILogService): vibecoda.ChatPromptReference | undefined {
		let value: vibecoda.ChatPromptReference['value'] = variable.value;
		if (!value) {
			let varStr: string;
			try {
		...
		if (isUriComponents(value)) {
			...
			value = new types.ChatReferenceDiagnostic(diagnostics.map(([uri, d]): [vibecoda.Uri, vibecoda.Diagnostic[]] => {
...
export namespace ChatLanguageModelToolReference {
	export function to(variable: IChatRequestVariableEntry): vibecoda.ChatLanguageModelToolReference {
...
namespace ChatLanguageModelToolReferences {
	export function to(variables: readonly ChatRequestToolReferenceEntry[]): vibecoda.ChatLanguageModelToolReference[] {
...
export namespace ChatRequestModeInstructions {
	export function to(mode: IChatRequestModeInstructions | undefined): vibecoda.ChatRequestModeInstructions | undefined {
		if (mode) {
			return {
				name: mode.name,
...
export namespace ChatAgentCompletionItem {
	export function from(item: vibecoda.ChatCompletionItem, commandsConverter: CommandsConverter, disposables: DisposableStore): extHostProtocol.IChatAgentCompletionItem {
		return {
			id: item.id,
			label: item.label,
...
export namespace ChatAgentResult {
	export function to(result: IChatAgentResult): vibecoda.ChatResult {
		return {
	...
	export function from(result: vibecoda.ChatResult): Dto<IChatAgentResult> {
		return {
			errorDetails: result.errorDetails,
...
export namespace ChatAgentUserActionEvent {
	export function to(result: IChatAgentResult, event: IChatUserActionEvent, commandsConverter: CommandsConverter): vibecoda.ChatUserActionEvent | undefined {
		...
		if (event.action.kind === 'command') {
			...
			const commandAction: vibecoda.ChatCommandAction = { kind: 'command', commandButton };
			return { action: commandAction, result: ehResult };
		} else if (event.action.kind === 'followUp') {
			const followupAction: vibecoda.ChatFollowupAction = { kind: 'followUp', followup: ChatFollowup.to(event.action.followup) };
...
export namespace TerminalQuickFix {
	export function from(quickFix: vibecoda.TerminalQuickFixTerminalCommand | vibecoda.TerminalQuickFixOpener | vibecoda.Command, converter: Command.ICommandsConverter, disposables: DisposableStore): extHostProtocol.ITerminalQuickFixTerminalCommandDto | extHostProtocol.ITerminalQuickFixOpenerDto | extHostProtocol.ICommandDto | undefined {
...
export namespace TerminalCompletionItemDto {
	export function from(item: vibecoda.TerminalCompletionItem): extHostProtocol.ITerminalCompletionItemDto {
		return {
			...item,
...
export namespace TerminalCompletionList {
	export function from(completions: vibecoda.TerminalCompletionList | vibecoda.TerminalCompletionItem[], pathSeparator: string): extHostProtocol.TerminalCompletionListDto {
...
export namespace TerminalCompletionResourceOptions {
	export function from(resourceOptions: vibecoda.TerminalCompletionResourceOptions, pathSeparator: string): extHostProtocol.TerminalCompletionResourceOptionsDto {
		return {
			...resourceOptions,
			pathSeparator,
...
export namespace InlineCompletionEndOfLifeReason {
	export function to<T>(reason: languages.InlineCompletionEndOfLifeReason<T>, convertFn: (item: T) => vibecoda.InlineCompletionItem | undefined): vibecoda.InlineCompletionEndOfLifeReason {
...
export namespace InlineCompletionHintStyle {
	export function from(value: vibecoda.InlineCompletionDisplayLocationKind): languages.InlineCompletionHintStyle {
...
export namespace DebugTreeItem {
	export function from(item: vibecoda.DebugTreeItem, id: number): IDebugVisualizationTreeItem {
		return {
			id,
			label: item.label,
			description: item.description,
...
export namespace LanguageModelToolSource {
	export function to(source: Dto<ToolDataSource>): vibecoda.LanguageModelToolInformation['source'] {
		if (source.type === 'mcp') {
...
export namespace LanguageModelToolResult {
	export function to(result: IToolResult): vibecoda.LanguageModelToolResult {
	...
	export function from(result: vibecoda.ExtendedLanguageModelToolResult, extension: IExtensionDescription): Dto<IToolResult> | SerializableObjectWithBuffers<Dto<IToolResult>> {
		...
		const dto: Dto<IToolResult> = {
			...
			toolResultDetails: result.toolResultDetails?.map(detail => URI.isUri(detail) ? detail : Location.from(detail as vibecoda.Location)),
		};
...
export namespace LanguageModelToolResult2 {
	export function to(result: IToolResult): vibecoda.LanguageModelToolResult2 {
		...
		if (result.toolMetadata) {
			(toolResult as vibecoda.ExtendedLanguageModelToolResult).toolMetadata = result.toolMetadata;
		}

		return toolResult;
	}

	export function from(result: vibecoda.ExtendedLanguageModelToolResult2, extension: IExtensionDescription): Dto<IToolResult> | SerializableObjectWithBuffers<Dto<IToolResult>> {
		if (result.toolResultMessage) {
			checkProposedApiEnabled(extension, 'chatParticipantPrivate');
		}
		...
		if (Array.isArray(result.toolResultDetails)) {
			detailsDto = result.toolResultDetails?.map(detail => {
				return URI.isUri(detail) ? detail : Location.from(detail as vibecoda.Location);
			});
		} else {
			if (result.toolResultDetails2) {
				detailsDto = {
					output: {
						type: 'data',
						mimeType: (result.toolResultDetails2 as vibecoda.ToolResultDataOutput).mime,
						value: VSBuffer.wrap((result.toolResultDetails2 as vibecoda.ToolResultDataOutput).value),
					}
...
export namespace IconPath {
	export function fromThemeIcon(iconPath: vibecoda.ThemeIcon): languages.IconPath {
		return iconPath;
	}

	/**
	 * Converts a {@link vibecoda.IconPath} to an {@link extHostProtocol.IconPathDto}.
	 ...
	 * See https://github.com/microsoft/vibecoda/issues/110432#issuecomment-726144556 for context.
	 */
	export function from(value: undefined): undefined;
	export function from(value: vibecoda.IconPath): extHostProtocol.IconPathDto;
	export function from(value: vibecoda.IconPath | undefined): extHostProtocol.IconPathDto | undefined;
	export function from(value: vibecoda.IconPath | undefined): extHostProtocol.IconPathDto | undefined {
		if (!value) {
			return undefined;
	...
	/**
	 * Converts a {@link extHostProtocol.IconPathDto} to a {@link vibecoda.IconPath}.
	...
	export function to(value: extHostProtocol.IconPathDto): vibecoda.IconPath;
	export function to(value: extHostProtocol.IconPathDto | undefined): vibecoda.IconPath | undefined;
	export function to(value: extHostProtocol.IconPathDto | undefined): vibecoda.IconPath | undefined {
		if (!value) {
			return undefined;
		} else if (ThemeIcon.isThemeIcon(value)) {
...
export namespace AiSettingsSearch {
	export function fromSettingsSearchResult(result: vibecoda.SettingsSearchResult): AiSettingsSearchResult {
		return {
			query: result.query,
...
export namespace McpServerDefinition {
	function isHttpConfig(candidate: vibecoda.McpServerDefinition): candidate is vibecoda.McpHttpServerDefinition {
		return !!(candidate as vibecoda.McpHttpServerDefinition).uri;
	}

	export function from(item: vibecoda.McpServerDefinition): McpServerLaunch.Serialized {
