...
export class ExtHostDocumentsAndEditors implements ExtHostDocumentsAndEditorsShape {
	...
	acceptDocumentsAndEditorsDelta(delta: IDocumentsAndEditorsDelta): void {
		...
		if (delta.addedDocuments) {
			for (const data of delta.addedDocuments) {
				...
				if (ref) {
					if (resource.scheme !== Schemas.vibecodaNotebookCell && resource.scheme !== Schemas.vibecodaInteractiveInput) {
	...
	activeEditor(): vibecoda.TextEditor | undefined;
	activeEditor(internal: true): ExtHostTextEditor | undefined;
	activeEditor(internal?: true): vibecoda.TextEditor | ExtHostTextEditor | undefined {
