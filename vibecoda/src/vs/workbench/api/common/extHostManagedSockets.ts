...
export interface IExtHostManagedSockets extends ExtHostManagedSocketsShape {
	setFactory(socketFactoryId: number, makeConnection: () => Thenable<vibecoda.ManagedMessagePassing>): void;
...
class ManagedSocketFactory {
	constructor(
		...
		public readonly makeConnection: () => Thenable<vibecoda.ManagedMessagePassing>,
	) { }
}
...
class ManagedSocket extends Disposable {
	constructor(
		...
		public readonly actual: vibecoda.ManagedMessagePassing,
