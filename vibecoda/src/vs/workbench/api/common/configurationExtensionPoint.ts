...
const configurationEntrySchema: IJSONSchema = {
	...
	properties: {
		title: {
			description: nls.localize('vibecoda.extension.contributes.configuration.title', 'A title for the current category of settings. This label will be rendered in the Settings editor as a subheading. If the title is the same as the extension display name, then the category will be grouped under the main extension heading.'),
			type: 'string'
		},
		order: {
			description: nls.localize('vibecoda.extension.contributes.configuration.order', 'When specified, gives the order of this category of settings relative to other categories.'),
			type: 'integer'
		},
		properties: {
			description: nls.localize('vibecoda.extension.contributes.configuration.properties', 'Description of the configuration properties.'),
			type: 'object',
			propertyNames: {
				pattern: '\\S+',
				patternErrorMessage: nls.localize('vibecoda.extension.contributes.configuration.property.empty', 'Property should not be empty.'),
			},
			additionalProperties: {
				anyOf: [
					{
						title: nls.localize('vibecoda.extension.contributes.configuration.properties.schema', 'Schema of the configuration property.'),
...
// BEGIN Vibecoda extension point `configurationDefaults`
...
// END Vibecoda extension point `configurationDefaults`


// BEGIN Vibecoda extension point `configuration`
const configurationExtPoint = ExtensionsRegistry.registerExtensionPoint<IConfigurationNode>({
	extensionPoint: 'configuration',
	deps: [defaultConfigurationExtPoint],
	jsonSchema: {
		description: nls.localize('vibecoda.extension.contributes.configuration', 'Contributes configuration settings.'),
		oneOf: [
...
// END Vibecoda extension point `configuration`

jsonRegistry.registerSchema('vibecoda://schemas/workspaceConfig', {
	allowComments: true,
	...
	properties: {
		...
		'extensions': {
			...
			$ref: 'vibecoda://schemas/extensions'
		},
		'remoteAuthority': {
			type: 'string',
			doNotSuggest: true,
