...
export class ExtHostEmbeddings implements ExtHostEmbeddingsShape {
	...
	private readonly _provider = new Map<number, { id: string; provider: vibecoda.EmbeddingsProvider }>();
	...
	registerEmbeddingsProvider(_extension: IExtensionDescription, embeddingsModel: string, provider: vibecoda.EmbeddingsProvider): IDisposable {
	...
	async computeEmbeddings(embeddingsModel: string, input: string, token?: vibecoda.CancellationToken): Promise<vibecoda.Embedding>;
	async computeEmbeddings(embeddingsModel: string, input: string[], token?: vibecoda.CancellationToken): Promise<vibecoda.Embedding[]>;
	async computeEmbeddings(embeddingsModel: string, input: string | string[], token?: vibecoda.CancellationToken): Promise<vibecoda.Embedding[] | vibecoda.Embedding> {
