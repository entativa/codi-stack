...
export class ExtHostQuickDiff implements ExtHostQuickDiffShape {
	...
	private providers: Map<number, vibecoda.QuickDiffProvider> = new Map();
	...
	registerQuickDiffProvider(extension: IExtensionDescription, selector: vibecoda.DocumentSelector, quickDiffProvider: vibecoda.QuickDiffProvider, id: string, label: string, rootUri?: vibecoda.Uri): vibecoda.Disposable {
