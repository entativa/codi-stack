...
export interface IExtHostTerminalShellIntegration extends ExtHostTerminalShellIntegrationShape {
	...
	readonly onDidChangeTerminalShellIntegration: Event<vibecoda.TerminalShellIntegrationChangeEvent>;
	readonly onDidStartTerminalShellExecution: Event<vibecoda.TerminalShellExecutionStartEvent>;
	readonly onDidEndTerminalShellExecution: Event<vibecoda.TerminalShellExecutionEndEvent>;
}
...
export class ExtHostTerminalShellIntegration extends Disposable implements IExtHostTerminalShellIntegration {
	...
	protected readonly _onDidChangeTerminalShellIntegration = new Emitter<vibecoda.TerminalShellIntegrationChangeEvent>();
	readonly onDidChangeTerminalShellIntegration = this._onDidChangeTerminalShellIntegration.event;
	protected readonly _onDidStartTerminalShellExecution = new Emitter<vibecoda.TerminalShellExecutionStartEvent>();
	readonly onDidStartTerminalShellExecution = this._onDidStartTerminalShellExecution.event;
	protected readonly _onDidEndTerminalShellExecution = new Emitter<vibecoda.TerminalShellExecutionEndEvent>();
	...
	public $shellExecutionStart(instanceId: number, commandLineValue: string, commandLineConfidence: TerminalShellExecutionCommandLineConfidence, isTrusted: boolean, cwd: string | undefined): void {
		...
		const commandLine: vibecoda.TerminalShellExecutionCommandLine = {
...
export class InternalTerminalShellIntegration extends Disposable {
	...
	private _env: vibecoda.TerminalShellIntegrationEnvironment | undefined;
	private _cwd: URI | undefined;

	readonly store: DisposableStore = this._register(new DisposableStore());

	readonly value: vibecoda.TerminalShellIntegration;

	protected readonly _onDidRequestChangeShellIntegration = this._register(new Emitter<vibecoda.TerminalShellIntegrationChangeEvent>());
	...
	protected readonly _onDidRequestEndExecution = this._register(new Emitter<vibecoda.TerminalShellExecutionEndEvent>());
	...
	constructor(
		private readonly _terminal: vibecoda.Terminal,
		private readonly _onDidStartTerminalShellExecution: Emitter<vibecoda.TerminalShellExecutionStartEvent>
	) {
		super();
		...
		this.value = {
			...
			get env(): vibecoda.TerminalShellIntegrationEnvironment | undefined {
				if (!that._env) {
					return undefined;
				}
			...
			// executeCommand(commandLine: string): vibecoda.TerminalShellExecution;
			// executeCommand(executable: string, args: string[]): vibecoda.TerminalShellExecution;
			executeCommand(commandLineOrExecutable: string, args?: string[]): vibecoda.TerminalShellExecution {
	...
	requestNewShellExecution(commandLine: vibecoda.TerminalShellExecutionCommandLine, cwd: URI | undefined) {
	...
	startShellExecution(commandLine: vibecoda.TerminalShellExecutionCommandLine, cwd: URI | undefined): undefined {
	...
	endShellExecution(commandLine: vibecoda.TerminalShellExecutionCommandLine | undefined, exitCode: number | undefined): void {
...
class InternalTerminalShellExecution {
	readonly value: vibecoda.TerminalShellExecution;

	private _dataStream: ShellExecutionDataStream | undefined;
	private _isEnded: boolean = false;

	constructor(
		private _commandLine: vibecoda.TerminalShellExecutionCommandLine,
		readonly cwd: URI | undefined,
	) {
		const that = this;
		this.value = {
			get commandLine(): vibecoda.TerminalShellExecutionCommandLine {
	...
	endExecution(commandLine: vibecoda.TerminalShellExecutionCommandLine | undefined): void {
		if (commandLine) {
 ...
 * execution.
 */
function isSubExecution(unresolvedCommandLines: string[], commandLine: vibecoda.TerminalShellExecutionCommandLine): { unresolvedCommandLines: string[] } | false {
