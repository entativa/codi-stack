...
export class ExtHostNotebookRenderers implements ExtHostNotebookRenderersShape {
	private readonly _rendererMessageEmitters = new Map<string /* rendererId */, Emitter<{ editor: vibecoda.NotebookEditor; message: unknown }>>();
	...
	public createRendererMessaging(manifest: IExtensionDescription, rendererId: string): vibecoda.NotebookRendererMessaging {
		...
		const messaging: vibecoda.NotebookRendererMessaging = {
