...
export class ExtHostChatContext implements ExtHostChatContextShape {
	...
	private _providers: Map<number, vibecoda.ChatContextProvider> = new Map();
	private _itemPool: number = 0;
	private _items: Map<number, Map<number, vibecoda.ChatContextItem>> = new Map(); // handle -> itemHandle -> item
	...
	private _getProvider(handle: number): vibecoda.ChatContextProvider {
