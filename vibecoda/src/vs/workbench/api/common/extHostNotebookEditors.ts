...
export class ExtHostNotebookEditors implements ExtHostNotebookEditorsShape {
	...
	private readonly _onDidChangeNotebookEditorSelection = new Emitter<vibecoda.NotebookEditorSelectionChangeEvent>();
	private readonly _onDidChangeNotebookEditorVisibleRanges = new Emitter<vibecoda.NotebookEditorVisibleRangesChangeEvent>();
