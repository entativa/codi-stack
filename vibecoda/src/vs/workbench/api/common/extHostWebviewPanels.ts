...
class ExtHostWebviewPanel extends Disposable implements vibecoda.WebviewPanel {
	...
	readonly #options: vibecoda.WebviewPanelOptions;

	#title: string;
	#iconPath?: IconPath;
	#viewColumn: vibecoda.ViewColumn | undefined = undefined;
	...
	readonly #onDidChangeViewState = this._register(new Emitter<vibecoda.WebviewPanelOnDidChangeViewStateEvent>());
	...
	constructor(
		...
		params: {
			viewType: string;
			title: string;
			viewColumn: vibecoda.ViewColumn | undefined;
			panelOptions: vibecoda.WebviewPanelOptions;
			active: boolean;
		}
	) {
		super();
	...
	_updateViewState(newState: { active: boolean; visible: boolean; viewColumn: vibecoda.ViewColumn }) {
		if (this.#isDisposed) {
			return;
		}
	...
	public reveal(viewColumn?: vibecoda.ViewColumn, preserveFocus?: boolean): void {
		this.assertNotDisposed();
...
export class ExtHostWebviewPanels extends Disposable implements extHostProtocol.ExtHostWebviewPanelsShape {
	...
	private readonly _serializers = new Map<string, {
		readonly serializer: vibecoda.WebviewPanelSerializer;
	...
	public createWebviewPanel(
		...
		viewType: string,
		title: string,
		showOptions: vibecoda.ViewColumn | { viewColumn: vibecoda.ViewColumn; preserveFocus?: boolean },
		options: (vibecoda.WebviewPanelOptions & vibecoda.WebviewOptions) = {},
	): vibecoda.WebviewPanel {
	...
	public registerWebviewPanelSerializer(
		extension: IExtensionDescription,
		viewType: string,
		serializer: vibecoda.WebviewPanelSerializer
	): vibecoda.Disposable {
	...
	public createNewWebviewPanel(webviewHandle: string, viewType: string, title: string, position: vibecoda.ViewColumn, options: extHostProtocol.IWebviewPanelOptions, webview: ExtHostWebview, active: boolean) {
...
function serializeWebviewPanelOptions(options: vibecoda.WebviewPanelOptions): extHostProtocol.IWebviewPanelOptions {
	return {
