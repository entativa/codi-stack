...
export class ExtHostDocumentContentProvider implements ExtHostDocumentContentProvidersShape {
	...
	private readonly _documentContentProviders = new Map<number, vibecoda.TextDocumentContentProvider>();
	...
	registerTextDocumentContentProvider(scheme: string, provider: vibecoda.TextDocumentContentProvider): vibecoda.Disposable {
		// todo@remote
