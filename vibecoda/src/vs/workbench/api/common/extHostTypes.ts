...
export class ManagedResolvedAuthority {
	...
	constructor(public readonly makeConnection: () => Thenable<vibecoda.ManagedMessagePassing>, public readonly connectionToken?: string) {
		if (typeof connectionToken !== 'undefined') {
			validateConnectionToken(connectionToken);
		}
	}
...
export class Hover {
	...
	public contents: (vibecoda.MarkdownString | vibecoda.MarkedString)[];
	public range: Range | undefined;

	constructor(
		contents: vibecoda.MarkdownString | vibecoda.MarkedString | (vibecoda.MarkdownString | vibecoda.MarkedString)[],
		range?: Range
	) {
		if (!contents) {
...
export class CallHierarchyIncomingCall {
	...
	from: vibecoda.CallHierarchyItem;
	fromRanges: vibecoda.Range[];

	constructor(item: vibecoda.CallHierarchyItem, fromRanges: vibecoda.Range[]) {
...
export class CodeLens {
	...
	command: vibecoda.Command | undefined;

	constructor(range: Range, command?: vibecoda.Command) {
		this.range = range;
...
export class ParameterInformation {
	...
	constructor(label: string | [number, number], documentation?: string | vibecoda.MarkdownString) {
		this.label = label;
...
export class SignatureInformation {
	...
	constructor(label: string, documentation?: string | vibecoda.MarkdownString) {
		this.label = label;
		this.documentation = documentation;
		this.parameters = [];
	}
...
export class InlayHintLabelPart {
	...
	value: string;
	tooltip?: string | vibecoda.MarkdownString;
	location?: Location;
	command?: vibecoda.Command;
...
@es5ClassCompat
export class InlayHint implements vibecoda.InlayHint {

	label: string | InlayHintLabelPart[];
	tooltip?: string | vibecoda.MarkdownString;
	position: Position;
	textEdits?: TextEdit[];
	kind?: vibecoda.InlayHintKind;
	paddingLeft?: boolean;
	paddingRight?: boolean;

	constructor(position: Position, label: string | InlayHintLabelPart[], kind?: vibecoda.InlayHintKind) {
...
@es5ClassCompat
export class CompletionItem implements vibecoda.CompletionItem {
...
export class CompletionList {
	...
	items: vibecoda.CompletionItem[];

	constructor(items: vibecoda.CompletionItem[] = [], isIncomplete: boolean = false) {
		this.items = items;
...
@es5ClassCompat
export class InlineSuggestion implements vibecoda.InlineCompletionItem {
	...
	constructor(insertText: string, range?: Range, command?: vibecoda.Command) {
...
@es5ClassCompat
export class InlineSuggestionList implements vibecoda.InlineCompletionList {
	items: vibecoda.InlineCompletionItem[];

	commands: (vibecoda.Command | { command: vibecoda.Command; icon: vibecoda.ThemeIcon })[] | undefined = undefined;

	suppressSuggestions: boolean | undefined = undefined;

	constructor(items: vibecoda.InlineCompletionItem[]) {
		this.items = items;
	}
}
...
export class TerminalLink implements vibecoda.TerminalLink {
	constructor(
...
export class TerminalProfile implements vibecoda.TerminalProfile {
	constructor(
		public options: vibecoda.TerminalOptions | vibecoda.ExtensionTerminalOptions
	) {
...
export class TerminalCompletionItem implements vibecoda.TerminalCompletionItem {
	label: string | CompletionItemLabel;
	replacementRange: readonly [number, number];
	icon?: ThemeIcon | undefined;
	detail?: string | undefined;
	documentation?: string | vibecoda.MarkdownString | undefined;
	isFile?: boolean | undefined;
	isDirectory?: boolean | undefined;
	isKeyword?: boolean | undefined;

	constructor(label: string | CompletionItemLabel, replacementRange: readonly [number, number], icon?: ThemeIcon, detail?: string, documentation?: string | vibecoda.MarkdownString, isFile?: boolean, isDirectory?: boolean, isKeyword?: boolean) {
		this.label = label;
...
@es5ClassCompat
export class TaskGroup implements vibecoda.TaskGroup {
...
@es5ClassCompat
export class ProcessExecution implements vibecoda.ProcessExecution {

	private _process: string;
	private _args: string[];
	private _options: vibecoda.ProcessExecutionOptions | undefined;

	constructor(process: string, options?: vibecoda.ProcessExecutionOptions);
	constructor(process: string, args: string[], options?: vibecoda.ProcessExecutionOptions);
	constructor(process: string, varg1?: string[] | vibecoda.ProcessExecutionOptions, varg2?: vibecoda.ProcessExecutionOptions) {
	...
	get options(): vibecoda.ProcessExecutionOptions | undefined {
		return this._options;
	}

	set options(value: vibecoda.ProcessExecutionOptions | undefined) {
		this._options = value;
	}
...
@es5ClassCompat
export class ShellExecution implements vibecoda.ShellExecution {

	private _commandLine: string | undefined;
	private _command: string | vibecoda.ShellQuotedString | undefined;
	private _args: (string | vibecoda.ShellQuotedString)[] = [];
	private _options: vibecoda.ShellExecutionOptions | undefined;

	constructor(commandLine: string, options?: vibecoda.ShellExecutionOptions);
	constructor(command: string | vibecoda.ShellQuotedString, args: (string | vibecoda.ShellQuotedString)[], options?: vibecoda.ShellExecutionOptions);
	constructor(arg0: string | vibecoda.ShellQuotedString, arg1?: vibecoda.ShellExecutionOptions | (string | vibecoda.ShellQuotedString)[], arg2?: vibecoda.ShellExecutionOptions) {
	...
	get command(): string | vibecoda.ShellQuotedString {
		return this._command ? this._command : '';
	}

	set command(value: string | vibecoda.ShellQuotedString) {
	...
	get args(): (string | vibecoda.ShellQuotedString)[] {
		return this._args;
	}

	set args(value: (string | vibecoda.ShellQuotedString)[] | undefined) {
		this._args = value || [];
	}

	get options(): vibecoda.ShellExecutionOptions | undefined {
		return this._options;
	}

	set options(value: vibecoda.ShellExecutionOptions | undefined) {
		this._options = value;
	}
...
export class CustomExecution implements vibecoda.CustomExecution {
	private _callback: (resolvedDefinition: vibecoda.TaskDefinition) => Thenable<vibecoda.Pseudoterminal>;
	constructor(callback: (resolvedDefinition: vibecoda.TaskDefinition) => Thenable<vibecoda.Pseudoterminal>) {
	...
	public set callback(value: (resolvedDefinition: vibecoda.TaskDefinition) => Thenable<vibecoda.Pseudoterminal>) {
		this._callback = value;
	}

	public get callback(): ((resolvedDefinition: vibecoda.TaskDefinition) => Thenable<vibecoda.Pseudoterminal>) {
		return this._callback;
	}
}

@es5ClassCompat
export class Task implements vibecoda.Task {
	...
	private _definition: vibecoda.TaskDefinition;
	private _scope: vibecoda.TaskScope.Global | vibecoda.TaskScope.Workspace | vibecoda.WorkspaceFolder | undefined;
	...
	private _presentationOptions: vibecoda.TaskPresentationOptions;
	private _runOptions: vibecoda.RunOptions;
	private _detail: string | undefined;

	constructor(definition: vibecoda.TaskDefinition, name: string, source: string, execution?: ProcessExecution | ShellExecution | CustomExecution, problemMatchers?: string | string[]);
	constructor(definition: vibecoda.TaskDefinition, scope: vibecoda.TaskScope.Global | vibecoda.TaskScope.Workspace | vibecoda.WorkspaceFolder, name: string, source: string, execution?: ProcessExecution | ShellExecution | CustomExecution, problemMatchers?: string | string[]);
	constructor(definition: vibecoda.TaskDefinition, arg2: string | (vibecoda.TaskScope.Global | vibecoda.TaskScope.Workspace) | vibecoda.WorkspaceFolder, arg3: any, arg4?: any, arg5?: any, arg6?: any) {
	...
	get definition(): vibecoda.TaskDefinition {
		return this._definition;
	}

	set definition(value: vibecoda.TaskDefinition) {
	...
	get scope(): vibecoda.TaskScope.Global | vibecoda.TaskScope.Workspace | vibecoda.WorkspaceFolder | undefined {
		return this._scope;
	}

	set target(value: vibecoda.TaskScope.Global | vibecoda.TaskScope.Workspace | vibecoda.WorkspaceFolder) {
		this.clear();
		this._scope = value;
	}
	...
	get presentationOptions(): vibecoda.TaskPresentationOptions {
		return this._presentationOptions;
	}

	set presentationOptions(value: vibecoda.TaskPresentationOptions) {
	...
	get runOptions(): vibecoda.RunOptions {
		return this._runOptions;
	}

	set runOptions(value: vibecoda.RunOptions) {
		if (value === null || value === undefined) {
			value = Object.create(null);
		}
		this.clear();
...
export namespace ViewBadge {
	export function isViewBadge(thing: any): thing is vibecoda.ViewBadge {
		const viewBadgeThing = thing as vibecoda.ViewBadge;
...
export class TreeItem {
	...
	label?: string | vibecoda.TreeItemLabel;
	resourceUri?: URI;
	iconPath?: string | URI | { light: string | URI; dark: string | URI } | ThemeIcon;
	command?: vibecoda.Command;
	contextValue?: string;
	tooltip?: string | vibecoda.MarkdownString;
	checkboxState?: vibecoda.TreeItemCheckboxState;

	static isTreeItem(thing: any, extension: IExtensionDescription): thing is TreeItem {
		const treeItemThing = thing as vibecoda.TreeItem;
		...
		if ((treeItemThing.iconPath !== undefined) && !isString(treeItemThing.iconPath) && !URI.isUri(treeItemThing.iconPath) && (!treeItemThing.iconPath || !isString((treeItemThing.iconPath as vibecoda.ThemeIcon).id))) {
	...
	constructor(label: string | vibecoda.TreeItemLabel, collapsibleState?: vibecoda.TreeItemCollapsibleState);
	constructor(resourceUri: URI, collapsibleState?: vibecoda.TreeItemCollapsibleState);
	constructor(arg1: string | vibecoda.TreeItemLabel | URI, public collapsibleState: vibecoda.TreeItemCollapsibleState = TreeItemCollapsibleState.None) {
		if (URI.isUri(arg1)) {
...
@es5ClassCompat
export class DataTransferItem implements vibecoda.DataTransferItem {

	async asString(): Promise<string> {
		return typeof this.value === 'string' ? this.value : JSON.stringify(this.value);
	}

	asFile(): undefined | vibecoda.DataTransferFile {
		return undefined;
	}
...
/**
 * A data transfer item that has been created by Vibecoda instead of by a extension.
 *
...
export class InternalFileDataTransferItem extends InternalDataTransferItem {
	...
	readonly #file: vibecoda.DataTransferFile;

	constructor(file: vibecoda.DataTransferFile) {
		super('');
		this.#file = file;
	}
 ...
 * Intentionally not exported to extensions
 */
export class DataTransferFile implements vibecoda.DataTransferFile {

	public readonly name: string;
	public readonly uri: vibecoda.Uri | undefined;

	public readonly _itemId: string;
	private readonly _getData: () => Promise<Uint8Array>;

	constructor(name: string, uri: vibecoda.Uri | undefined, itemId: string, getData: () => Promise<Uint8Array>) {
		this.name = name;
		this.uri = uri;
		this._itemId = itemId;
...
@es5ClassCompat
export class DataTransfer implements vibecoda.DataTransfer {
	#items = new Map<string, vibecoda.DataTransferItem[]>();

	constructor(init?: Iterable<readonly [string, vibecoda.DataTransferItem]>) {
	...
	get(mimeType: string): vibecoda.DataTransferItem | undefined {
		return this.#items.get(this.#normalizeMime(mimeType))?.[0];
	}

	set(mimeType: string, value: vibecoda.DataTransferItem): void {
	...
	forEach(callbackfn: (value: vibecoda.DataTransferItem, key: string, dataTransfer: DataTransfer) => void, thisArg?: unknown): void {
	...
	*[Symbol.iterator](): IterableIterator<[mimeType: string, item: vibecoda.DataTransferItem]> {
		for (const [mime, items] of this.#items) {
			for (const item of items) {
				yield [mime, item];
			}
...
export class RelativePattern implements IRelativePattern {
	...
	constructor(base: vibecoda.WorkspaceFolder | URI | string, pattern: string) {
...
@es5ClassCompat
export class DebugAdapterExecutable implements vibecoda.DebugAdapterExecutable {
	readonly command: string;
	readonly args: string[];
	readonly options?: vibecoda.DebugAdapterExecutableOptions;

	constructor(command: string, args: string[], options?: vibecoda.DebugAdapterExecutableOptions) {
		this.command = command;
		this.args = args || [];
...
@es5ClassCompat
export class DebugAdapterServer implements vibecoda.DebugAdapterServer {
	readonly port: number;
	readonly host?: string;
...
@es5ClassCompat
export class DebugAdapterNamedPipeServer implements vibecoda.DebugAdapterNamedPipeServer {
	constructor(public readonly path: string) {
	}
}

@es5ClassCompat
export class DebugAdapterInlineImplementation implements vibecoda.DebugAdapterInlineImplementation {
	readonly implementation: vibecoda.DebugAdapter;

	constructor(impl: vibecoda.DebugAdapter) {
		this.implementation = impl;
	}
}


export class DebugStackFrame implements vibecoda.DebugStackFrame {
	constructor(
		public readonly session: vibecoda.DebugSession,
		readonly threadId: number,
		readonly frameId: number) { }
}

export class DebugThread implements vibecoda.DebugThread {
	constructor(
		public readonly session: vibecoda.DebugSession,
		readonly threadId: number) { }
}
...
@es5ClassCompat
export class EvaluatableExpression implements vibecoda.EvaluatableExpression {
	readonly range: vibecoda.Range;
	readonly expression?: string;

	constructor(range: vibecoda.Range, expression?: string) {
		this.range = range;
...
@es5ClassCompat
export class InlineValueText implements vibecoda.InlineValueText {
...
@es5ClassCompat
export class InlineValueVariableLookup implements vibecoda.InlineValueVariableLookup {
	readonly range: Range;
...
@es5ClassCompat
export class InlineValueEvaluatableExpression implements vibecoda.InlineValueEvaluatableExpression {
	readonly range: Range;
	readonly expression?: string;
...
@es5ClassCompat
export class InlineValueContext implements vibecoda.InlineValueContext {

	readonly frameId: number;
	readonly stoppedLocation: vibecoda.Range;

	constructor(frameId: number, range: vibecoda.Range) {
...
export class NewSymbolName implements vibecoda.NewSymbolName {
	readonly newSymbolName: string;
	readonly tags?: readonly vibecoda.NewSymbolNameTag[] | undefined;
...
export class SemanticTokensBuilder {
	...
	constructor(legend?: vibecoda.SemanticTokensLegend) {
		this._prevLine = 0;
		this._prevChar = 0;
	...
	private _push(range: vibecoda.Range, tokenType: string, tokenModifiers?: string[]): void {
		if (!this._hasLegend) {
...
export class DebugVisualization {
	...
	visualization?: vibecoda.Command | vibecoda.TreeDataProvider<unknown>;
...
export class QuickInputButtons {
	...
	static readonly Back: vibecoda.QuickInputButton = { iconPath: new ThemeIcon('arrow-left') };
...
export class FileDecoration {
	...
	badge?: string | vibecoda.ThemeIcon;
	tooltip?: string;
	color?: vibecoda.ThemeColor;
	propagate?: boolean;
...
@es5ClassCompat
export class ColorTheme implements vibecoda.ColorTheme {
...
@es5ClassCompat
export class TimelineItem implements vibecoda.TimelineItem {
...
export class TestRunProfileBase {
	constructor(
		...
		public readonly kind: vibecoda.TestRunProfileKind,
	) { }
}

@es5ClassCompat
export class TestRunRequest implements vibecoda.TestRunRequest {
	constructor(
		public readonly include: vibecoda.TestItem[] | undefined = undefined,
		public readonly exclude: vibecoda.TestItem[] | undefined = undefined,
		public readonly profile: vibecoda.TestRunProfile | undefined = undefined,
...
@es5ClassCompat
export class TestMessage implements vibecoda.TestMessage {
	public expectedOutput?: string;
	public actualOutput?: string;
	public location?: vibecoda.Location;
	public contextValue?: string;

	/** proposed: */
	public stackTrace?: TestMessageStackFrame[];

	public static diff(message: string | vibecoda.MarkdownString, expected: string, actual: string) {
	...
	constructor(public message: string | vibecoda.MarkdownString) { }
}

@es5ClassCompat
export class TestTag implements vibecoda.TestTag {
...
export class TestCoverageCount implements vibecoda.TestCoverageCount {
	constructor(public covered: number, public total: number) {
		validateTestCoverageCount(this);
	}
}

export function validateTestCoverageCount(cc?: vibecoda.TestCoverageCount) {
	if (!cc) {
		return;
	}
...
export class FileCoverage implements vibecoda.FileCoverage {
	public static fromDetails(uri: vibecoda.Uri, details: vibecoda.FileCoverageDetail[]): vibecoda.FileCoverage {
	...
	detailedCoverage?: vibecoda.FileCoverageDetail[];

	constructor(
		public readonly uri: vibecoda.Uri,
		public statementCoverage: vibecoda.TestCoverageCount,
		public branchCoverage?: vibecoda.TestCoverageCount,
		public declarationCoverage?: vibecoda.TestCoverageCount,
		public includesTests: vibecoda.TestItem[] = [],
	) {
	}
}

export class StatementCoverage implements vibecoda.StatementCoverage {
	...
	constructor(
		...
		public branches: vibecoda.BranchCoverage[] = [],
	) { }
}

export class BranchCoverage implements vibecoda.BranchCoverage {
	// back compat until finalization:
	get executionCount() { return +this.executed; }
	set executionCount(n: number) { this.executed = n; }
...
export class DeclarationCoverage implements vibecoda.DeclarationCoverage {
	// back compat until finalization:
	get executionCount() { return +this.executed; }
	set executionCount(n: number) { this.executed = n; }
...
export class ChatCompletionItem implements vibecoda.ChatCompletionItem {
	id: string;
	label: string | CompletionItemLabel;
	fullName?: string | undefined;
	icon?: vibecoda.ThemeIcon;
	insertText?: string;
	values: vibecoda.ChatVariableValue[];
	detail?: string;
	documentation?: string | MarkdownString;
	command?: vibecoda.Command;

	constructor(id: string, label: string | CompletionItemLabel, values: vibecoda.ChatVariableValue[]) {
		this.id = id;
		this.label = label;
		this.values = values;
	}
...
export class ChatResponseMarkdownPart {
	value: vibecoda.MarkdownString;
	constructor(value: string | vibecoda.MarkdownString) {
...
export class ChatResponseMarkdownWithVulnerabilitiesPart {
	value: vibecoda.MarkdownString;
	vulnerabilities: vibecoda.ChatVulnerability[];
	constructor(value: string | vibecoda.MarkdownString, vulnerabilities: vibecoda.ChatVulnerability[]) {
		if (typeof value !== 'string' && value.isTrusted === true) {
			throw new Error('The boolean form of MarkdownString.isTrusted is NOT supported for chat participants.');
		}
...
export class ChatResponseConfirmationPart {
	title: string;
	message: string | vibecoda.MarkdownString;
	data: any;
	buttons?: string[];

	constructor(title: string, message: string | vibecoda.MarkdownString, data: any, buttons?: string[]) {
		this.title = title;
...
export class ChatResponseFileTreePart {
	value: vibecoda.ChatResponseFileTree[];
	baseUri: vibecoda.Uri;
	constructor(value: vibecoda.ChatResponseFileTree[], baseUri: vibecoda.Uri) {
		this.value = value;
...
export class ChatResponseMultiDiffPart {
	value: vibecoda.ChatResponseDiffEntry[];
	title: string;
	readOnly?: boolean;
	constructor(value: vibecoda.ChatResponseDiffEntry[], title: string, readOnly?: boolean) {
		this.value = value;
		this.title = title;
...
export class ChatResponseAnchorPart implements vibecoda.ChatResponseAnchorPart {
	value: vibecoda.Uri | vibecoda.Location;
	title?: string;

	value2: vibecoda.Uri | vibecoda.Location | vibecoda.SymbolInformation;
	resolve?(token: vibecoda.CancellationToken): Thenable<void>;

	constructor(value: vibecoda.Uri | vibecoda.Location | vibecoda.SymbolInformation, title?: string) {
...
export class ChatResponseProgressPart2 {
	value: string;
	task?: (progress: vibecoda.Progress<vibecoda.ChatResponseWarningPart>) => Thenable<string | void>;
	constructor(value: string, task?: (progress: vibecoda.Progress<vibecoda.ChatResponseWarningPart>) => Thenable<string | void>) {
		this.value = value;
		this.task = task;
	}
}
...
export class ChatResponseCommandButtonPart {
	value: vibecoda.Command;
	constructor(value: vibecoda.Command) {
		this.value = value;
	}
}

export class ChatResponseReferencePart {
	value: vibecoda.Uri | vibecoda.Location | { variableName: string; value?: vibecoda.Uri | vibecoda.Location } | string;
	iconPath?: vibecoda.Uri | vibecoda.ThemeIcon | { light: vibecoda.Uri; dark: vibecoda.Uri };
	options?: { status?: { description: string; kind: vibecoda.ChatResponseReferencePartStatusKind }; diffMeta?: { added: number; removed: number } };
	constructor(value: vibecoda.Uri | vibecoda.Location | { variableName: string; value?: vibecoda.Uri | vibecoda.Location } | string, iconPath?: vibecoda.Uri | vibecoda.ThemeIcon | { light: vibecoda.Uri; dark: vibecoda.Uri }, options?: { status?: { description: string; kind: vibecoda.ChatResponseReferencePartStatusKind } }) {
		this.value = value;
...
export class ChatResponseCodeblockUriPart {
	isEdit?: boolean;
	value: vibecoda.Uri;
	constructor(value: vibecoda.Uri, isEdit?: boolean) {
		this.value = value;
		this.isEdit = isEdit;
	}
}
...
export class ChatResponseCodeCitationPart {
	...
	license: string;
	snippet: string;
	constructor(value: vibecoda.Uri, license: string, snippet: string) {
		this.value = value;
...
export class ChatResponseTextEditPart implements vibecoda.ChatResponseTextEditPart {
	uri: vibecoda.Uri;
	edits: vibecoda.TextEdit[];
	isDone?: boolean;
	constructor(uri: vibecoda.Uri, editsOrDone: vibecoda.TextEdit | vibecoda.TextEdit[] | true) {
		this.uri = uri;
		if (editsOrDone === true) {
			this.isDone = true;
			this.edits = [];
...
export class ChatResponseNotebookEditPart implements vibecoda.ChatResponseNotebookEditPart {
	uri: vibecoda.Uri;
	edits: vibecoda.NotebookEdit[];
	isDone?: boolean;
	constructor(uri: vibecoda.Uri, editsOrDone: vibecoda.NotebookEdit | vibecoda.NotebookEdit[] | true) {
		this.uri = uri;
		if (editsOrDone === true) {
			this.isDone = true;
			this.edits = [];
...
export class ChatToolInvocationPart {
	...
	toolCallId: string;
	isError?: boolean;
	invocationMessage?: string | vibecoda.MarkdownString;
	originMessage?: string | vibecoda.MarkdownString;
	pastTenseMessage?: string | vibecoda.MarkdownString;
	isConfirmed?: boolean;
	isComplete?: boolean;
...
export class ChatRequestTurn implements vibecoda.ChatRequestTurn2 {
	constructor(
		readonly prompt: string,
		readonly command: string | undefined,
		readonly references: vibecoda.ChatPromptReference[],
		readonly participant: string,
		readonly toolReferences: vibecoda.ChatLanguageModelToolReference[],
		readonly editedFileEvents?: vibecoda.ChatRequestEditedFileEvent[]
	) { }
}

export class ChatResponseTurn implements vibecoda.ChatResponseTurn {

	constructor(
		readonly response: ReadonlyArray<ChatResponseMarkdownPart | ChatResponseFileTreePart | ChatResponseAnchorPart | ChatResponseCommandButtonPart>,
		readonly result: vibecoda.ChatResult,
		readonly participant: string,
		readonly command?: string
	) { }
}

export class ChatResponseTurn2 implements vibecoda.ChatResponseTurn2 {
...
export class ChatRequestEditorData implements vibecoda.ChatRequestEditorData {
	constructor(
		readonly document: vibecoda.TextDocument,
		readonly selection: vibecoda.Selection,
		readonly wholeRange: vibecoda.Range,
	) { }
}

export class ChatRequestNotebookData implements vibecoda.ChatRequestNotebookData {
	constructor(
		readonly cell: vibecoda.TextDocument
	) { }
}

export class ChatReferenceBinaryData implements vibecoda.ChatReferenceBinaryData {
	mimeType: string;
	data: () => Thenable<Uint8Array>;
	reference?: vibecoda.Uri;
	constructor(mimeType: string, data: () => Thenable<Uint8Array>, reference?: vibecoda.Uri) {
...
export class ChatReferenceDiagnostic implements vibecoda.ChatReferenceDiagnostic {
	constructor(public readonly diagnostics: [vibecoda.Uri, vibecoda.Diagnostic[]][]) { }
}
...
export class LanguageModelToolResultPart implements vibecoda.LanguageModelToolResultPart {
...
export class LanguageModelChatMessage implements vibecoda.LanguageModelChatMessage {
	...
	role: vibecoda.LanguageModelChatMessageRole;
	...
	constructor(role: vibecoda.LanguageModelChatMessageRole, content: string | (LanguageModelTextPart | LanguageModelToolResultPart | LanguageModelToolCallPart | LanguageModelDataPart)[], name?: string) {
		this.role = role;
		this.content = content;
		this.name = name;
	}
...
export class LanguageModelChatMessage2 implements vibecoda.LanguageModelChatMessage2 {
	...
	constructor(role: vibecoda.LanguageModelChatMessageRole, content: string | (LanguageModelTextPart | LanguageModelToolResultPart | LanguageModelToolCallPart | LanguageModelDataPart | LanguageModelThinkingPart)[], name?: string) {
		this.role = role;
		this.content = content;
		this.name = name;
	}
...
export class LanguageModelToolCallPart implements vibecoda.LanguageModelToolCallPart {
	callId: string;
	name: string;
	input: any;
...
export class LanguageModelTextPart implements vibecoda.LanguageModelTextPart2 {
	value: string;
	audience: vibecoda.LanguageModelPartAudience[] | undefined;

	constructor(value: string, audience?: vibecoda.LanguageModelPartAudience[]) {
		this.value = value;
		audience = audience;
	}
...
export class LanguageModelDataPart implements vibecoda.LanguageModelDataPart2 {
	mimeType: string;
	data: Uint8Array<ArrayBufferLike>;
	audience: vibecoda.LanguageModelPartAudience[] | undefined;

	constructor(data: Uint8Array<ArrayBufferLike>, mimeType: string, audience?: vibecoda.LanguageModelPartAudience[]) {
		this.mimeType = mimeType;
		this.data = data;
		this.audience = audience;
	}

	static image(data: Uint8Array<ArrayBufferLike>, mimeType: string): vibecoda.LanguageModelDataPart {
		return new LanguageModelDataPart(data, mimeType);
	}

	static json(value: object, mime: string = 'text/x-json'): vibecoda.LanguageModelDataPart {
		const rawStr = JSON.stringify(value, undefined, '\t');
		return new LanguageModelDataPart(VSBuffer.fromString(rawStr).buffer, mime);
	}

	static text(value: string, mime: string = Mimes.text): vibecoda.LanguageModelDataPart {
...
export class LanguageModelThinkingPart implements vibecoda.LanguageModelThinkingPart {
	value: string | string[];
	id?: string;
	metadata?: { readonly [key: string]: any };
...
export class LanguageModelToolExtensionSource implements vibecoda.LanguageModelToolExtensionSource {
	constructor(public readonly id: string, public readonly label: string) { }
}

export class LanguageModelToolMCPSource implements vibecoda.LanguageModelToolMCPSource {
...
export class McpStdioServerDefinition implements vibecoda.McpStdioServerDefinition {
	cwd?: URI;
	...
	constructor(
		...
		public metadata?: vibecoda.McpServerMetadata,
	) { }
}

export class McpHttpServerDefinition implements vibecoda.McpHttpServerDefinition {
	constructor(
		public label: string,
		public uri: URI,
