...
export class ExtHostStatusBarEntry implements vibecoda.StatusBarItem {
	...
	private _tooltip?: string | vibecoda.MarkdownString;
	private _tooltip2?: string | vibecoda.MarkdownString | undefined | ((token: vibecoda.CancellationToken) => Promise<string | vibecoda.MarkdownString | undefined>);
	...
	private _command?: {
		readonly fromApi: string | vibecoda.Command;
		readonly internal: ICommandDto;
	};

	private _timeoutHandle: Timeout | undefined;
	private _accessibilityInformation?: vibecoda.AccessibilityInformation;
	...
	private validatePriority(priority?: number): number | undefined {
		...
		// https://github.com/microsoft/vibecoda/issues/133317
	...
	public get alignment(): vibecoda.StatusBarAlignment {
	...
	public get tooltip(): vibecoda.MarkdownString | string | undefined {
		return this._tooltip;
	}

	public get tooltip2(): vibecoda.MarkdownString | string | undefined | ((token: vibecoda.CancellationToken) => Promise<vibecoda.MarkdownString | string | undefined>) {
		if (this._extension) {
	...
	public get command(): string | vibecoda.Command | undefined {
		return this._command?.fromApi;
	}

	public get accessibilityInformation(): vibecoda.AccessibilityInformation | undefined {
	...
	public set tooltip(tooltip: vibecoda.MarkdownString | string | undefined) {
		this._tooltip = tooltip;
		this.update();
	}

	public set tooltip2(tooltip: vibecoda.MarkdownString | string | undefined | ((token: vibecoda.CancellationToken) => Promise<vibecoda.MarkdownString | string | undefined>)) {
		if (this._extension) {
			checkProposedApiEnabled(this._extension, 'statusBarItemTooltip');
		}
	...
	public set command(command: string | vibecoda.Command | undefined) {
	...
	public set accessibilityInformation(accessibilityInformation: vibecoda.AccessibilityInformation | undefined) {
...
class StatusBarMessage {
	...
	private readonly _item: vibecoda.StatusBarItem;
...
export class ExtHostStatusBar implements ExtHostStatusBarShape {
	...
	async $provideTooltip(entryId: string, cancellation: vibecoda.CancellationToken): Promise<string | htmlContent.IMarkdownString | undefined> {
	...
	createStatusBarEntry(extension: IExtensionDescription | undefined, id: string, alignment?: ExtHostStatusBarAlignment, priority?: number): vibecoda.StatusBarItem;
	createStatusBarEntry(extension: IExtensionDescription, id?: string, alignment?: ExtHostStatusBarAlignment, priority?: number): vibecoda.StatusBarItem;
	createStatusBarEntry(extension: IExtensionDescription, id: string, alignment?: ExtHostStatusBarAlignment, priority?: number): vibecoda.StatusBarItem {
