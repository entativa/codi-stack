...
export interface IExtHostMpcService extends ExtHostMcpShape {
	registerMcpConfigurationProvider(extension: IExtensionDescription, id: string, provider: vibecoda.McpServerDefinitionProvider): IDisposable;
}
...
// declare const _serverDataValidationTest: vibecoda.McpStdioServerDefinition | vibecoda.McpHttpServerDefinition;
...
export class ExtHostMcpService extends Disposable implements IExtHostMpcService {
	...
	private readonly _unresolvedMcpServers = new Map</* collectionId */ string, {
		provider: vibecoda.McpServerDefinitionProvider;
		servers: vibecoda.McpServerDefinition[];
	}>();
	...
	/** {@link vibecoda.lm.registerMcpServerDefinitionProvider} */
	public registerMcpConfigurationProvider(extension: IExtensionDescription, id: string, provider: vibecoda.McpServerDefinitionProvider): IDisposable {
