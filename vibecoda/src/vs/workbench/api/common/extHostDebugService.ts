...
export interface IExtHostDebugService extends ExtHostDebugServiceShape {
	...
	readonly onDidStartDebugSession: Event<vibecoda.DebugSession>;
	readonly onDidTerminateDebugSession: Event<vibecoda.DebugSession>;
	readonly onDidChangeActiveDebugSession: Event<vibecoda.DebugSession | undefined>;
	activeDebugSession: vibecoda.DebugSession | undefined;
	activeDebugConsole: vibecoda.DebugConsole;
	readonly onDidReceiveDebugSessionCustomEvent: Event<vibecoda.DebugSessionCustomEvent>;
	readonly onDidChangeBreakpoints: Event<vibecoda.BreakpointsChangeEvent>;
	breakpoints: vibecoda.Breakpoint[];
	readonly onDidChangeActiveStackItem: Event<vibecoda.DebugThread | vibecoda.DebugStackFrame | undefined>;
	activeStackItem: vibecoda.DebugThread | vibecoda.DebugStackFrame | undefined;

	addBreakpoints(breakpoints0: readonly vibecoda.Breakpoint[]): Promise<void>;
	removeBreakpoints(breakpoints0: readonly vibecoda.Breakpoint[]): Promise<void>;
	startDebugging(folder: vibecoda.WorkspaceFolder | undefined, nameOrConfig: string | vibecoda.DebugConfiguration, options: vibecoda.DebugSessionOptions): Promise<boolean>;
	stopDebugging(session?: vibecoda.DebugSession): Promise<void>;
	registerDebugConfigurationProvider(type: string, provider: vibecoda.DebugConfigurationProvider, trigger: vibecoda.DebugConfigurationProviderTriggerKind): vibecoda.Disposable;
	registerDebugAdapterDescriptorFactory(extension: IExtensionDescription, type: string, factory: vibecoda.DebugAdapterDescriptorFactory): vibecoda.Disposable;
	registerDebugAdapterTrackerFactory(type: string, factory: vibecoda.DebugAdapterTrackerFactory): vibecoda.Disposable;
	registerDebugVisualizationProvider<T extends vibecoda.DebugVisualization>(extension: IExtensionDescription, id: string, provider: vibecoda.DebugVisualizationProvider<T>): vibecoda.Disposable;
	registerDebugVisualizationTree<T extends vibecoda.DebugTreeItem>(extension: IExtensionDescription, id: string, provider: vibecoda.DebugVisualizationTree<T>): vibecoda.Disposable;
...
export abstract class ExtHostDebugServiceBase extends DisposableCls implements IExtHostDebugService, ExtHostDebugServiceShape {
	...
	private readonly _onDidStartDebugSession: Emitter<vibecoda.DebugSession>;
	get onDidStartDebugSession(): Event<vibecoda.DebugSession> { return this._onDidStartDebugSession.event; }

	private readonly _onDidTerminateDebugSession: Emitter<vibecoda.DebugSession>;
	get onDidTerminateDebugSession(): Event<vibecoda.DebugSession> { return this._onDidTerminateDebugSession.event; }

	private readonly _onDidChangeActiveDebugSession: Emitter<vibecoda.DebugSession | undefined>;
	get onDidChangeActiveDebugSession(): Event<vibecoda.DebugSession | undefined> { return this._onDidChangeActiveDebugSession.event; }

	private _activeDebugSession: ExtHostDebugSession | undefined;
	get activeDebugSession(): vibecoda.DebugSession | undefined { return this._activeDebugSession?.api; }

	private readonly _onDidReceiveDebugSessionCustomEvent: Emitter<vibecoda.DebugSessionCustomEvent>;
	get onDidReceiveDebugSessionCustomEvent(): Event<vibecoda.DebugSessionCustomEvent> { return this._onDidReceiveDebugSessionCustomEvent.event; }

	private _activeDebugConsole: ExtHostDebugConsole;
	get activeDebugConsole(): vibecoda.DebugConsole { return this._activeDebugConsole.value; }

	private _breakpoints: Map<string, vibecoda.Breakpoint>;

	private readonly _onDidChangeBreakpoints: Emitter<vibecoda.BreakpointsChangeEvent>;

	private _activeStackItem: vibecoda.DebugThread | vibecoda.DebugStackFrame | undefined;
	private readonly _onDidChangeActiveStackItem: Emitter<vibecoda.DebugThread | vibecoda.DebugStackFrame | undefined>;

	private _debugAdapters: Map<number, IDebugAdapter>;
	private _debugAdaptersTrackers: Map<number, vibecoda.DebugAdapterTracker>;

	private _debugVisualizationTreeItemIdsCounter = 0;
	private readonly _debugVisualizationProviders = new Map<string, vibecoda.DebugVisualizationProvider>();
	private readonly _debugVisualizationTrees = new Map<string, vibecoda.DebugVisualizationTree>();
	private readonly _debugVisualizationTreeItemIds = new WeakMap<vibecoda.DebugTreeItem, number>();
	private readonly _debugVisualizationElements = new Map<number, { provider: string; item: vibecoda.DebugTreeItem; children?: number[] }>();

	private _signService: ISignService | undefined;

	private readonly _visualizers = new Map<number, { v: vibecoda.DebugVisualization; provider: vibecoda.DebugVisualizationProvider; extensionId: string }>();
	...
	constructor(
		...
		this._onDidStartDebugSession = this._register(new Emitter<vibecoda.DebugSession>());
		this._onDidTerminateDebugSession = this._register(new Emitter<vibecoda.DebugSession>());
		this._onDidChangeActiveDebugSession = this._register(new Emitter<vibecoda.DebugSession | undefined>());
		this._onDidReceiveDebugSessionCustomEvent = this._register(new Emitter<vibecoda.DebugSessionCustomEvent>());

		this._debugServiceProxy = extHostRpcService.getProxy(MainContext.MainThreadDebugService);

		this._onDidChangeBreakpoints = this._register(new Emitter<vibecoda.BreakpointsChangeEvent>());

		this._onDidChangeActiveStackItem = this._register(new Emitter<vibecoda.DebugThread | vibecoda.DebugStackFrame | undefined>());

		this._activeDebugConsole = new ExtHostDebugConsole(this._debugServiceProxy);

		this._breakpoints = new Map<string, vibecoda.Breakpoint>();
	...
	public registerDebugVisualizationTree<T extends vibecoda.DebugTreeItem>(manifest: IExtensionDescription, id: string, provider: vibecoda.DebugVisualizationTree<T>): vibecoda.Disposable {
	...
	private convertVisualizerTreeItem(treeId: string, item: vibecoda.DebugTreeItem): IDebugVisualizationTreeItem {
	...
	public asDebugSourceUri(src: vibecoda.DebugProtocolSource, session?: vibecoda.DebugSession): URI {
	...
	get activeStackItem(): vibecoda.DebugThread | vibecoda.DebugStackFrame | undefined {
		return this._activeStackItem;
	}

	get onDidChangeActiveStackItem(): Event<vibecoda.DebugThread | vibecoda.DebugStackFrame | undefined> {
		return this._onDidChangeActiveStackItem.event;
	}

	get onDidChangeBreakpoints(): Event<vibecoda.BreakpointsChangeEvent> {
		return this._onDidChangeBreakpoints.event;
	}

	get breakpoints(): vibecoda.Breakpoint[] {
		const result: vibecoda.Breakpoint[] = [];
	...
	private hydrateVisualizationContext(context: IDebugVisualizationContext): vibecoda.DebugVisualizationContext | undefined {
	...
	public registerDebugVisualizationProvider<T extends vibecoda.DebugVisualization>(manifest: IExtensionDescription, id: string, provider: vibecoda.DebugVisualizationProvider<T>): vibecoda.Disposable {
	...
	public addBreakpoints(breakpoints0: vibecoda.Breakpoint[]): Promise<void> {
		...
		// send DTOs to Vibecoda
		return this._debugServiceProxy.$registerBreakpoints(dtos);
	}

	public removeBreakpoints(breakpoints0: vibecoda.Breakpoint[]): Promise<void> {
		// remove from array
	...
	public startDebugging(folder: vibecoda.WorkspaceFolder | undefined, nameOrConfig: string | vibecoda.DebugConfiguration, options: vibecoda.DebugSessionOptions): Promise<boolean> {
	...
	public stopDebugging(session?: vibecoda.DebugSession): Promise<void> {
		return this._debugServiceProxy.$stopDebugging(session ? session.id : undefined);
	}

	public registerDebugConfigurationProvider(type: string, provider: vibecoda.DebugConfigurationProvider, trigger: vibecoda.DebugConfigurationProviderTriggerKind): vibecoda.Disposable {
	...
	public registerDebugAdapterDescriptorFactory(extension: IExtensionDescription, type: string, factory: vibecoda.DebugAdapterDescriptorFactory): vibecoda.Disposable {
	...
	public registerDebugAdapterTrackerFactory(type: string, factory: vibecoda.DebugAdapterTrackerFactory): vibecoda.Disposable {
	...
	protected createDebugAdapter(adapter: vibecoda.DebugAdapterDescriptor, session: ExtHostDebugSession): AbstractDebugAdapter | undefined {
	...
	public $acceptBreakpointsDelta(delta: IBreakpointsDeltaDto): void {
		...
		const a: vibecoda.Breakpoint[] = [];
		const r: vibecoda.Breakpoint[] = [];
		const c: vibecoda.Breakpoint[] = [];
	...
	public async $acceptStackFrameFocus(focusDto: IThreadFocusDto | IStackFrameFocusDto | undefined): Promise<void> {
		let focus: vibecoda.DebugThread | vibecoda.DebugStackFrame | undefined;
		if (focusDto) {
	...
	public $provideDebugConfigurations(configProviderHandle: number, folderUri: UriComponents | undefined, token: CancellationToken): Promise<vibecoda.DebugConfiguration[]> {
	...
	public $resolveDebugConfiguration(configProviderHandle: number, folderUri: UriComponents | undefined, debugConfiguration: vibecoda.DebugConfiguration, token: CancellationToken): Promise<vibecoda.DebugConfiguration | null | undefined> {
		return asPromise(async () => {
			const provider = this.getConfigProviderByHandle(configProviderHandle);
			if (!provider) {
				throw new Error('no DebugConfigurationProvider found');
	...
	public $resolveDebugConfigurationWithSubstitutedVariables(configProviderHandle: number, folderUri: UriComponents | undefined, debugConfiguration: vibecoda.DebugConfiguration, token: CancellationToken): Promise<vibecoda.DebugConfiguration | null | undefined> {
		return asPromise(async () => {
			const provider = this.getConfigProviderByHandle(configProviderHandle);
			if (!provider) {
				throw new Error('no DebugConfigurationProvider found');
	...
	public async $acceptDebugSessionCustomEvent(sessionDto: IDebugSessionDto, event: any): Promise<void> {
		const session = await this.getSession(sessionDto);
		const ee: vibecoda.DebugSessionCustomEvent = {
			session: session.api,
			event: event.event,
			body: event.body
		};
	...
	private convertToDto(x: vibecoda.DebugAdapterDescriptor): Dto<IAdapterDescriptor> {
	...
	private getAdapterDescriptorFactoryByType(type: string): vibecoda.DebugAdapterDescriptorFactory | undefined {
	...
	private getAdapterDescriptorFactoryByHandle(handle: number): vibecoda.DebugAdapterDescriptorFactory | undefined {
	...
	private getConfigProviderByHandle(handle: number): vibecoda.DebugConfigurationProvider | undefined {
	...
	private getDebugAdapterTrackers(session: ExtHostDebugSession): Promise<vibecoda.DebugAdapterTracker | undefined> {
		...
		const promises = this._trackerFactories
			...
			.map(tuple => asPromise<vibecoda.ProviderResult<vibecoda.DebugAdapterTracker>>(() => tuple.factory.createDebugAdapterTracker(session.api)).then(p => p, err => null));
	...
	private async getAdapterDescriptor(adapterDescriptorFactory: vibecoda.DebugAdapterDescriptorFactory | undefined, session: ExtHostDebugSession): Promise<vibecoda.DebugAdapterDescriptor | undefined> {
	...
	private fireBreakpointChanges(added: vibecoda.Breakpoint[], removed: vibecoda.Breakpoint[], changed: vibecoda.Breakpoint[]) {
	...
	private getFolder(_folderUri: UriComponents | undefined): Promise<vibecoda.WorkspaceFolder | undefined> {
		if (_folderUri) {
	...
	private serializeVisualization(extensionId: string, viz: vibecoda.DebugVisualization['visualization']): MainThreadDebugVisualization | undefined {
		if (!viz) {
			return undefined;
		}
	...
	private getIconPathOrClass(icon: vibecoda.DebugVisualization['iconPath']) {
	...
	private getIconUris(iconPath: vibecoda.DebugVisualization['iconPath']): { dark: URI; light?: URI } | { id: string } {
...
export class ExtHostDebugSession {
	private apiSession?: vibecoda.DebugSession;
	constructor(
		private _debugServiceProxy: MainThreadDebugServiceShape,
		private _id: DebugSessionUUID,
		private _type: string,
		private _name: string,
		private _workspaceFolder: vibecoda.WorkspaceFolder | undefined,
		private _configuration: vibecoda.DebugConfiguration,
		private _parentSession: vibecoda.DebugSession | undefined) {
	}

	public get api(): vibecoda.DebugSession {
		const that = this;
		return this.apiSession ??= Object.freeze({
			...
			getDebugProtocolBreakpoint(breakpoint: vibecoda.Breakpoint): Promise<vibecoda.DebugProtocolBreakpoint | undefined> {
	...
	public get configuration(): vibecoda.DebugConfiguration {
...
export class ExtHostDebugConsole {
	...
	readonly value: vibecoda.DebugConsole;
...
interface ConfigProviderTuple {
	type: string;
	handle: number;
	provider: vibecoda.DebugConfigurationProvider;
}

interface DescriptorFactoryTuple {
	type: string;
	handle: number;
	factory: vibecoda.DebugAdapterDescriptorFactory;
}

interface TrackerFactoryTuple {
	type: string;
	handle: number;
	factory: vibecoda.DebugAdapterTrackerFactory;
}

class MultiTracker implements vibecoda.DebugAdapterTracker {

	constructor(private trackers: vibecoda.DebugAdapterTracker[]) {
	}
...
class DirectDebugAdapter extends AbstractDebugAdapter {
	...
	constructor(private implementation: vibecoda.DebugAdapter) {
		super();

		implementation.onDidSendMessage((message: vibecoda.DebugProtocolMessage) => {
