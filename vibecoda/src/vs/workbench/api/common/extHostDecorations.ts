...
interface ProviderData {
	provider: vibecoda.FileDecorationProvider;
...
export class ExtHostDecorations implements ExtHostDecorationsShape {
	...
	registerFileDecorationProvider(provider: vibecoda.FileDecorationProvider, extensionDescription: IExtensionDescription): vibecoda.Disposable {
