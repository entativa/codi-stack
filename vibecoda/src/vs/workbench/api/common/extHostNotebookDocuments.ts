...
export class ExtHostNotebookDocuments implements extHostProtocol.ExtHostNotebookDocumentsShape {
	...
	private readonly _onDidSaveNotebookDocument = new Emitter<vibecoda.NotebookDocument>();
	readonly onDidSaveNotebookDocument = this._onDidSaveNotebookDocument.event;

	private readonly _onDidChangeNotebookDocument = new Emitter<vibecoda.NotebookDocumentChangeEvent>();
