...
suite('ExtHostCommands', function () {
	...
	test('onCommand:abc activates extensions when executed from command palette, but not when executed programmatically with vibecoda.commands.executeCommand #150293', async function () {
