...
/**
 * The identifier of an extension in the format: `PUBLISHER.NAME`. For example: `vibecoda.csharp`
 */
...
export interface ICommand {
	 ...
	 * using the `vibecoda.commands.executeCommand` API using that command ID.
	 */
	id: string;
