...
// - UTF-32: we do not support this encoding in Vibecoda
...
async function guessEncodingByBuffer(buffer: VSBuffer, candidateGuessEncodings?: string[]): Promise<string | null> {
	...
	try {
		...
		return null; // jschardet throws for unknown encodings (https://github.com/microsoft/vibecoda/issues/239928)
	}
