 ...
 * TODO@roblou - merge this with the GlobPattern docs/definition in vibecoda.d.ts.
...
export interface SearchOptions {
	 ...
	 * See the vibecoda setting `"search.useIgnoreFiles"`.
	 */
	useIgnoreFiles: boolean;

	/**
	 * Whether symlinks should be followed while searching.
	 * See the vibecoda setting `"search.followSymlinks"`.
	 */
	followSymlinks: boolean;

	/**
	 * Whether global files that exclude files, like .gitignore, should be respected.
	 * See the vibecoda setting `"search.useGlobalIgnoreFiles"`.
	 */
	useGlobalIgnoreFiles: boolean;

	/**
	 * Whether files in parent directories that exclude files, like .gitignore, should be respected.
	 * See the vibecoda setting `"search.useParentIgnoreFiles"`.
	 */
...
export interface TextSearchOptions extends SearchOptions {
	 ...
	 * See the vibecoda setting `"files.encoding"`
	 */
	encoding?: string;
 ...
 *
 * A FileSearchProvider is the more powerful of two ways to implement file search in Vibecoda. Use a FileSearchProvider if you wish to search within a folder for
