...
import { AST as ReAST, RegExpParser, RegExpVisitor } from 'vibecoda-regexpp';
import { rgPath } from '@vibecoda/ripgrep';
...
// If @vibecoda/ripgrep is in an .asar file, then the binary is unpacked.
...
export class RipgrepParser extends EventEmitter {
	...
	private createTextSearchMatch(data: IRgMatch, uri: URI): TextSearchMatch2 {
		...
		// https://github.com/microsoft/vibecoda/issues/100569#issuecomment-738496991
