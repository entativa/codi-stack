...
export class FileDialogService extends AbstractFileDialogService implements IFileDialogService {
	...
	private shouldUseSimplified(schema: string): { useSimplified: boolean; isSetting: boolean } {
		...
		return {
			...
			useSimplified: ((schema !== Schemas.file) && (schema !== Schemas.vibecodaUserData)) || setting || !!this.environmentService.enableSmokeTestDriver,
	...
	private toNativeSaveDialogOptions(options: ISaveDialogOptions): SaveDialogOptions & INativeHostOptions {
		...
		return {
			...
			title: options.title,
			targetWindowId: getActiveWindow().vibecodaWindowId
		};
	}
