...
import type { Parser, Language, Query } from '@vibecoda/tree-sitter-wasm';
...
const MODULE_LOCATION_SUBPATH = `@vibecoda/tree-sitter-wasm/wasm`;
...
export class TreeSitterLibraryService extends Disposable implements ITreeSitterLibraryService {
	...
	private readonly _treeSitterImport = new Lazy(async () => {
		const TreeSitter = await importAMDNodeModule<typeof import('@vibecoda/tree-sitter-wasm')>('@vibecoda/tree-sitter-wasm', 'wasm/tree-sitter.js');
