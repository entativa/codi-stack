...
const regexpModuleLocation: AppResourcePath = `${nodeModulesPath}/vibecoda-regexp-languagedetection`;
const regexpModuleLocationAsar: AppResourcePath = `${nodeModulesAsarPath}/vibecoda-regexp-languagedetection`;
const moduleLocation: AppResourcePath = `${nodeModulesPath}/@vibecoda/vibecoda-languagedetection`;
const moduleLocationAsar: AppResourcePath = `${nodeModulesAsarPath}/@vibecoda/vibecoda-languagedetection`;
...
export class LanguageDetectionService extends Disposable implements ILanguageDetectionService {
	...
	constructor(
		...
		this._languageDetectionWorkerClient = this._register(new LanguageDetectionWorkerClient(
			...
			languageService,
			telemetryService,
			// TODO See if it's possible to bundle vibecoda-languagedetection
			useAsar
