...
suite('ConfigurationEditing', () => {
	...
	setup(async () => {
		...
		disposables.add(fileService.registerProvider(Schemas.vibecodaUserData, disposables.add(new FileUserDataProvider(ROOT.scheme, fileSystemProvider, Schemas.vibecodaUserData, userDataProfilesService, uriIdentityService, logService))));
