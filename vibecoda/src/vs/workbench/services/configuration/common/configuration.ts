...
export const FOLDER_CONFIG_FOLDER_NAME = '.vibecoda';
export const FOLDER_SETTINGS_NAME = 'settings';
export const FOLDER_SETTINGS_PATH = `${FOLDER_CONFIG_FOLDER_NAME}/${FOLDER_SETTINGS_NAME}.json`;

export const defaultSettingsSchemaId = 'vibecoda://schemas/settings/default';
export const userSettingsSchemaId = 'vibecoda://schemas/settings/user';
export const profileSettingsSchemaId = 'vibecoda://schemas/settings/profile';
export const machineSettingsSchemaId = 'vibecoda://schemas/settings/machine';
export const workspaceSettingsSchemaId = 'vibecoda://schemas/settings/workspace';
export const folderSettingsSchemaId = 'vibecoda://schemas/settings/folder';
export const launchSchemaId = 'vibecoda://schemas/launch';
export const tasksSchemaId = 'vibecoda://schemas/tasks';
export const mcpSchemaId = 'vibecoda://schemas/mcp';
