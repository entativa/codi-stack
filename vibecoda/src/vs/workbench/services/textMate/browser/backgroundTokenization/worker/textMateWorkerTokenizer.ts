...
import type { StackDiff, StateStack, diffStateStacksRefEq } from 'vibecoda-textmate';
...
export class TextMateWorkerTokenizer extends MirrorTextModel {
	...
	private async _tokenize(): Promise<void> {
		...
		if (!this._diffStateStacksRefEqFn) {
			const { diffStateStacksRefEq } = await importAMDNodeModule<typeof import('vibecoda-textmate')>('vibecoda-textmate', 'release/main.js');
