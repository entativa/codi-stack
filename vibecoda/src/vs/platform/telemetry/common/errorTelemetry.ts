...
type ErrorEventFragment = {
	...
	comment: 'Whenever an error in Vibecoda is thrown.';
...
export default abstract class BaseErrorTelemetry {
	...
	private _onErrorEvent(err: any): void {
		...
		//
		// Explicitly filter out PendingMigrationError for https://github.com/microsoft/vibecoda/issues/250648#issuecomment-3394040431
