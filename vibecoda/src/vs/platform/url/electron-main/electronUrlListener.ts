...
/**
 * A listener for URLs that are opened from the OS and handled by Vibecoda.
 * Depending on the platform, this works differently:
 * - Windows: we use `app.setAsDefaultProtocolClient()` to register Vibecoda with the OS
 ...
 *            that calls Vibecoda with the `open-url` command line argument
 *            (https://github.com/microsoft/vibecoda/pull/56727)
 */
