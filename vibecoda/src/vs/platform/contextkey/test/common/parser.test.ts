	...
	suite('controversial', () => {
		...
		*/
		...
		/*
			...
			old parser output: { key: 'viewItem', op: '==', value: 'Vibecoda WorkSpace' }
			new parser output: { key: 'viewItem', op: '==', value: 'Vibecoda' }
		...
		*/
		test(` viewItem == Vibecoda WorkSpace`, () => {
			const input = ` viewItem == Vibecoda WorkSpace`;
