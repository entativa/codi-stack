...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit Vibecoda's "shell environment" that may
	 ...
	 * a terminal used to drive some Vibecoda feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to Vibecoda and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** Vibecoda shell integration sequences have been encountered. Supercedes FinalTerm. */
	Vibecoda
}
