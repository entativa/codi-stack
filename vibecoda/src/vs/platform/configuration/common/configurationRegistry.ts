...
export const resourceLanguageSettingsSchemaId = 'vibecoda://schemas/settings/resourceLanguage';
export const configurationDefaultsSchemaId = 'vibecoda://schemas/settings/configurationDefaults';
