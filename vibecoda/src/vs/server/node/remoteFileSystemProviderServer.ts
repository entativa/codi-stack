...
export class RemoteAgentFileSystemProviderChannel extends AbstractDiskFileSystemProviderChannel<RemoteAgentConnectionContext> {
	...
	protected override transformIncoming(uriTransformer: IURITransformer, _resource: UriComponents, supportVibecodaResource = false): URI {
		if (supportVibecodaResource && _resource.path === '/vibecoda-resource' && _resource.query) {
