		...
		try {
			...
			this._hooks.add(toDisposable(() => {
				try {
					...
					// See https://github.com/microsoft/vibecoda/issues/161731
					//
			...
			// See https://github.com/microsoft/vibecoda/issues/144584
			// See https://github.com/microsoft/vibecoda/issues/146947
