...
export class ListView<T> implements IListView<T> {
	...
	private onDragOver(event: IListDragEvent<T>): boolean {
		...
		if (StaticDND.CurrentDragAndDropData && StaticDND.CurrentDragAndDropData.getData() === 'vibecoda-ui') {
			return false;
		}
		...
		while (true) {
			...
			if (!didChange) {
				...
				if (typeof anchorElementIndex === 'number') {
					...
					// See https://github.com/microsoft/vibecoda/issues/104144
					// See https://github.com/microsoft/vibecoda/pull/104284
					// See https://github.com/microsoft/vibecoda/issues/107704
