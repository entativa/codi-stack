...
suite('URI', () => {
	...
	test('Vibecoda URI module\'s driveLetterPath regex is incorrect, #32961', function () {
	...
	test('URI#joinPath (windows)', function () {
		...
		//https://github.com/microsoft/vibecoda/issues/93831
		assertJoined('file:///c:/foo/bar', './other/foo.img', 'file:///c:/foo/bar/other/foo.img', false);
	});

	test('vibecoda-uri: URI.toString() wrongly encode IPv6 literals #154048', function () {
