...
const vibecodaGlobal = (globalThis as unknown as ISandboxGlobal).vibecoda;
export const ipcRenderer: IpcRenderer = vibecodaGlobal.ipcRenderer;
export const ipcMessagePort: IpcMessagePort = vibecodaGlobal.ipcMessagePort;
export const webFrame: WebFrame = vibecodaGlobal.webFrame;
export const process: ISandboxNodeProcess = vibecodaGlobal.process;
export const context: ISandboxContext = vibecodaGlobal.context;
export const webUtils: WebUtils = vibecodaGlobal.webUtils;
