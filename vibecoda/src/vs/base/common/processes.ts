...
/**
 * Sanitizes a Vibecoda process environment by removing all Electron/Vibecoda-related values.
 */
...
export function removeDangerousEnvVariables(env: IProcessEnvironment | undefined): void {
	...
	// See https://github.com/microsoft/vibecoda/issues/130072
	delete env['DEBUG'];

	if (isLinux) {
		// Unset `LD_PRELOAD`, as it might lead to process crashes
		// See https://github.com/microsoft/vibecoda/issues/134177
