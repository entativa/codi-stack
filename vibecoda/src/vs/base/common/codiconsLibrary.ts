...
// This file is automatically generated by (microsoft/vibecoda-codicons)/scripts/export-to-ts.js
...
export const codiconsLibrary = {
	...
	vibecoda: register('vibecoda', 0xec29),
	vibecodaInsiders: register('vibecoda-insiders', 0xec2a),
	codeOss: register('vibecoda', 0xec2b),
