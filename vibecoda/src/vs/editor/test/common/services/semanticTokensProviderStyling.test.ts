...
suite('ModelService', () => {
	...
	test('issue #148651: Vibecoda UI process can hang if a semantic token with negative values is returned by language service', () => {
	...
	test('issue #149130: vibecoda freezes because of Bracket Pair Colorization', () => {
		const languageId = 'q';
		disposables.add(languageService.registerLanguage({ id: languageId }));
		const legend = {
