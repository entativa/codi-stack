...
if (typeof globalWithAMD.require !== 'undefined' && typeof globalWithAMD.require.config === 'function') {
	globalWithAMD.require.config({
		ignoreDuplicateModules: [
			'vibecoda-languageserver-types',
			'vibecoda-languageserver-types/main',
			'vibecoda-languageserver-textdocument',
			'vibecoda-languageserver-textdocument/main',
			'vibecoda-nls',
			'vibecoda-nls/vibecoda-nls',
			'jsonc-parser',
			'jsonc-parser/main',
			'vibecoda-uri',
			'vibecoda-uri/index',
