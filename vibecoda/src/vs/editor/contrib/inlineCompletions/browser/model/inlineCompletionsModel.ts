...
export class InlineCompletionsModel extends Disposable {
	...
	constructor(
		...
		{ // Determine editor type
			const isNotebook = this.textModel.uri.scheme === 'vibecoda-notebook-cell';
	...
	public readonly state = derivedOpts<{
		...
		if (inlineEditResult) {
			...
			const nextEditUri = (item.inlineEdit?.command?.id === 'vibecoda.open' || item.inlineEdit?.command?.id === '_workbench.open') &&
