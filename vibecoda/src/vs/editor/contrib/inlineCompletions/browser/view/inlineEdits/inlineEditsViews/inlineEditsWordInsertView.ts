				...
				return [
					n.div({
						style: {
							...
							borderRadius: '4px',
							background: 'var(--vibecoda-editor-background)'
						}
					}, []),
					n.div({
						style: {
							...
							padding: '0px',
							textAlign: 'center',
							background: 'var(--vibecoda-inlineEdit-modifiedChangedTextBackground)',
					...
					n.div({
						style: {
							...
							background: 'var(--vibecoda-inlineEdit-wordReplacementView-background)',
						}
					}, []),
					n.svg({
						viewBox: '0 0 12 18',
						...
						n.svgElem('path', {
							...
							fill: 'var(--vibecoda-inlineEdit-modifiedChangedTextBackground)',
						})
					])
				];
			})
