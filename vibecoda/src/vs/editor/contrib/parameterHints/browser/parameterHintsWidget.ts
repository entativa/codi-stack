...
export class ParameterHintsWidget extends Disposable implements IContentWidget {
	...
	private createParameterHintDOMNodes() {
		...
		const updateFont = () => {
			...
			element.style.setProperty('--vibecoda-parameterHintsWidget-editorFontFamily', fontInfo.fontFamily);
			element.style.setProperty('--vibecoda-parameterHintsWidget-editorFontFamilyDefault', EDITOR_FONT_DEFAULTS.fontFamily);
		};
