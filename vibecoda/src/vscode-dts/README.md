...
1. run `npx vibecoda-dts dev` to download the `d.ts` files into your project
...
1. create a _new_ file in this directory, its name must follow this pattern `vibecoda.proposed.[a-zA-Z]+.d.ts`
...
1. Most likely will need to add your proposed api to vibecoda-api-tests as well
