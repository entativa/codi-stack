...
declare module 'vibecoda' {
	...
	export interface RemoteAuthorityResolver {
		/**
		 * Resolve the authority part of the current opened `vibecoda-remote://` URI.
		 *
		 * This method will be invoked once during the startup of the editor and again each time
		 * the editor detects a disconnection.
		 *
		 * @param authority The authority part of the current opened `vibecoda-remote://` URI.
		...
		/**
		 * Get the canonical URI (if applicable) for a `vibecoda-remote://` URI.
		 *
	...
	export interface ResourceLabelFormatting {
		...
		// eslint-disable-next-line local/vibecoda-dts-literal-or-types, local/vibecoda-dts-string-type-literals
		separator: '/' | '\\' | '';
		tildify?: boolean;
	...
	export namespace env {
		...
		/**
		 * The authority part of the current opened `vibecoda-remote://` URI.
