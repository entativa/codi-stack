...
export default tseslint.config(
	...
	// vibecoda TS: strict no explicit `any`
	{
		files: [
			'src/**/*.ts',
		],
	...
	// vibecoda API
	{
		...
		rules: {
			...
			'local/vibecoda-dts-create-func': 'warn',
			'local/vibecoda-dts-literal-or-types': 'warn',
			'local/vibecoda-dts-string-type-literals': 'warn',
			'local/vibecoda-dts-interface-naming': 'warn',
			'local/vibecoda-dts-cancellation': 'warn',
			'local/vibecoda-dts-use-export': 'warn',
			'local/vibecoda-dts-use-thenable': 'warn',
			'local/vibecoda-dts-vibecoda-in-comments': 'warn',
			'local/vibecoda-dts-provider-naming': [
				'warn',
				{
					'allowed': [
						'FileSystemProvider',
			...
			'local/vibecoda-dts-event-naming': [
				'warn',
				{
					'allowed': [
			...
			'local/code-import-patterns': [
				...
				},
				{
					...
					'allow': [
						'@parcel/watcher',
						'@vibecoda/sqlite3',
						'@vibecoda/vibecoda-languagedetection',
						'@vibecoda/ripgrep',
						'@vibecoda/iconv-lite-umd',
						'@vibecoda/policy-watcher',
						'@vibecoda/proxy-agent',
						'@vibecoda/spdlog',
						'@vibecoda/windows-process-tree',
						'assert',
						'child_process',
						'console',
						'cookie',
				...
				},
				{
					...
					'restrictions': [
						...
						'vs/platform/*/~',
						'vs/editor/~',
						'@vibecoda/tree-sitter-wasm' // node module allowed even in /common/
					]
				},
				{
				...
				},
				{
					...
					'restrictions': [
						...
						'@vibecoda/tree-sitter-wasm' // type import
					]
				},
				{
				...
				},
				{
					...
					'restrictions': [
						...
						'tas-client-umd', // node module allowed even in /common/
						'vibecoda-textmate', // node module allowed even in /common/
						'@vibecoda/vibecoda-languagedetection', // node module allowed even in /common/
						'@vibecoda/tree-sitter-wasm', // type import
						{
							'when': 'hasBrowser',
							'pattern': '@xterm/xterm'
				...
				},
				{
					...
					'restrictions': [
						...
						'vibecoda-notebook-renderer', // Type only import
						'@vibecoda/tree-sitter-wasm', // type import
						{
							'when': 'hasBrowser',
							'pattern': '@xterm/xterm'
