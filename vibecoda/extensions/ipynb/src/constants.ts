...
import type { DocumentSelector } from 'vibecoda';
...
// Copied from NotebookCellKind.Markup as we cannot import it from vibecoda directly in worker threads.
export const NotebookCellKindMarkup = 1;
// Copied from NotebookCellKind.Code as we cannot import it from vibecoda directly in worker threads.
