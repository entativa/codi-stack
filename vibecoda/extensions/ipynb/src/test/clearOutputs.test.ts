...
suite(`ipynb Clear Outputs`, () => {
	...
	const context = { subscriptions: disposables } as vibecoda.ExtensionContext;
	setup(() => {
	...
	test.skip('Clear outputs after opening Notebook', async () => {
		...
		const notebookDocumentPromise = vibecoda.workspace.openNotebookDocument('jupyter-notebook', notebook);
		...
		await raceTimeout(vibecoda.window.showNotebookDocument(notebookDocument), 20000, () => {
			throw new Error('Timeout waiting for notebook to open');
		});
		...
		// Clear all outputs
		await raceTimeout(vibecoda.commands.executeCommand('notebook.clearAllCellsOutputs'), 5000, () => {
		...
		vibecoda.workspace.onDidChangeNotebookDocument(() => verifyMetadataChanges(), undefined, disposables);
	...
	// 	const markdownCell = new vibecoda.NotebookCellData(vibecoda.NotebookCellKind.Markup, '# header1', 'markdown');
	...
	// 	const markdownCell2 = new vibecoda.NotebookCellData(vibecoda.NotebookCellKind.Markup, '# header1', 'markdown');
	...
	// 		expectedOutputs: vibecoda.NotebookCellOutput[],
	...
	// 			],
	// 			[
	// 				new vibecoda.NotebookCellOutput([vibecoda.NotebookCellOutputItem.stderr('Error')], {
	// 					outputType: 'stream'
	// 				}),
	// 				new vibecoda.NotebookCellOutput([vibecoda.NotebookCellOutputItem.stdout('NoError')], {
	// 					outputType: 'stream'
	// 				})
	// 			]
	// 		);
	...
	// 			],
	// 			[
	// 				new vibecoda.NotebookCellOutput([vibecoda.NotebookCellOutputItem.stdout('Line1\n\nLine3\nLine4')], {
	// 					outputType: 'stream'
	// 				})
	// 			]
	// 		);
	...
	// 			],
	// 			[
	// 				new vibecoda.NotebookCellOutput([vibecoda.NotebookCellOutputItem.stdout('Hello\nHello\nHello\nHello\nHello\nHello\n')], {
	// 					outputType: 'stream'
	// 				})
	// 			]
	// 		);
	...
	// 			],
	// 			[
	// 				new vibecoda.NotebookCellOutput([vibecoda.NotebookCellOutputItem.stdout(['Epoch 1/5\n',
	// 					'...\n',
	// 					'Epoch 2/5\n',
	// 					'...\n',
	// 					'Epoch 3/5\n',
	...
	// 			],
	// 			[
	// 				new vibecoda.NotebookCellOutput([vibecoda.NotebookCellOutputItem.stderr(['Epoch 1/5\n',
	// 					'...\n',
	// 					'Epoch 2/5\n',
	// 					'...\n',
	// 					'Epoch 3/5\n',
	...
	// 					[vibecoda.NotebookCellOutputItem.stderr('\u001b[K\u001b[33m✅ \u001b[0m Loading\n')],
	// 					{
	// 						outputType: 'stream'
	// 					}
	// 				)
	...
	// 			],
	// 			[
	// 				new vibecoda.NotebookCellOutput([vibecoda.NotebookCellOutputItem.stderr('1 is < 2')], {
	// 					outputType: 'stream'
	// 				})
	// 			]
	// 		);
	...
	// 			[
	// 				new vibecoda.NotebookCellOutput(
	// 					[vibecoda.NotebookCellOutputItem.stderr('1 is < 2\u001b[K\u001b[33m✅ \u001b[0m Loading\n')],
	// 					{
	// 						outputType: 'stream'
	// 					}
	// 				)
	...
	// 				new vibecoda.NotebookCellOutput(
	// 					[
	// 						vibecoda.NotebookCellOutputItem.error({
	// 							name: 'Error Name',
	// 							message: 'Error Value',
	...
	// 					[
	// 						new vibecoda.NotebookCellOutput(
	// 							[new vibecoda.NotebookCellOutputItem(Buffer.from('Hello World!', 'utf8'), 'text/plain')],
	// 							{
	...
	// 						new vibecoda.NotebookCellOutput(
	// 							[
	// 								new vibecoda.NotebookCellOutputItem(Buffer.from(base64EncodedImage, 'base64'), 'image/png'),
	// 								new vibecoda.NotebookCellOutputItem(Buffer.from(base64EncodedImage, 'base64'), 'image/jpeg')
	// 							],
	// 							{
	// 								executionCount: 1,
	// 								outputType: output_type,
