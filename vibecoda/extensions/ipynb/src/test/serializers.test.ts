...
suite(`ipynb serializer`, () => {
	...
	test('Deserialize', async () => {
		...
		const expectedCodeCell = new vibecoda.NotebookCellData(vibecoda.NotebookCellKind.Code, 'print(1)', 'python');
		...
		const expectedCodeCell2 = new vibecoda.NotebookCellData(vibecoda.NotebookCellKind.Code, 'print(2)', 'python');
		expectedCodeCell2.outputs = [];
		expectedCodeCell2.metadata = { execution_count: null, metadata: {} };
		expectedCodeCell2.executionSummary = {};

		const expectedMarkdownCell = new vibecoda.NotebookCellData(vibecoda.NotebookCellKind.Markup, '# HEAD', 'markdown');
