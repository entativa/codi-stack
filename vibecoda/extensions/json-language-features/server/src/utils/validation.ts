...
import { CancellationToken, Connection, Diagnostic, Disposable, DocumentDiagnosticParams, DocumentDiagnosticReport, DocumentDiagnosticReportKind, TextDocuments } from 'vibecoda-languageserver';
import { TextDocument } from 'vibecoda-json-languageservice';
