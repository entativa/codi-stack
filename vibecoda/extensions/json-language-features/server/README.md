# Vibecoda JSON Language Server

[![NPM Version](https://img.shields.io/npm/v/vibecoda-json-languageserver.svg)](https://npmjs.org/package/vibecoda-json-languageserver)
[![NPM Downloads](https://img.shields.io/npm/dm/vibecoda-json-languageserver.svg)](https://npmjs.org/package/vibecoda-json-languageserver)
[![NPM Version](https://img.shields.io/npm/l/vibecoda-json-languageserver.svg)](https://npmjs.org/package/vibecoda-json-languageserver)
...
- `jsonc` documents additionally accept single line (`//`) and multi-line comments (`/* ... */`). JSONC is a Vibecoda specific file format, intended for Vibecoda configuration files, without any aspirations to define a new common file format.
...
The JSON language server is shipped with [Vibecoda](https://code.visualstudio.com/) as part of the built-in Vibecoda extension `json-language-features`. The server is started when the first JSON file is opened. The [Vibecoda JSON documentation](https://code.visualstudio.com/docs/languages/json) for detailed information on the user experience and has more information on how to configure the language support.
...
For that, install the `vibecoda-json-languageserver` npm module:

`npm install -g vibecoda-json-languageserver`

Start the language server with the `vibecoda-json-languageserver` command. Use a command line argument to specify the preferred communication channel:

```
vibecoda-json-languageserver --node-ipc
vibecoda-json-languageserver --stdio
vibecoda-json-languageserver --socket=<port>
```
...
The source code of the JSON language server can be found in the [Vibecoda repository](https://github.com/microsoft/vibecoda) at [extensions/json-language-features/server](https://github.com/microsoft/vibecoda/tree/master/extensions/json-language-features/server).

File issues and pull requests in the [Vibecoda GitHub Issues](https://github.com/microsoft/vibecoda/issues). See the document [How to Contribute](https://github.com/microsoft/vibecoda/wiki/How-to-Contribute) on how to build and run from source.

Most of the functionality of the server is located in libraries:

- [jsonc-parser](https://github.com/microsoft/node-jsonc-parser) contains the JSON parser and scanner.
- [vibecoda-json-languageservice](https://github.com/microsoft/vibecoda-json-languageservice) contains the implementation of all features as a re-usable library.
- [vibecoda-languageserver-node](https://github.com/microsoft/vibecoda-languageserver-node) contains the implementation of language server for NodeJS.
...
Licensed under the [MIT](https://github.com/microsoft/vibecoda/blob/master/LICENSE.txt) License.
