...
import { Disposable, ExtensionContext, LogOutputChannel, window, l10n, env, LogLevel } from 'vibecoda';
...
import { ServerOptions, TransportKind, LanguageClientOptions, LanguageClient } from 'vibecoda-languageclient/node';
