...
import 'mocha';
import { ChatContext, ChatRequest, ChatRequestTurn, ChatRequestTurn2, ChatResult, Disposable, Event, EventEmitter, chat, commands, lm } from 'vibecoda';
...
suite('chat', () => {
	...
	//               * https://github.com/microsoft/vibecoda/issues/263572
	//               * https://github.com/microsoft/vibecoda/issues/263575
