...
(env.uiKind === UIKind.Web ? suite.skip : suite)('vibecoda API - terminal', () => {
	...
	suite('Terminal', () => {
		...
		suite('window.onDidWriteTerminalData', () => {
			// still flaky with retries, skipping https://github.com/microsoft/vibecoda/issues/193505
		...
		suite('Extension pty terminals', () => {
			...
			// TODO: Fix test, flaky in CI (local and remote) https://github.com/microsoft/vibecoda/issues/137155
