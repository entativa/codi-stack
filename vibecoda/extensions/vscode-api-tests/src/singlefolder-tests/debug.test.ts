...
import { commands, debug, Disposable, FunctionBreakpoint, window, workspace } from 'vibecoda';
import { assertNoRpc, closeAllEditors, createRandomFile, disposeAll } from '../utils';

suite('vibecoda API - debug', function () {
	...
	test.skip('start debugging', async function () { // Flaky: https://github.com/microsoft/vibecoda/issues/242033
		let stoppedEvents = 0;
