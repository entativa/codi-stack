...
import { env, Position, Range, Selection, SnippetString, TextDocument, TextEditor, TextEditorCursorStyle, TextEditorLineNumbersStyle, Uri, window, workspace } from 'vibecoda';
import { assertNoRpc, closeAllEditors, createRandomFile, deleteFile } from '../utils';

suite('vibecoda API - editors', () => {
