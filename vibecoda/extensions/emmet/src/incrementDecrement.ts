 ...
 */
export function locate(document: vibecoda.TextDocument, pos: vibecoda.Position): vibecoda.Range | undefined {
	...
	if (start !== end && isValidNumber(line.slice(start, end))) {
		return new vibecoda.Range(pos.line, start, pos.line, end);
	}
