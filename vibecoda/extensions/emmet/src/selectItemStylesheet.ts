...
export function nextItemStylesheet(document: vibecoda.TextDocument, startPosition: vibecoda.Position, endPosition: vibecoda.Position, rootNode: Node): vibecoda.Selection | undefined {
...
export function prevItemStylesheet(document: vibecoda.TextDocument, startPosition: vibecoda.Position, endPosition: vibecoda.Position, rootNode: CssNode): vibecoda.Selection | undefined {
	const startOffset = document.offsetAt(startPosition);
	const endOffset = document.offsetAt(endPosition);
...
function getSelectionFromNode(document: vibecoda.TextDocument, node: Node | undefined): vibecoda.Selection | undefined {
	if (!node) {
		return;
	}
...
function getSelectionFromProperty(document: vibecoda.TextDocument, node: Node | undefined, selectionStart: number, selectionEnd: number, selectFullValue: boolean, direction: string): vibecoda.Selection | undefined {
	...
	return new vibecoda.Selection(newSelectionStart, newSelectionEnd);
}
