...
let balanceOutStack: Array<readonly vibecoda.Selection[]> = [];
let lastBalancedSelections: readonly vibecoda.Selection[] = [];
...
function balance(out: boolean) {
	...
	let newSelections: readonly vibecoda.Selection[] = editor.selections.map(selection => {
...
function getRangeToBalanceOut(document: vibecoda.TextDocument, rootNode: HtmlFlatNode, selection: vibecoda.Selection): vibecoda.Selection {
	...
	let innerSelection: vibecoda.Selection;
	let outerSelection: vibecoda.Selection;
...
function getRangeToBalanceIn(document: vibecoda.TextDocument, rootNode: HtmlFlatNode, selection: vibecoda.Selection): vibecoda.Selection {
	const offset = document.offsetAt(selection.start);
...
function areSameSelections(a: readonly vibecoda.Selection[], b: readonly vibecoda.Selection[]): boolean {
