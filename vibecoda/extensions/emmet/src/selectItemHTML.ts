...
export function nextItemHTML(document: vibecoda.TextDocument, selectionStart: vibecoda.Position, selectionEnd: vibecoda.Position, rootNode: HtmlNode): vibecoda.Selection | undefined {
...
export function prevItemHTML(document: vibecoda.TextDocument, selectionStart: vibecoda.Position, selectionEnd: vibecoda.Position, rootNode: HtmlNode): vibecoda.Selection | undefined {
	const selectionStartOffset = document.offsetAt(selectionStart);
...
function getSelectionFromNode(document: vibecoda.TextDocument, node: HtmlNode): vibecoda.Selection | undefined {
	if (node && node.open) {
...
function getNextAttribute(document: vibecoda.TextDocument, selectionStart: number, selectionEnd: number, node: HtmlNode): vibecoda.Selection | undefined {
...
function getPrevAttribute(document: vibecoda.TextDocument, selectionStart: number, selectionEnd: number, node: HtmlNode): vibecoda.Selection | undefined {
	if (!node.attributes || node.attributes.length === 0 || node.type === 'comment') {
		return;
	}
