...
export function matchTag() {
	...
	const updatedSelections: vibecoda.Selection[] = [];
...
function getUpdatedSelections(document: vibecoda.TextDocument, rootNode: HtmlFlatNode, position: vibecoda.Position): vibecoda.Selection | undefined {
