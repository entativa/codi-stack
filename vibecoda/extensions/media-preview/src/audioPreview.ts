...
class AudioPreviewProvider implements vibecoda.CustomReadonlyEditorProvider {

	public static readonly viewType = 'vibecoda.audioPreview';
...
<body class="container loading" data-vibecoda-context='{ "preventDefaultContextMenuItems": true }'>
	<div class="loading-indicator"></div>
	<div class="loading-error">
		<p>${vibecoda.l10n.t("An error occurred while loading the audio file.")}</p>
...
export function registerAudioPreviewSupport(context: vibecoda.ExtensionContext, binarySizeStatusBarEntry: BinarySizeStatusBarEntry): vibecoda.Disposable {
	const provider = new AudioPreviewProvider(context.extensionUri, binarySizeStatusBarEntry);
	return vibecoda.window.registerCustomEditorProvider(AudioPreviewProvider.viewType, provider, {
