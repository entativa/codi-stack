...
import { Event, EventEmitter, ExtensionContext, SecretStorage, SecretStorageChangeEvent } from 'vibecoda';
...
export class BetterTokenStorage<T> {
	...
	// The vibecoda SecretStorage instance for this extension.
	 ...
	 * @param context the vibecoda Context used to register disposables and retreive the vibecoda.SecretStorage for this instance of Vibecoda
	 */
	...
	// a different window of Vibecoda and sends the necessary event if it has.
	...
	private async handleSecretChange(e: SecretStorageChangeEvent) {
		...
		// The KeyList is only a list of keys to aid initial start up of Vibecoda to know which
