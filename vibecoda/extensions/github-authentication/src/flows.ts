...
import { ProgressLocation, Uri, commands, env, l10n, window, workspace } from 'vibecoda';
...
interface IFlowTriggerOptions {
	...
	/**
	 * The Uri that the OAuth flow will redirect to. (i.e. vibecoda.dev/redirect)
	 */
	redirectUri: Uri;
	/**
	 * The Uri to redirect to after redirecting to the redirect Uri. (i.e. vibecoda://....)
	 */
	callbackUri: Uri;
	/**
