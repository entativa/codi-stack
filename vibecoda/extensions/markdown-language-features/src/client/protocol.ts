...
import { FileRename, RequestType } from 'vibecoda-languageclient';
import type * as lsp from 'vibecoda-languageserver-types';
import type * as md from 'vibecoda-markdown-languageservice';


export type ResolvedDocumentLinkTarget =
	| { readonly kind: 'file'; readonly uri: vibecoda.Uri; position?: lsp.Position; fragment?: string }
	| { readonly kind: 'folder'; readonly uri: vibecoda.Uri }
	| { readonly kind: 'external'; readonly uri: vibecoda.Uri };
