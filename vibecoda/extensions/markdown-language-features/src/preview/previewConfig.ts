...
export class MarkdownPreviewConfiguration {
	public static getForResource(resource: vibecoda.Uri | null) {
	...
	private constructor(resource: vibecoda.Uri | null) {
		const editorConfig = vibecoda.workspace.getConfiguration('editor', resource);
		const markdownConfig = vibecoda.workspace.getConfiguration('markdown', resource);
		const markdownEditorConfig = vibecoda.workspace.getConfiguration('[markdown]', resource);
...
export class MarkdownPreviewConfigurationManager {
	...
	public hasConfigurationChanged(resource: vibecoda.Uri): boolean {
	...
	private _getKey(
		...
		const folder = vibecoda.workspace.getWorkspaceFolder(resource);
