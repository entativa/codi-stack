...
import { workspace, commands, window, Uri, WorkspaceEdit, Range, TextDocument, extensions, TabInputTextDiff } from 'vibecoda';
...
suite('git smoke test', function () {
	...
	suiteSetup(async function () {
		...
		const ext = extensions.getExtension<GitExtension>('vibecoda.git');
		await ext?.activate();
