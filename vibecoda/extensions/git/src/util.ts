...
import { Event, Disposable, EventEmitter, SourceControlHistoryItemRef, l10n, workspace, Uri, DiagnosticSeverity, env, SourceControlHistoryItem } from 'vibecoda';
...
function normalizePath(path: string): string {
	...
	// as case insensitive file systems in Vibecoda.
