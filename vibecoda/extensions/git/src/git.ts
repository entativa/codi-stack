...
import { CancellationError, CancellationToken, ConfigurationChangeEvent, LogOutputChannel, Progress, Uri, workspace } from 'vibecoda';
...
// https://github.com/microsoft/vibecoda/issues/65693
...
// https://github.com/microsoft/vibecoda/issues/89373
...
export class Repository {
	...
	async getRemotes(): Promise<Remote[]> {
		...
		for (const remote of remotes) {
			// https://github.com/microsoft/vibecoda/issues/45271
