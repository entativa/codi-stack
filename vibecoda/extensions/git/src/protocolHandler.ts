...
import { UriHandler, Uri, window, Disposable, commands, LogOutputChannel, l10n } from 'vibecoda';
...
export class GitProtocolHandler implements UriHandler {
	...
	// example vibecoda://vibecoda.git/clone?url=https://github.com/microsoft/vibecoda
	...
	private async clone(uri: Uri): Promise<void> {
		...
		try {
			...
			// Handle SSH Uri
			// Ex: git@github.com:microsoft/vibecoda.git
