...
const pwshCommandTypeToCompletionKind: Map<PwshCommandType, vibecoda.TerminalCompletionItemKind> = new Map([
	[PwshCommandType.Alias, vibecoda.TerminalCompletionItemKind.Alias],
	[PwshCommandType.Function, vibecoda.TerminalCompletionItemKind.Method],
	[PwshCommandType.Filter, vibecoda.TerminalCompletionItemKind.Method],
	[PwshCommandType.Cmdlet, vibecoda.TerminalCompletionItemKind.Method],
	[PwshCommandType.ExternalScript, vibecoda.TerminalCompletionItemKind.Method],
	[PwshCommandType.Application, vibecoda.TerminalCompletionItemKind.Method],
	[PwshCommandType.Script, vibecoda.TerminalCompletionItemKind.Method],
	[PwshCommandType.Configuration, vibecoda.TerminalCompletionItemKind.Argument],
]);
	...
	return (json as unknown[])
		...
		.map(e => {
			...
			return {
				...
				kind: (isAlias
					? vibecoda.TerminalCompletionItemKind.Alias
