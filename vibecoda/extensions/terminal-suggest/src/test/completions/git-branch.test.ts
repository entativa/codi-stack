...
feature/test|Jane Smith|def5678|Add new feature|1 week ago`;
		...
		assert.strictEqual(result[0].icon, `vibecoda://icon?type=${vibecoda.TerminalCompletionItemKind.ScmBranch}`);
		...
		assert.strictEqual(result[1].icon, `vibecoda://icon?type=${vibecoda.TerminalCompletionItemKind.ScmBranch}`);
	});
