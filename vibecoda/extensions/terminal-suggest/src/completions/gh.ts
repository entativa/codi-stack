		...
		postProcess: (out) => {
			...
			return items.map((line) => {
				...
				return {
					...
					icon: `vibecoda://icon?type=${state === "OPEN" ? vibecoda.TerminalCompletionItemKind.PullRequest : vibecoda.TerminalCompletionItemKind.PullRequestDone}`,
				};
			});
		},
	},
...
For more information about output formatting flags, see 'gh help formatting'`,
		...
		},
		{
			...
			subcommands: [
				{
					name: "code",
					description: "Open a codespace in Vibecoda",
					options: [
						codespaceOption,
						{
							name: "--insiders",
							description: "Use the insiders version of Vibecoda",
						},
						{
							name: ["-w", "--web"],
							description: "Use the web version of Vibecoda",
						},
					],
				},
				{
