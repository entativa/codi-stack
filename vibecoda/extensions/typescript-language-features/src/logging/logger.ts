...
export class Logger {
	...
	private readonly output = new Lazy<vibecoda.LogOutputChannel>(() => {
		return vibecoda.window.createOutputChannel('TypeScript', { log: true });
	});

	public get logLevel(): vibecoda.LogLevel {
