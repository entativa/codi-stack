...
export function doesResourceLookLikeATypeScriptFile(resource: vibecoda.Uri): boolean {
	return /\.(tsx?|mts|cts)$/i.test(resource.fsPath);
}

export function doesResourceLookLikeAJavaScriptFile(resource: vibecoda.Uri): boolean {
