...
export interface IFilePathToResourceConverter {
	/**
	 * Convert a typescript filepath to a Vibecoda resource.
	 */
				...
				if (currentLink) {
					if (currentLink.target) {
						...
						const args: OpenJsDocLinkCommand_Args = {
							file: { ...file.toJSON(), $mid: undefined }, // Prevent Vibecoda from trying to transform the uri,
...
export function documentationToMarkdown(
	...
	tags: readonly Proto.JSDocTagInfo[],
	filePathConverter: IFilePathToResourceConverter,
	baseUri: vibecoda.Uri | undefined,
): vibecoda.MarkdownString {
	const out = new vibecoda.MarkdownString();
