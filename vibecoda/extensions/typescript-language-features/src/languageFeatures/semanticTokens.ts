...
export function register(
	...
	return conditionalRegistration([
		...
		return vibecoda.languages.registerDocumentRangeSemanticTokensProvider(selector.semantic, provider, provider.getLegend());
	});
}

class DocumentSemanticTokensProvider implements vibecoda.DocumentSemanticTokensProvider, vibecoda.DocumentRangeSemanticTokensProvider {

	constructor(
		private readonly client: ITypeScriptServiceClient
	) { }

	public getLegend(): vibecoda.SemanticTokensLegend {
		return new vibecoda.SemanticTokensLegend(tokenTypes, tokenModifiers);
	}

	public async provideDocumentSemanticTokens(document: vibecoda.TextDocument, token: vibecoda.CancellationToken): Promise<vibecoda.SemanticTokens | null> {
	...
	public async provideDocumentRangeSemanticTokens(document: vibecoda.TextDocument, range: vibecoda.Range, token: vibecoda.CancellationToken): Promise<vibecoda.SemanticTokens | null> {
		const file = this.client.toOpenTsFilePath(document);
	...
	private async provideSemanticTokens(document: vibecoda.TextDocument, requestArg: Proto.EncodedSemanticClassificationsRequestArgs, token: vibecoda.CancellationToken): Promise<vibecoda.SemanticTokens | null> {
		const file = this.client.toOpenTsFilePath(document);
		if (!file) {
			return null;
		}
		...
		const builder = new vibecoda.SemanticTokensBuilder();
...
function waitForDocumentChangesToEnd(document: vibecoda.TextDocument) {
