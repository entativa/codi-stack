...
class TypeScriptFormattingProvider implements vibecoda.DocumentRangeFormattingEditProvider, vibecoda.OnTypeFormattingEditProvider {
	public constructor(
	...
	public async provideDocumentRangeFormattingEdits(
		...
		options: vibecoda.FormattingOptions,
		token: vibecoda.CancellationToken
	): Promise<vibecoda.TextEdit[] | undefined> {
	...
	public async provideOnTypeFormattingEdits(
		...
		const result: vibecoda.TextEdit[] = [];
...
export function register(
	...
	return conditionalRegistration([
		...
		return vibecoda.Disposable.from(
			vibecoda.languages.registerOnTypeFormattingEditProvider(selector.syntax, formattingProvider, ';', '}', '\n'),
			vibecoda.languages.registerDocumentRangeFormattingEditProvider(selector.syntax, formattingProvider),
		);
	});
}
