...
class TypeScriptHoverProvider implements vibecoda.HoverProvider {
	private lastHoverAndLevel: [vibecoda.Hover, number] | undefined;
	...
	public async provideHover(
		...
		context?: vibecoda.HoverContext,
	): Promise<vibecoda.VerboseHover | undefined> {
	...
	private getContents(
		...
		const parts: vibecoda.MarkdownString[] = [];
		...
		if (data.displayString) {
			...
			parts.push(new vibecoda.MarkdownString().appendCodeblock(displayParts.join(' '), 'typescript'));
		}
	...
	private getPreviousLevel(previousHover: vibecoda.Hover | undefined): number {
...
export function register(
	...
	return conditionalRegistration([
		...
		return vibecoda.languages.registerHoverProvider(selector.syntax,
