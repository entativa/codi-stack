...
import { TextDocument, CompletionList, TextEdit } from 'vibecoda-languageserver-types';
import { WorkspaceFolder } from 'vibecoda-languageserver-protocol';
import { getCSSLanguageService, LanguageServiceOptions, getSCSSLanguageService } from 'vibecoda-css-languageservice';
