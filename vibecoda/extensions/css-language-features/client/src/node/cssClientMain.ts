...
import { ExtensionContext, extensions, l10n } from 'vibecoda';
import { BaseLanguageClient, LanguageClient, LanguageClientOptions, ServerOptions, TransportKind } from 'vibecoda-languageclient/node';
...
export async function activate(context: ExtensionContext) {
	const clientMain = extensions.getExtension('vibecoda.css-language-features')?.packageJSON?.main || '';
