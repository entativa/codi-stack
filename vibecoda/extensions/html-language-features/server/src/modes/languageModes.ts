...
import { DocumentUri, TextDocument } from 'vibecoda-languageserver-textdocument';
...
export { ClientCapabilities, DocumentContext, LanguageService, HTMLDocument, HTMLFormatConfiguration, TokenType } from 'vibecoda-html-languageservice';

export { TextDocument, DocumentUri } from 'vibecoda-languageserver-textdocument';
