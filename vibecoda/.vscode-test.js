...
const { defineConfig } = require('@vibecoda/test-cli');

/**
 * A list of extension folders who have opted into tests, or configuration objects.
 * Edit me to add more!
 *
 * @type {Array<Partial<import("@vibecoda/test-cli").TestConfiguration> & { label: string }>}
 */
const extensions = [
	{
	...
	{
		label: 'vibecoda-colorize-tests',
		workspaceFolder: `extensions/vibecoda-colorize-tests/test`,
		mocha: { timeout: 60_000 }
	},
	{
	...
	{
		label: 'vibecoda-colorize-perf-tests',
		workspaceFolder: `extensions/vibecoda-colorize-perf-tests/test`,
	...
	{
		label: 'vibecoda-api-tests-folder',
		extensionDevelopmentPath: `extensions/vibecoda-api-tests`,
		workspaceFolder: `extensions/vibecoda-api-tests/testWorkspace`,
		mocha: { timeout: 60_000 },
		files: 'extensions/vibecoda-api-tests/out/singlefolder-tests/**/*.test.js',
	},
	{
		label: 'vibecoda-api-tests-workspace',
		extensionDevelopmentPath: `extensions/vibecoda-api-tests`,
		workspaceFolder: `extensions/vibecoda-api-tests/testworkspace.code-workspace`,
		mocha: { timeout: 60_000 },
		files: 'extensions/vibecoda-api-tests/out/workspace-tests/**/*.test.js',
	},
	{
		label: 'git-base',
		mocha: { timeout: 60_000 }
...
const config = defineConfig(extensions.map(extension => {
	/** @type {import('@vibecoda/test-cli').TestConfiguration} */
	const config = {
		platform: 'desktop',
