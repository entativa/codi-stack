...
export function applyDebugTools(server: McpServer, appService: ApplicationService): RegisteredTool[] {
	...
	tools.push(server.tool(
		'vibecoda_automation_debug_open',
	...
	tools.push(server.tool(
		'vibecoda_automation_debug_set_breakpoint',
	...
	tools.push(server.tool(
		'vibecoda_automation_debug_start',
		'Start debugging',
		async () => {
			const app = await appService.getOrCreateApplication();
	...
	// server.tool(
	// 	'vibecoda_automation_debug_stop',
	// 	'Stop debugging',
	// 	async () => {
	...
	// Playwright can probably figure this out
	// server.tool(
	// 	'vibecoda_automation_debug_step_over',
	...
	// Playwright can probably figure this out
	// server.tool(
	// 	'vibecoda_automation_debug_step_in',
	...
	// Playwright can probably figure this out
	// server.tool(
	// 	'vibecoda_automation_debug_step_out',
	...
	// Playwright can probably figure this out
	// server.tool(
	// 	'vibecoda_automation_debug_continue',
