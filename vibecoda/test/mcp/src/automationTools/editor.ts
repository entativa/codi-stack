...
export function applyEditorTools(server: McpServer, appService: ApplicationService): RegisteredTool[] {
	...
	// server.tool(
	// 	'vibecoda_automation_editor_open_file',
	// 	'Open a file in the Vibecoda editor through quick open',
	// 	{
	...
	tools.push(server.tool(
		'vibecoda_automation_editor_type_text',
	...
	// server.tool(
	// 	'vibecoda_automation_editor_get_selection',
	...
	// Doesn't seem particularly useful
	// server.tool(
	// 	'vibecoda_automation_editor_go_to_definition',
	...
	// Playwright can probably figure this one out
	// server.tool(
	// 	'vibecoda_automation_editor_peek_definition',
	...
	// Playwright can probably figure this one out
	// server.tool(
	// 	'vibecoda_automation_editor_rename_symbol',
	...
	// Playwright can probably figure this one out
	// server.tool(
	// 	'vibecoda_automation_editor_find_references',
	...
	tools.push(server.tool(
		'vibecoda_automation_editor_new_untitled_file',
	...
	tools.push(server.tool(
		'vibecoda_automation_editor_save_file',
	...
	// server.tool(
	// 	'vibecoda_automation_editor_select_tab',
	...
	// Playwright can probably figure this out
	// server.tool(
	// 	'vibecoda_automation_editor_wait_for_tab',
	...
	// Playwright can probably figure this out
	// server.tool(
	// 	'vibecoda_automation_editor_wait_for_focus',
