...
export function applyCoreTools(server: McpServer, appService: ApplicationService): RegisteredTool[] {
	...
	// server.tool(
	// 	'vibecoda_automation_restart',
	// 	'Restart Vibecoda with optional workspace or folder and extra arguments',
	// 	{
	...
	// 			content: [{
	// 				type: 'text' as const,
	// 				text: `Vibecoda restarted successfully${workspaceOrFolder ? ` with workspace: ${workspaceOrFolder}` : ''}`
	// 			}]
	// 		};
	// 	}
	// );
	...
	tools.push(server.tool(
		'vibecoda_automation_stop',
		'Stop the Vibecoda application',
		async () => {
			...
			return {
				content: [{
					type: 'text' as const,
					text: 'Vibecoda stopped successfully'
				}]
			};
		}
	));
	...
	// server.tool(
	// 	'vibecoda_automation_get_quality',
	// 	'Get the quality/build type of Vibecoda (Dev, Insiders, Stable, etc.)',
	// 	async () => {
	// 		const info = {
	// 			quality: app.quality,
	// 			remote: app.remote,
	...
	// This doesn't seem particularly useful
	// server.tool(
	// 	'vibecoda_automation_wait_for_element',
	...
	// server.tool(
	// 	'vibecoda_automation_click_element',
	...
	// Defer to Playwright's tool
	// server.tool(
	// 	'vibecoda_automation_send_keybinding',
	// 	'Send a keybinding to Vibecoda (e.g., ctrl+shift+p, cmd+s)',
	// 	{
	...
	// Defer to Playwright's tool
	// server.tool(
	// 	'vibecoda_automation_get_text_content',
