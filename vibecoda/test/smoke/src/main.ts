...
const testRepoUrl = 'https://github.com/microsoft/vibecoda-smoketest-express';
const workspacePath = path.join(testDataPath, `vibecoda-smoketest-express`);
...
before(async function () {
	this.timeout(5 * 60 * 1000); // increase since we download Vibecoda
...
describe(`Vibecoda Smoke Tests (${opts.web ? 'Web' : 'Electron'})`, () => {
