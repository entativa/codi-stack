package io.codibase.server.plugin.report.jacoco;
...
import io.codibase.server.plugin.report.coverage.Coverage;
import io.codibase.server.plugin.report.coverage.CoverageReport;
import io.codibase.server.plugin.report.coverage.CoverageStats;
import io.codibase.server.plugin.report.coverage.FileCoverage;
import io.codibase.server.plugin.report.coverage.GroupCoverage;
import io.codibase.server.plugin.report.coverage.PublishCoverageReportStep;
...
public class PublishJacocoReportStep extends PublishCoverageReportStep {
	...
	@Editable(order=100, description="Specify JaCoCo coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, "
