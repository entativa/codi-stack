package io.codibase.server.plugin.report.roslynator;
...
public class PublishRoslynatorReportStep extends PublishProblemReportStep {
	...
	@Editable(order=100, description="Specify Roslynator diagnostics output file in XML format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. "
