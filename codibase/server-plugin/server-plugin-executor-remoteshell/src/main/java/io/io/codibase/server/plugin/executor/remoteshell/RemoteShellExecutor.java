package io.codibase.server.plugin.executor.remoteshell;

import io.codibase.agent.Message;
import io.codibase.agent.MessageTypes;
import io.codibase.agent.job.ShellJobData;
import io.codibase.agent.job.TestShellJobData;
...
import io.codibase.server.plugin.executor.servershell.ServerShellExecutor;
...
@Editable(order=500, name="Remote Shell Executor", description=""
		...
		+ "<b class='text-danger'>WARNING</b>: Jobs running with this executor has same permission as CodiBase agent process. "
