...
public class ImportOption implements Serializable {
	...
	@Editable(order=600, description="Specify how to map JIRA issue statuses to CodiBase custom fields.<br>"
	...
	@Editable(order=700, description="Specify how to map JIRA issue types to CodiBase custom fields.<br>"
			+ "<b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here")
	...
	@Editable(order=800, description="Specify how to map JIRA issue priorities to CodiBase custom fields.<br>"
			+ "<b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here")
