...
public class PublishCloverReportStep extends PublishCoverageReportStep {
	...
	@Editable(order=100, description="Specify clover coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, "
