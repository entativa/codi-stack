package io.codibase.server.plugin.sso.discord;
...
import io.codibase.server.plugin.sso.discord.oauth2.AccessTokenResponse;
import io.codibase.server.plugin.sso.discord.oauth2.Request;
import io.codibase.server.plugin.sso.discord.oauth2.UserGuildsResponse;
import io.codibase.server.plugin.sso.discord.oauth2.UserInfoResponse;
