package io.codibase.server.plugin.report.cpd;
...
public class PublishCPDReportStep extends PublishProblemReportStep {
	...
	@Editable(order=100, description="Specify CPD result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, "
