...
import static io.codibase.server.plugin.report.html.PublishHtmlReportStep.START_PAGE;
...
public class HtmlReportPage extends BuildReportPage {
	...
	protected void onInitialize() {
		...
		var startPage = CodiBase.getInstance(ProjectService.class).runOnActiveServer(
				projectId, 
