package io.codibase.server.plugin.mail.office365;
...
public class Office365Connector implements MailConnector {
	...
	@Editable(order=450, name="Check Incoming Email", description="Enable this to process issue or pull request comments posted via email. "
			...
			+ "needs to be enabled for system email address above, as CodiBase uses it to track issue and pull request contexts")
