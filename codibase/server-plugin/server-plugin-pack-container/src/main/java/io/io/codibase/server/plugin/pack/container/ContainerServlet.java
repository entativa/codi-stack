...
import io.codibase.server.util.Digest;
import io.codibase.server.util.HttpUtils;
...
import static io.codibase.server.plugin.pack.container.ContainerAuthenticationFilter.ATTR_BUILD_ID;
import static io.codibase.server.plugin.pack.container.ContainerManifest.isImageIndex;
import static io.codibase.server.plugin.pack.container.ContainerManifest.isImageManifest;
import static io.codibase.server.plugin.pack.container.ContainerPackSupport.TYPE;
import static io.codibase.server.util.Digest.SHA256;
import static io.codibase.server.util.IOUtils.copyWithMaxSize;
...
public class ContainerServlet extends HttpServlet {
	...
	private String getChallenge() {
		...
		return "Bearer realm=\"" + serverUrl + "/v2/token\",service=\"codibase\",scope=\"*\"";
	}
