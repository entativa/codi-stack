package io.codibase.server.plugin.report.pylint;
...
public class PublishPylintReportStep extends PublishProblemReportStep {
	...
	@Editable(order=100, description="Specify pylint json result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. "
