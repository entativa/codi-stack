package io.codibase.server.plugin.sso.openid;
...
@Editable(name="GitHub", order=100, description="Refer to this <a href='https://docs.codibase.io/tutorials/security/sso-with-github' target='_blank'>tutorial</a> for an example setup")
