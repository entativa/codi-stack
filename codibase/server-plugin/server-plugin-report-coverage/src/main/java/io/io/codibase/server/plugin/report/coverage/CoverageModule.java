...
import static io.codibase.server.plugin.report.coverage.CoverageStats.CATEGORY;
	...
	protected void configure() {
		...
		contribute(ProjectMenuContribution.class, new ProjectMenuContribution() {
			...
			public List<SidebarMenuItem> getMenuItems(Project project) {
				...
				if (!CodiBase.getInstance(BuildMetricService.class).getAccessibleReportNames(project, CoverageMetric.class).isEmpty()) {
