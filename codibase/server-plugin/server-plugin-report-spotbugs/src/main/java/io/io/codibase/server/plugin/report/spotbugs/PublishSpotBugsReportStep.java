package io.codibase.server.plugin.report.spotbugs;
...
public class PublishSpotBugsReportStep extends PublishProblemReportStep {
	...
	@Editable(order=100, description="Specify SpotBugs result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, "
