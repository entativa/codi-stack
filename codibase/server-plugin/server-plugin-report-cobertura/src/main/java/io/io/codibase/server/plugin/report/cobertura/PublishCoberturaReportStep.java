package io.codibase.server.plugin.report.cobertura;
...
import io.codibase.server.plugin.report.coverage.*;
...
import static io.codibase.server.codequality.CoverageStatus.*;
...
public class PublishCoberturaReportStep extends PublishCoverageReportStep {
	...
	@Editable(order=100, description="Specify cobertura coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, "
