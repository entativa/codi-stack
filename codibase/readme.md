...
> **NOTE: ** We develop CodiBase at <a href="https://code.codibase.io">code.codibase.io</a> for sake of dogfooding. Please submit issues and pull requests there
...
<h2>
<a href="https://docs.codibase.io">Get Started</a> 
</h2>
...
[**Try It**](https://code.codibase.io/demo/dotnet-runtime)
...
[**Tutorial**](https://docs.codibase.io/tutorials/cicd/dependency-update)
...
[**Demo**](https://code.codibase.io/demo/react/~files/6039030814aedeaa6ebac706c0886e3675160666/packages/react-dom/src/client/ReactDOMSelect.js?position=source-202.1-202.36-1)
...
[**Tutorial**](https://docs.codibase.io/tutorials/code/pullrequest-approval)
...
[**See It In Action**](https://code.codibase.io/codibase/server/~boards/State?iteration=4.2.0&backlog=true)
...
[**Tutorial**](https://docs.codibase.io/tutorials/issue/state-auto-transition)
...
[**Tutorial**](https://docs.codibase.io/tutorials/issue/service-desk)
...
[**Tutorial**](https://docs.codibase.io/tutorials/issue/time-tracking)
...
[**Tutorial**](https://docs.codibase.io/category/cicd)
...
[**Example1**](https://docs.codibase.io/tutorials/cicd/agent-farm)
[**Example2**](https://docs.codibase.io/tutorials/cicd/k8s-farm)
...
[**Tutorial1**](https://docs.codibase.io/tutorials/cicd/diagnose-with-web-terminal)
[**Tutorial2**](https://docs.codibase.io/tutorials/cicd/run-job-against-local-change)
...
CI/CD jobs.
[**Tutorial**](https://docs.codibase.io/category/packages)
...
[**Example1**](https://code.codibase.io/codibase/server/~builds/4799/fixed-issues?query=%22State%22+is+%22Released%22+order+by+%22Priority%22+desc+and+%22Type%22+asc)
[**Example2**](https://code.codibase.io/codibase/server/~issues/1794/builds)
...
[**See It In Action**](https://code.codibase.io/~projects?query=%22Path%22+is+%22codibase%22)
...
[**Try It**](https://code.codibase.io/codibase/server/~issues)

![issue query](./doc/images/issue-query.gif)

## 🤖 MCP server to interact with CodiBase via AI agents
...
[**Tutorial**](https://docs.codibase.io/tutorials/misc/working-with-mcp)
...
for everyone.
[**See It In Action**](https://code.codibase.io/~dashboards)
...
[**More Info**](https://docs.codibase.io/administration-guide/high-availabilty-scalabilty)
...
[**See It In Action**](https://code.codibase.io/codibase/server/~stats/lines)
...
[**Performance Comparison**](https://faun.pub/performance-compasion-of-codibase-and-gitlab-c11fc27b25be#:~:text=Git%20Push%3A%20CodiBase%20is%2040,50%25%20less%20memory%20than%20GitLab)
