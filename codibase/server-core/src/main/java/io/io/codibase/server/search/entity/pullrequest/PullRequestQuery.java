...
import static io.codibase.server.model.PullRequest.SORT_FIELDS;
...
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.ApprovedBy;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.ApprovedByMe;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.AssignedTo;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.AssignedToMe;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.CommentedBy;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.CommentedByMe;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.Contains;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.Discarded;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.HasMergeConflicts;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.HasPendingReviews;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.HasUnfinishedBuilds;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.HasUnsuccessfulBuilds;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.IgnoredBy;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.IgnoredByMe;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.IncludesCommit;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.IncludesIssue;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.Is;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.IsGreaterThan;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.IsLessThan;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.IsNot;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.IsSince;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.IsUntil;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.Mentioned;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.MentionedMe;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.Merged;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.NeedActionOf;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.NeedMyAction;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.Open;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.ReadyToMerge;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.RequestedForChangesBy;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.RequestedForChangesByMe;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.SomeoneRequestedForChanges;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.SubmittedBy;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.SubmittedByMe;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.ToBeChangedBy;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.ToBeChangedByMe;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.ToBeMergedBy;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.ToBeMergedByMe;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.ToBeReviewedBy;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.ToBeReviewedByMe;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.WatchedBy;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.WatchedByMe;
...
import io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.AndCriteriaContext;
import io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.CriteriaContext;
import io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.FieldOperatorValueCriteriaContext;
import io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.FuzzyCriteriaContext;
import io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.NotCriteriaContext;
import io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.OperatorCriteriaContext;
import io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.OperatorValueCriteriaContext;
import io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.OrCriteriaContext;
import io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.OrderContext;
import io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.ParensCriteriaContext;
import io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.QueryContext;
import io.codibase.server.search.entity.pullrequest.PullRequestQueryParser.ReferenceCriteriaContext;
