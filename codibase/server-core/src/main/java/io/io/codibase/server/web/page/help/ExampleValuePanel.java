...
import static io.codibase.server.web.page.help.ApiHelpUtils.getJsonMembers;
import static io.codibase.server.web.page.help.ValueInfo.Origin.*;
...
public class ExampleValuePanel extends Panel {
	...
	static {
		ResourceConfig config = CodiBase.getInstance(ResourceConfig.class);
	...
	private String toJson(Object value) {
		try {
			return CodiBase.getInstance(ObjectMapper.class).writeValueAsString(value);
