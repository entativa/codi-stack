package io.codibase.server.web.editable.rolechoice;
...
import io.codibase.server.web.component.rolechoice.RoleSingleChoice;
...
public class RoleSingleChoiceEditor extends PropertyEditor<String> {
	...
	protected void onInitialize() {
		...
		try {
			...
			choices.addAll(CodiBase.getInstance(RoleService.class).query());
		...
		if (getModelObject() != null)
			role = CodiBase.getInstance(RoleService.class).find(getModelObject());
		else
			role = null;
