						...
						if (user == null) {
							...
							if (settingService.getMailConnector() != null) {
								...
								mailService.sendMail(Arrays.asList(emailAddressValue),
										...
										"[Password Reset] You are Requesting to Reset Your CodiBase Password",
			...
			if (userId != null) {
				...
				Form<?> form = new Form<Void>("form") {
					...
					protected void onSubmit() {
						...
						user.setPassword(CodiBase.getInstance(PasswordService.class).encryptPassword(bean.getNewPassword()));
						getUserService().update(user, null);
