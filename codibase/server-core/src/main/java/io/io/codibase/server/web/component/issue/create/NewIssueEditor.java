...
import io.codibase.server.web.component.iteration.choice.IterationMultiChoice;
		...
		IModel<List<Issue>> similarIssuesModel = new LoadableDetachableModel<List<Issue>>() {
			...
			protected List<Issue> load() {
				if (StringUtils.isNotBlank(editingTitle)) {
					IssueTextService issueTextService = CodiBase.getInstance(IssueTextService.class);
					...
					var issues = CodiBase.getInstance(IssueService.class).loadIssues(issueIds);
