package io.codibase.server.web.page.project.pullrequests.create;

import static io.codibase.server.search.commit.Revision.Type.COMMIT;
...
import io.codibase.server.search.commit.Revision;
import io.codibase.server.search.commit.RevisionCriteria;
...
import io.codibase.server.web.ajaxlistener.DisableGlobalAjaxIndicatorListener;
import io.codibase.server.web.behavior.ReferenceInputBehavior;
import io.codibase.server.web.component.branch.BranchLink;
import io.codibase.server.web.component.branch.picker.AffinalBranchPicker;
import io.codibase.server.web.component.comment.CommentInput;
import io.codibase.server.web.component.commit.list.CommitListPanel;
			...
			public void onSubmit() {
				...
				if (!target.getObjectName().equals(getPullRequest().getTarget().getObjectName()) 
					...
					for (var label: labelsBean.getLabels()) {
						...
						requestLabel.setSpec(CodiBase.getInstance(LabelSpecService.class).find(label));
