package io.codibase.server.web.page.project.blob.search.advanced;
...
import io.codibase.server.search.code.query.*;
import io.codibase.server.web.WebSession;
import io.codibase.server.web.behavior.RunTaskBehavior;
import io.codibase.server.web.component.codequeryoption.FileQueryOptionEditor;
import io.codibase.server.web.component.codequeryoption.SymbolQueryOptionEditor;
import io.codibase.server.web.component.codequeryoption.TextQueryOptionEditor;
...
public abstract class AdvancedSearchPanel extends Panel {
				...
				add(runTaskBehavior = new RunTaskBehavior() {
					...
					protected void runTask(AjaxRequestTarget target) {
						...
						if (revision != null) {
							...
							var searchService = CodiBase.getInstance(CodeSearchService.class);
	...
	private static int getMaxQueryEntries() {
		return CodiBase.getInstance(SettingService.class).getPerformanceSetting().getMaxCodeSearchEntries();
	}
