package io.codibase.server.web.page.admin.gpgsigningkey;
				...
				public void onClick(AjaxRequestTarget target) {
					new ConfirmModalPanel(target) {
						...
						protected String getConfirmMessage() {
							return _T("Commits generated by CodiBase previously will be shown as unverified if this key is deleted. "
