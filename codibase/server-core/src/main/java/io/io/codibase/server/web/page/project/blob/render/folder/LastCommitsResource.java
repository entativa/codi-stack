	...
	protected ResourceResponse newResourceResponse(Attributes attributes) {
		...
		response.setWriteCallback(new WriteCallback() {
			...
			public void writeData(Attributes attributes) throws IOException {
				...
				var avatarService = CodiBase.getInstance(AvatarService.class);
				var emailAddressService = CodiBase.getInstance(EmailAddressService.class);
				...
				String json;
				try {
					json = CodiBase.getInstance(ObjectMapper.class).writeValueAsString(map);
