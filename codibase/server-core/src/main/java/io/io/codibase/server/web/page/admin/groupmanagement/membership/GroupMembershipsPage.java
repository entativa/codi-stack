package io.codibase.server.web.page.admin.groupmanagement.membership;
...
import io.codibase.server.web.component.EmailAddressVerificationStatusBadge;
	...
	protected void onInitialize() {
		...
		dataProvider = new SortableDataProvider<Membership, Void>() {
			...
			public Iterator<? extends Membership> iterator(long first, long count) {
				...
				return CodiBase.getInstance(MembershipService.class).query(criteria, (int)first,
						(int)count).iterator();
			}
