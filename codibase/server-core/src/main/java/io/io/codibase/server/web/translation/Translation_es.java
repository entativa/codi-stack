package io.codibase.server.web.translation;
...
public class Translation_es extends TranslationResourceBundle {
	...
	public static void init(Map<String, String> m) {
		...
		m.put("** Enterprise edition is disabled as the trial subscription was expired, order subscription to enable or contact support@codibase.io if you need to extend your trial **", 
			"** La edición empresarial está deshabilitada porque la suscripción de prueba expiró, ordene una suscripción para habilitarla o contacte a support@codibase.io si necesita extender su prueba **");
		...
		m.put("7 days", "7 días");
		m.put("<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">user</a> to reset password for", 
			"<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">usuario</a> para restablecer la contraseña");
		m.put("<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">user</a> to verify email for", 
			"<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">usuario</a> para verificar el correo electrónico");
		m.put("<a href=\"https://guides.github.com/features/mastering-markdown/\" target=\"_blank\">GitHub flavored markdown</a> is accepted, with <a href=\"https://docs.codibase.io/appendix/markdown-syntax\" target=\"_blank\">mermaid and katex support</a>.", 
			"<a href=\"https://guides.github.com/features/mastering-markdown/\" target=\"_blank\">Markdown con estilo GitHub</a> es aceptado, con <a href=\"https://docs.codibase.io/appendix/markdown-syntax\" target=\"_blank\">soporte para mermaid y katex</a>.");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/event/Event.java' target='_blank'>event object</a> triggering the notification", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/event/Event.java' target='_blank'>objeto de evento</a> que desencadena la notificación");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Alert.java'>alert</a> to display", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Alert.java'>alerta</a> para mostrar");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Stopwatch.java'>Stopwatch</a> overdue", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Stopwatch.java'>cronómetro</a> vencido");
		...
		m.put("<b class='text-danger'>NOTE: </b> This requires an enterprise subscription. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>NOTA: </b> Esto requiere una suscripción empresarial. <a href='https://codibase.io/pricing' target='_blank'>Pruebe gratis</a> durante 30 días");
		m.put("<b class='text-danger'>NOTE: </b> This step requires an enterprise subscription. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>NOTA: </b> Este paso requiere una suscripción empresarial. <a href='https://codibase.io/pricing' target='_blank'>Pruebe gratis</a> durante 30 días");
		m.put("<b class='text-danger'>NOTE: </b>SendGrid integration is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>NOTA: </b>La integración con SendGrid es una característica empresarial. <a href='https://codibase.io/pricing' target='_blank'>Pruebe gratis</a> durante 30 días");
		m.put("<b class='text-warning'>NOTE: </b><a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>Time tracking</a> is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-warning'>NOTA: </b><a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>El seguimiento de tiempo</a> es una característica empresarial. <a href='https://codibase.io/pricing' target='_blank'>Pruebe gratis</a> durante 30 días");
		...
		m.put("<b>Tips: </b> Type <tt>@</tt> to <a href='https://docs.codibase.io/appendix/job-variables' target='_blank' tabindex='-1'>insert variable</a>. Use <tt>@@</tt> for literal <tt>@</tt>", 
			"<b>Consejos: </b> Escriba <tt>@</tt> para <a href='https://docs.codibase.io/appendix/job-variables' target='_blank' tabindex='-1'>insertar una variable</a>. Use <tt>@@</tt> para un <tt>@</tt> literal");
		...
		m.put("Auto update check is performed by requesting an image in your browser from codibase.io indicating new version availability, with color indicating severity of the update. It works the same way as how gravatar requests avatar images. If disabled, you are highly recommended to check update manually from time to time (can be done via help menu on left bottom of the screen) to see if there are any security/critical fixes", 
			"La verificación de actualización automática se realiza solicitando una imagen en su navegador desde codibase.io que indica la disponibilidad de una nueva versión, con un color que indica la gravedad de la actualización. Funciona de la misma manera que las solicitudes de gravatar para imágenes de avatar. Si está deshabilitado, se recomienda encarecidamente verificar la actualización manualmente de vez en cuando (puede hacerse a través del menú de ayuda en la parte inferior izquierda de la pantalla) para ver si hay correcciones de seguridad/críticas");
		...
		m.put("Build statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Las estadísticas de compilación son una función empresarial. <a href='https://codibase.io/pricing' target='_blank'>Pruebe gratis</a> durante 30 días");
		...
		m.put("Change property <code>serverUrl</code> in file <code>conf/agent.properties</code> if necessary. The default value is taken from CodiBase server url specified in <i>Administration / System Setting</i>", 
			"Cambie la propiedad <code>serverUrl</code> en el archivo <code>conf/agent.properties</code> si es necesario. El valor predeterminado se toma de la URL del servidor CodiBase especificada en <i>Administración / Configuración del Sistema</i>");
		...
		m.put("Check <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">agent management</a> for details, including instructions on how to run agent as service", 
			"Consulte <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">la gestión de agentes</a> para obtener detalles, incluidas instrucciones sobre cómo ejecutar el agente como servicio");
		m.put("Check <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">agent management</a> for details, including list of supported environment variables", 
			"Consulte <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">la gestión de agentes</a> para obtener detalles, incluida la lista de variables de entorno compatibles");
		...
		m.put("Client ID of this CodiBase instance registered in Google cloud", "ID de cliente de esta instancia de CodiBase registrada en Google Cloud");
		m.put("Client Id", "ID de Cliente");
		m.put("Client Secret", "Secreto de Cliente");
		m.put("Client secret of this CodiBase instance registered in Google cloud", "Secreto de cliente de esta instancia de CodiBase registrada en Google Cloud");
		...
		m.put("Commits generated by CodiBase previously will be shown as unverified if this key is deleted. Type <code>yes</code> below if you want to continue.", 
			"Los commits generados previamente por CodiBase se mostrarán como no verificados si esta clave se elimina. Escribe <code>yes</code> abajo si deseas continuar.");
		...
		m.put("Enable <a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>time tracking</a> for this project to track progress and generate timesheets", 
			"Habilite <a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>seguimiento de tiempo</a> para este proyecto para rastrear el progreso y generar hojas de tiempo");
		m.put("Enable <a href='https://docs.codibase.io/tutorials/package/working-with-packages' target='_blank'>package management</a> for this project", 
			"Habilitar <a href='https://docs.codibase.io/tutorials/package/working-with-packages' target='_blank'>gestión de paquetes</a> para este proyecto");
		...
		m.put("Enable this to allow to run site publish step. CodiBase will serve project site files as is. To avoid XSS attack, make sure this executor can only be used by trusted jobs", 
			"Habilitar esto para permitir ejecutar el paso de publicación del sitio. CodiBase servirá los archivos del sitio del proyecto tal como están. Para evitar ataques XSS, asegúrese de que este ejecutor solo pueda ser utilizado por trabajos confiables");
		...
		m.put("Enable this to process issue or pull request comments posted via email. <b class='text-danger'>NOTE:</b> <a href='https://docs.microsoft.com/en-us/exchange/recipients-in-exchange-online/plus-addressing-in-exchange-online' target='_blank'>Sub addressing</a> needs to be enabled for system email address above, as CodiBase uses it to track issue and pull request contexts", 
			"Habilitar esto para procesar comentarios de problemas o solicitudes de extracción publicados por correo electrónico. <b class='text-danger'>NOTA:</b> <a href='https://docs.microsoft.com/en-us/exchange/recipients-in-exchange-online/plus-addressing-in-exchange-online' target='_blank'>El subdireccionamiento</a> debe estar habilitado para la dirección de correo electrónico del sistema anterior, ya que CodiBase lo utiliza para rastrear contextos de problemas y solicitudes de extracción");
		m.put("Enable this to process issue or pull request comments posted via email. <b class='text-danger'>NOTE:</b> <a href='https://en.wikipedia.org/wiki/Email_address#Subaddressing' target='_blank'>Sub addressing</a> needs to be enabled for system email address above, as CodiBase uses it to track issue and pull request contexts", 
		...
		m.put("Environment variable <code>serverUrl</code> in above command is taken from CodiBase server url specified in <i>Administration / System Setting</i>. Change it if necessary", 
			"La variable de entorno <code>serverUrl</code> en el comando anterior se toma de la URL del servidor CodiBase especificada en <i>Administración / Configuración del Sistema</i>. Cámbiela si es necesario");
		m.put("Equal", "Igual");
		...
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with create branch permission", 
			"Para confirmaciones de construcción no alcanzables desde la rama predeterminada, se debe especificar un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>secreto de trabajo</a> como token de acceso con permiso para crear ramas");
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with create tag permission", 
			"Para confirmaciones de construcción no alcanzables desde la rama predeterminada, se debe especificar un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>secreto de trabajo</a> como token de acceso con permiso para crear etiquetas");
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with manage issue permission", 
			"Para confirmaciones de construcción no alcanzables desde la rama predeterminada, se debe especificar un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>secreto de trabajo</a> como token de acceso con permiso para gestionar problemas");
		m.put("For docker aware executors, this path is inside container, and accepts both absolute path and relative path (relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>). For shell related executors which runs on host machine directly, only relative path is accepted", 
			"Para ejecutores conscientes de Docker, esta ruta está dentro del contenedor y acepta tanto rutas absolutas como relativas (relativas a <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>el espacio de trabajo del trabajo</a>). Para ejecutores relacionados con shell que se ejecutan directamente en la máquina host, solo se acepta la ruta relativa");
		m.put("For each build, CodiBase calculates a list of fixed issues since previous build automatically. This setting provides a default query to further filter/order this list. For a given job, the first matching entry will be used.", 
			"Para cada construcción, CodiBase calcula automáticamente una lista de problemas corregidos desde la construcción anterior. Esta configuración proporciona una consulta predeterminada para filtrar/ordenar aún más esta lista. Para un trabajo dado, se usará la primera entrada coincidente.");
		...
		m.put("For web hooks defined here and in parent projects, CodiBase will post event data in JSON format to specified URLs when subscribed events happen", 
			"Para los web hooks definidos aquí y en proyectos principales, CodiBase enviará datos de eventos en formato JSON a las URL especificadas cuando ocurran eventos suscritos");
		m.put("Force", "Forzar");
		...
		m.put("GPG signing key will be used to sign commits generated by CodiBase, including pull request merge commits, user commits created via web UI or RESTful api.", 
			"La clave de firma GPG se utilizará para firmar confirmaciones generadas por CodiBase, incluidas las confirmaciones de fusión de solicitudes de extracción, confirmaciones de usuario creadas a través de la interfaz web o la API RESTful.");
		...
		m.put("Groovy script to be evaluated. It should return a <i>Date</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy para evaluar. Debe devolver un valor de tipo <i>Date</i>. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ayuda de scripting</a> para más detalles");
		m.put("Groovy script to be evaluated. It should return a <i>Float</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy para evaluar. Debe devolver un valor de tipo <i>Float</i>. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ayuda de scripting</a> para más detalles");
		m.put("Groovy script to be evaluated. It should return a <i>Integer</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy para evaluar. Debe devolver un valor de tipo <i>Integer</i>. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ayuda de scripting</a> para más detalles");
		m.put("Groovy script to be evaluated. It should return a <i>String</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy para evaluar. Debe devolver un valor de tipo <i>String</i>. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ayuda de scripting</a> para más detalles");
		m.put("Groovy script to be evaluated. It should return a <i>boolean</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy para evaluar. Debe devolver un valor de tipo <i>boolean</i>. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ayuda de scripting</a> para más detalles");
		m.put("Groovy script to be evaluated. It should return a <i>string</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy para evaluar. Debe devolver un valor de tipo <i>string</i>. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ayuda de scripting</a> para más detalles");
		m.put("Groovy script to be evaluated. It should return name of a group. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy para evaluar. Debe devolver el nombre de un grupo. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ayuda de scripting</a> para más detalles");
		m.put("Groovy script to be evaluated. It should return string or list of string. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy para evaluar. Debe devolver una cadena o lista de cadenas. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ayuda de scripting</a> para más detalles");
		m.put("Groovy script to be evaluated. The return value should be a list of group facade object to be used as choices. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy para evaluar. El valor devuelto debe ser una lista de objetos fachada de grupo para usar como opciones. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ayuda de scripting</a> para más detalles");
		m.put("Groovy script to be evaluated. The return value should be a list of user login names to be used as choices. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy para evaluar. El valor devuelto debe ser una lista de nombres de inicio de sesión de usuario para usar como opciones. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ayuda de scripting</a> para más detalles");
		m.put("Groovy script to be evaluated. The return value should be a value to color map, for instance:<br><code>return [\"Successful\":\"#00ff00\", \"Failed\":\"#ff0000\"]</code>, Use <tt>null</tt> if the value does not have a color. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy para evaluar. El valor devuelto debe ser un mapa de valor a color, por ejemplo:<br><code>return [\"Successful\":\"#00ff00\", \"Failed\":\"#ff0000\"]</code>, Use <tt>null</tt> si el valor no tiene un color. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ayuda de scripting</a> para más detalles");
		m.put("Groovy scripts", "Scripts Groovy");
		m.put("Group", "Grupo");
		...
		m.put("If specified, CodiBase will only display iterations with this prefix", "Si se especifica, CodiBase solo mostrará iteraciones con este prefijo");
		...
		m.put("If this option is enabled, git lfs command needs to be installed on CodiBase server (even this step runs on other node)", 
			"Si esta opción está habilitada, el comando git lfs necesita estar instalado en el servidor CodiBase (incluso si este paso se ejecuta en otro nodo)");
		...
		m.put("In case IMAP host certificate is self-signed or its CA root is not accepted, you may tell CodiBase to bypass certificate check. <b class='text-danger'>WARNING: </b> In an untrusted network, this may lead to man-in-the-middle attack, and you should <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>import the certificate into CodiBase</a> instead", 
			"En caso de que el certificado del host IMAP sea autofirmado o su raíz CA no sea aceptada, puede indicar a CodiBase que omita la verificación del certificado. <b class='text-danger'>ADVERTENCIA: </b> En una red no confiable, esto puede llevar a un ataque de intermediario, y debería <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>importar el certificado en CodiBase</a> en su lugar");
		m.put("In case SMTP host certificate is self-signed or its CA root is not accepted, you may tell CodiBase to bypass certificate check. <b class='text-danger'>WARNING: </b> In an untrusted network, this may lead to man-in-the-middle attack, and you should <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>import the certificate into CodiBase</a> instead", 
			"En caso de que el certificado del host SMTP sea autofirmado o su raíz CA no sea aceptada, puede indicar a CodiBase que omita la verificación del certificado. <b class='text-danger'>ADVERTENCIA: </b> En una red no confiable, esto puede llevar a un ataque de intermediario, y debería <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>importar el certificado en CodiBase</a> en su lugar");
		...
		m.put("In case cache is not hit via above key, CodiBase will loop through load keys defined here in order until a matching cache is found in project hierarchy. A cache is considered matching if its key is prefixed with the load key. If multiple caches matches, the most recent cache will be returned", 
			"En caso de que la caché no se encuentre mediante la clave anterior, CodiBase recorrerá las claves de carga definidas aquí en orden hasta que se encuentre una caché coincidente en la jerarquía del proyecto. Una caché se considera coincidente si su clave tiene el prefijo de la clave de carga. Si varias cachés coinciden, se devolverá la caché más reciente");
		...
		m.put("Interactive web shell access to running jobs is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"El acceso interactivo a la shell web para trabajos en ejecución es una característica empresarial. <a href='https://codibase.io/pricing' target='_blank'>Prueba gratis</a> por 30 días");
		...
		m.put("Invalid state. Please make sure you are visiting CodiBase using server url specified in system setting", 
			"Estado inválido. Por favor asegúrese de estar visitando CodiBase usando la URL del servidor especificada en la configuración del sistema");
		...
		m.put("Issue statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Las estadísticas de problemas son una característica empresarial. <a href='https://codibase.io/pricing' target='_blank'>Prueba gratis</a> por 30 días");
		...
		m.put("Login to CodiBase docker registry", "Iniciar sesión en el registro de Docker de CodiBase");
		...
		m.put("No previous successful build on <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">same stream</a> to calculate fixed issues since", 
			"No hay compilación exitosa previa en <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">la misma secuencia</a> para calcular problemas solucionados desde entonces");
		...
		m.put("CodiBase Issue Field", "Campo de Problema de CodiBase");
		m.put("CodiBase Issue Link", "Enlace de Problema de CodiBase");
		m.put("CodiBase Issue State", "Estado de Problema de CodiBase");
		m.put("CodiBase analyzes repository files for code search, line statistics, and code contribution statistics. This setting tells which files should be analyzed, and expects space-separated <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path patterns</a>. A pattern can be excluded by prefixing with '-', for instance <code>-**/vendors/**</code> will exclude all files with vendors in path. <b>NOTE: </b> Changing this setting only affects new commits. To apply the change to history commits, please stop the server and delete folder <code>index</code> and <code>info/commit</code> under <a href='https://docs.codibase.io/concepts#project-storage' target='_blank'>project's storage directory</a>. The repository will be re-analyzed when server is started", 
			"CodiBase analiza archivos del repositorio para búsqueda de código, estadísticas de líneas y estadísticas de contribución de código. Esta configuración indica qué archivos deben ser analizados y espera patrones de ruta separados por espacios <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path patterns</a>. Un patrón puede ser excluido prefijándolo con '-', por ejemplo <code>-**/vendors/**</code> excluirá todos los archivos con vendors en la ruta. <b>NOTA: </b> Cambiar esta configuración solo afecta a nuevos commits. Para aplicar el cambio a commits históricos, detenga el servidor y elimine la carpeta <code>index</code> y <code>info/commit</code> bajo el <a href='https://docs.codibase.io/concepts#project-storage' target='_blank'>directorio de almacenamiento del proyecto</a>. El repositorio será reanalizado cuando se inicie el servidor");
		m.put("CodiBase configures git hooks to communicate with itself via curl", "CodiBase configura hooks de git para comunicarse consigo mismo vía curl");
		m.put("CodiBase needs to search and determine user DN, as well as searching user group information if group retrieval is enabled. Tick this option and specify 'manager' DN and password if these operations needs to be authenticated", 
			"CodiBase necesita buscar y determinar el DN del usuario, así como buscar información del grupo de usuarios si la recuperación de grupos está habilitada. Marque esta opción y especifique el DN del 'manager' y la contraseña si estas operaciones necesitan autenticación");
		m.put("CodiBase requires git command line to manage repositories. The minimum required version is 2.11.1. Also make sure that git-lfs is installed if you want to retrieve LFS files in build job", 
			"CodiBase requiere la línea de comandos de git para gestionar repositorios. La versión mínima requerida es 2.11.1. También asegúrese de que git-lfs esté instalado si desea recuperar archivos LFS en el trabajo de construcción");
		...
		m.put("OpenID", "OpenID");
		m.put("OpenID client identification will be assigned by your OpenID provider when registering this CodiBase instance as client application", 
			"La identificación del cliente OpenID será asignada por su proveedor de OpenID al registrar esta instancia de CodiBase como aplicación cliente");
		m.put("OpenID client secret will be generated by your OpenID provider when registering this CodiBase instance as client application", 
			"El secreto del cliente OpenID será generado por su proveedor de OpenID al registrar esta instancia de CodiBase como aplicación cliente");
		...
		m.put("Optionally specify <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as GitHub access token. This is used to retrieve release notes of dependencies hosted on GitHub, and the authenticated access will get a higher rate limit", 
			"Opcionalmente especifique <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>secreto de trabajo</a> para usar como token de acceso de GitHub. Esto se utiliza para recuperar notas de lanzamiento de dependencias alojadas en GitHub, y el acceso autenticado tendrá un límite de tasa más alto.");
		...
		m.put("Optionally specify Dockerfile relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Leave empty to use file <tt>Dockerfile</tt> under build path specified above", 
			"Opcionalmente especifique el Dockerfile relativo al <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>espacio de trabajo del trabajo</a>. Déjelo vacío para usar el archivo <tt>Dockerfile</tt> bajo la ruta de construcción especificada anteriormente.");
		...
		m.put("Optionally specify a CodiBase project to be used as parent of imported projects. Leave empty to import as root projects", 
			"Opcionalmente especifique un proyecto de CodiBase para usar como padre de los proyectos importados. Déjelo vacío para importar como proyectos raíz.");
		m.put("Optionally specify a CodiBase project to be used as parent of imported repositories. Leave empty to import as root projects", 
			"Opcionalmente especifique un proyecto de CodiBase para usar como padre de los repositorios importados. Déjelo vacío para importar como proyectos raíz.");
		...
		m.put("Optionally specify a cron expression to schedule database auto-backup. The cron expression format is <em>&lt;seconds&gt; &lt;minutes&gt; &lt;hours&gt; &lt;day-of-month&gt; &lt;month&gt; &lt;day-of-week&gt;</em>.For example, <em>0 0 1 * * ?</em> means 1:00am every day. For details of the format, refer to <a href='http://www.quartz-scheduler.org/documentation/quartz-2.3.0/tutorials/crontrigger.html#format' target='_blank'>Quartz tutorial</a>.The backup files will be placed into <em>db-backup</em> folder under CodiBase installation directory. In case multiple servers connect to form a cluster, auto-backup takes place on the <a href='https://docs.codibase.io/concepts#lead-server' target='_blank'>lead server</a>. Leave this property empty if you do not want to enable database auto backup.", 
			"Opcionalmente especifique una expresión cron para programar la copia de seguridad automática de la base de datos. El formato de la expresión cron es <em>&lt;segundos&gt; &lt;minutos&gt; &lt;horas&gt; &lt;día-del-mes&gt; &lt;mes&gt; &lt;día-de-la-semana&gt;</em>. Por ejemplo, <em>0 0 1 * * ?</em> significa 1:00am todos los días. Para detalles del formato, consulte el <a href='http://www.quartz-scheduler.org/documentation/quartz-2.3.0/tutorials/crontrigger.html#format' target='_blank'>tutorial de Quartz</a>. Los archivos de copia de seguridad se colocarán en la carpeta <em>db-backup</em> bajo el directorio de instalación de CodiBase. En caso de que varios servidores se conecten para formar un clúster, la copia de seguridad automática se realiza en el <a href='https://docs.codibase.io/concepts#lead-server' target='_blank'>servidor principal</a>. Deje esta propiedad vacía si no desea habilitar la copia de seguridad automática de la base de datos.");
		m.put("Optionally specify a date field to hold due date information.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Opcionalmente especifique un campo de fecha para contener información de fecha de vencimiento.<br><b>NOTA: </b> Puede personalizar los campos de problemas de CodiBase en caso de que no haya una opción adecuada aquí.");
		m.put("Optionally specify a path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to put retrieved artifacts. Leave empty to use job workspace itself", 
			"Opcionalmente especifique una ruta relativa al <a href='https://docs.codibase.io/concepts#job-workspace'>espacio de trabajo del trabajo</a> para colocar artefactos recuperados. Déjelo vacío para usar el espacio de trabajo del trabajo en sí.");
		...
		m.put("Optionally specify a working period field to hold estimated time infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Opcionalmente especifique un campo de período de trabajo para contener información de tiempo estimado.<br><b>NOTA: </b> Puede personalizar los campos de problemas de CodiBase en caso de que no haya una opción adecuada aquí.");
		m.put("Optionally specify a working period field to hold spent time infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Opcionalmente especifique un campo de período de trabajo para contener información de tiempo gastado.<br><b>NOTA: </b> Puede personalizar los campos de problemas de CodiBase en caso de que no haya una opción adecuada aquí.");
		m.put("Optionally specify a working period field to hold time estimate infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Opcionalmente especifique un campo de período de trabajo para contener información de estimación de tiempo.<br><b>NOTA: </b> Puede personalizar los campos de problemas de CodiBase en caso de que no haya una opción adecuada aquí.");
		m.put("Optionally specify a working period field to hold time spent infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Opcionalmente especifique un campo de período de trabajo para contener información de tiempo gastado.<br><b>NOTA: </b> Puede personalizar los campos de problemas de CodiBase en caso de que no haya una opción adecuada aquí.");
		...
		m.put("Optionally specify artifacts to retrieve from the dependency into <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Only published artifacts (via artifact publish step) can be retrieved. Leave empty to not retrieve any artifacts", 
			"Opcionalmente especifique artefactos para recuperar de la dependencia en el <a href='https://docs.codibase.io/concepts#job-workspace'>espacio de trabajo del trabajo</a>. Solo se pueden recuperar artefactos publicados (a través del paso de publicación de artefactos). Déjelo vacío para no recuperar ningún artefacto.");
		...
		m.put("Optionally specify build context path relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Leave empty to use job workspace itself. The file <code>Dockerfile</code> is expected to exist in build context directory, unless you specify a different location with option <code>--dockerfile</code>", 
			"Opcionalmente especifique la ruta de contexto de construcción relativa al <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>espacio de trabajo del trabajo</a>. Déjelo vacío para usar el espacio de trabajo del trabajo en sí. Se espera que el archivo <code>Dockerfile</code> exista en el directorio de contexto de construcción, a menos que especifique una ubicación diferente con la opción <code>--dockerfile</code>.");
		m.put("Optionally specify build path relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Leave empty to use job workspace itself", 
			"Opcionalmente especifique la ruta de construcción relativa al <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>espacio de trabajo del trabajo</a>. Déjelo vacío para usar el espacio de trabajo del trabajo en sí.");
		...
		m.put("Optionally specify files relative to cache path to ignore when detect cache changes. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Multiple files should be separated by space, and single file containing space should be quoted", 
			"Opcionalmente especifique archivos relativos a la ruta de caché para ignorar al detectar cambios en la caché. Use '**', '*' o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>. Los múltiples archivos deben estar separados por espacio, y un único archivo que contenga espacio debe estar entre comillas.");
		m.put("Optionally specify group search base if you want to retrieve group membership information of the user. For example: <i>cn=Users, dc=example, dc=com</i>. To give appropriate permissions to a Active Directory group, a CodiBase group with same name should be defined. Leave empty to manage group memberships at CodiBase side", 
			"Opcionalmente especifique la base de búsqueda de grupos si desea recuperar información de membresía de grupo del usuario. Por ejemplo: <i>cn=Users, dc=example, dc=com</i>. Para otorgar permisos apropiados a un grupo de Active Directory, se debe definir un grupo de CodiBase con el mismo nombre. Déjelo vacío para gestionar las membresías de grupo en el lado de CodiBase.");
		...
		m.put("Optionally specify osv scanner <a href='https://google.github.io/osv-scanner/configuration/' target='_blank'>config file</a> under <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. You may ignore particular vulnerabilities via this file", 
			"Opcionalmente especifique el archivo de configuración del escáner osv <a href='https://google.github.io/osv-scanner/configuration/' target='_blank'>config file</a> bajo el <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>espacio de trabajo del trabajo</a>. Puede ignorar vulnerabilidades particulares a través de este archivo.");
		m.put("Optionally specify path protection rules", "Opcionalmente especifique reglas de protección de ruta.");
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be used as trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/configuration/filtering/#by-finding-ids' target='_blank'>ignore file</a>", 
			"Opcionalmente especifique la ruta relativa al <a href='https://docs.codibase.io/concepts#job-workspace'>espacio de trabajo del trabajo</a> para usar como archivo de ignorar de trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/configuration/filtering/#by-finding-ids' target='_blank'>ignore file</a>.");
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be used as trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/scanner/secret/#configuration' target='_blank'>secret config</a>", 
			"Opcionalmente especifique la ruta relativa al <a href='https://docs.codibase.io/concepts#job-workspace'>espacio de trabajo del trabajo</a> para usar como configuración de secretos de trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/scanner/secret/#configuration' target='_blank'>secret config</a>.");
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to publish artifacts from. Leave empty to use job workspace itself", 
			"Opcionalmente especifique la ruta relativa al <a href='https://docs.codibase.io/concepts#job-workspace'>espacio de trabajo del trabajo</a> para publicar artefactos. Déjelo vacío para usar el espacio de trabajo del trabajo en sí.");
		...
		m.put("Optionally specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to clone code into. Leave empty to use job workspace itself", 
			"Opcionalmente especifique la ruta relativa bajo el <a href='https://docs.codibase.io/concepts#job-workspace'>espacio de trabajo del trabajo</a> para clonar el código. Déjelo vacío para usar el espacio de trabajo del trabajo en sí.");
		m.put("Optionally specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to scan. Leave empty to use job workspace itself", 
			"Opcionalmente especifique la ruta relativa bajo el <a href='https://docs.codibase.io/concepts#job-workspace'>espacio de trabajo del trabajo</a> para escanear. Déjelo vacío para usar el espacio de trabajo del trabajo en sí.");
		m.put("Optionally specify relative paths under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to scan dependency vulnerabilities. Multiple paths can be specified and should be separated with space. Leave empty to use job workspace itself", 
			"Opcionalmente especifique rutas relativas bajo el <a href='https://docs.codibase.io/concepts#job-workspace'>espacio de trabajo del trabajo</a> para escanear vulnerabilidades de dependencias. Se pueden especificar múltiples rutas y deben estar separadas por espacio. Déjelo vacío para usar el espacio de trabajo del trabajo en sí.");
		...
		m.put("Optionally specify space-separated branches applicable for this transition. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all", 
			"Opcionalmente especifique ramas separadas por espacio aplicables para esta transición. Use '**', '*' o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>. Prefijo con '-' para excluir. Déjelo vacío para coincidir con todas.");
		m.put("Optionally specify space-separated branches applicable for this trigger. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty for default branch", 
			"Opcionalmente especifique ramas separadas por espacio aplicables para este disparador. Use '**', '*' o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>. Prefijo con '-' para excluir. Déjelo vacío para la rama predeterminada.");
		m.put("Optionally specify space-separated branches to check. Use '**' or '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all branches", 
			"Opcionalmente especifique ramas separadas por espacio para verificar. Use '**' o '*' o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>. Prefijo con '-' para excluir. Déjelo vacío para coincidir con todas las ramas.");
		...
		m.put("Optionally specify space-separated files to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all files", 
			"Opcionalmente especifique archivos separados por espacio para verificar. Use '**', '*' o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>. Prefijo con '-' para excluir. Déjelo vacío para coincidir con todos los archivos.");
		...
		m.put("Optionally specify space-separated projects applicable for this trigger. This is useful for instance when you want to prevent the job from being triggered in forked projects. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all projects", 
			"Opcionalmente especifique proyectos separados por espacio aplicables para este disparador. Esto es útil, por ejemplo, cuando desea evitar que el trabajo se active en proyectos bifurcados. Use '**', '*' o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>. Prefijo con '-' para excluir. Déjelo vacío para coincidir con todos los proyectos.");
		m.put("Optionally specify space-separated projects to search in. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to search in all projects with code read permission", 
			"Opcionalmente especifique proyectos separados por espacio para buscar. Use '**', '*' o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>. Prefijo con '-' para excluir. Déjelo vacío para buscar en todos los proyectos con permiso de lectura de código.");
		...
		m.put("Optionally specify space-separated service images applicable for this locator. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all", 
			"Opcionalmente especifique imágenes de servicio separadas por espacios aplicables para este localizador. Use '**', '*' o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>. Prefije con '-' para excluir. Deje vacío para coincidir con todos");
		...
		m.put("Optionally specify space-separated tags to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all tags", 
			"Opcionalmente especifique etiquetas separadas por espacios para verificar. Use '**', '*' o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>. Prefije con '-' para excluir. Deje vacío para coincidir con todas las etiquetas");
		m.put("Optionally specify space-separated target branches of the pull requests to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all branches", 
			"Opcionalmente especifique ramas objetivo separadas por espacios de las solicitudes de extracción para verificar. Use '**', '*' o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>. Prefije con '-' para excluir. Deje vacío para coincidir con todas las ramas");
		...
		m.put("Parent CodiBase Project", "Proyecto Padre de CodiBase");
		...
		m.put("Projects need to be redistributed when cluster members are added/removed. CodiBase does not do this automatically as this is resource intensive, and you may only want to do it after cluster is finalized and stable.", 
			"Los proyectos necesitan ser redistribuidos cuando se agregan/eliminan miembros del clúster. CodiBase no hace esto automáticamente ya que es intensivo en recursos, y es posible que solo desees hacerlo después de que el clúster esté finalizado y estable.");
		...
		m.put("Pull request statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Las estadísticas de solicitudes de extracción son una función empresarial. <a href='https://codibase.io/pricing' target='_blank'>Prueba gratis</a> durante 30 días");
		...
		m.put("Refer to this <a href='https://docs.codibase.io/tutorials/security/sso-with-github' target='_blank'>tutorial</a> for an example setup", 
			"Consulta este <a href='https://docs.codibase.io/tutorials/security/sso-with-github' target='_blank'>tutorial</a> para un ejemplo de configuración");
		m.put("Refer to this <a href='https://docs.codibase.io/tutorials/security/sso-with-okta' target='_blank'>tutorial</a> for an example setup", 
			"Consulta este <a href='https://docs.codibase.io/tutorials/security/sso-with-okta' target='_blank'>tutorial</a> para un ejemplo de configuración");
		...
		m.put("Run specified docker container. <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job workspace</a> is mounted into the container and its path is placed in environment variable <code>CODIBASE_WORKSPACE</code>. <b class='text-warning'>Note: </b> this step can only be executed by server docker executor or remote docker executor", 
			"Ejecute el contenedor Docker especificado. <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>El espacio de trabajo del trabajo</a> se monta en el contenedor y su ruta se coloca en la variable de entorno <code>CODIBASE_WORKSPACE</code>. <b class='text-warning'>Nota: </b> este paso solo puede ser ejecutado por el ejecutor docker del servidor o el ejecutor docker remoto");
		...
		m.put("Set up job cache to speed up job execution. Check <a href='https://docs.codibase.io/tutorials/cicd/job-cache' target='_blank'>this tutorial</a> on how to use job cache", 
			"Configurar caché de trabajos para acelerar la ejecución de trabajos. Consulta <a href='https://docs.codibase.io/tutorials/cicd/job-cache' target='_blank'>este tutorial</a> sobre cómo usar el caché de trabajos.");
		...
		m.put("Signature verified successfully with CodiBase GPG key", "Firma verificada exitosamente con la clave GPG de CodiBase");
		...
		m.put("Specifies the attribute containing group name inside the found group LDAP entry. Value of this attribute will be mapped to a CodiBase group. This attribute is normally set to <i>cn</i>", 
			"Especifica el atributo que contiene el nombre del grupo dentro de la entrada LDAP del grupo encontrado. El valor de este atributo se mapeará a un grupo de CodiBase. Este atributo normalmente se establece en <i>cn</i>");
		m.put("Specify .net TRX test result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>TestResults/*.trx</tt>. Use * or ? for pattern match", 
			"Especifica el archivo de resultados de prueba .net TRX relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, por ejemplo <tt>TestResults/*.trx</tt>. Usa * o ? para coincidencia de patrones");
		m.put("Specify <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> whose value is access token with code write permission over above projects. Commits, issues, and pull requests will also be created under name of the access token owner", 
			"Especifica <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> cuyo valor es un token de acceso con permiso de escritura de código sobre los proyectos mencionados anteriormente. Los commits, problemas y solicitudes de extracción también se crearán bajo el nombre del propietario del token de acceso");
		m.put("Specify <a href='https://github.com/rust-lang/rust-clippy'>rust clippy</a> json output file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with clippy json output option, for instance <code>cargo clippy --message-format json>check-result.json</code>. Use * or ? for pattern match", 
			"Especifica el archivo de salida json de <a href='https://github.com/rust-lang/rust-clippy'>rust clippy</a> relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Este archivo puede generarse con la opción de salida json de clippy, por ejemplo <code>cargo clippy --message-format json>check-result.json</code>. Usa * o ? para coincidencia de patrones");
		m.put("Specify Build Options", "Especifica las opciones de compilación");
		m.put("Specify CPD result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/cpd.xml</tt>. Use * or ? for pattern match", 
			"Especifica el archivo xml de resultados de CPD relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, por ejemplo, <tt>target/cpd.xml</tt>. Usa * o ? para coincidencia de patrones");
		m.put("Specify Commit Message", "Especifica el mensaje de commit");
		m.put("Specify ESLint report file in checkstyle format under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with ESLint option <tt>'-f checkstyle'</tt> and <tt>'-o'</tt>. Use * or ? for pattern match", 
			"Especifica el archivo de informe ESLint en formato checkstyle bajo <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Este archivo puede generarse con la opción de ESLint <tt>'-f checkstyle'</tt> y <tt>'-o'</tt>. Usa * o ? para coincidencia de patrones");
		...
		m.put("Specify JUnit test result file in XML format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>target/surefire-reports/TEST-*.xml</tt>. Use * or ? for pattern match", 
			"Especifica el archivo de resultados de prueba JUnit en formato XML relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, por ejemplo <tt>target/surefire-reports/TEST-*.xml</tt>. Usa * o ? para coincidencia de patrones");
		m.put("Specify JaCoCo coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/jacoco/jacoco.xml</tt>. Use * or ? for pattern match", 
			"Especifica el archivo de informe de cobertura xml de JaCoCo relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, por ejemplo, <tt>target/site/jacoco/jacoco.xml</tt>. Usa * o ? para coincidencia de patrones");
		m.put("Specify Jest coverage report file in clover format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>coverage/clover.xml</tt>. This file can be generated with Jest option <tt>'--coverage'</tt>. Use * or ? for pattern match", 
			"Especifica el archivo de informe de cobertura de Jest en formato clover relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, por ejemplo <tt>coverage/clover.xml</tt>. Este archivo puede generarse con la opción de Jest <tt>'--coverage'</tt>. Usa * o ? para coincidencia de patrones");
		m.put("Specify Jest test result file in json format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated via Jest option <tt>'--json'</tt> and <tt>'--outputFile'</tt>. Use * or ? for pattern match", 
			"Especifica el archivo de resultados de prueba de Jest en formato json relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Este archivo puede generarse mediante la opción de Jest <tt>'--json'</tt> y <tt>'--outputFile'</tt>. Usa * o ? para coincidencia de patrones");
		m.put("Specify OCI layout directory of the image to scan. This directory can be generated via build image step or pull image step. It should be relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Especifica el directorio de diseño OCI de la imagen para escanear. Este directorio puede generarse mediante el paso de construcción de imagen o el paso de extracción de imagen. Debe ser relativo a <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>");
		m.put("Specify OCI layout directory relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to push from", 
			"Especifica el directorio de diseño OCI relativo a <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> para realizar el push");
		m.put("Specify OpenID scopes to request", "Especifica los alcances de OpenID a solicitar");
		m.put("Specify PMD result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/pmd.xml</tt>. Use * or ? for pattern match", 
			"Especifica el archivo xml de resultados de PMD relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, por ejemplo, <tt>target/pmd.xml</tt>. Usa * o ? para coincidencia de patrones");
		m.put("Specify PowerShell commands to execute under the <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>.<br><b class='text-warning'>NOTE: </b> CodiBase checks exit code of the script to determine if step is successful. Since PowerShell always exit with 0 even if there are script errors, you should handle errors in the script and exit with non-zero code, or add line <code>$ErrorActionPreference = &quot;Stop&quot;</code> at start of your script<br>", 
			"Especifica los comandos de PowerShell para ejecutar bajo <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>.<br><b class='text-warning'>NOTA: </b> CodiBase verifica el código de salida del script para determinar si el paso es exitoso. Dado que PowerShell siempre sale con 0 incluso si hay errores en el script, deberías manejar los errores en el script y salir con un código distinto de cero, o agregar la línea <code>$ErrorActionPreference = &quot;Stop&quot;</code> al inicio de tu script<br>");
		m.put("Specify Roslynator diagnostics output file in XML format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with <i>-o</i> option. Use * or ? for pattern match", 
			"Especifica el archivo de salida de diagnósticos de Roslynator en formato XML relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Este archivo puede generarse con la opción <i>-o</i>. Usa * o ? para coincidencia de patrones");
		m.put("Specify Shell/Batch Commands to Run", "Especifica los comandos Shell/Batch para ejecutar");
		m.put("Specify SpotBugs result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/spotbugsXml.xml</tt>. Use * or ? for pattern match", 
			"Especifica el archivo xml de resultados de SpotBugs relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, por ejemplo, <tt>target/spotbugsXml.xml</tt>. Usa * o ? para coincidencia de patrones");
		...
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as SSH private key", 
			"Especifica un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> para usar como clave privada SSH");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as access token", 
			"Especifica un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> para usar como token de acceso");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as access token to import build spec from above project if its code is not publicly accessible", 
			"Especifica un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> para usar como token de acceso para importar la especificación de compilación del proyecto mencionado anteriormente si su código no es accesible públicamente");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as password or access token of the registry", 
			"Especifica un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> para usar como contraseña o token de acceso del registro");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as password or access token to access remote repository", 
			"Especifica un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> para usar como contraseña o token de acceso para acceder al repositorio remoto");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as private key for SSH authentication. <b class='text-info'>NOTE:</b> Private key with passphrase is not supported", 
			"Especifica un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> para usar como clave privada para la autenticación SSH. <b class='text-info'>NOTA:</b> No se admite la clave privada con frase de contraseña");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as private key of above user for SSH authentication. <b class='text-info'>NOTE:</b> Private key with passphrase is not supported", 
			"Especifica un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> para usar como clave privada del usuario mencionado anteriormente para la autenticación SSH. <b class='text-info'>NOTA:</b> No se admite la clave privada con frase de contraseña");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> whose value is an access token with management permission for above project. Note that access token is not required if sync to current or child project and build commit is reachable from default branch", 
			"Especifica un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> cuyo valor es un token de acceso con permiso de gestión para el proyecto mencionado anteriormente. Ten en cuenta que no se requiere el token de acceso si se sincroniza con el proyecto actual o hijo y el commit de compilación es alcanzable desde la rama predeterminada");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> whose value is an access token with upload cache permission for above project. Note that this property is not required if upload cache to current or child project and build commit is reachable from default branch", 
			"Especifica un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> cuyo valor es un token de acceso con permiso para cargar caché para el proyecto mencionado anteriormente. Ten en cuenta que esta propiedad no es necesaria si se carga caché al proyecto actual o hijo y el commit de compilación es alcanzable desde la rama predeterminada");
		...
		m.put("Specify a file relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to write checksum into", 
			"Especifica un archivo relativo a <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> para escribir el checksum");
		m.put("Specify a multi-value user field to hold assignees information.<b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Especifica un campo de usuario de múltiples valores para mantener la información de los asignados.<b>NOTA: </b> Puedes personalizar los campos de problemas de CodiBase en caso de que no haya una opción adecuada aquí");
		m.put("Specify a multi-value user field to hold assignees information.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Especifica un campo de usuario de múltiples valores para mantener la información de los asignados.<br><b>NOTA: </b> Puedes personalizar los campos de problemas de CodiBase en caso de que no haya una opción adecuada aquí");
		...
		m.put("Specify absolute path to the kubectl utility, for instance: <i>/usr/bin/kubectl</i>. If left empty, CodiBase will try to find the utility from system path", 
			"Especifica la ruta absoluta a la utilidad kubectl, por ejemplo: <i>/usr/bin/kubectl</i>. Si se deja vacío, CodiBase intentará encontrar la utilidad desde la ruta del sistema");
		...
		m.put("Specify applicable projects for above option. Multiple projects should be separated by space. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty for all projects", 
			"Especifica proyectos aplicables para la opción mencionada anteriormente. Múltiples proyectos deben separarse por espacio. Usa '**', '*' o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de patrones de ruta</a>. Prefija con '-' para excluir. Déjalo vacío para todos los proyectos");
		m.put("Specify applicable projects separated by space. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty for all projects", 
			"Especifica proyectos aplicables separados por espacio. Usa '**', '*' o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de patrones de ruta</a>. Prefija con '-' para excluir. Déjalo vacío para todos los proyectos");
		...
		m.put("Specify artifacts to retrieve into <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Only published artifacts (via artifact publish step) can be retrieved.", 
			"Especifica artefactos para recuperar en <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Solo se pueden recuperar artefactos publicados (mediante el paso de publicación de artefactos).");
		m.put("Specify at least 10 alphanumeric chars to be used as secret, and then add an inbound parse entry at SendGrid side:<ul><li><code>Destination URL</code> should be set to <i>&lt;CodiBase root url&gt;/~sendgrid/&lt;secret&gt;</i>, for instance, <i>https://codibase.example.com/~sendgrid/1234567890</i>. Note that in production environment, <a href='https://docs.codibase.io/administration-guide/https-setup' target='_blank'>https should be enabled</a> to protect the secret</li><li><code>Receiving domain</code> should be the same as domain part of system email address specified above</li><li>Option <code>POST the raw, full MIME message</code> is enabled</li></ul>", 
			"Especifica al menos 10 caracteres alfanuméricos para usar como secreto, y luego agrega una entrada de análisis de entrada en el lado de SendGrid:<ul><li><code>Destination URL</code> debe configurarse como <i>&lt;CodiBase root url&gt;/~sendgrid/&lt;secret&gt;</i>, por ejemplo, <i>https://codibase.example.com/~sendgrid/1234567890</i>. Ten en cuenta que en un entorno de producción, <a href='https://docs.codibase.io/administration-guide/https-setup' target='_blank'>debería habilitarse https</a> para proteger el secreto</li><li><code>Receiving domain</code> debe ser el mismo que la parte del dominio de la dirección de correo del sistema especificada anteriormente</li><li>La opción <code>POST the raw, full MIME message</code> está habilitada</li></ul>");
		...
		m.put("Specify checkstyle result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/checkstyle-result.xml</tt>. Refer to <a href='https://checkstyle.org/'>checkstyle documentation</a> on how to generate the result xml file. Use * or ? for pattern match", 
			"Especifica el archivo xml de resultados de checkstyle relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, por ejemplo, <tt>target/checkstyle-result.xml</tt>. Consulta la <a href='https://checkstyle.org/'>documentación de checkstyle</a> sobre cómo generar el archivo xml de resultados. Usa * o ? para coincidencia de patrones");
		...
		m.put("Specify clover coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/clover/clover.xml</tt>. Refer to <a href='https://openclover.org/documentation'>OpenClover documentation</a> on how to generate clover xml file. Use * or ? for pattern match", 
			"Especifica el archivo de informe de cobertura xml de clover relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, por ejemplo, <tt>target/site/clover/clover.xml</tt>. Consulta la <a href='https://openclover.org/documentation'>documentación de OpenClover</a> sobre cómo generar el archivo xml de clover. Usa * o ? para coincidencia de patrones");
		m.put("Specify cobertura coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/cobertura/coverage.xml</tt>. Use * or ? for pattern match", 
			"Especifica el archivo de informe de cobertura xml de cobertura relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, por ejemplo, <tt>target/site/cobertura/coverage.xml</tt>. Usa * o ? para coincidencia de patrones");
		...
		m.put("Specify configuration discovery url of your OpenID provider, for instance: <code>https://openid.example.com/.well-known/openid-configuration</code>. Make sure to use HTTPS protocol as CodiBase relies on TLS encryption to ensure token validity", 
			"Especifique la URL de descubrimiento de configuración de su proveedor OpenID, por ejemplo: <code>https://openid.example.com/.well-known/openid-configuration</code>. Asegúrese de usar el protocolo HTTPS ya que CodiBase depende del cifrado TLS para garantizar la validez del token");
		...
		m.put("Specify cppcheck xml result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with cppcheck xml output option, for instance <code>cppcheck src --xml 2>check-result.xml</code>. Use * or ? for pattern match", 
			"Especifique el archivo de resultados xml de cppcheck relativo al <a href='https://docs.codibase.io/concepts#job-workspace'>espacio de trabajo del trabajo</a>. Este archivo puede generarse con la opción de salida xml de cppcheck, por ejemplo <code>cppcheck src --xml 2>check-result.xml</code>. Use * o ? para coincidencia de patrones");
		...
		m.put("Specify directory relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to store OCI layout", 
			"Especifique el directorio relativo al <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>espacio de trabajo del trabajo</a> para almacenar el diseño OCI");
		m.put("Specify docker image of the service", "Especifique la imagen de Docker del servicio");
		m.put("Specify dockerx builder used to build docker image. CodiBase will create the builder automatically if it does not exist. Check <a href='https://docs.codibase.io/tutorials/cicd/insecure-docker-registry' target='_blank'>this tutorial</a> on how to customize the builder for instance to allow publishing to insecure registries", 
			"Especifique el constructor dockerx utilizado para construir la imagen de Docker. CodiBase creará el constructor automáticamente si no existe. Consulte <a href='https://docs.codibase.io/tutorials/cicd/insecure-docker-registry' target='_blank'>este tutorial</a> sobre cómo personalizar el constructor, por ejemplo, para permitir la publicación en registros inseguros");
		...
		m.put("Specify how to map GitHub issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Especifique cómo mapear las etiquetas de problemas de GitHub a los campos personalizados de CodiBase.<br><b>NOTA: </b> Puede personalizar los campos de problemas de CodiBase en caso de que no haya una opción adecuada aquí");
		m.put("Specify how to map GitLab issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Especifique cómo mapear las etiquetas de problemas de GitLab a los campos personalizados de CodiBase.<br><b>NOTA: </b> Puede personalizar los campos de problemas de CodiBase en caso de que no haya una opción adecuada aquí");
		m.put("Specify how to map Gitea issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Especifique cómo mapear las etiquetas de problemas de Gitea a los campos personalizados de CodiBase.<br><b>NOTA: </b> Puede personalizar los campos de problemas de CodiBase en caso de que no haya una opción adecuada aquí");
		m.put("Specify how to map JIRA issue priorities to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Especifique cómo mapear las prioridades de problemas de JIRA a los campos personalizados de CodiBase.<br><b>NOTA: </b> Puede personalizar los campos de problemas de CodiBase en caso de que no haya una opción adecuada aquí");
		m.put("Specify how to map JIRA issue statuses to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Especifique cómo mapear los estados de problemas de JIRA a los campos personalizados de CodiBase.<br><b>NOTA: </b> Puede personalizar los estados de problemas de CodiBase en caso de que no haya una opción adecuada aquí");
		m.put("Specify how to map JIRA issue types to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Especifique cómo mapear los tipos de problemas de JIRA a los campos personalizados de CodiBase.<br><b>NOTA: </b> Puede personalizar los campos de problemas de CodiBase en caso de que no haya una opción adecuada aquí");
		m.put("Specify how to map YouTrack issue fields to CodiBase. Unmapped fields will be reflected in issue description.<br><b>Note: </b><ul><li>Enum field needs to be mapped in form of <tt>&lt;Field Name&gt;::&lt;Field Value&gt;</tt>, for instance <tt>Priority::Critical</tt><li>You may customize CodiBase issue fields in case there is no appropriate option here</ul>", 
			"Especifique cómo mapear los campos de problemas de YouTrack a CodiBase. Los campos no mapeados se reflejarán en la descripción del problema.<br><b>Nota: </b><ul><li>El campo de enumeración necesita ser mapeado en forma de <tt>&lt;Field Name&gt;::&lt;Field Value&gt;</tt>, por ejemplo <tt>Priority::Critical</tt><li>Puede personalizar los campos de problemas de CodiBase en caso de que no haya una opción adecuada aquí</ul>");
		m.put("Specify how to map YouTrack issue links to CodiBase issue links.<br><b>NOTE: </b> You may customize CodiBase issue links in case there is no appropriate option here", 
			"Especifique cómo mapear los enlaces de problemas de YouTrack a los enlaces de problemas de CodiBase.<br><b>NOTA: </b> Puede personalizar los enlaces de problemas de CodiBase en caso de que no haya una opción adecuada aquí");
		m.put("Specify how to map YouTrack issue state to CodiBase issue state. Unmapped states will use the initial state in CodiBase.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Especifique cómo mapear el estado de problemas de YouTrack al estado de problemas de CodiBase. Los estados no mapeados usarán el estado inicial en CodiBase.<br><b>NOTA: </b> Puede personalizar los estados de problemas de CodiBase en caso de que no haya una opción adecuada aquí");
		m.put("Specify how to map YouTrack issue tags to CodiBase issue custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Especifique cómo mapear las etiquetas de problemas de YouTrack a los campos personalizados de problemas de CodiBase.<br><b>NOTA: </b> Puede personalizar los campos de problemas de CodiBase en caso de que no haya una opción adecuada aquí");
		...
		m.put("Specify manager DN to authenticate CodiBase itself to Active Directory. The manager DN should be specified in form of <i>&lt;account name&gt;@&lt;domain&gt;</i>, for instance: <i>manager@example.com</i>", 
			"Especifique el DN del administrador para autenticar CodiBase a Active Directory. El DN del administrador debe especificarse en forma de <i>&lt;account name&gt;@&lt;domain&gt;</i>, por ejemplo: <i>manager@example.com</i>");
		m.put("Specify manager DN to authenticate CodiBase itself to LDAP server", "Especifique el DN del administrador para autenticar CodiBase al servidor LDAP");
		m.put("Specify markdown file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be published", 
			"Especifique el archivo markdown relativo al <a href='https://docs.codibase.io/concepts#job-workspace'>espacio de trabajo del trabajo</a> para publicar");
		...
		m.put("Specify mypy output file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated by redirecting mypy output <b>without option '--pretty'</b>, for instance <code>mypy --exclude=.git --exclude=.venv . > mypy-output</code>. Use * or ? for pattern match", 
			"Especifique el archivo de salida de mypy relativo al <a href='https://docs.codibase.io/concepts#job-workspace'>espacio de trabajo del trabajo</a>. Este archivo puede generarse redirigiendo la salida de mypy <b>sin la opción '--pretty'</b>, por ejemplo <code>mypy --exclude=.git --exclude=.venv . > mypy-output</code>. Use * o ? para coincidencia de patrones");
		...
		m.put("Specify project to import into at CodiBase side", "Especifique el proyecto para importar en el lado de CodiBase");
		...
		m.put("Specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to store OCI layout", 
			"Especifique la ruta relativa bajo el <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>espacio de trabajo del trabajo</a> para almacenar el diseño OCI");
		...
		m.put("Specify ruff json result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with ruff json output format option, for instance <code>--exit-zero --output-format json --output-file ruff-result.json</code>. Note that we do not fail ruff command upon violations, as this step will fail build based on configured threshold. Use * or ? for pattern match", 
			"Especifique el archivo de resultados json de ruff relativo al <a href='https://docs.codibase.io/concepts#job-workspace'>espacio de trabajo del trabajo</a>. Este archivo puede generarse con la opción de formato de salida json de ruff, por ejemplo <code>--exit-zero --output-format json --output-file ruff-result.json</code>. Tenga en cuenta que no fallamos el comando ruff ante violaciones, ya que este paso fallará la compilación según el umbral configurado. Use * o ? para coincidencia de patrones");
		m.put("Specify shell commands (on Linux/Unix) or batch commands (on Windows) to execute under the <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Especifique los comandos shell (en Linux/Unix) o comandos batch (en Windows) para ejecutar bajo el <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>espacio de trabajo del trabajo</a>");
		m.put("Specify shell commands to execute under the <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Especifique los comandos shell para ejecutar bajo el <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>espacio de trabajo del trabajo</a>");
		...
		m.put("Specify space-separated branches to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Especifique las ramas separadas por espacios para proteger. Use '**', '*' o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de patrones de ruta</a>. Prefijo con '-' para excluir");
		...
		m.put("Specify space-separated paths to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Especifique las rutas separadas por espacios para proteger. Use '**', '*' o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de patrones de ruta</a>. Prefijo con '-' para excluir");
		...
		m.put("Specify space-separated tags to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Especifique las etiquetas separadas por espacios para proteger. Use '**', '*' o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de patrones de ruta</a>. Prefijo con '-' para excluir");
		m.put("Specify start page of the report relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance: <tt>manual/index.md</tt>", 
			"Especifique la página de inicio del informe relativa al <a href='https://docs.codibase.io/concepts#job-workspace'>espacio de trabajo del trabajo</a>, por ejemplo: <tt>manual/index.md</tt>");
		m.put("Specify start page of the report relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance: api/index.html", 
			"Especifique la página de inicio del informe relativa al <a href='https://docs.codibase.io/concepts#job-workspace'>espacio de trabajo del trabajo</a>, por ejemplo: api/index.html");
		...
		m.put("Specify the strategy to retrieve group membership information. To give appropriate permissions to a LDAP group, a CodiBase group with same name should be defined. Use strategy <tt>Do Not Retrieve Groups</tt> if you want to manage group memberships at CodiBase side", 
			"Especifique la estrategia para recuperar información de membresía de grupo. Para otorgar permisos apropiados a un grupo LDAP, se debe definir un grupo de CodiBase con el mismo nombre. Use la estrategia <tt>No Recuperar Grupos</tt> si desea gestionar las membresías de grupo en el lado de CodiBase");
		...
		m.put("Specify which issue state to use for closed GitHub issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Especifique qué estado de problema usar para problemas cerrados de GitHub.<br><b>NOTA: </b> Puede personalizar los estados de problemas de CodiBase en caso de que no haya una opción adecuada aquí");
		m.put("Specify which issue state to use for closed GitLab issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Especifique qué estado de problema usar para problemas cerrados de GitLab.<br><b>NOTA: </b> Puede personalizar los estados de problemas de CodiBase en caso de que no haya una opción adecuada aquí");
		m.put("Specify which issue state to use for closed Gitea issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Especifique qué estado de problema usar para problemas cerrados de Gitea.<br><b>NOTA: </b> Puede personalizar los estados de problemas de CodiBase en caso de que no haya una opción adecuada aquí");
		m.put("Specify which states are considered as closed for various issues created by Renovate to orchestrate dependency update. Additionally, when Renovate closes the issue, CodiBase will transit the issue to first state specified here", 
			"Especifique qué estados se consideran cerrados para varios problemas creados por Renovate para orquestar la actualización de dependencias. Además, cuando Renovate cierre el problema, CodiBase transitará el problema al primer estado especificado aquí");
		...
		m.put("Steps", "Pasos");
		m.put("Steps will be executed serially on same node, sharing the same <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>", 
			"Los pasos se ejecutarán en serie en el mismo nodo, compartiendo el mismo <a href='https://docs.codibase.io/concepts#job-workspace'>espacio de trabajo del trabajo</a>");
		...
		m.put("The secret which allows you to ensure that POST requests sent to the payload URL are from CodiBase. When you set a secret you'll receive the X-CodiBase-Signature header in the webhook POST request", 
			"El secreto que te permite asegurarte de que las solicitudes POST enviadas a la URL de carga útil provienen de CodiBase. Cuando configures un secreto, recibirás el encabezado X-CodiBase-Signature en la solicitud POST del webhook");
		m.put("The service desk feature enables user to create issues by sending emails to CodiBase. Issues can be discussed over email completely, without the need of logging to CodiBase.", 
			"La función de mesa de servicio permite al usuario crear incidencias enviando correos electrónicos a CodiBase. Las incidencias pueden discutirse completamente por correo electrónico, sin necesidad de iniciar sesión en CodiBase.");
		...
		m.put("This executor runs build jobs as docker containers on CodiBase server", "Este ejecutor ejecuta trabajos de construcción como contenedores de Docker en el servidor de CodiBase");
		...
		m.put("This executor runs build jobs with CodiBase server's shell facility.<br><b class='text-danger'>WARNING</b>: Jobs running with this executor has same permission as CodiBase server process. Make sure it can only be used by trusted jobs", 
			"Este ejecutor ejecuta trabajos de construcción con la instalación de shell del servidor de CodiBase.<br><b class='text-danger'>ADVERTENCIA</b>: Los trabajos que se ejecutan con este ejecutor tienen los mismos permisos que el proceso del servidor de CodiBase. Asegúrese de que solo pueda ser utilizado por trabajos confiables");
		m.put("This executor runs build jobs with remote machines's shell facility via <a href='/~administration/agents' target='_blank'>agents</a><br><b class='text-danger'>WARNING</b>: Jobs running with this executor has same permission as CodiBase agent process. Make sure it can only be used by trusted jobs", 
			"Este ejecutor ejecuta trabajos de construcción con la instalación de shell de máquinas remotas a través de <a href='/~administration/agents' target='_blank'>agentes</a><br><b class='text-danger'>ADVERTENCIA</b>: Los trabajos que se ejecutan con este ejecutor tienen los mismos permisos que el proceso del agente de CodiBase. Asegúrese de que solo pueda ser utilizado por trabajos confiables");
		...
		m.put("This installation does not have an active subscription and runs as community edition. To access <a href=\"https://codibase.io/pricing\">enterprise features</a>, an active subscription is required", 
			"Esta instalación no tiene una suscripción activa y se ejecuta como edición comunitaria. Para acceder a <a href=\"https://codibase.io/pricing\">funciones empresariales</a>, se requiere una suscripción activa");
		...
		m.put("This is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Esta es una característica enterprise. <a href='https://codibase.io/pricing' target='_blank'>Pruebe gratis</a> por 30 días");
		...
		m.put("This page lists changes since previous build on <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">same stream</a>", 
			"Esta página lista los cambios desde la construcción anterior en <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">la misma corriente</a>");
		...
		m.put("This server is currently accessed via http protocol, please configure your docker daemon or buildx builder to <a href=\"https://docs.codibase.io/tutorials/cicd/insecure-docker-registry\" target=\"_blank\">work with insecure registry</a>", 
			"Este servidor está siendo accedido actualmente a través del protocolo http, configure su demonio de Docker o constructor buildx para <a href=\"https://docs.codibase.io/tutorials/cicd/insecure-docker-registry\" target=\"_blank\">trabajar con un registro inseguro</a>");
		...
		m.put("This step can only be executed by a docker aware executor. It runs under <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Este paso solo puede ser ejecutado por un ejecutor compatible con Docker. Se ejecuta bajo <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>el espacio de trabajo del trabajo</a>");
		...
		m.put("This step publishes specified files to be served as project web site. Project web site can be accessed publicly via <code>http://&lt;codibase base url&gt;/path/to/project/~site</code>", 
			"Este paso publica los archivos especificados para ser servidos como sitio web del proyecto. El sitio web del proyecto puede ser accedido públicamente a través de <code>http://&lt;codibase base url&gt;/path/to/project/~site</code>");
		...
		m.put("This tab shows the pipeline containing current build. Check <a href=\"https://robinshen.medium.com/understanding-codibase-pipeline-db0bb0e54aa7\" target=\"_blank\">this article</a> to understand how build pipeline works", 
			"Esta pestaña muestra el pipeline que contiene la construcción actual. Consulte <a href=\"https://robinshen.medium.com/understanding-codibase-pipeline-db0bb0e54aa7\" target=\"_blank\">este artículo</a> para entender cómo funciona el pipeline de construcción");
		...
		m.put("Two-factor authentication is enabled. Please input passcode displayed on your TOTP authenticator. If you encounter problems, make sure time of CodiBase server and your device running TOTP authenticator is in sync", 
			"La autenticación de dos factores está habilitada. Por favor, ingrese el código mostrado en su autenticador TOTP. Si encuentra problemas, asegúrese de que el tiempo del servidor CodiBase y su dispositivo con el autenticador TOTP estén sincronizados");
		...
		m.put("Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>", 
			"Usa '**', '*' o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>");
		m.put("Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Usa '**', '*' o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>. Prefija con '-' para excluir");
		m.put("Use '**', '*', or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>", 
			"Usa '**', '*', o '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>coincidencia de comodines de ruta</a>");
		...
		m.put("Use job token as user name so that CodiBase can know which build is ${permission.equals(\"write\")? \"deploying\": \"using\"} packages", 
			"Usar token de trabajo como nombre de usuario para que CodiBase sepa qué compilación está ${permission.equals(\"write\")? \"implementando\": \"usando\"} paquetes");
		m.put("Use job token to tell CodiBase the build publishing the package", "Usar token de trabajo para decirle a CodiBase la compilación que publica el paquete");
		m.put("Use job token to tell CodiBase the build pushing the chart", "Usar token de trabajo para decirle a CodiBase la compilación que empuja el gráfico");
		m.put("Use job token to tell CodiBase the build pushing the package", "Usar token de trabajo para decirle a CodiBase la compilación que empuja el paquete");
		m.put("Use job token to tell CodiBase the build using the package", "Usar token de trabajo para decirle a CodiBase la compilación que usa el paquete");
		...
		m.put("When login via CodiBase's built-in form, submitted user credentials can be checked against authenticator defined here, besides the internal database", 
			"Cuando inicies sesión a través del formulario incorporado de CodiBase, las credenciales de usuario enviadas pueden ser verificadas contra el autenticador definido aquí, además de la base de datos interna");
		...
		m.put("Whether or not to create as a service account for task automation purpose. Service account does not have password and email addresses, and will not generate notifications for its activities. <b class='text-warning'>NOTE:</b> Service account is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Si se crea como una cuenta de servicio para propósitos de automatización de tareas o no. La cuenta de servicio no tiene contraseña ni direcciones de correo electrónico, y no generará notificaciones por sus actividades. <b class='text-warning'>NOTA:</b> La cuenta de servicio es una característica empresarial. <a href='https://codibase.io/pricing' target='_blank'>Prueba gratis</a> por 30 días");
		...
		m.put("Whether or not to fetch LFS objects if pull request is opened from a different project. If this option is enabled, git lfs command needs to be installed on CodiBase server", 
			"Si se deben obtener objetos LFS si la solicitud de extracción se abre desde un proyecto diferente o no. Si esta opción está habilitada, el comando git lfs necesita estar instalado en el servidor de CodiBase");
		...
		m.put("Whether or not to mount docker sock into job container to support docker operations in job commands<br><b class='text-danger'>WARNING</b>: Malicious jobs can take control of whole CodiBase by operating the mounted docker sock. Make sure this executor can only be used by trusted jobs if this option is enabled", 
			"Si se debe montar o no el socket de Docker en el contenedor del trabajo para admitir operaciones de Docker en los comandos del trabajo<br><b class='text-danger'>ADVERTENCIA</b>: Los trabajos maliciosos pueden tomar el control de todo CodiBase operando el socket de Docker montado. Asegúrese de que este ejecutor solo pueda ser utilizado por trabajos confiables si esta opción está habilitada");
		...
		m.put("Whether or not to retrieve submodules. Refer to <a href='https://docs.codibase.io/tutorials/cicd/clone-submodules' target='_blank'>this tutorial</a> on how to set up clone credential above to retrieve submodules", 
			"Si se deben recuperar submódulos o no. Consulta <a href='https://docs.codibase.io/tutorials/cicd/clone-submodules' target='_blank'>este tutorial</a> sobre cómo configurar la credencial de clonación anterior para recuperar submódulos");
		...
		m.put("[Any state]", "[Cualquier estado]");
		m.put("[Reset Password] Please Reset Your CodiBase Password", "[Restablecer Contraseña] Por favor, restablece tu contraseña de CodiBase");
		...
		m.put("adding .codibase-buildspec.yml", "agregando .codibase-buildspec.yml");
		m.put("after specified date", "después de la fecha especificada");
		m.put("an <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/notification/Unsubscribable.java' target='_blank'>object</a> holding unsubscribe information.  A <code>null</code> value means that the notification can not be unsubscribed", 
			"un <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/notification/Unsubscribable.java' target='_blank'>objeto</a> que contiene información de cancelación de suscripción. Un valor <code>null</code> significa que la notificación no puede ser cancelada");
		...
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Build.java' target='_blank'>build</a> object to be notified", 
			"representa el objeto <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Build.java' target='_blank'>compilación</a> que será notificado");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a> being opened via service desk", 
			"representa el <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>problema</a> que se abre a través del servicio de asistencia");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a> object to be notified", 
			"representa el objeto <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>problema</a> que será notificado");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Pack.java' target='_blank'>package</a> object to be notified", 
			"representa el objeto <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Pack.java' target='_blank'>paquete</a> que será notificado");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a> object to be notified", 
			"representa el objeto <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>solicitud de extracción</a> que será notificado");
		...
		m.put("represents the unsubscribed <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a>", 
			"representa el <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>problema</a> no suscrito");
		m.put("represents the unsubscribed <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a>", 
			"representa la <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>solicitud de extracción</a> no suscrita");
		m.put("request to change", "solicitud de cambio");
		m.put("root", "raíz");
		m.put("root url of CodiBase server", "url raíz del servidor CodiBase");
		m.put("run job", "ejecutar trabajo");
