...
import static io.codibase.server.model.Agent.NAME_IP_ADDRESS;
import static io.codibase.server.model.Agent.NAME_NAME;
import static io.codibase.server.model.Agent.NAME_OS_ARCH;
import static io.codibase.server.model.Agent.NAME_OS_NAME;
import static io.codibase.server.model.Agent.NAME_OS_VERSION;
import static io.codibase.server.model.Agent.QUERY_FIELDS;
import static io.codibase.server.model.Agent.SORT_FIELDS;
...
import static io.codibase.server.search.entity.agent.AgentQueryParser.HasRunningBuilds;
import static io.codibase.server.search.entity.agent.AgentQueryParser.Is;
import static io.codibase.server.search.entity.agent.AgentQueryParser.IsNot;
import static io.codibase.server.search.entity.agent.AgentQueryParser.Offline;
import static io.codibase.server.search.entity.agent.AgentQueryParser.Online;
import static io.codibase.server.search.entity.agent.AgentQueryParser.Paused;
...
import io.codibase.server.search.entity.agent.AgentQueryParser.AndCriteriaContext;
import io.codibase.server.search.entity.agent.AgentQueryParser.CriteriaContext;
import io.codibase.server.search.entity.agent.AgentQueryParser.FieldOperatorValueCriteriaContext;
import io.codibase.server.search.entity.agent.AgentQueryParser.FuzzyCriteriaContext;
import io.codibase.server.search.entity.agent.AgentQueryParser.NotCriteriaContext;
import io.codibase.server.search.entity.agent.AgentQueryParser.OperatorCriteriaContext;
import io.codibase.server.search.entity.agent.AgentQueryParser.OperatorValueCriteriaContext;
import io.codibase.server.search.entity.agent.AgentQueryParser.OrCriteriaContext;
import io.codibase.server.search.entity.agent.AgentQueryParser.OrderContext;
import io.codibase.server.search.entity.agent.AgentQueryParser.ParensCriteriaContext;
import io.codibase.server.search.entity.agent.AgentQueryParser.QueryContext;
...
public class AgentQuery extends EntityQuery<Agent> {
	...
	public static void checkField(String fieldName, int operator) {
		var attributeNames = CodiBase.getInstance(AgentAttributeService.class).getAttributeNames();
