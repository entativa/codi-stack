...
import static io.codibase.server.security.SecurityUtils.getAuthUser;
...
public abstract class BoardCardPanel extends GenericPanel<Issue> {
		...
		add(ajaxBehavior = new AbstractPostAjaxBehavior() {
			...
			protected void respond(AjaxRequestTarget target) {
				if (canManageIssues(getProject())) {
					...
					Issue issue = CodiBase.getInstance(IssueService.class).load(issueId);
	...
	public void renderHead(IHeaderResponse response) {
		...
		String script = String.format("codibase.server.issueBoards.onCardDomReady('%s', %s);", 
