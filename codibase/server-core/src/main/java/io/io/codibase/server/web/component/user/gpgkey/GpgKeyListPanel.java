package io.codibase.server.web.component.user.gpgkey;
			...
			public void populateItem(Item<ICellPopulator<GpgKey>> cellItem, String componentId, 
				...
				fragment.add(new AjaxLink<Void>("delete") {
					...
					public void onClick(AjaxRequestTarget target) {
						...
						CodiBase.getInstance(GpgKeyService.class).delete(gpgKey);
						if (getPage() instanceof UserPage)
							CodiBase.getInstance(AuditService.class).audit(null, "deleted GPG key \"" + GpgUtils.getKeyIDString(gpgKey.getKeyId()) + "\" from account \"" + gpgKey.getOwner().getName() + "\"", null, null);
			...
			public IModel<GpgKey> model(GpgKey gpgKey) {
				...
				return new LoadableDetachableModel<GpgKey>() {
					...
					protected GpgKey load() {
						return CodiBase.getInstance(GpgKeyService.class).load(id);
					}
