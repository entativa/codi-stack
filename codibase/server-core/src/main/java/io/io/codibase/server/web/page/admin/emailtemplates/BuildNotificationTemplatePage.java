...
import static io.codibase.server.model.support.administration.emailtemplates.EmailTemplates.PROP_BUILD_NOTIFICATION;
...
public class BuildNotificationTemplatePage extends AbstractSimpleNotificationTemplatePage {
	...
	protected Map<String, String> getVariableHelp() {
		return CollectionUtils.newLinkedHashMap("build",
				_T("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Build.java' target='_blank'>build</a> object to be notified"));
	}
