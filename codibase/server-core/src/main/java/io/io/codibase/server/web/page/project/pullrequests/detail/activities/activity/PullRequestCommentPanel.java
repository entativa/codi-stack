...
import io.codibase.server.web.page.project.pullrequests.detail.activities.SinceChangesLink;
...
class PullRequestCommentPanel extends Panel {
	...
	private PullRequestCommentRevisionService getPullRequestCommentRevisionService() {
		return CodiBase.getInstance(PullRequestCommentRevisionService.class);
	}

	private PullRequestCommentService getPullRequestCommentService() {
		return CodiBase.getInstance(PullRequestCommentService.class);
	}

	private PullRequestCommentReactionService getPullRequestCommentReactionService() {
		return CodiBase.getInstance(PullRequestCommentReactionService.class);
	}
