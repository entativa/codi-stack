...
import io.codibase.commons.loader.ImplementationRegistry;
import io.codibase.server.CodiBase;
import io.codibase.server.model.AbstractEntity;
import io.codibase.server.rest.annotation.Api;
import io.codibase.server.rest.annotation.Immutable;
...
import static io.codibase.server.web.page.help.ValueInfo.Origin.CREATE_BODY;
import static io.codibase.server.web.page.help.ValueInfo.Origin.UPDATE_BODY;
	...
	public static List<Class<?>> getImplementations(Class<?> clazz) {
		...
		if (clazz == ContributedAdministrationSetting.class) {
			for (AdministrationSettingContribution contribution: 
					CodiBase.getExtensions(AdministrationSettingContribution.class)) {
			...
			implementations.addAll(CodiBase.getInstance(ImplementationRegistry.class).getImplementations(clazz));
		}
