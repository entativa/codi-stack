...
import io.codibase.server.web.behavior.InputChangeBehavior;
...
import static io.codibase.server.git.GitUtils.branch2ref;
import static io.codibase.server.git.GitUtils.tag2ref;
...
public abstract class RevisionSelector extends Panel {
	...
	public void renderHead(IHeaderResponse response) {
		...
		String script = String.format("codibase.server.revisionSelector.onDomReady('%s');", getMarkupId(true));
