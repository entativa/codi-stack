...
public class Translation_fr extends TranslationResourceBundle {
	...
	public static void init(Map<String, String> m) {
		...
		m.put("** Enterprise edition is disabled as the trial subscription was expired, order subscription to enable or contact support@codibase.io if you need to extend your trial **", 
			"** L'édition Enterprise est désactivée car l'abonnement d'essai a expiré, commandez un abonnement pour l'activer ou contactez support@codibase.io si vous avez besoin de prolonger votre essai **");
		...
		m.put("<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">user</a> to reset password for", 
			"<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">utilisateur</a> pour réinitialiser le mot de passe");
		m.put("<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">user</a> to verify email for", 
			"<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">utilisateur</a> pour vérifier l'email");
		m.put("<a href=\"https://guides.github.com/features/mastering-markdown/\" target=\"_blank\">GitHub flavored markdown</a> is accepted, with <a href=\"https://docs.codibase.io/appendix/markdown-syntax\" target=\"_blank\">mermaid and katex support</a>.", 
			"<a href=\"https://guides.github.com/features/mastering-markdown/\" target=\"_blank\">Markdown au format GitHub</a> est accepté, avec <a href=\"https://docs.codibase.io/appendix/markdown-syntax\" target=\"_blank\">support mermaid et katex</a>.");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/event/Event.java' target='_blank'>event object</a> triggering the notification", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/event/Event.java' target='_blank'>objet événement</a> déclenchant la notification");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Alert.java'>alert</a> to display", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Alert.java'>alerte</a> à afficher");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Stopwatch.java'>Stopwatch</a> overdue", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Stopwatch.java'>Chronomètre</a> en retard");
		...
		m.put("<b class='text-danger'>NOTE: </b> This requires an enterprise subscription. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>NOTE : </b> Cela nécessite un abonnement Enterprise. <a href='https://codibase.io/pricing' target='_blank'>Essayez gratuitement</a> pendant 30 jours");
		m.put("<b class='text-danger'>NOTE: </b> This step requires an enterprise subscription. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>NOTE : </b> Cette étape nécessite un abonnement Enterprise. <a href='https://codibase.io/pricing' target='_blank'>Essayez gratuitement</a> pendant 30 jours");
		m.put("<b class='text-danger'>NOTE: </b>SendGrid integration is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>NOTE : </b>L'intégration SendGrid est une fonctionnalité Enterprise. <a href='https://codibase.io/pricing' target='_blank'>Essayez gratuitement</a> pendant 30 jours");
		m.put("<b class='text-warning'>NOTE: </b><a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>Time tracking</a> is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-warning'>NOTE : </b><a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>Le suivi du temps</a> est une fonctionnalité Enterprise. <a href='https://codibase.io/pricing' target='_blank'>Essayez gratuitement</a> pendant 30 jours");
		...
		m.put("<b>Tips: </b> Type <tt>@</tt> to <a href='https://docs.codibase.io/appendix/job-variables' target='_blank' tabindex='-1'>insert variable</a>. Use <tt>@@</tt> for literal <tt>@</tt>", 
			"<b>Conseils : </b> Tapez <tt>@</tt> pour <a href='https://docs.codibase.io/appendix/job-variables' target='_blank' tabindex='-1'>insérer une variable</a>. Utilisez <tt>@@</tt> pour un <tt>@</tt> littéral");
		...
		m.put("Build statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Les statistiques de construction sont une fonctionnalité d'entreprise. <a href='https://codibase.io/pricing' target='_blank'>Essayez gratuitement</a> pendant 30 jours");
		m.put("Build version", "Version de construction");
		...
		m.put("Change property <code>serverUrl</code> in file <code>conf/agent.properties</code> if necessary. The default value is taken from CodiBase server url specified in <i>Administration / System Setting</i>", 
			"Modifiez la propriété <code>serverUrl</code> dans le fichier <code>conf/agent.properties</code> si nécessaire. La valeur par défaut est prise à partir de l'URL du serveur CodiBase spécifiée dans <i>Administration / Paramètres système</i>");
		...
		m.put("Check <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">agent management</a> for details, including instructions on how to run agent as service", 
			"Consultez <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">la gestion des agents</a> pour plus de détails, y compris les instructions sur la façon d'exécuter un agent en tant que service");
		m.put("Check <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">agent management</a> for details, including list of supported environment variables", 
			"Consultez <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">la gestion des agents</a> pour plus de détails, y compris la liste des variables d'environnement prises en charge");
		...
		m.put("Client ID of this CodiBase instance registered in Google cloud", "ID client de cette instance CodiBase enregistrée dans le cloud Google");
		m.put("Client Id", "ID client");
		m.put("Client Secret", "Secret client");
		m.put("Client secret of this CodiBase instance registered in Google cloud", "Secret client de cette instance CodiBase enregistrée dans le cloud Google");
		...
		m.put("Commits generated by CodiBase previously will be shown as unverified if this key is deleted. Type <code>yes</code> below if you want to continue.", 
			"Les commits générés précédemment par CodiBase seront affichés comme non vérifiés si cette clé est supprimée. Tapez <code>yes</code> ci-dessous si vous souhaitez continuer.");
		...
		m.put("Enable <a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>time tracking</a> for this project to track progress and generate timesheets", 
			"Activez <a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>le suivi du temps</a> pour ce projet afin de suivre les progrès et de générer des feuilles de temps");
		m.put("Enable <a href='https://docs.codibase.io/tutorials/package/working-with-packages' target='_blank'>package management</a> for this project", 
			"Activer la <a href='https://docs.codibase.io/tutorials/package/working-with-packages' target='_blank'>gestion des packages</a> pour ce projet");
		...
		m.put("Enable this to allow to run site publish step. CodiBase will serve project site files as is. To avoid XSS attack, make sure this executor can only be used by trusted jobs", 
			"Activer ceci pour permettre l'exécution de l'étape de publication du site. CodiBase servira les fichiers du site du projet tels quels. Pour éviter les attaques XSS, assurez-vous que cet exécuteur ne peut être utilisé que par des travaux de confiance");
		...
		m.put("Enable this to process issue or pull request comments posted via email. <b class='text-danger'>NOTE:</b> <a href='https://docs.microsoft.com/en-us/exchange/recipients-in-exchange-online/plus-addressing-in-exchange-online' target='_blank'>Sub addressing</a> needs to be enabled for system email address above, as CodiBase uses it to track issue and pull request contexts", 
			"Activer ceci pour traiter les commentaires sur les problèmes ou les demandes de tirage publiés par e-mail. <b class='text-danger'>REMARQUE :</b> <a href='https://docs.microsoft.com/en-us/exchange/recipients-in-exchange-online/plus-addressing-in-exchange-online' target='_blank'>Le sous-adressage</a> doit être activé pour l'adresse e-mail système ci-dessus, car CodiBase l'utilise pour suivre les contextes des problèmes et des demandes de tirage");
		m.put("Enable this to process issue or pull request comments posted via email. <b class='text-danger'>NOTE:</b> <a href='https://en.wikipedia.org/wiki/Email_address#Subaddressing' target='_blank'>Sub addressing</a> needs to be enabled for system email address above, as CodiBase uses it to track issue and pull request contexts", 
			"Activer ceci pour traiter les commentaires sur les problèmes ou les demandes de tirage publiés par e-mail. <b class='text-danger'>REMARQUE :</b> <a href='https://en.wikipedia.org/wiki/Email_address#Subaddressing' target='_blank'>Le sous-adressage</a> doit être activé pour l'adresse e-mail système ci-dessus, car CodiBase l'utilise pour suivre les contextes des problèmes et des demandes de tirage");
		...
		m.put("Environment variable <code>serverUrl</code> in above command is taken from CodiBase server url specified in <i>Administration / System Setting</i>. Change it if necessary", 
			"La variable d'environnement <code>serverUrl</code> dans la commande ci-dessus est tirée de l'URL du serveur CodiBase spécifiée dans <i>Administration / Paramètre système</i>. Modifiez-la si nécessaire");
		m.put("Equal", "Égal");
		...
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with create branch permission", 
			"Pour un commit de build non accessible depuis la branche par défaut, un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>secret de travail</a> doit être spécifié comme jeton d'accès avec la permission de créer une branche");
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with create tag permission", 
			"Pour un commit de build non accessible depuis la branche par défaut, un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>secret de travail</a> doit être spécifié comme jeton d'accès avec la permission de créer une balise");
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with manage issue permission", 
			"Pour un commit de build non accessible depuis la branche par défaut, un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>secret de travail</a> doit être spécifié comme jeton d'accès avec la permission de gérer les problèmes");
		m.put("For docker aware executors, this path is inside container, and accepts both absolute path and relative path (relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>). For shell related executors which runs on host machine directly, only relative path is accepted", 
			"Pour les exécuteurs compatibles avec Docker, ce chemin est à l'intérieur du conteneur et accepte à la fois les chemins absolus et relatifs (relatifs à <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>l'espace de travail du travail</a>). Pour les exécuteurs liés au shell qui s'exécutent directement sur la machine hôte, seuls les chemins relatifs sont acceptés");
		m.put("For each build, CodiBase calculates a list of fixed issues since previous build automatically. This setting provides a default query to further filter/order this list. For a given job, the first matching entry will be used.", 
			"Pour chaque build, CodiBase calcule automatiquement une liste de problèmes corrigés depuis le build précédent. Ce paramètre fournit une requête par défaut pour filtrer/ordonner davantage cette liste. Pour un travail donné, la première entrée correspondante sera utilisée.");
		...
		m.put("For web hooks defined here and in parent projects, CodiBase will post event data in JSON format to specified URLs when subscribed events happen", 
			"Pour les webhooks définis ici et dans les projets parents, CodiBase enverra les données d'événement au format JSON aux URL spécifiées lorsque les événements abonnés se produisent");
		m.put("Force", "Forcer");
		...
		m.put("GPG signing key will be used to sign commits generated by CodiBase, including pull request merge commits, user commits created via web UI or RESTful api.", 
			"La clé de signature GPG sera utilisée pour signer les commits générés par CodiBase, y compris les commits de fusion des demandes de tirage, les commits utilisateur créés via l'interface web ou l'API RESTful.");
		...
		m.put("Groovy script to be evaluated. It should return a <i>Date</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy à évaluer. Il doit retourner une valeur de type <i>Date</i>. Consultez <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>l'aide au script</a> pour plus de détails");
		m.put("Groovy script to be evaluated. It should return a <i>Float</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy à évaluer. Il doit retourner une valeur de type <i>Float</i>. Consultez <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>l'aide au script</a> pour plus de détails");
		m.put("Groovy script to be evaluated. It should return a <i>Integer</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy à évaluer. Il doit retourner une valeur de type <i>Integer</i>. Consultez <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>l'aide au script</a> pour plus de détails");
		m.put("Groovy script to be evaluated. It should return a <i>String</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy à évaluer. Il doit retourner une valeur de type <i>String</i>. Consultez <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>l'aide au script</a> pour plus de détails");
		m.put("Groovy script to be evaluated. It should return a <i>boolean</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy à évaluer. Il doit retourner une valeur de type <i>boolean</i>. Consultez <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>l'aide au script</a> pour plus de détails");
		m.put("Groovy script to be evaluated. It should return a <i>string</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy à évaluer. Il doit retourner une valeur de type <i>string</i>. Consultez <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>l'aide au script</a> pour plus de détails");
		m.put("Groovy script to be evaluated. It should return name of a group. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy à évaluer. Il doit retourner le nom d'un groupe. Consultez <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>l'aide au script</a> pour plus de détails");
		m.put("Groovy script to be evaluated. It should return string or list of string. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy à évaluer. Il doit retourner une chaîne ou une liste de chaînes. Consultez <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>l'aide au script</a> pour plus de détails");
		m.put("Groovy script to be evaluated. The return value should be a list of group facade object to be used as choices. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy à évaluer. La valeur retournée doit être une liste d'objets façade de groupe à utiliser comme choix. Consultez <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>l'aide au script</a> pour plus de détails");
		m.put("Groovy script to be evaluated. The return value should be a list of user login names to be used as choices. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy à évaluer. La valeur retournée doit être une liste de noms de connexion utilisateur à utiliser comme choix. Consultez <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>l'aide au script</a> pour plus de détails");
		...
		m.put("If specified, CodiBase will only display iterations with this prefix", "Si spécifié, CodiBase n'affichera que les itérations avec ce préfixe");
		...
		m.put("If this option is enabled, git lfs command needs to be installed on CodiBase server (even this step runs on other node)", 
			"Si cette option est activée, la commande git lfs doit être installée sur le serveur CodiBase (même si cette étape s'exécute sur un autre nœud)");
		...
		m.put("In case IMAP host certificate is self-signed or its CA root is not accepted, you may tell CodiBase to bypass certificate check. <b class='text-danger'>WARNING: </b> In an untrusted network, this may lead to man-in-the-middle attack, and you should <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>import the certificate into CodiBase</a> instead", 
			"Dans le cas où le certificat de l'hôte IMAP est auto-signé ou que sa racine CA n'est pas acceptée, vous pouvez demander à CodiBase de contourner la vérification du certificat. <b class='text-danger'>AVERTISSEMENT : </b> Dans un réseau non sécurisé, cela peut entraîner une attaque de type homme du milieu, et vous devriez plutôt <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>importer le certificat dans CodiBase</a>");
		...
		m.put("In case cache is not hit via above key, CodiBase will loop through load keys defined here in order until a matching cache is found in project hierarchy. A cache is considered matching if its key is prefixed with the load key. If multiple caches matches, the most recent cache will be returned", 
			"Dans le cas où le cache n'est pas trouvé via la clé ci-dessus, CodiBase parcourra les clés de chargement définies ici dans l'ordre jusqu'à ce qu'un cache correspondant soit trouvé dans la hiérarchie du projet. Un cache est considéré comme correspondant si sa clé est préfixée par la clé de chargement. Si plusieurs caches correspondent, le cache le plus récent sera retourné");
		...
		m.put("Interactive web shell access to running jobs is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"L'accès interactif à la console web pour les tâches en cours est une fonctionnalité d'entreprise. <a href='https://codibase.io/pricing' target='_blank'>Essayez gratuitement</a> pendant 30 jours");
		...
		m.put("Invalid state. Please make sure you are visiting CodiBase using server url specified in system setting", 
			"État invalide. Veuillez vous assurer que vous visitez CodiBase en utilisant l'URL du serveur spécifiée dans les paramètres système");
		...
		m.put("Issue statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Les statistiques des problèmes sont une fonctionnalité d'entreprise. <a href='https://codibase.io/pricing' target='_blank'>Essayez gratuitement</a> pendant 30 jours");
		...
		m.put("Login to CodiBase docker registry", "Connexion au registre docker de CodiBase");
		...
		m.put("No previous successful build on <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">same stream</a> to calculate fixed issues since", 
			"Aucune construction réussie précédente sur <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">le même flux</a> pour calculer les problèmes résolus depuis");
		...
		m.put("CodiBase Issue Field", "Champ de problème CodiBase");
		m.put("CodiBase Issue Link", "Lien de problème CodiBase");
		m.put("CodiBase Issue State", "État du problème CodiBase");
		...
		m.put("CodiBase needs to search and determine user DN, as well as searching user group information if group retrieval is enabled. Tick this option and specify 'manager' DN and password if these operations needs to be authenticated", 
			"CodiBase doit rechercher et déterminer le DN de l'utilisateur, ainsi que rechercher les informations de groupe de l'utilisateur si la récupération de groupe est activée. Cochez cette option et spécifiez le DN et le mot de passe du 'manager' si ces opérations doivent être authentifiées");
		m.put("CodiBase requires git command line to manage repositories. The minimum required version is 2.11.1. Also make sure that git-lfs is installed if you want to retrieve LFS files in build job", 
			"CodiBase nécessite la ligne de commande git pour gérer les dépôts. La version minimale requise est 2.11.1. Assurez-vous également que git-lfs est installé si vous souhaitez récupérer des fichiers LFS dans le job de construction");
		...
		m.put("OpenID client identification will be assigned by your OpenID provider when registering this CodiBase instance as client application", 
			"L'identification du client OpenID sera attribuée par votre fournisseur OpenID lors de l'enregistrement de cette instance CodiBase en tant qu'application cliente");
		m.put("OpenID client secret will be generated by your OpenID provider when registering this CodiBase instance as client application", 
			"Le secret du client OpenID sera généré par votre fournisseur OpenID lors de l'enregistrement de cette instance CodiBase en tant qu'application cliente");
		...
		m.put("Optionally specify <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as GitHub access token. This is used to retrieve release notes of dependencies hosted on GitHub, and the authenticated access will get a higher rate limit", 
			"Spécifiez éventuellement un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>secret de tâche</a> à utiliser comme jeton d'accès GitHub. Cela est utilisé pour récupérer les notes de version des dépendances hébergées sur GitHub, et l'accès authentifié bénéficiera d'une limite de taux plus élevée.");
		...
		m.put("Optionally specify Dockerfile relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Leave empty to use file <tt>Dockerfile</tt> under build path specified above", 
			"Spécifiez éventuellement le Dockerfile relatif à <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>l'espace de travail de la tâche</a>. Laissez vide pour utiliser le fichier <tt>Dockerfile</tt> sous le chemin de construction spécifié ci-dessus.");
		...
		m.put("Optionally specify a CodiBase project to be used as parent of imported projects. Leave empty to import as root projects", 
			"Spécifiez éventuellement un projet CodiBase à utiliser comme parent des projets importés. Laissez vide pour importer en tant que projets racine.");
		m.put("Optionally specify a CodiBase project to be used as parent of imported repositories. Leave empty to import as root projects", 
			"Spécifiez éventuellement un projet CodiBase à utiliser comme parent des dépôts importés. Laissez vide pour importer en tant que projets racine.");
		...
		m.put("Optionally specify a date field to hold due date information.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Spécifiez éventuellement un champ de date pour contenir les informations de date d'échéance.<br><b>NOTE : </b> Vous pouvez personnaliser les champs de problème CodiBase au cas où il n'y aurait pas d'option appropriée ici.");
		m.put("Optionally specify a path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to put retrieved artifacts. Leave empty to use job workspace itself", 
			"Spécifiez éventuellement un chemin relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail de la tâche</a> pour placer les artefacts récupérés. Laissez vide pour utiliser l'espace de travail de la tâche lui-même.");
		...
		m.put("Optionally specify a working period field to hold estimated time infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Spécifiez éventuellement un champ de période de travail pour contenir les informations de temps estimé.<br><b>NOTE : </b> Vous pouvez personnaliser les champs de problème CodiBase au cas où il n'y aurait pas d'option appropriée ici.");
		m.put("Optionally specify a working period field to hold spent time infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Spécifiez éventuellement un champ de période de travail pour contenir les informations de temps passé.<br><b>NOTE : </b> Vous pouvez personnaliser les champs de problème CodiBase au cas où il n'y aurait pas d'option appropriée ici.");
		m.put("Optionally specify a working period field to hold time estimate infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Spécifiez éventuellement un champ de période de travail pour contenir les informations d'estimation de temps.<br><b>NOTE : </b> Vous pouvez personnaliser les champs de problème CodiBase au cas où il n'y aurait pas d'option appropriée ici.");
		...
		m.put("Optionally specify artifacts to retrieve from the dependency into <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Only published artifacts (via artifact publish step) can be retrieved. Leave empty to not retrieve any artifacts", 
			"Spécifiez éventuellement des artefacts à récupérer de la dépendance dans <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail de la tâche</a>. Seuls les artefacts publiés (via l'étape de publication d'artefacts) peuvent être récupérés. Laissez vide pour ne récupérer aucun artefact.");
		...
		m.put("Optionally specify build path relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Leave empty to use job workspace itself", 
			"Spécifiez éventuellement le chemin de construction relatif à <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>l'espace de travail de la tâche</a>. Laissez vide pour utiliser l'espace de travail de la tâche lui-même.");
		...
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be used as trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/configuration/filtering/#by-finding-ids' target='_blank'>ignore file</a>", 
			"Spécifiez éventuellement le chemin relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail de la tâche</a> à utiliser comme fichier d'ignorance trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/configuration/filtering/#by-finding-ids' target='_blank'>ignore file</a>.");
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be used as trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/scanner/secret/#configuration' target='_blank'>secret config</a>", 
			"Spécifiez éventuellement le chemin relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail de la tâche</a> à utiliser comme fichier de configuration de secret trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/scanner/secret/#configuration' target='_blank'>secret config</a>.");
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to publish artifacts from. Leave empty to use job workspace itself", 
			"Spécifiez éventuellement le chemin relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail de la tâche</a> pour publier des artefacts. Laissez vide pour utiliser l'espace de travail de la tâche lui-même.");
		...
		m.put("Optionally specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to clone code into. Leave empty to use job workspace itself", 
			"Spécifiez éventuellement le chemin relatif sous <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail de la tâche</a> pour cloner le code. Laissez vide pour utiliser l'espace de travail de la tâche lui-même.");
		m.put("Optionally specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to scan. Leave empty to use job workspace itself", 
			"Spécifiez éventuellement le chemin relatif sous <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail de la tâche</a> pour analyser. Laissez vide pour utiliser l'espace de travail de la tâche lui-même.");
		...
		m.put("Optionally specify space-separated branches applicable for this transition. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all", 
			"Spécifiez éventuellement les branches séparées par des espaces applicables à cette transition. Utilisez '**', '*' ou '?' pour <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la correspondance de modèle de chemin</a>. Préfixez avec '-' pour exclure. Laissez vide pour correspondre à toutes.");
		m.put("Optionally specify space-separated branches applicable for this trigger. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty for default branch", 
			"Spécifiez éventuellement les branches séparées par des espaces applicables à ce déclencheur. Utilisez '**', '*' ou '?' pour <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la correspondance de modèle de chemin</a>. Préfixez avec '-' pour exclure. Laissez vide pour la branche par défaut.");
		m.put("Optionally specify space-separated branches to check. Use '**' or '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all branches", 
			"Spécifiez éventuellement les branches séparées par des espaces à vérifier. Utilisez '**' ou '*' ou '?' pour <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la correspondance de modèle de chemin</a>. Préfixez avec '-' pour exclure. Laissez vide pour correspondre à toutes les branches.");
		...
		m.put("Optionally specify space-separated files to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all files", 
			"Spécifiez éventuellement les fichiers séparés par des espaces à vérifier. Utilisez '**', '*' ou '?' pour <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la correspondance de modèle de chemin</a>. Préfixez avec '-' pour exclure. Laissez vide pour correspondre à tous les fichiers.");
		...
		m.put("Optionally specify space-separated projects to search in. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to search in all projects with code read permission", 
			"Spécifiez éventuellement les projets séparés par des espaces dans lesquels rechercher. Utilisez '**', '*' ou '?' pour <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la correspondance de modèle de chemin</a>. Préfixez avec '-' pour exclure. Laissez vide pour rechercher dans tous les projets avec permission de lecture de code.");
		...
		m.put("Optionally specify space-separated service images applicable for this locator. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all", 
			"Spécifiez éventuellement des images de service séparées par des espaces applicables à ce localisateur. Utilisez '**', '*' ou '?' pour <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>une correspondance avec des caractères génériques de chemin</a>. Préfixez avec '-' pour exclure. Laissez vide pour correspondre à tous");
		...
		m.put("Optionally specify space-separated tags to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all tags", 
			"Spécifiez éventuellement des balises séparées par des espaces à vérifier. Utilisez '**', '*' ou '?' pour <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>une correspondance avec des caractères génériques de chemin</a>. Préfixez avec '-' pour exclure. Laissez vide pour correspondre à toutes les balises");
		m.put("Optionally specify space-separated target branches of the pull requests to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all branches", 
			"Spécifiez éventuellement des branches cibles séparées par des espaces des demandes de tirage à vérifier. Utilisez '**', '*' ou '?' pour <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>une correspondance avec des caractères génériques de chemin</a>. Préfixez avec '-' pour exclure. Laissez vide pour correspondre à toutes les branches");
		...
		m.put("Parent CodiBase Project", "Projet parent CodiBase");
		...
		m.put("Projects need to be redistributed when cluster members are added/removed. CodiBase does not do this automatically as this is resource intensive, and you may only want to do it after cluster is finalized and stable.", 
			"Les projets doivent être redistribués lorsque des membres du cluster sont ajoutés/supprimés. CodiBase ne le fait pas automatiquement car cela demande beaucoup de ressources, et vous pourriez vouloir le faire uniquement après que le cluster soit finalisé et stable.");
		...
		m.put("Pull request statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Les statistiques des pull requests sont une fonctionnalité d'entreprise. <a href='https://codibase.io/pricing' target='_blank'>Essayez gratuitement</a> pendant 30 jours");
		...
		m.put("Refer to this <a href='https://docs.codibase.io/tutorials/security/sso-with-github' target='_blank'>tutorial</a> for an example setup", 
			"Consultez ce <a href='https://docs.codibase.io/tutorials/security/sso-with-github' target='_blank'>tutoriel</a> pour un exemple de configuration");
		m.put("Refer to this <a href='https://docs.codibase.io/tutorials/security/sso-with-okta' target='_blank'>tutorial</a> for an example setup", 
			"Consultez ce <a href='https://docs.codibase.io/tutorials/security/sso-with-okta' target='_blank'>tutoriel</a> pour un exemple de configuration");
		...
		m.put("Run specified docker container. <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job workspace</a> is mounted into the container and its path is placed in environment variable <code>CODIBASE_WORKSPACE</code>. <b class='text-warning'>Note: </b> this step can only be executed by server docker executor or remote docker executor", 
			"Exécutez le conteneur docker spécifié. <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>L'espace de travail du travail</a> est monté dans le conteneur et son chemin est placé dans la variable d'environnement <code>CODIBASE_WORKSPACE</code>. <b class='text-warning'>Remarque : </b> cette étape ne peut être exécutée que par un exécuteur docker serveur ou un exécuteur docker distant");
		...
		m.put("Set up job cache to speed up job execution. Check <a href='https://docs.codibase.io/tutorials/cicd/job-cache' target='_blank'>this tutorial</a> on how to use job cache", 
			"Configurer le cache de tâches pour accélérer l'exécution des tâches. Consultez <a href='https://docs.codibase.io/tutorials/cicd/job-cache' target='_blank'>ce tutoriel</a> pour savoir comment utiliser le cache de tâches.");
		...
		m.put("Signature verified successfully with CodiBase GPG key", "Signature vérifiée avec succès avec la clé GPG de CodiBase");
		...
		m.put("Specifies the attribute containing group name inside the found group LDAP entry. Value of this attribute will be mapped to a CodiBase group. This attribute is normally set to <i>cn</i>", 
			"Spécifie l'attribut contenant le nom du groupe dans l'entrée LDAP du groupe trouvé. La valeur de cet attribut sera mappée à un groupe CodiBase. Cet attribut est normalement défini sur <i>cn</i>");
		m.put("Specify .net TRX test result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>TestResults/*.trx</tt>. Use * or ? for pattern match", 
			"Spécifie le fichier de résultats de test .net TRX relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>, par exemple <tt>TestResults/*.trx</tt>. Utilisez * ou ? pour la correspondance de modèle");
		...
		m.put("Specify <a href='https://github.com/rust-lang/rust-clippy'>rust clippy</a> json output file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with clippy json output option, for instance <code>cargo clippy --message-format json>check-result.json</code>. Use * or ? for pattern match", 
			"Spécifie le fichier de sortie json <a href='https://github.com/rust-lang/rust-clippy'>rust clippy</a> relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>. Ce fichier peut être généré avec l'option de sortie json de clippy, par exemple <code>cargo clippy --message-format json>check-result.json</code>. Utilisez * ou ? pour la correspondance de modèle");
		...
		m.put("Specify CPD result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/cpd.xml</tt>. Use * or ? for pattern match", 
			"Spécifie le fichier xml de résultats CPD relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>, par exemple, <tt>target/cpd.xml</tt>. Utilisez * ou ? pour la correspondance de modèle");
		...
		m.put("Specify ESLint report file in checkstyle format under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with ESLint option <tt>'-f checkstyle'</tt> and <tt>'-o'</tt>. Use * or ? for pattern match", 
			"Spécifie le fichier de rapport ESLint au format checkstyle sous <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>. Ce fichier peut être généré avec l'option ESLint <tt>'-f checkstyle'</tt> et <tt>'-o'</tt>. Utilisez * ou ? pour la correspondance de modèle");
		...
		m.put("Specify JUnit test result file in XML format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>target/surefire-reports/TEST-*.xml</tt>. Use * or ? for pattern match", 
			"Spécifie le fichier de résultats de test JUnit au format XML relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>, par exemple <tt>target/surefire-reports/TEST-*.xml</tt>. Utilisez * ou ? pour la correspondance de modèle");
		m.put("Specify JaCoCo coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/jacoco/jacoco.xml</tt>. Use * or ? for pattern match", 
			"Spécifie le fichier de rapport de couverture xml JaCoCo relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>, par exemple, <tt>target/site/jacoco/jacoco.xml</tt>. Utilisez * ou ? pour la correspondance de modèle");
		m.put("Specify Jest coverage report file in clover format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>coverage/clover.xml</tt>. This file can be generated with Jest option <tt>'--coverage'</tt>. Use * or ? for pattern match", 
			"Spécifie le fichier de rapport de couverture Jest au format clover relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>, par exemple <tt>coverage/clover.xml</tt>. Ce fichier peut être généré avec l'option Jest <tt>'--coverage'</tt>. Utilisez * ou ? pour la correspondance de modèle");
		m.put("Specify Jest test result file in json format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated via Jest option <tt>'--json'</tt> and <tt>'--outputFile'</tt>. Use * or ? for pattern match", 
			"Spécifie le fichier de résultats de test Jest au format json relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>. Ce fichier peut être généré via l'option Jest <tt>'--json'</tt> et <tt>'--outputFile'</tt>. Utilisez * ou ? pour la correspondance de modèle");
		m.put("Specify OCI layout directory of the image to scan. This directory can be generated via build image step or pull image step. It should be relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Spécifie le répertoire de mise en page OCI de l'image à analyser. Ce répertoire peut être généré via l'étape de construction d'image ou l'étape de récupération d'image. Il doit être relatif à <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>l'espace de travail du job</a>");
		m.put("Specify OCI layout directory relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to push from", 
			"Spécifie le répertoire de mise en page OCI relatif à <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>l'espace de travail du job</a> à partir duquel effectuer le push");
		...
		m.put("Specify PMD result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/pmd.xml</tt>. Use * or ? for pattern match", 
			"Spécifie le fichier xml de résultats PMD relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>, par exemple, <tt>target/pmd.xml</tt>. Utilisez * ou ? pour la correspondance de modèle");
		...
		m.put("Specify Roslynator diagnostics output file in XML format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with <i>-o</i> option. Use * or ? for pattern match", 
			"Spécifie le fichier de sortie des diagnostics Roslynator au format XML relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>. Ce fichier peut être généré avec l'option <i>-o</i>. Utilisez * ou ? pour la correspondance de modèle");
		...
		m.put("Specify SpotBugs result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/spotbugsXml.xml</tt>. Use * or ? for pattern match", 
			"Spécifie le fichier xml de résultats SpotBugs relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>, par exemple, <tt>target/spotbugsXml.xml</tt>. Utilisez * ou ? pour la correspondance de modèle");
		...
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as SSH private key", 
			"Spécifie un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>secret de job</a> à utiliser comme clé privée SSH");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as access token", 
			"Spécifie un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>secret de job</a> à utiliser comme jeton d'accès");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as access token to import build spec from above project if its code is not publicly accessible", 
			"Spécifie un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>secret de job</a> à utiliser comme jeton d'accès pour importer la spécification de construction du projet ci-dessus si son code n'est pas accessible publiquement");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as password or access token of the registry", 
			"Spécifie un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>secret de job</a> à utiliser comme mot de passe ou jeton d'accès du registre");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as password or access token to access remote repository", 
			"Spécifie un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>secret de job</a> à utiliser comme mot de passe ou jeton d'accès pour accéder au dépôt distant");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as private key for SSH authentication. <b class='text-info'>NOTE:</b> Private key with passphrase is not supported", 
			"Spécifie un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>secret de job</a> à utiliser comme clé privée pour l'authentification SSH. <b class='text-info'>NOTE :</b> Les clés privées avec passphrase ne sont pas prises en charge");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as private key of above user for SSH authentication. <b class='text-info'>NOTE:</b> Private key with passphrase is not supported", 
			"Spécifie un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>secret de job</a> à utiliser comme clé privée de l'utilisateur ci-dessus pour l'authentification SSH. <b class='text-info'>NOTE :</b> Les clés privées avec passphrase ne sont pas prises en charge");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> whose value is an access token with management permission for above project. Note that access token is not required if sync to current or child project and build commit is reachable from default branch", 
			"Spécifie un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>secret de job</a> dont la valeur est un jeton d'accès avec la permission de gestion pour le projet ci-dessus. Notez que le jeton d'accès n'est pas requis si la synchronisation est effectuée vers le projet actuel ou un projet enfant et que le commit de construction est accessible depuis la branche par défaut");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> whose value is an access token with upload cache permission for above project. Note that this property is not required if upload cache to current or child project and build commit is reachable from default branch", 
			"Spécifie un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>secret de job</a> dont la valeur est un jeton d'accès avec la permission de téléchargement de cache pour le projet ci-dessus. Notez que cette propriété n'est pas requise si le téléchargement de cache est effectué vers le projet actuel ou un projet enfant et que le commit de construction est accessible depuis la branche par défaut");
		...
		m.put("Specify a file relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to write checksum into", 
			"Spécifie un fichier relatif à <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>l'espace de travail du job</a> pour écrire le checksum");
		m.put("Specify a multi-value user field to hold assignees information.<b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Spécifie un champ utilisateur multi-valeurs pour contenir les informations des assignés.<b>NOTE : </b> Vous pouvez personnaliser les champs de problème CodiBase si aucune option appropriée n'est disponible ici");
		m.put("Specify a multi-value user field to hold assignees information.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Spécifie un champ utilisateur multi-valeurs pour contenir les informations des assignés.<br><b>NOTE : </b> Vous pouvez personnaliser les champs de problème CodiBase si aucune option appropriée n'est disponible ici");
		...
		m.put("Specify absolute path to the kubectl utility, for instance: <i>/usr/bin/kubectl</i>. If left empty, CodiBase will try to find the utility from system path", 
			"Spécifie le chemin absolu vers l'utilitaire kubectl, par exemple : <i>/usr/bin/kubectl</i>. Si laissé vide, CodiBase essaiera de trouver l'utilitaire dans le chemin système");
		...
		m.put("Specify applicable projects for above option. Multiple projects should be separated by space. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty for all projects", 
			"Spécifie les projets applicables pour l'option ci-dessus. Plusieurs projets doivent être séparés par un espace. Utilisez '**', '*' ou '?' pour <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la correspondance de modèle de chemin</a>. Préfixez avec '-' pour exclure. Laissez vide pour tous les projets");
		m.put("Specify applicable projects separated by space. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty for all projects", 
			"Spécifie les projets applicables séparés par un espace. Utilisez '**', '*' ou '?' pour <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la correspondance de modèle de chemin</a>. Préfixez avec '-' pour exclure. Laissez vide pour tous les projets");
		...
		m.put("Specify artifacts to retrieve into <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Only published artifacts (via artifact publish step) can be retrieved.", 
			"Spécifie les artefacts à récupérer dans <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>. Seuls les artefacts publiés (via l'étape de publication d'artefacts) peuvent être récupérés.");
		m.put("Specify at least 10 alphanumeric chars to be used as secret, and then add an inbound parse entry at SendGrid side:<ul><li><code>Destination URL</code> should be set to <i>&lt;CodiBase root url&gt;/~sendgrid/&lt;secret&gt;</i>, for instance, <i>https://codibase.example.com/~sendgrid/1234567890</i>. Note that in production environment, <a href='https://docs.codibase.io/administration-guide/https-setup' target='_blank'>https should be enabled</a> to protect the secret</li><li><code>Receiving domain</code> should be the same as domain part of system email address specified above</li><li>Option <code>POST the raw, full MIME message</code> is enabled</li></ul>", 
			"Spécifie au moins 10 caractères alphanumériques à utiliser comme secret, puis ajoutez une entrée de parse inbound côté SendGrid :<ul><li><code>URL de destination</code> doit être défini sur <i>&lt;URL racine CodiBase&gt;/~sendgrid/&lt;secret&gt;</i>, par exemple, <i>https://codibase.example.com/~sendgrid/1234567890</i>. Notez qu'en environnement de production, <a href='https://docs.codibase.io/administration-guide/https-setup' target='_blank'>https doit être activé</a> pour protéger le secret</li><li><code>Domaine de réception</code> doit être le même que la partie domaine de l'adresse email système spécifiée ci-dessus</li><li>L'option <code>POST le message MIME brut et complet</code> est activée</li></ul>");
		...
		m.put("Specify clover coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/clover/clover.xml</tt>. Refer to <a href='https://openclover.org/documentation'>OpenClover documentation</a> on how to generate clover xml file. Use * or ? for pattern match", 
			"Spécifie le fichier de rapport de couverture xml clover relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>, par exemple, <tt>target/site/clover/clover.xml</tt>. Consultez la <a href='https://openclover.org/documentation'>documentation OpenClover</a> pour savoir comment générer le fichier xml clover. Utilisez * ou ? pour la correspondance de modèle");
		m.put("Specify cobertura coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/cobertura/coverage.xml</tt>. Use * or ? for pattern match", 
			"Spécifie le fichier de rapport de couverture xml cobertura relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>, par exemple, <tt>target/site/cobertura/coverage.xml</tt>. Utilisez * ou ? pour la correspondance de modèle");
		...
		m.put("Specify configuration discovery url of your OpenID provider, for instance: <code>https://openid.example.com/.well-known/openid-configuration</code>. Make sure to use HTTPS protocol as CodiBase relies on TLS encryption to ensure token validity", 
			"Spécifiez l'URL de découverte de configuration de votre fournisseur OpenID, par exemple : <code>https://openid.example.com/.well-known/openid-configuration</code>. Assurez-vous d'utiliser le protocole HTTPS car CodiBase s'appuie sur le chiffrement TLS pour garantir la validité des jetons");
		...
		m.put("Specify cppcheck xml result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with cppcheck xml output option, for instance <code>cppcheck src --xml 2>check-result.xml</code>. Use * or ? for pattern match", 
			"Spécifiez le fichier de résultats XML de cppcheck relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>. Ce fichier peut être généré avec l'option de sortie XML de cppcheck, par exemple <code>cppcheck src --xml 2>check-result.xml</code>. Utilisez * ou ? pour correspondre au modèle");
		...
		m.put("Specify directory relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to store OCI layout", 
			"Spécifiez le répertoire relatif à <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>l'espace de travail du job</a> pour stocker la disposition OCI");
		...
		m.put("Specify dockerx builder used to build docker image. CodiBase will create the builder automatically if it does not exist. Check <a href='https://docs.codibase.io/tutorials/cicd/insecure-docker-registry' target='_blank'>this tutorial</a> on how to customize the builder for instance to allow publishing to insecure registries", 
			"Spécifiez le builder dockerx utilisé pour construire l'image Docker. CodiBase créera automatiquement le builder s'il n'existe pas. Consultez <a href='https://docs.codibase.io/tutorials/cicd/insecure-docker-registry' target='_blank'>ce tutoriel</a> pour savoir comment personnaliser le builder, par exemple pour permettre la publication dans des registres non sécurisés");
		...
		m.put("Specify files relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be published. Use * or ? for pattern match", 
			"Spécifiez les fichiers relatifs à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a> à publier. Utilisez * ou ? pour correspondre au modèle");
		...
		m.put("Specify how to map GitHub issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Spécifiez comment mapper les étiquettes de problèmes GitHub aux champs personnalisés de CodiBase.<br><b>REMARQUE :</b> Vous pouvez personnaliser les champs de problèmes CodiBase au cas où aucune option appropriée ne serait disponible ici");
		m.put("Specify how to map GitLab issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Spécifiez comment mapper les étiquettes de problèmes GitLab aux champs personnalisés de CodiBase.<br><b>REMARQUE :</b> Vous pouvez personnaliser les champs de problèmes CodiBase au cas où aucune option appropriée ne serait disponible ici");
		m.put("Specify how to map Gitea issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Spécifiez comment mapper les étiquettes de problèmes Gitea aux champs personnalisés de CodiBase.<br><b>REMARQUE :</b> Vous pouvez personnaliser les champs de problèmes CodiBase au cas où aucune option appropriée ne serait disponible ici");
		m.put("Specify how to map JIRA issue priorities to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Spécifiez comment mapper les priorités des problèmes JIRA aux champs personnalisés de CodiBase.<br><b>REMARQUE :</b> Vous pouvez personnaliser les champs de problèmes CodiBase au cas où aucune option appropriée ne serait disponible ici");
		m.put("Specify how to map JIRA issue statuses to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Spécifiez comment mapper les statuts des problèmes JIRA aux champs personnalisés de CodiBase.<br><b>REMARQUE :</b> Vous pouvez personnaliser les états des problèmes CodiBase au cas où aucune option appropriée ne serait disponible ici");
		m.put("Specify how to map JIRA issue types to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Spécifiez comment mapper les types de problèmes JIRA aux champs personnalisés de CodiBase.<br><b>REMARQUE :</b> Vous pouvez personnaliser les champs de problèmes CodiBase au cas où aucune option appropriée ne serait disponible ici");
		m.put("Specify how to map YouTrack issue fields to CodiBase. Unmapped fields will be reflected in issue description.<br><b>Note: </b><ul><li>Enum field needs to be mapped in form of <tt>&lt;Field Name&gt;::&lt;Field Value&gt;</tt>, for instance <tt>Priority::Critical</tt><li>You may customize CodiBase issue fields in case there is no appropriate option here</ul>", 
			"Spécifiez comment mapper les champs des problèmes YouTrack à CodiBase. Les champs non mappés seront reflétés dans la description du problème.<br><b>Remarque :</b><ul><li>Un champ d'énumération doit être mappé sous la forme <tt>&lt;Nom du champ&gt;::&lt;Valeur du champ&gt;</tt>, par exemple <tt>Priorité::Critique</tt><li>Vous pouvez personnaliser les champs de problèmes CodiBase au cas où aucune option appropriée ne serait disponible ici</ul>");
		m.put("Specify how to map YouTrack issue links to CodiBase issue links.<br><b>NOTE: </b> You may customize CodiBase issue links in case there is no appropriate option here", 
			"Spécifiez comment mapper les liens des problèmes YouTrack aux liens des problèmes CodiBase.<br><b>REMARQUE :</b> Vous pouvez personnaliser les liens des problèmes CodiBase au cas où aucune option appropriée ne serait disponible ici");
		m.put("Specify how to map YouTrack issue state to CodiBase issue state. Unmapped states will use the initial state in CodiBase.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Spécifiez comment mapper l'état des problèmes YouTrack à l'état des problèmes CodiBase. Les états non mappés utiliseront l'état initial dans CodiBase.<br><b>REMARQUE :</b> Vous pouvez personnaliser les états des problèmes CodiBase au cas où aucune option appropriée ne serait disponible ici");
		m.put("Specify how to map YouTrack issue tags to CodiBase issue custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Spécifiez comment mapper les tags des problèmes YouTrack aux champs personnalisés des problèmes CodiBase.<br><b>REMARQUE :</b> Vous pouvez personnaliser les champs de problèmes CodiBase au cas où aucune option appropriée ne serait disponible ici");
		...
		m.put("Specify manager DN to authenticate CodiBase itself to Active Directory. The manager DN should be specified in form of <i>&lt;account name&gt;@&lt;domain&gt;</i>, for instance: <i>manager@example.com</i>", 
			"Spécifiez le DN du gestionnaire pour authentifier CodiBase lui-même auprès d'Active Directory. Le DN du gestionnaire doit être spécifié sous la forme <i>&lt;nom du compte&gt;@&lt;domaine&gt;</i>, par exemple : <i>manager@example.com</i>");
		m.put("Specify manager DN to authenticate CodiBase itself to LDAP server", "Spécifiez le DN du gestionnaire pour authentifier CodiBase lui-même auprès du serveur LDAP");
		m.put("Specify markdown file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be published", 
			"Spécifiez le fichier markdown relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a> à publier");
		...
		m.put("Specify mypy output file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated by redirecting mypy output <b>without option '--pretty'</b>, for instance <code>mypy --exclude=.git --exclude=.venv . > mypy-output</code>. Use * or ? for pattern match", 
			"Spécifiez le fichier de sortie mypy relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>. Ce fichier peut être généré en redirigeant la sortie de mypy <b>sans l'option '--pretty'</b>, par exemple <code>mypy --exclude=.git --exclude=.venv . > mypy-output</code>. Utilisez * ou ? pour correspondre au modèle");
		...
		m.put("Specify project to import into at CodiBase side", "Spécifiez le projet à importer dans le côté CodiBase");
		...
		m.put("Specify pylint json result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with pylint json output format option, for instance <code>--exit-zero --output-format=json:pylint-result.json</code>. Note that we do not fail pylint command upon violations, as this step will fail build based on configured threshold. Use * or ? for pattern match", 
			"Spécifiez le fichier de résultats JSON pylint relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>. Ce fichier peut être généré avec l'option de format de sortie JSON pylint, par exemple <code>--exit-zero --output-format=json:pylint-result.json</code>. Notez que nous ne faisons pas échouer la commande pylint en cas de violations, car cette étape échouera la construction en fonction du seuil configuré. Utilisez * ou ? pour correspondre au modèle");
		...
		m.put("Specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to store OCI layout", 
			"Spécifiez le chemin relatif sous <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>l'espace de travail du job</a> pour stocker la disposition OCI");
		...
		m.put("Specify ruff json result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with ruff json output format option, for instance <code>--exit-zero --output-format json --output-file ruff-result.json</code>. Note that we do not fail ruff command upon violations, as this step will fail build based on configured threshold. Use * or ? for pattern match", 
			"Spécifiez le fichier de résultats JSON ruff relatif à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>. Ce fichier peut être généré avec l'option de format de sortie JSON ruff, par exemple <code>--exit-zero --output-format json --output-file ruff-result.json</code>. Notez que nous ne faisons pas échouer la commande ruff en cas de violations, car cette étape échouera la construction en fonction du seuil configuré. Utilisez * ou ? pour correspondre au modèle");
		m.put("Specify shell commands (on Linux/Unix) or batch commands (on Windows) to execute under the <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Spécifiez les commandes shell (sur Linux/Unix) ou les commandes batch (sur Windows) à exécuter sous <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>l'espace de travail du job</a>");
		m.put("Specify shell commands to execute under the <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Spécifiez les commandes shell à exécuter sous <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>l'espace de travail du job</a>");
		...
		m.put("Specify space-separated branches to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Spécifiez les branches séparées par des espaces à protéger. Utilisez '**', '*' ou '?' pour une <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondance par wildcard de chemin</a>. Préfixez avec '-' pour exclure");
		...
		m.put("Specify space-separated paths to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Spécifiez les chemins séparés par des espaces à protéger. Utilisez '**', '*' ou '?' pour une <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondance par wildcard de chemin</a>. Préfixez avec '-' pour exclure");
		...
		m.put("Specify space-separated tags to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Spécifiez les tags séparés par des espaces à protéger. Utilisez '**', '*' ou '?' pour une <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondance par wildcard de chemin</a>. Préfixez avec '-' pour exclure");
		m.put("Specify start page of the report relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance: <tt>manual/index.md</tt>", 
			"Spécifiez la page de démarrage du rapport relative à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>, par exemple : <tt>manual/index.md</tt>");
		m.put("Specify start page of the report relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance: api/index.html", 
			"Spécifiez la page de démarrage du rapport relative à <a href='https://docs.codibase.io/concepts#job-workspace'>l'espace de travail du job</a>, par exemple : api/index.html");
		...
		m.put("Specify the strategy to retrieve group membership information. To give appropriate permissions to a LDAP group, a CodiBase group with same name should be defined. Use strategy <tt>Do Not Retrieve Groups</tt> if you want to manage group memberships at CodiBase side", 
			"Spécifiez la stratégie pour récupérer les informations d'appartenance au groupe. Pour attribuer des permissions appropriées à un groupe LDAP, un groupe CodiBase portant le même nom doit être défini. Utilisez la stratégie <tt>Ne pas récupérer les groupes</tt> si vous souhaitez gérer les appartenances aux groupes du côté de CodiBase");
		...
		m.put("Specify which issue state to use for closed GitHub issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Spécifiez l'état du problème à utiliser pour les problèmes GitHub fermés.<br><b>REMARQUE :</b> Vous pouvez personnaliser les états des problèmes CodiBase si aucune option appropriée n'est disponible ici");
		m.put("Specify which issue state to use for closed GitLab issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Spécifiez l'état du problème à utiliser pour les problèmes GitLab fermés.<br><b>REMARQUE :</b> Vous pouvez personnaliser les états des problèmes CodiBase si aucune option appropriée n'est disponible ici");
		m.put("Specify which issue state to use for closed Gitea issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Spécifiez l'état du problème à utiliser pour les problèmes Gitea fermés.<br><b>REMARQUE :</b> Vous pouvez personnaliser les états des problèmes CodiBase si aucune option appropriée n'est disponible ici");
		m.put("Specify which states are considered as closed for various issues created by Renovate to orchestrate dependency update. Additionally, when Renovate closes the issue, CodiBase will transit the issue to first state specified here", 
			"Spécifiez quels états sont considérés comme fermés pour divers problèmes créés par Renovate pour orchestrer la mise à jour des dépendances. De plus, lorsque Renovate ferme le problème, CodiBase fera passer le problème au premier état spécifié ici");
		...
		m.put("Steps will be executed serially on same node, sharing the same <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>", 
			"Les étapes seront exécutées séquentiellement sur le même nœud, partageant le même <a href='https://docs.codibase.io/concepts#job-workspace'>espace de travail du travail</a>");
		...
		m.put("The secret which allows you to ensure that POST requests sent to the payload URL are from CodiBase. When you set a secret you'll receive the X-CodiBase-Signature header in the webhook POST request", 
			"Le secret qui vous permet de garantir que les requêtes POST envoyées à l'URL de charge utile proviennent de CodiBase. Lorsque vous définissez un secret, vous recevrez l'en-tête X-CodiBase-Signature dans la requête POST du webhook");
		m.put("The service desk feature enables user to create issues by sending emails to CodiBase. Issues can be discussed over email completely, without the need of logging to CodiBase.", 
			"La fonctionnalité de service desk permet à l'utilisateur de créer des issues en envoyant des emails à CodiBase. Les issues peuvent être discutées entièrement par email, sans avoir besoin de se connecter à CodiBase.");
		...
		m.put("This executor runs build jobs as docker containers on CodiBase server", "Cet exécuteur exécute des tâches de construction en tant que conteneurs Docker sur le serveur CodiBase");
		...
		m.put("This executor runs build jobs with CodiBase server's shell facility.<br><b class='text-danger'>WARNING</b>: Jobs running with this executor has same permission as CodiBase server process. Make sure it can only be used by trusted jobs", 
			"Cet exécuteur exécute des travaux de construction avec la fonctionnalité shell du serveur CodiBase.<br><b class='text-danger'>AVERTISSEMENT</b> : Les travaux exécutés avec cet exécuteur ont les mêmes permissions que le processus du serveur CodiBase. Assurez-vous qu'il ne peut être utilisé que par des travaux de confiance");
		m.put("This executor runs build jobs with remote machines's shell facility via <a href='/~administration/agents' target='_blank'>agents</a><br><b class='text-danger'>WARNING</b>: Jobs running with this executor has same permission as CodiBase agent process. Make sure it can only be used by trusted jobs", 
			"Cet exécuteur exécute des travaux de construction avec la fonctionnalité shell des machines distantes via <a href='/~administration/agents' target='_blank'>agents</a><br><b class='text-danger'>AVERTISSEMENT</b> : Les travaux exécutés avec cet exécuteur ont les mêmes permissions que le processus de l'agent CodiBase. Assurez-vous qu'il ne peut être utilisé que par des travaux de confiance");
		...
		m.put("This installation does not have an active subscription and runs as community edition. To access <a href=\"https://codibase.io/pricing\">enterprise features</a>, an active subscription is required", 
			"Cette installation n'a pas d'abonnement actif et fonctionne en tant qu'édition communautaire. Pour accéder aux <a href=\"https://codibase.io/pricing\">fonctionnalités d'entreprise</a>, un abonnement actif est requis");
		...
		m.put("This is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Ceci est une fonctionnalité Enterprise. <a href='https://codibase.io/pricing' target='_blank'>Essayez gratuitement</a> pendant 30 jours");
		...
		m.put("This page lists changes since previous build on <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">same stream</a>", 
			"Cette page liste les changements depuis la construction précédente sur <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">le même flux</a>");
		...
		m.put("This server is currently accessed via http protocol, please configure your docker daemon or buildx builder to <a href=\"https://docs.codibase.io/tutorials/cicd/insecure-docker-registry\" target=\"_blank\">work with insecure registry</a>", 
			"Ce serveur est actuellement accessible via le protocole http, veuillez configurer votre démon Docker ou votre builder buildx pour <a href=\"https://docs.codibase.io/tutorials/cicd/insecure-docker-registry\" target=\"_blank\">travailler avec un registre non sécurisé</a>");
		...
		m.put("This step can only be executed by a docker aware executor. It runs under <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Cette étape ne peut être exécutée que par un exécuteur compatible avec Docker. Elle s'exécute sous <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>l'espace de travail de la tâche</a>");
		...
		m.put("This step publishes specified files to be served as project web site. Project web site can be accessed publicly via <code>http://&lt;codibase base url&gt;/path/to/project/~site</code>", 
			"Cette étape publie les fichiers spécifiés pour être servis comme site web du projet. Le site web du projet peut être accessible publiquement via <code>http://&lt;codibase base url&gt;/path/to/project/~site</code>");
		...
		m.put("This tab shows the pipeline containing current build. Check <a href=\"https://robinshen.medium.com/understanding-codibase-pipeline-db0bb0e54aa7\" target=\"_blank\">this article</a> to understand how build pipeline works", 
			"Cet onglet montre le pipeline contenant la construction actuelle. Consultez <a href=\"https://robinshen.medium.com/understanding-codibase-pipeline-db0bb0e54aa7\" target=\"_blank\">cet article</a> pour comprendre comment fonctionne le pipeline de construction");
		...
		m.put("Two-factor authentication is enabled. Please input passcode displayed on your TOTP authenticator. If you encounter problems, make sure time of CodiBase server and your device running TOTP authenticator is in sync", 
			"L'authentification à deux facteurs est activée. Veuillez entrer le code affiché sur votre authentificateur TOTP. En cas de problème, assurez-vous que l'heure du serveur CodiBase et de votre appareil exécutant l'authentificateur TOTP est synchronisée");
		...
		m.put("Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>", 
			"Utilisez '**', '*' ou '?' pour une <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondance générique de chemin</a>");
		m.put("Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Utilisez '**', '*' ou '?' pour une <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondance générique de chemin</a>. Préfixez avec '-' pour exclure");
		m.put("Use '**', '*', or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>", 
			"Utilisez '**', '*', ou '?' pour une <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondance générique de chemin</a>");
		...
		m.put("Use job token as user name so that CodiBase can know which build is ${permission.equals(\"write\")? \"deploying\": \"using\"} packages", 
			"Utiliser le jeton de travail comme nom d'utilisateur afin que CodiBase puisse savoir quel build est ${permission.equals(\"write\")? \"en train de déployer\": \"en train d'utiliser\"} des packages");
		m.put("Use job token to tell CodiBase the build publishing the package", "Utiliser le jeton de travail pour indiquer à CodiBase le build publiant le package");
		m.put("Use job token to tell CodiBase the build pushing the chart", "Utiliser le jeton de travail pour indiquer à CodiBase le build poussant le chart");
		m.put("Use job token to tell CodiBase the build pushing the package", "Utiliser le jeton de travail pour indiquer à CodiBase le build poussant le package");
		m.put("Use job token to tell CodiBase the build using the package", "Utiliser le jeton de travail pour indiquer à CodiBase le build utilisant le package");
		...
		m.put("When login via CodiBase's built-in form, submitted user credentials can be checked against authenticator defined here, besides the internal database", 
			"Lors de la connexion via le formulaire intégré de CodiBase, les informations d'identification de l'utilisateur soumises peuvent être vérifiées par rapport à l'authentificateur défini ici, en plus de la base de données interne");
		...
		m.put("Whether or not to create as a service account for task automation purpose. Service account does not have password and email addresses, and will not generate notifications for its activities. <b class='text-warning'>NOTE:</b> Service account is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Si le compte doit être créé comme un compte de service à des fins d'automatisation des tâches ou non. Le compte de service n'a pas de mot de passe ni d'adresses email, et ne générera pas de notifications pour ses activités. <b class='text-warning'>REMARQUE :</b> Le compte de service est une fonctionnalité d'entreprise. <a href='https://codibase.io/pricing' target='_blank'>Essayez gratuitement</a> pendant 30 jours");
		...
		m.put("Whether or not to fetch LFS objects if pull request is opened from a different project. If this option is enabled, git lfs command needs to be installed on CodiBase server", 
			"Si les objets LFS doivent être récupérés si la pull request est ouverte depuis un projet différent ou non. Si cette option est activée, la commande git lfs doit être installée sur le serveur CodiBase");
		...
		m.put("Whether or not to mount docker sock into job container to support docker operations in job commands<br><b class='text-danger'>WARNING</b>: Malicious jobs can take control of whole CodiBase by operating the mounted docker sock. Make sure this executor can only be used by trusted jobs if this option is enabled", 
			"Monter ou non le socket docker dans le conteneur de travail pour prendre en charge les opérations docker dans les commandes de travail<br><b class='text-danger'>AVERTISSEMENT</b> : Des travaux malveillants peuvent prendre le contrôle de l'ensemble de CodiBase en opérant sur le socket docker monté. Assurez-vous que cet exécuteur ne peut être utilisé que par des travaux de confiance si cette option est activée");
		...
		m.put("Whether or not to retrieve submodules. Refer to <a href='https://docs.codibase.io/tutorials/cicd/clone-submodules' target='_blank'>this tutorial</a> on how to set up clone credential above to retrieve submodules", 
			"Si les sous-modules doivent être récupérés ou non. Référez-vous à <a href='https://docs.codibase.io/tutorials/cicd/clone-submodules' target='_blank'>ce tutoriel</a> pour savoir comment configurer les identifiants de clonage ci-dessus pour récupérer les sous-modules");
		...
		m.put("[Reset Password] Please Reset Your CodiBase Password", "[Réinitialiser le mot de passe] Veuillez réinitialiser votre mot de passe CodiBase");
		...
		m.put("adding .codibase-buildspec.yml", "ajout de .codibase-buildspec.yml");
		...
		m.put("an <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/notification/Unsubscribable.java' target='_blank'>object</a> holding unsubscribe information.  A <code>null</code> value means that the notification can not be unsubscribed", 
			"un <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/notification/Unsubscribable.java' target='_blank'>objet</a> contenant des informations de désabonnement. Une valeur <code>null</code> signifie que la notification ne peut pas être désabonnée");
		...
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Build.java' target='_blank'>build</a> object to be notified", 
			"représente l'objet <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Build.java' target='_blank'>build</a> à notifier");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a> being opened via service desk", 
			"représente le <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>problème</a> ouvert via le service desk");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a> object to be notified", 
			"représente l'objet <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>problème</a> à notifier");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Pack.java' target='_blank'>package</a> object to be notified", 
			"représente l'objet <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Pack.java' target='_blank'>package</a> à notifier");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a> object to be notified", 
			"représente l'objet <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a> à notifier");
		...
		m.put("represents the unsubscribed <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a>", 
			"représente le <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>problème</a> désabonné");
		m.put("represents the unsubscribed <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a>", 
			"représente le <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a> désabonné");
		m.put("request to change", "demande de modification");
		m.put("root", "racine");
		m.put("root url of CodiBase server", "url racine du serveur CodiBase");
		m.put("run job", "exécuter le travail");
