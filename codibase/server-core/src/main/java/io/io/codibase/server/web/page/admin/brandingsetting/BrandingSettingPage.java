package io.codibase.server.web.page.admin.brandingsetting;
...
public class BrandingSettingPage extends AdministrationPage {
	...
	private static File getCustomLogoFile(boolean darkMode) {
		if (darkMode)
			return new File(CodiBase.getAssetsDir(), "logo-dark.png");
		else
			return new File(CodiBase.getAssetsDir(), "logo.png");			
	}
	...
	protected void onInitialize() {
		...
		form.add(new Link<Void>("useDefault") {
			...
			protected void onConfigure() {
				super.onConfigure();
				setVisible(!setting.getName().equals("CodiBase") 
