...
import static io.codibase.k8shelper.KubernetesHelper.checkStatus;
...
public class CodiBase extends AbstractPlugin implements Serializable, Runnable {
	
	private static final Logger logger = LoggerFactory.getLogger(CodiBase.class);
	...
	@Inject
	public CodiBase(Provider<JettyService> jettyLauncherProvider, TaskScheduler taskScheduler,
	...
	public String guessServerUrl() {
		String serviceHost = System.getenv("CODIBASE_SERVICE_HOST");
		if (serviceHost != null) {
	...
	public static CodiBase getInstance() {
		return AppLoader.getInstance(CodiBase.class);
	}
	...
	public Object writeReplace() throws ObjectStreamException {
		return new ManagedSerializedForm(CodiBase.class);
	}	
