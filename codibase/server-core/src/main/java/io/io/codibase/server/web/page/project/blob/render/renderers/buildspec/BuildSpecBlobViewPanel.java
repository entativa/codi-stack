...
import static io.codibase.server.web.page.project.blob.render.renderers.buildspec.BuildSpecRenderer.getPosition;
import static io.codibase.server.web.page.project.blob.render.renderers.buildspec.BuildSpecRenderer.getSelection;
				...
				add(new Fragment("content", "parseableFrag", this) {
					...
					private void setupJobsViewer(@Nullable AjaxRequestTarget target) {
						...
						jobsViewer.add(new Behavior() {
							...
							public void renderHead(Component component, IHeaderResponse response) {
								super.renderHead(component, response);
								response.render(OnDomReadyHeaderItem.forScript("codibase.server.buildSpec.onTabDomReady('.jobs');"));
							}
					...
					private void setupServicesViewer(@Nullable AjaxRequestTarget target) {
						...
						servicesViewer.add(new Behavior() {
							...
							public void renderHead(Component component, IHeaderResponse response) {
								super.renderHead(component, response);
								response.render(OnDomReadyHeaderItem.forScript("codibase.server.buildSpec.onTabDomReady('.services');"));
							}
					...
					private void setupStepTemplatesViewer(@Nullable AjaxRequestTarget target) {
						...
						templatesViewer.add(new Behavior() {
							...
							public void renderHead(Component component, IHeaderResponse response) {
								super.renderHead(component, response);
								response.render(OnDomReadyHeaderItem.forScript("codibase.server.buildSpec.onTabDomReady('.step-templates');"));
							}
