package io.codibase.server.web.page.admin.issuesetting.issuetemplate;
		...
		form.add(new AjaxButton("save") {
			...
			protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
				...
				if (editor.isValid()) {
					...
					CodiBase.getInstance(AuditService.class).audit(null, verb + " issue description template", oldAuditContent, newAuditContent);
					onSave(target);
				} else {
					target.add(form);
				}
