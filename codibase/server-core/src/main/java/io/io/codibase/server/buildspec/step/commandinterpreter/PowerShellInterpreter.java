...
import io.codibase.k8shelper.PowerShellFacade;
...
public class PowerShellInterpreter extends Interpreter {
	...
	@Editable(order=110, description="Specify PowerShell commands to execute "
			+ "under the <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>.<br>"
			+ "<b class='text-warning'>NOTE: </b> CodiBase checks exit code of the script to determine if step is successful. "
