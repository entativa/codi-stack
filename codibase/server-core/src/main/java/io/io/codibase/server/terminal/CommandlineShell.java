...
import io.codibase.commons.utils.ImmediateFuture;
import io.codibase.commons.utils.command.*;
import io.codibase.commons.utils.command.PtyMode.ResizeSupport;
...
public class CommandlineShell implements Shell {
	...
	public CommandlineShell(Terminal terminal, Commandline cmdline) {
        ...
        execution = CodiBase.getInstance(ExecutorService.class).submit(new Runnable() {
