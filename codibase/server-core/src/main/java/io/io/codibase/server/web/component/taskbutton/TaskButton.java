package io.codibase.server.web.component.taskbutton;
...
import io.codibase.commons.utils.WordUtils;
...
import io.codibase.server.job.log.StyleBuilder;
	...
	protected void updateAjaxAttributes(AjaxRequestAttributes attributes) {
		...
		attributes.getAjaxCallListeners().add(new IAjaxCallListener() {
			...
			public CharSequence getPrecondition(Component component) {
				return String.format("codibase.server.taskButtonFormDirty = $('#%s').closest('form').hasClass('dirty');",
						getMarkupId());
			}
			...
			public CharSequence getCompleteHandler(Component component) {
				return String.format(""
						+ "if (codibase.server.taskButtonFormDirty) "
						+ "  codibase.server.form.markDirty($('#%s').closest('form'));",
						getMarkupId());
			}
