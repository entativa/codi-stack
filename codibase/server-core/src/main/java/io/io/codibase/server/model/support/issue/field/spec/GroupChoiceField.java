package io.codibase.server.model.support.issue.field.spec;
...
import io.codibase.server.buildspecmodel.inputspec.groupchoiceinput.GroupChoiceInput;
import io.codibase.server.buildspecmodel.inputspec.groupchoiceinput.choiceprovider.AllGroups;
import io.codibase.server.buildspecmodel.inputspec.groupchoiceinput.choiceprovider.ChoiceProvider;
import io.codibase.server.buildspecmodel.inputspec.groupchoiceinput.defaultvalueprovider.DefaultValueProvider;
import io.codibase.server.buildspecmodel.inputspec.groupchoiceinput.defaultvalueprovider.SpecifiedDefaultValue;
...
public class GroupChoiceField extends FieldSpec {
	...
	private static boolean isSubscriptionActive() {
		return CodiBase.getInstance(SubscriptionService.class).isSubscriptionActive();
	}
