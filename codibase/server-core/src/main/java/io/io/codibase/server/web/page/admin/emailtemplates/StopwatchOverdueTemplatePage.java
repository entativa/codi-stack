...
import static io.codibase.server.model.support.administration.emailtemplates.EmailTemplates.DEFAULT_STOPWATCH_OVERDUE;
import static io.codibase.server.model.support.administration.emailtemplates.EmailTemplates.PROP_STOPWATCH_OVERDUE;
...
public class StopwatchOverdueTemplatePage extends AbstractTemplatePage {
	...
	protected Map<String, String> getVariableHelp() {
		return CollectionUtils.newLinkedHashMap(
				"stopwatch", _T("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Stopwatch.java'>Stopwatch</a> overdue"));
	}
