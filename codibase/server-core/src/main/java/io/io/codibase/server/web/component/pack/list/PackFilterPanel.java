package io.codibase.server.web.component.pack.list;

import static io.codibase.server.search.entity.pack.PackQueryLexer.Is;
...
import io.codibase.server.search.entity.pack.LabelCriteria;
import io.codibase.server.search.entity.pack.PackQueryLexer;
import io.codibase.server.search.entity.pack.PublishDateCriteria;
import io.codibase.server.search.entity.pack.PublishedByCriteria;
import io.codibase.server.search.entity.pack.PublishedByUserCriteria;
import io.codibase.server.search.entity.pack.PublishedViaProjectCriteria;
import io.codibase.server.search.entity.pack.TypeCriteria;
	...
	protected void onInitialize() {
        ...
        var typeChoice = new StringMultiChoice("type", new IModel<Collection<String>>() {
			...
			protected List<String> load() {
				var packSupports = new ArrayList<>(CodiBase.getExtensions(PackSupport.class));
