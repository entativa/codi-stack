...
import io.codibase.server.git.command.AdvertiseReceiveRefsCommand;
import io.codibase.server.git.command.AdvertiseUploadRefsCommand;
...
public class GitFilter implements Filter {
	...
	private final CodiBase codibase;
	...
	@Inject
	public GitFilter(CodiBase oneDev, ProjectService projectService, WorkExecutionService workExecutionService,
                     SessionService sessionService, ClusterService clusterService,
                     Set<CodePullAuthorizationSource> codePullAuthorizationSources) {
		this.codibase = oneDev;
