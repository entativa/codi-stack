...
import io.codibase.server.model.support.issue.changedata.IssueConfidentialChangeData;
import io.codibase.server.model.support.issue.changedata.IssueDescriptionChangeData;
import io.codibase.server.model.support.issue.changedata.IssueFieldChangeData;
import io.codibase.server.model.support.issue.changedata.IssueIterationAddData;
import io.codibase.server.model.support.issue.changedata.IssueIterationChangeData;
import io.codibase.server.model.support.issue.changedata.IssueIterationRemoveData;
import io.codibase.server.model.support.issue.changedata.IssueLinkAddData;
import io.codibase.server.model.support.issue.changedata.IssueLinkRemoveData;
...
import io.codibase.server.model.support.issue.changedata.IssueTitleChangeData;
...
import io.codibase.server.model.support.issue.transitionspec.BranchUpdatedSpec;
import io.codibase.server.model.support.issue.transitionspec.BuildSuccessfulSpec;
import io.codibase.server.model.support.issue.transitionspec.IssueStateTransitedSpec;
import io.codibase.server.model.support.issue.transitionspec.NoActivitySpec;
import io.codibase.server.model.support.issue.transitionspec.PullRequestDiscardedSpec;
import io.codibase.server.model.support.issue.transitionspec.PullRequestMergedSpec;
import io.codibase.server.model.support.issue.transitionspec.PullRequestOpenedSpec;
import io.codibase.server.model.support.issue.transitionspec.PullRequestSpec;
import io.codibase.server.model.support.issue.transitionspec.TransitionSpec;
...
import io.codibase.server.search.entity.issue.LastActivityDateCriteria;
...
public class DefaultIssueChangeService extends BaseEntityService<IssueChange>
	...
	private List<TransitionSpec> getTransitionSpecs() {
		return CodiBase.getInstance(SettingService.class).getIssueSetting().getTransitionSpecs();
	}
	...
	@Transactional
	@Listen
	public void on(io.codibase.server.event.project.pullrequest.PullRequestOpened event) {
		on(event.getRequest(), PullRequestOpenedSpec.class);
	}
