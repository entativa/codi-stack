package io.codibase.server.web.page.admin.authenticator;
...
public class AuthenticatorPage extends AdministrationPage {
	...
	protected void onInitialize() {
		...
		bean.setAuthenticator(CodiBase.getInstance(SettingService.class).getAuthenticator());
		...
		Button saveButton = new Button("save") {
			...
			public void onSubmit() {
				...
				CodiBase.getInstance(SettingService.class).saveAuthenticator(bean.getAuthenticator());
