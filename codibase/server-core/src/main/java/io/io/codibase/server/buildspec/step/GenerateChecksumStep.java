...
import io.codibase.server.buildspec.step.commandinterpreter.ShellInterpreter;
...
public class GenerateChecksumStep extends CommandStep {
	...
	@Editable(order=100, description = "Specify files to create md5 checksum from. Multiple files " +
			...
			"Non-absolute file is considered to be relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>")
	...
	@Editable(order=200, description = "Specify a file relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to write checksum into")
	@Interpolative(variableSuggester="suggestVariables")
	@NotEmpty
