...
import io.codibase.server.web.behavior.InterpolativePatternSetAssistBehavior;
    		        	...
    		        	return new StringPropertyEditor(componentId, descriptor, model).setInputAssist(
							...
							protected List<String> getHints(TerminalExpect terminalExpect) {
								return Lists.newArrayList(
										...
										patterns.path()? "Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude": "Use '*' or '?' for wildcard match. Prefix with '-' to exclude");
							}
