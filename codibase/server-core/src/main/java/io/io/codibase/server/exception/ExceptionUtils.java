...
public class ExceptionUtils extends io.codibase.commons.utils.ExceptionUtils {
	...
	public static HttpResponse buildResponse(Throwable exception) {
		...
		for (ExceptionHandler<? extends Throwable> handler: CodiBase.getExtensions(ExceptionHandler.class)) 
