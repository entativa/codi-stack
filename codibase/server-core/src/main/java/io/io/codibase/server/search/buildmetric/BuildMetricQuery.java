package io.codibase.server.search.buildmetric;
...
import static io.codibase.server.model.Build.*;
import static io.codibase.server.search.buildmetric.BuildMetricQueryParser.*;
...
public class BuildMetricQuery implements Serializable {
	...
	public static void checkField(Project project, String fieldName, int operator) {
		Collection<String> paramNames = CodiBase.getInstance(BuildParamService.class).getParamNames(null);
