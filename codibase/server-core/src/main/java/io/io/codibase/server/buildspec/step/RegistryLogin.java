...
public class RegistryLogin implements Serializable {
	...
	@Editable(order=300, description = "Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as password or access token of the registry")
