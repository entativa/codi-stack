package io.codibase.server.web.component.branch.choice;
...
public class BranchSingleChoice extends Select2Choice<String> {
	...
	protected void onInitialize() {
		...
		getSettings().setFormatResult("codibase.server.branchChoiceFormatter.formatResult");
		getSettings().setFormatSelection("codibase.server.branchChoiceFormatter.formatSelection");
		getSettings().setEscapeMarkup("codibase.server.branchChoiceFormatter.escapeMarkup");
