...
import io.codibase.server.util.PropertyChange;
import io.codibase.server.web.UrlService;
import io.codibase.server.web.asset.emoji.Emojis;
import io.codibase.server.web.asset.fieldcompare.FieldCompareCssResourceReference;
import io.codibase.server.web.component.codecomment.referencedfrom.ReferencedFromCodeCommentPanel;
import io.codibase.server.web.component.commit.info.CommitInfoPanel;
import io.codibase.server.web.component.issue.referencedfrom.ReferencedFromIssuePanel;
import io.codibase.server.web.component.pullrequest.referencedfrom.ReferencedFromPullRequestPanel;
...
public class ActivityDetail implements Serializable {
	...
	public static ActivityDetail referencedFrom(CodeComment comment) {
		String url = CodiBase.getInstance(UrlService.class).urlFor(comment, true);
	...
	public static ActivityDetail referencedFrom(Issue issue) {
		String url = CodiBase.getInstance(UrlService.class).urlFor(issue, true);
	...
	public static ActivityDetail referencedFrom(PullRequest request) {
		String url = CodiBase.getInstance(UrlService.class).urlFor(request, true);
		String htmlVersion = String.format("<div><a href='%s'>[%s] %s</a></div>", 
	...
	public static ActivityDetail referencedFrom(ProjectScopedCommit commit) {
		...
		String url = CodiBase.getInstance(UrlService.class).urlFor(commit.getProject(), commit.getCommitId(), true);
		String htmlVersion = String.format("<div><a href='%s'>[%s] %s</a></div>",
