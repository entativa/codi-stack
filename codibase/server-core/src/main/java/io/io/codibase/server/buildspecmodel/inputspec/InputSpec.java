...
public abstract class InputSpec implements Serializable {
	...
	public static Class<?> defineClass(String className, String description, Collection<? extends InputSpec> inputs) {
		...
		buffer.append("import io.codibase.server.annotation.*;\n");
		buffer.append("import io.codibase.util.*;\n");
		buffer.append("import io.codibase.server.util.*;\n");
		buffer.append("import io.codibase.server.util.facade.*;\n");
