...
import io.codibase.server.annotation.RegEx;
import io.codibase.server.buildspec.BuildSpec;
import io.codibase.server.buildspec.job.EnvVar;
...
@Editable(order=150, name="Run Docker Container", description="Run specified docker container. <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job workspace</a> "
		+ "is mounted into the container and its path is placed in environment variable <code>CODIBASE_WORKSPACE</code>. " +
