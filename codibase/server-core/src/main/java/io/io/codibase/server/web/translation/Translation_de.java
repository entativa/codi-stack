...
public class Translation_de extends TranslationResourceBundle {
	...
	public static void init(Map<String, String> m) {
		...
		m.put("** Enterprise edition is disabled as the trial subscription was expired, order subscription to enable or contact support@codibase.io if you need to extend your trial **", 
			"** Enterprise-Edition ist deaktiviert, da das Testabonnement abgelaufen ist. Bestellen Sie ein Abonnement, um es zu aktivieren, oder kontaktieren Sie support@codibase.io, wenn Sie Ihre Testphase verlängern möchten **");
		...
		m.put("<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">user</a> to reset password for", 
			"<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">Benutzer</a>, um das Passwort zurückzusetzen");
		m.put("<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">user</a> to verify email for", 
			"<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">Benutzer</a>, um die E-Mail zu verifizieren");
		m.put("<a href=\"https://guides.github.com/features/mastering-markdown/\" target=\"_blank\">GitHub flavored markdown</a> is accepted, with <a href=\"https://docs.codibase.io/appendix/markdown-syntax\" target=\"_blank\">mermaid and katex support</a>.", 
			"<a href=\"https://guides.github.com/features/mastering-markdown/\" target=\"_blank\">GitHub-flavored Markdown</a> wird akzeptiert, mit <a href=\"https://docs.codibase.io/appendix/markdown-syntax\" target=\"_blank\">Mermaid- und KaTeX-Unterstützung</a>.");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/event/Event.java' target='_blank'>event object</a> triggering the notification", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/event/Event.java' target='_blank'>Ereignisobjekt</a>, das die Benachrichtigung auslöst");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Alert.java'>alert</a> to display", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Alert.java'>Alarm</a> zur Anzeige");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Stopwatch.java'>Stopwatch</a> overdue", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Stopwatch.java'>Stoppuhr</a> überfällig");
		...
		m.put("<b class='text-danger'>NOTE: </b> This requires an enterprise subscription. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>HINWEIS: </b> Dies erfordert ein Enterprise-Abonnement. <a href='https://codibase.io/pricing' target='_blank'>30 Tage kostenlos testen</a>");
		m.put("<b class='text-danger'>NOTE: </b> This step requires an enterprise subscription. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>HINWEIS: </b> Dieser Schritt erfordert ein Enterprise-Abonnement. <a href='https://codibase.io/pricing' target='_blank'>30 Tage kostenlos testen</a>");
		m.put("<b class='text-danger'>NOTE: </b>SendGrid integration is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>HINWEIS: </b>SendGrid-Integration ist eine Enterprise-Funktion. <a href='https://codibase.io/pricing' target='_blank'>30 Tage kostenlos testen</a>");
		m.put("<b class='text-warning'>NOTE: </b><a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>Time tracking</a> is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-warning'>HINWEIS: </b><a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>Zeiterfassung</a> ist eine Enterprise-Funktion. <a href='https://codibase.io/pricing' target='_blank'>30 Tage kostenlos testen</a>");
		...
		m.put("<b>Tips: </b> Type <tt>@</tt> to <a href='https://docs.codibase.io/appendix/job-variables' target='_blank' tabindex='-1'>insert variable</a>. Use <tt>@@</tt> for literal <tt>@</tt>", 
			"<b>Tipps: </b> Geben Sie <tt>@</tt> ein, um <a href='https://docs.codibase.io/appendix/job-variables' target='_blank' tabindex='-1'>Variable einzufügen</a>. Verwenden Sie <tt>@@</tt> für ein literales <tt>@</tt>");
		...
		m.put("Build statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Build-Statistiken sind eine Enterprise-Funktion. <a href='https://codibase.io/pricing' target='_blank'>30 Tage kostenlos testen</a>");
		m.put("Build version", "Build-Version");
		...
		m.put("Change property <code>serverUrl</code> in file <code>conf/agent.properties</code> if necessary. The default value is taken from CodiBase server url specified in <i>Administration / System Setting</i>", 
			"Eigenschaft <code>serverUrl</code> in Datei <code>conf/agent.properties</code> bei Bedarf ändern. Der Standardwert wird aus der CodiBase-Server-URL übernommen, die unter <i>Administration / System Setting</i> angegeben ist");
		...
		m.put("Check <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">agent management</a> for details, including instructions on how to run agent as service", 
			"Sehen Sie sich <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">Agent-Verwaltung</a> für Details an, einschließlich Anweisungen, wie man Agent als Dienst ausführt");
		m.put("Check <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">agent management</a> for details, including list of supported environment variables", 
			"Sehen Sie sich <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">Agent-Verwaltung</a> für Details an, einschließlich Liste unterstützter Umgebungsvariablen");
		...
		m.put("Client ID of this CodiBase instance registered in Google cloud", "Client-ID dieser CodiBase-Instanz, die in der Google-Cloud registriert ist");
		m.put("Client Id", "Client-ID");
		m.put("Client Secret", "Client-Secret");
		m.put("Client secret of this CodiBase instance registered in Google cloud", "Client-Secret dieser CodiBase-Instanz, die in der Google-Cloud registriert ist");
		...
		m.put("Commits generated by CodiBase previously will be shown as unverified if this key is deleted. Type <code>yes</code> below if you want to continue.", 
			"Commits, die zuvor von CodiBase generiert wurden, werden als nicht verifiziert angezeigt, wenn dieser Schlüssel gelöscht wird. Geben Sie <code>yes</code> unten ein, wenn Sie fortfahren möchten.");
		...
		m.put("Enable <a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>time tracking</a> for this project to track progress and generate timesheets", 
			"Aktivieren Sie <a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>Zeiterfassung</a> für dieses Projekt, um Fortschritte zu verfolgen und Zeiterfassungen zu erstellen.");
		m.put("Enable <a href='https://docs.codibase.io/tutorials/package/working-with-packages' target='_blank'>package management</a> for this project", 
			"Aktivieren Sie <a href='https://docs.codibase.io/tutorials/package/working-with-packages' target='_blank'>Paketverwaltung</a> für dieses Projekt");
		...
		m.put("Enable this to allow to run site publish step. CodiBase will serve project site files as is. To avoid XSS attack, make sure this executor can only be used by trusted jobs", 
			"Aktivieren Sie dies, um den Site-Veröffentlichungsschritt auszuführen. CodiBase wird Projekt-Site-Dateien unverändert bereitstellen. Um XSS-Angriffe zu vermeiden, stellen Sie sicher, dass dieser Executor nur von vertrauenswürdigen Jobs verwendet werden kann");
		...
		m.put("Environment variable <code>serverUrl</code> in above command is taken from CodiBase server url specified in <i>Administration / System Setting</i>. Change it if necessary", 
			"Die Umgebungsvariable <code>serverUrl</code> im obigen Befehl wird aus der CodiBase-Server-URL übernommen, die in <i>Administration / System Setting</i> angegeben ist. Ändern Sie sie bei Bedarf");
		m.put("Equal", "Gleich");
		...
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with create branch permission", 
			"Für Build-Commit, der vom Standardzweig nicht erreichbar ist, sollte ein <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>Job-Geheimnis</a> als Zugriffstoken mit Berechtigung zum Erstellen von Zweigen angegeben werden");
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with create tag permission", 
			"Für Build-Commit, der vom Standardzweig nicht erreichbar ist, sollte ein <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>Job-Geheimnis</a> als Zugriffstoken mit Berechtigung zum Erstellen von Tags angegeben werden");
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with manage issue permission", 
			"Für Build-Commit, der vom Standardzweig nicht erreichbar ist, sollte ein <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>Job-Geheimnis</a> als Zugriffstoken mit Berechtigung zum Verwalten von Problemen angegeben werden");
		m.put("For docker aware executors, this path is inside container, and accepts both absolute path and relative path (relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>). For shell related executors which runs on host machine directly, only relative path is accepted", 
			"Für Docker-fähige Executor befindet sich dieser Pfad im Container und akzeptiert sowohl absolute als auch relative Pfade (relativ zu <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job-Arbeitsbereich</a>). Für Shell-bezogene Executor, die direkt auf der Host-Maschine laufen, werden nur relative Pfade akzeptiert");
		m.put("For each build, CodiBase calculates a list of fixed issues since previous build automatically. This setting provides a default query to further filter/order this list. For a given job, the first matching entry will be used.", 
			"Für jeden Build berechnet CodiBase automatisch eine Liste von behobenen Problemen seit dem vorherigen Build. Diese Einstellung bietet eine Standardabfrage, um diese Liste weiter zu filtern/zu ordnen. Für einen bestimmten Job wird der erste passende Eintrag verwendet.");
		...
		m.put("For web hooks defined here and in parent projects, CodiBase will post event data in JSON format to specified URLs when subscribed events happen", 
			"Für Webhooks, die hier und in übergeordneten Projekten definiert sind, sendet CodiBase Ereignisdaten im JSON-Format an die angegebenen URLs, wenn abonnierte Ereignisse auftreten");
		...
		m.put("GPG signing key will be used to sign commits generated by CodiBase, including pull request merge commits, user commits created via web UI or RESTful api.", 
			"GPG-Signaturschlüssel wird verwendet, um von CodiBase generierte Commits zu signieren, einschließlich Pull-Request-Merge-Commits, Benutzer-Commits, die über die Web-UI oder RESTful-API erstellt wurden.");
		...
		m.put("Groovy script to be evaluated. It should return a <i>Date</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Groovy-Skript zur Auswertung. Es sollte einen <i>Date</i>-Wert zurückgeben. Weitere Details finden Sie in der <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>Scripting-Hilfe</a>");
		m.put("Groovy script to be evaluated. It should return a <i>Float</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Groovy-Skript zur Auswertung. Es sollte einen <i>Float</i>-Wert zurückgeben. Weitere Details finden Sie in der <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>Scripting-Hilfe</a>");
		m.put("Groovy script to be evaluated. It should return a <i>Integer</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Groovy-Skript zur Auswertung. Es sollte einen <i>Integer</i>-Wert zurückgeben. Weitere Details finden Sie in der <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>Scripting-Hilfe</a>");
		m.put("Groovy script to be evaluated. It should return a <i>String</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Groovy-Skript zur Auswertung. Es sollte einen <i>String</i>-Wert zurückgeben. Weitere Details finden Sie in der <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>Scripting-Hilfe</a>");
		m.put("Groovy script to be evaluated. It should return a <i>boolean</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Groovy-Skript zur Auswertung. Es sollte einen <i>boolean</i>-Wert zurückgeben. Weitere Details finden Sie in der <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>Scripting-Hilfe</a>");
		m.put("Groovy script to be evaluated. It should return a <i>string</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Groovy-Skript zur Auswertung. Es sollte einen <i>string</i>-Wert zurückgeben. Weitere Details finden Sie in der <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>Scripting-Hilfe</a>");
		m.put("Groovy script to be evaluated. It should return name of a group. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Groovy-Skript zur Auswertung. Es sollte den Namen einer Gruppe zurückgeben. Weitere Details finden Sie in der <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>Scripting-Hilfe</a>");
		m.put("Groovy script to be evaluated. It should return string or list of string. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Groovy-Skript zur Auswertung. Es sollte einen String oder eine Liste von Strings zurückgeben. Weitere Details finden Sie in der <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>Scripting-Hilfe</a>");
		m.put("Groovy script to be evaluated. The return value should be a list of group facade object to be used as choices. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Groovy-Skript zur Auswertung. Der Rückgabewert sollte eine Liste von Gruppenfassadenobjekten sein, die als Auswahlmöglichkeiten verwendet werden. Weitere Details finden Sie in der <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>Scripting-Hilfe</a>");
		m.put("Groovy script to be evaluated. The return value should be a list of user login names to be used as choices. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Groovy-Skript zur Auswertung. Der Rückgabewert sollte eine Liste von Benutzeranmeldenamen sein, die als Auswahlmöglichkeiten verwendet werden. Weitere Details finden Sie in der <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>Scripting-Hilfe</a>");
		...
		m.put("If specified, CodiBase will only display iterations with this prefix", "Wenn angegeben, zeigt CodiBase nur Iterationen mit diesem Präfix an");
		...
		m.put("If this option is enabled, git lfs command needs to be installed on CodiBase server (even this step runs on other node)", 
			"Wenn diese Option aktiviert ist, muss der Befehl git lfs auf dem CodiBase-Server installiert sein (auch wenn dieser Schritt auf einem anderen Knoten ausgeführt wird)");
		...
		m.put("In case IMAP host certificate is self-signed or its CA root is not accepted, you may tell CodiBase to bypass certificate check. <b class='text-danger'>WARNING: </b> In an untrusted network, this may lead to man-in-the-middle attack, and you should <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>import the certificate into CodiBase</a> instead", 
			"Falls das IMAP-Host-Zertifikat selbstsigniert ist oder dessen CA-Root nicht akzeptiert wird, können Sie CodiBase anweisen, die Zertifikatsprüfung zu umgehen. <b class='text-danger'>WARNUNG: </b> In einem unzuverlässigen Netzwerk kann dies zu einem Man-in-the-Middle-Angriff führen, und Sie sollten stattdessen <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>das Zertifikat in CodiBase importieren</a>");
		m.put("In case SMTP host certificate is self-signed or its CA root is not accepted, you may tell CodiBase to bypass certificate check. <b class='text-danger'>WARNING: </b> In an untrusted network, this may lead to man-in-the-middle attack, and you should <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>import the certificate into CodiBase</a> instead", 
			"Falls das SMTP-Host-Zertifikat selbstsigniert ist oder dessen CA-Root nicht akzeptiert wird, können Sie CodiBase anweisen, die Zertifikatsprüfung zu umgehen. <b class='text-danger'>WARNUNG: </b> In einem unzuverlässigen Netzwerk kann dies zu einem Man-in-the-Middle-Angriff führen, und Sie sollten stattdessen <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>das Zertifikat in CodiBase importieren</a>");
		...
		m.put("In case cache is not hit via above key, CodiBase will loop through load keys defined here in order until a matching cache is found in project hierarchy. A cache is considered matching if its key is prefixed with the load key. If multiple caches matches, the most recent cache will be returned", 
			"Falls der Cache über den oben genannten Schlüssel nicht getroffen wird, wird CodiBase die hier definierten Lade-Schlüssel durchlaufen, bis ein passender Cache in der Projekt-Hierarchie gefunden wird. Ein Cache wird als passend angesehen, wenn sein Schlüssel mit dem Lade-Schlüssel beginnt. Wenn mehrere Caches passen, wird der neueste Cache zurückgegeben");
		...
		m.put("Interactive web shell access to running jobs is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Interaktiver Web-Shell-Zugriff auf laufende Jobs ist eine Enterprise-Funktion. <a href='https://codibase.io/pricing' target='_blank'>30 Tage kostenlos testen</a>");
		...
		m.put("Invalid state. Please make sure you are visiting CodiBase using server url specified in system setting", 
			"Ungültiger Zustand. Bitte stellen Sie sicher, dass Sie CodiBase über die in den Systemeinstellungen angegebene Server-URL besuchen");
		...
		m.put("Issue statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Problem-Statistiken sind eine Enterprise-Funktion. <a href='https://codibase.io/pricing' target='_blank'>30 Tage kostenlos testen</a>");
		...
		m.put("Login to CodiBase docker registry", "Anmelden beim CodiBase-Docker-Registry");
		...
		m.put("No previous successful build on <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">same stream</a> to calculate fixed issues since", 
			"Kein vorheriger erfolgreicher Build auf <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">dem gleichen Stream</a>, um behobene Issues seitdem zu berechnen");
		...
		m.put("CodiBase Issue Field", "CodiBase-Issue-Feld");
		m.put("CodiBase Issue Link", "CodiBase-Issue-Link");
		m.put("CodiBase Issue State", "CodiBase-Issue-Status");
		m.put("CodiBase analyzes repository files for code search, line statistics, and code contribution statistics. This setting tells which files should be analyzed, and expects space-separated <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path patterns</a>. A pattern can be excluded by prefixing with '-', for instance <code>-**/vendors/**</code> will exclude all files with vendors in path. <b>NOTE: </b> Changing this setting only affects new commits. To apply the change to history commits, please stop the server and delete folder <code>index</code> and <code>info/commit</code> under <a href='https://docs.codibase.io/concepts#project-storage' target='_blank'>project's storage directory</a>. The repository will be re-analyzed when server is started", 
			"CodiBase analysiert Repository-Dateien für Codesuche, Zeilenstatistiken und Code-Beitragsstatistiken. Diese Einstellung gibt an, welche Dateien analysiert werden sollen, und erwartet durch Leerzeichen getrennte <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>Pfad-Muster</a>. Ein Muster kann durch Voranstellen von '-' ausgeschlossen werden, beispielsweise <code>-**/vendors/**</code> schließt alle Dateien mit \"vendors\" im Pfad aus. <b>HINWEIS: </b> Änderungen dieser Einstellung betreffen nur neue Commits. Um die Änderung auf historische Commits anzuwenden, stoppen Sie bitte den Server und löschen Sie den Ordner <code>index</code> und <code>info/commit</code> im <a href='https://docs.codibase.io/concepts#project-storage' target='_blank'>Projekt-Speicherverzeichnis</a>. Das Repository wird neu analysiert, wenn der Server gestartet wird.");
		m.put("CodiBase configures git hooks to communicate with itself via curl", "CodiBase konfiguriert Git-Hooks, um über Curl mit sich selbst zu kommunizieren");
		m.put("CodiBase needs to search and determine user DN, as well as searching user group information if group retrieval is enabled. Tick this option and specify 'manager' DN and password if these operations needs to be authenticated", 
			"CodiBase muss Benutzer-DN suchen und bestimmen sowie Benutzergruppeninformationen abrufen, wenn die Gruppenabfrage aktiviert ist. Aktivieren Sie diese Option und geben Sie 'Manager'-DN und Passwort an, wenn diese Vorgänge authentifiziert werden müssen");
		m.put("CodiBase requires git command line to manage repositories. The minimum required version is 2.11.1. Also make sure that git-lfs is installed if you want to retrieve LFS files in build job", 
			"CodiBase benötigt die Git-Befehlszeile, um Repositories zu verwalten. Die minimal erforderliche Version ist 2.11.1. Stellen Sie außerdem sicher, dass Git-LFS installiert ist, wenn Sie LFS-Dateien im Build-Job abrufen möchten");
		m.put("Online", "Online");
		...
		m.put("OpenID client identification will be assigned by your OpenID provider when registering this CodiBase instance as client application", 
			"OpenID-Client-Identifikation wird von Ihrem OpenID-Anbieter zugewiesen, wenn Sie diese CodiBase-Instanz als Client-Anwendung registrieren");
		m.put("OpenID client secret will be generated by your OpenID provider when registering this CodiBase instance as client application", 
			"OpenID-Client-Secret wird von Ihrem OpenID-Anbieter generiert, wenn Sie diese CodiBase-Instanz als Client-Anwendung registrieren");
		...
		m.put("Optionally specify Dockerfile relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Leave empty to use file <tt>Dockerfile</tt> under build path specified above", 
			"Optional geben Sie die Dockerfile relativ zu <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job-Arbeitsbereich</a> an. Lassen Sie das Feld leer, um die Datei <tt>Dockerfile</tt> unter dem oben angegebenen Build-Pfad zu verwenden");
		...
		m.put("Optionally specify a CodiBase project to be used as parent of imported projects. Leave empty to import as root projects", 
			"Optional geben Sie ein CodiBase-Projekt an, das als übergeordnetes Projekt der importierten Projekte verwendet werden soll. Lassen Sie das Feld leer, um als Root-Projekte zu importieren");
		m.put("Optionally specify a CodiBase project to be used as parent of imported repositories. Leave empty to import as root projects", 
			"Optional geben Sie ein CodiBase-Projekt an, das als übergeordnetes Projekt der importierten Repositories verwendet werden soll. Lassen Sie das Feld leer, um als Root-Projekte zu importieren");
		...
		m.put("Optionally specify a cron expression to schedule database auto-backup. The cron expression format is <em>&lt;seconds&gt; &lt;minutes&gt; &lt;hours&gt; &lt;day-of-month&gt; &lt;month&gt; &lt;day-of-week&gt;</em>.For example, <em>0 0 1 * * ?</em> means 1:00am every day. For details of the format, refer to <a href='http://www.quartz-scheduler.org/documentation/quartz-2.3.0/tutorials/crontrigger.html#format' target='_blank'>Quartz tutorial</a>.The backup files will be placed into <em>db-backup</em> folder under CodiBase installation directory. In case multiple servers connect to form a cluster, auto-backup takes place on the <a href='https://docs.codibase.io/concepts#lead-server' target='_blank'>lead server</a>. Leave this property empty if you do not want to enable database auto backup.", 
			"Optional geben Sie einen Cron-Ausdruck an, um die automatische Datenbanksicherung zu planen. Das Cron-Ausdrucksformat ist <em>&lt;Sekunden&gt; &lt;Minuten&gt; &lt;Stunden&gt; &lt;Tag-des-Monats&gt; &lt;Monat&gt; &lt;Tag-der-Woche&gt;</em>. Zum Beispiel bedeutet <em>0 0 1 * * ?</em> 1:00 Uhr morgens jeden Tag. Einzelheiten zum Format finden Sie im <a href='http://www.quartz-scheduler.org/documentation/quartz-2.3.0/tutorials/crontrigger.html#format' target='_blank'>Quartz-Tutorial</a>. Die Sicherungsdateien werden im Ordner <em>db-backup</em> unter dem CodiBase-Installationsverzeichnis abgelegt. Wenn mehrere Server verbunden sind, um einen Cluster zu bilden, erfolgt die automatische Sicherung auf dem <a href='https://docs.codibase.io/concepts#lead-server' target='_blank'>Leitserver</a>. Lassen Sie diese Eigenschaft leer, wenn Sie die automatische Datenbanksicherung nicht aktivieren möchten.");
		m.put("Optionally specify a date field to hold due date information.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Optional geben Sie ein Datumsfeld an, um Informationen zum Fälligkeitsdatum zu speichern.<br><b>HINWEIS: </b> Sie können die CodiBase-Probleme-Felder anpassen, falls hier keine geeignete Option vorhanden ist");
		m.put("Optionally specify a path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to put retrieved artifacts. Leave empty to use job workspace itself", 
			"Optional geben Sie einen Pfad relativ zu <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, um abgerufene Artefakte abzulegen. Lassen Sie das Feld leer, um den Job-Arbeitsbereich selbst zu verwenden");
		...
		m.put("Optionally specify a working period field to hold estimated time infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Optional geben Sie ein Arbeitszeitfeld an, um geschätzte Zeitinformationen zu speichern.<br><b>HINWEIS: </b> Sie können die CodiBase-Probleme-Felder anpassen, falls hier keine geeignete Option vorhanden ist");
		m.put("Optionally specify a working period field to hold spent time infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Optional geben Sie ein Arbeitszeitfeld an, um aufgewendete Zeitinformationen zu speichern.<br><b>HINWEIS: </b> Sie können die CodiBase-Probleme-Felder anpassen, falls hier keine geeignete Option vorhanden ist");
		m.put("Optionally specify a working period field to hold time estimate infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Optional geben Sie ein Arbeitszeitfeld an, um Zeitabschätzungsinformationen zu speichern.<br><b>HINWEIS: </b> Sie können die CodiBase-Probleme-Felder anpassen, falls hier keine geeignete Option vorhanden ist");
		...
		m.put("Optionally specify artifacts to retrieve from the dependency into <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Only published artifacts (via artifact publish step) can be retrieved. Leave empty to not retrieve any artifacts", 
			"Optional geben Sie Artefakte an, die aus der Abhängigkeit in den <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> abgerufen werden sollen. Nur veröffentlichte Artefakte (über den Artefakt-Veröffentlichungsschritt) können abgerufen werden. Lassen Sie das Feld leer, um keine Artefakte abzurufen");
		...
		m.put("Optionally specify build context path relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Leave empty to use job workspace itself. The file <code>Dockerfile</code> is expected to exist in build context directory, unless you specify a different location with option <code>--dockerfile</code>", 
			"Optional geben Sie den Build-Kontextpfad relativ zu <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job-Arbeitsbereich</a> an. Lassen Sie das Feld leer, um den Job-Arbeitsbereich selbst zu verwenden. Die Datei <code>Dockerfile</code> wird im Build-Kontextverzeichnis erwartet, es sei denn, Sie geben einen anderen Speicherort mit der Option <code>--dockerfile</code> an");
		m.put("Optionally specify build path relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Leave empty to use job workspace itself", 
			"Optional geben Sie den Build-Pfad relativ zu <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job-Arbeitsbereich</a> an. Lassen Sie das Feld leer, um den Job-Arbeitsbereich selbst zu verwenden");
		...
		m.put("Optionally specify osv scanner <a href='https://google.github.io/osv-scanner/configuration/' target='_blank'>config file</a> under <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. You may ignore particular vulnerabilities via this file", 
			"Optional geben Sie die OSV-Scanner-<a href='https://google.github.io/osv-scanner/configuration/' target='_blank'>Konfigurationsdatei</a> unter <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job-Arbeitsbereich</a> an. Sie können bestimmte Schwachstellen über diese Datei ignorieren");
		...
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be used as trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/configuration/filtering/#by-finding-ids' target='_blank'>ignore file</a>", 
			"Optional geben Sie einen Pfad relativ zu <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, der als Trivy-<a href='https://aquasecurity.github.io/trivy/v0.50/docs/configuration/filtering/#by-finding-ids' target='_blank'>Ignore-Datei</a> verwendet werden soll");
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be used as trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/scanner/secret/#configuration' target='_blank'>secret config</a>", 
			"Optional geben Sie einen Pfad relativ zu <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, der als Trivy-<a href='https://aquasecurity.github.io/trivy/v0.50/docs/scanner/secret/#configuration' target='_blank'>Geheimnis-Konfiguration</a> verwendet werden soll");
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to publish artifacts from. Leave empty to use job workspace itself", 
			"Optional geben Sie einen Pfad relativ zu <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, um Artefakte zu veröffentlichen. Lassen Sie das Feld leer, um den Job-Arbeitsbereich selbst zu verwenden");
		...
		m.put("Optionally specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to clone code into. Leave empty to use job workspace itself", 
			"Optional geben Sie einen relativen Pfad unter <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, um Code zu klonen. Lassen Sie das Feld leer, um den Job-Arbeitsbereich selbst zu verwenden");
		m.put("Optionally specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to scan. Leave empty to use job workspace itself", 
			"Optional geben Sie einen relativen Pfad unter <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, um zu scannen. Lassen Sie das Feld leer, um den Job-Arbeitsbereich selbst zu verwenden");
		...
		m.put("Optionally specify space-separated branches applicable for this transition. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all", 
			"Optional geben Sie durch Leerzeichen getrennte Zweige an, die für diesen Übergang anwendbar sind. Verwenden Sie '**', '*' oder '?' für <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>Pfad-Wildcard-Abgleich</a>. Präfix mit '-' zum Ausschließen. Lassen Sie das Feld leer, um alle zu entsprechen");
		m.put("Optionally specify space-separated branches applicable for this trigger. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty for default branch", 
			"Optional geben Sie durch Leerzeichen getrennte Zweige an, die für diesen Trigger anwendbar sind. Verwenden Sie '**', '*' oder '?' für <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>Pfad-Wildcard-Abgleich</a>. Präfix mit '-' zum Ausschließen. Lassen Sie das Feld leer für den Standardzweig");
		m.put("Optionally specify space-separated branches to check. Use '**' or '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all branches", 
			"Optional geben Sie durch Leerzeichen getrennte Zweige an, die überprüft werden sollen. Verwenden Sie '**' oder '*' oder '?' für <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>Pfad-Wildcard-Abgleich</a>. Präfix mit '-' zum Ausschließen. Lassen Sie das Feld leer, um alle Zweige zu entsprechen");
		...
		m.put("Optionally specify space-separated files to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all files", 
			"Optional geben Sie durch Leerzeichen getrennte Dateien an, die überprüft werden sollen. Verwenden Sie '**', '*' oder '?' für <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>Pfad-Wildcard-Abgleich</a>. Präfix mit '-' zum Ausschließen. Lassen Sie das Feld leer, um alle Dateien zu entsprechen");
		...
		m.put("Optionally specify space-separated projects to search in. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to search in all projects with code read permission", 
			"Optional geben Sie durch Leerzeichen getrennte Projekte an, in denen gesucht werden soll. Verwenden Sie '**', '*' oder '?' für <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>Pfad-Wildcard-Abgleich</a>. Präfix mit '-' zum Ausschließen. Lassen Sie das Feld leer, um in allen Projekten mit Leseberechtigung für Code zu suchen");
		...
		m.put("Optionally specify space-separated service images applicable for this locator. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all", 
			"Optional geben Sie durch Leerzeichen getrennte Service-Images an, die für diesen Locator gelten. Verwenden Sie '**', '*' oder '?' für <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>Pfad-Platzhalter</a>. Mit '-' voranstellen, um auszuschließen. Leer lassen, um alle zuzuordnen");
		...
		m.put("Optionally specify space-separated tags to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all tags", 
			"Optional geben Sie durch Leerzeichen getrennte Tags an, die überprüft werden sollen. Verwenden Sie '**', '*' oder '?' für <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>Pfad-Platzhalter</a>. Mit '-' voranstellen, um auszuschließen. Leer lassen, um alle Tags zuzuordnen");
		m.put("Optionally specify space-separated target branches of the pull requests to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all branches", 
			"Optional geben Sie durch Leerzeichen getrennte Zielzweige der Pull-Requests an, die überprüft werden sollen. Verwenden Sie '**', '*' oder '?' für <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>Pfad-Platzhalter</a>. Mit '-' voranstellen, um auszuschließen. Leer lassen, um alle Zweige zuzuordnen");
		...
		m.put("Parent CodiBase Project", "Übergeordnetes CodiBase-Projekt");
		...
		m.put("Projects need to be redistributed when cluster members are added/removed. CodiBase does not do this automatically as this is resource intensive, and you may only want to do it after cluster is finalized and stable.", 
			"Projekte müssen neu verteilt werden, wenn Cluster-Mitglieder hinzugefügt/entfernt werden. CodiBase macht dies nicht automatisch, da dies ressourcenintensiv ist, und Sie möchten dies möglicherweise erst tun, nachdem der Cluster finalisiert und stabil ist.");
		...
		m.put("Pull request statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Statistiken zu Pull-Requests sind eine Enterprise-Funktion. <a href='https://codibase.io/pricing' target='_blank'>30 Tage kostenlos testen</a>");
		...
		m.put("Refer to this <a href='https://docs.codibase.io/tutorials/security/sso-with-github' target='_blank'>tutorial</a> for an example setup", 
			"Siehe dieses <a href='https://docs.codibase.io/tutorials/security/sso-with-github' target='_blank'>Tutorial</a> für ein Beispiel-Setup");
		m.put("Refer to this <a href='https://docs.codibase.io/tutorials/security/sso-with-okta' target='_blank'>tutorial</a> for an example setup", 
			"Siehe dieses <a href='https://docs.codibase.io/tutorials/security/sso-with-okta' target='_blank'>Tutorial</a> für ein Beispiel-Setup");
		...
		m.put("Run specified docker container. <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job workspace</a> is mounted into the container and its path is placed in environment variable <code>CODIBASE_WORKSPACE</code>. <b class='text-warning'>Note: </b> this step can only be executed by server docker executor or remote docker executor", 
			"Führen Sie den angegebenen Docker-Container aus. <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job-Arbeitsbereich</a> wird in den Container eingebunden und sein Pfad wird in der Umgebungsvariable <code>CODIBASE_WORKSPACE</code> platziert. <b class='text-warning'>Hinweis: </b> Dieser Schritt kann nur vom Server-Docker-Executor oder Remote-Docker-Executor ausgeführt werden");
		...
		m.put("Set up job cache to speed up job execution. Check <a href='https://docs.codibase.io/tutorials/cicd/job-cache' target='_blank'>this tutorial</a> on how to use job cache", 
			"Job-Cache einrichten, um die Ausführung von Jobs zu beschleunigen. Siehe <a href='https://docs.codibase.io/tutorials/cicd/job-cache' target='_blank'>dieses Tutorial</a>, wie man den Job-Cache verwendet.");
		...
		m.put("Signature verified successfully with CodiBase GPG key", "Signatur erfolgreich mit CodiBase GPG-Schlüssel verifiziert");
		...
		m.put("Specifies the attribute containing group name inside the found group LDAP entry. Value of this attribute will be mapped to a CodiBase group. This attribute is normally set to <i>cn</i>", 
			"Gibt das Attribut an, das den Gruppennamen innerhalb des gefundenen Gruppen-LDAP-Eintrags enthält. Der Wert dieses Attributs wird einer CodiBase-Gruppe zugeordnet. Dieses Attribut wird normalerweise auf <i>cn</i> gesetzt");
		m.put("Specify .net TRX test result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>TestResults/*.trx</tt>. Use * or ? for pattern match", 
			"Gibt die relative .net TRX-Testergebnisdatei zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, z. B. <tt>TestResults/*.trx</tt>. Verwenden Sie * oder ? für Musterabgleich");
		m.put("Specify <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> whose value is access token with code write permission over above projects. Commits, issues, and pull requests will also be created under name of the access token owner", 
			"Gibt ein <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>Job-Geheimnis</a> an, dessen Wert ein Zugriffstoken mit Schreibberechtigung für Code über die oben genannten Projekte ist. Commits, Issues und Pull-Requests werden auch unter dem Namen des Zugriffstoken-Besitzers erstellt");
		m.put("Specify <a href='https://github.com/rust-lang/rust-clippy'>rust clippy</a> json output file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with clippy json output option, for instance <code>cargo clippy --message-format json>check-result.json</code>. Use * or ? for pattern match", 
			"Gibt die relative <a href='https://github.com/rust-lang/rust-clippy'>Rust Clippy</a>-JSON-Ausgabedatei zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an. Diese Datei kann mit der Clippy-JSON-Ausgabeoption generiert werden, z. B. <code>cargo clippy --message-format json>check-result.json</code>. Verwenden Sie * oder ? für Musterabgleich");
		...
		m.put("Specify CPD result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/cpd.xml</tt>. Use * or ? for pattern match", 
			"Gibt die relative CPD-Ergebnis-XML-Datei zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, z. B. <tt>target/cpd.xml</tt>. Verwenden Sie * oder ? für Musterabgleich");
		...
		m.put("Specify ESLint report file in checkstyle format under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with ESLint option <tt>'-f checkstyle'</tt> and <tt>'-o'</tt>. Use * or ? for pattern match", 
			"Gibt die ESLint-Berichtsdatei im Checkstyle-Format unter <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an. Diese Datei kann mit der ESLint-Option <tt>'-f checkstyle'</tt> und <tt>'-o'</tt> generiert werden. Verwenden Sie * oder ? für Musterabgleich");
		...
		m.put("Specify GoogleTest XML result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This report can be generated with environment variable <tt>GTEST_OUTPUT</tt> when running tests, For instance, <code>export GTEST_OUTPUT=&quot;xml:gtest-result.xml&quot;</code>. Use * or ? for pattern match", 
			"Gibt die relative GoogleTest-XML-Ergebnisdatei zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an. Dieser Bericht kann mit der Umgebungsvariable <tt>GTEST_OUTPUT</tt> beim Testen generiert werden, z. B. <code>export GTEST_OUTPUT=&quot;xml:gtest-result.xml&quot;</code>. Verwenden Sie * oder ? für Musterabgleich");
		...
		m.put("Specify JUnit test result file in XML format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>target/surefire-reports/TEST-*.xml</tt>. Use * or ? for pattern match", 
			"Gibt die JUnit-Testergebnisdatei im XML-Format relativ zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, z. B. <tt>target/surefire-reports/TEST-*.xml</tt>. Verwenden Sie * oder ? für Musterabgleich");
		m.put("Specify JaCoCo coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/jacoco/jacoco.xml</tt>. Use * or ? for pattern match", 
			"Gibt die relative JaCoCo-Abdeckungs-XML-Berichtsdatei zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, z. B. <tt>target/site/jacoco/jacoco.xml</tt>. Verwenden Sie * oder ? für Musterabgleich");
		m.put("Specify Jest coverage report file in clover format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>coverage/clover.xml</tt>. This file can be generated with Jest option <tt>'--coverage'</tt>. Use * or ? for pattern match", 
			"Gibt die relative Jest-Abdeckungs-Berichtsdatei im Clover-Format zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, z. B. <tt>coverage/clover.xml</tt>. Diese Datei kann mit der Jest-Option <tt>'--coverage'</tt> generiert werden. Verwenden Sie * oder ? für Musterabgleich");
		m.put("Specify Jest test result file in json format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated via Jest option <tt>'--json'</tt> and <tt>'--outputFile'</tt>. Use * or ? for pattern match", 
			"Gibt die relative Jest-Testergebnisdatei im JSON-Format zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an. Diese Datei kann über die Jest-Option <tt>'--json'</tt> und <tt>'--outputFile'</tt> generiert werden. Verwenden Sie * oder ? für Musterabgleich");
		m.put("Specify OCI layout directory of the image to scan. This directory can be generated via build image step or pull image step. It should be relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Gibt das OCI-Layout-Verzeichnis des zu scannenden Images an. Dieses Verzeichnis kann über den Build-Image-Schritt oder den Pull-Image-Schritt generiert werden. Es sollte relativ zum <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job-Arbeitsbereich</a> sein");
		m.put("Specify OCI layout directory relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to push from", 
			"Gibt das relative OCI-Layout-Verzeichnis zum <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job-Arbeitsbereich</a> an, von dem aus gepusht werden soll");
		...
		m.put("Specify PMD result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/pmd.xml</tt>. Use * or ? for pattern match", 
			"Gibt die relative PMD-Ergebnis-XML-Datei zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, z. B. <tt>target/pmd.xml</tt>. Verwenden Sie * oder ? für Musterabgleich");
		...
		m.put("Specify Roslynator diagnostics output file in XML format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with <i>-o</i> option. Use * or ? for pattern match", 
			"Gibt die relative Roslynator-Diagnose-Ausgabedatei im XML-Format zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an. Diese Datei kann mit der Option <i>-o</i> generiert werden. Verwenden Sie * oder ? für Musterabgleich");
		...
		m.put("Specify SpotBugs result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/spotbugsXml.xml</tt>. Use * or ? for pattern match", 
			"Gibt die relative SpotBugs-Ergebnis-XML-Datei zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, z. B. <tt>target/spotbugsXml.xml</tt>. Verwenden Sie * oder ? für Musterabgleich");
		...
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as SSH private key", 
			"Gibt ein <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>Job-Geheimnis</a> an, das als privater SSH-Schlüssel verwendet werden soll");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as access token", 
			"Gibt ein <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>Job-Geheimnis</a> an, das als Zugriffstoken verwendet werden soll");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as access token to import build spec from above project if its code is not publicly accessible", 
			"Gibt ein <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>Job-Geheimnis</a> an, das als Zugriffstoken verwendet werden soll, um die Build-Spezifikation aus dem oben genannten Projekt zu importieren, falls dessen Code nicht öffentlich zugänglich ist");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as password or access token of the registry", 
			"Gibt ein <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>Job-Geheimnis</a> an, das als Passwort oder Zugriffstoken des Registrierungsdienstes verwendet werden soll");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as password or access token to access remote repository", 
			"Gibt ein <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>Job-Geheimnis</a> an, das als Passwort oder Zugriffstoken für den Zugriff auf das Remote-Repository verwendet werden soll");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as private key for SSH authentication. <b class='text-info'>NOTE:</b> Private key with passphrase is not supported", 
			"Gibt ein <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>Job-Geheimnis</a> an, das als privater Schlüssel für die SSH-Authentifizierung verwendet werden soll. <b class='text-info'>HINWEIS:</b> Privater Schlüssel mit Passphrase wird nicht unterstützt");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as private key of above user for SSH authentication. <b class='text-info'>NOTE:</b> Private key with passphrase is not supported", 
			"Gibt ein <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>Job-Geheimnis</a> an, das als privater Schlüssel des oben genannten Benutzers für die SSH-Authentifizierung verwendet werden soll. <b class='text-info'>HINWEIS:</b> Privater Schlüssel mit Passphrase wird nicht unterstützt");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> whose value is an access token with management permission for above project. Note that access token is not required if sync to current or child project and build commit is reachable from default branch", 
			"Gibt ein <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>Job-Geheimnis</a> an, dessen Wert ein Zugriffstoken mit Verwaltungsberechtigung für das oben genannte Projekt ist. Beachten Sie, dass das Zugriffstoken nicht erforderlich ist, wenn die Synchronisierung mit dem aktuellen oder einem untergeordneten Projekt erfolgt und der Build-Commit vom Standardbranch erreichbar ist");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> whose value is an access token with upload cache permission for above project. Note that this property is not required if upload cache to current or child project and build commit is reachable from default branch", 
			"Gibt ein <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>Job-Geheimnis</a> an, dessen Wert ein Zugriffstoken mit Berechtigung zum Hochladen von Cache für das oben genannte Projekt ist. Beachten Sie, dass diese Eigenschaft nicht erforderlich ist, wenn der Cache in das aktuelle oder ein untergeordnetes Projekt hochgeladen wird und der Build-Commit vom Standardbranch erreichbar ist");
		...
		m.put("Specify a file relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to write checksum into", 
			"Gibt eine Datei relativ zum <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job-Arbeitsbereich</a> an, in die die Prüfsumme geschrieben werden soll");
		m.put("Specify a multi-value user field to hold assignees information.<b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Gibt ein mehrwertiges Benutzerfeld an, um Informationen zu den Zuweisungen zu speichern.<b>HINWEIS: </b> Sie können die CodiBase-Issue-Felder anpassen, falls hier keine geeignete Option vorhanden ist");
		m.put("Specify a multi-value user field to hold assignees information.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Gibt ein mehrwertiges Benutzerfeld an, um Informationen zu den Zuweisungen zu speichern.<br><b>HINWEIS: </b> Sie können die CodiBase-Issue-Felder anpassen, falls hier keine geeignete Option vorhanden ist");
		...
		m.put("Specify absolute path to the kubectl utility, for instance: <i>/usr/bin/kubectl</i>. If left empty, CodiBase will try to find the utility from system path", 
			"Gibt den absoluten Pfad zum kubectl-Dienstprogramm an, z. B. <i>/usr/bin/kubectl</i>. Falls leer gelassen, versucht CodiBase, das Dienstprogramm aus dem Systempfad zu finden");
		...
		m.put("Specify applicable projects separated by space. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty for all projects", 
			"Gibt anwendbare Projekte durch Leerzeichen getrennt an. Verwenden Sie '**', '*' oder '?' für <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>Pfad-Wildcard-Abgleich</a>. Mit '-' vorangestellt, um auszuschließen. Lassen Sie das Feld leer für alle Projekte");
		...
		m.put("Specify artifacts to retrieve into <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Only published artifacts (via artifact publish step) can be retrieved.", 
			"Gibt Artefakte an, die in den <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> abgerufen werden sollen. Nur veröffentlichte Artefakte (über den Artefakt-Veröffentlichungsschritt) können abgerufen werden");
		m.put("Specify at least 10 alphanumeric chars to be used as secret, and then add an inbound parse entry at SendGrid side:<ul><li><code>Destination URL</code> should be set to <i>&lt;CodiBase root url&gt;/~sendgrid/&lt;secret&gt;</i>, for instance, <i>https://codibase.example.com/~sendgrid/1234567890</i>. Note that in production environment, <a href='https://docs.codibase.io/administration-guide/https-setup' target='_blank'>https should be enabled</a> to protect the secret</li><li><code>Receiving domain</code> should be the same as domain part of system email address specified above</li><li>Option <code>POST the raw, full MIME message</code> is enabled</li></ul>", 
			"Gibt mindestens 10 alphanumerische Zeichen an, die als Geheimnis verwendet werden sollen, und fügt dann einen eingehenden Parse-Eintrag auf der SendGrid-Seite hinzu:<ul><li><code>Destination URL</code> sollte auf <i>&lt;CodiBase root url&gt;/~sendgrid/&lt;secret&gt;</i> gesetzt werden, z. B. <i>https://codibase.example.com/~sendgrid/1234567890</i>. Beachten Sie, dass in einer Produktionsumgebung <a href='https://docs.codibase.io/administration-guide/https-setup' target='_blank'>HTTPS aktiviert sein sollte</a>, um das Geheimnis zu schützen</li><li><code>Receiving domain</code> sollte mit dem Domain-Teil der oben angegebenen System-E-Mail-Adresse übereinstimmen</li><li>Option <code>POST the raw, full MIME message</code> ist aktiviert</li></ul>");
		...
		m.put("Specify clover coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/clover/clover.xml</tt>. Refer to <a href='https://openclover.org/documentation'>OpenClover documentation</a> on how to generate clover xml file. Use * or ? for pattern match", 
			"Gibt die relative Clover-Abdeckungs-XML-Berichtsdatei zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, z. B. <tt>target/site/clover/clover.xml</tt>. Siehe <a href='https://openclover.org/documentation'>OpenClover-Dokumentation</a>, wie die Clover-XML-Datei generiert wird. Verwenden Sie * oder ? für Musterabgleich");
		m.put("Specify cobertura coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/cobertura/coverage.xml</tt>. Use * or ? for pattern match", 
			"Gibt die relative Cobertura-Abdeckungs-XML-Berichtsdatei zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, z. B. <tt>target/site/cobertura/coverage.xml</tt>. Verwenden Sie * oder ? für Musterabgleich");
		...
		m.put("Specify configuration discovery url of your OpenID provider, for instance: <code>https://openid.example.com/.well-known/openid-configuration</code>. Make sure to use HTTPS protocol as CodiBase relies on TLS encryption to ensure token validity", 
			"Geben Sie die Konfigurations-Discovery-URL Ihres OpenID-Anbieters an, beispielsweise: <code>https://openid.example.com/.well-known/openid-configuration</code>. Stellen Sie sicher, dass Sie das HTTPS-Protokoll verwenden, da CodiBase auf TLS-Verschlüsselung angewiesen ist, um die Token-Gültigkeit zu gewährleisten.");
		...
		m.put("Specify cppcheck xml result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with cppcheck xml output option, for instance <code>cppcheck src --xml 2>check-result.xml</code>. Use * or ? for pattern match", 
			"Geben Sie die cppcheck-XML-Ergebnisdatei relativ zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an. Diese Datei kann mit der cppcheck-XML-Ausgabeoption generiert werden, beispielsweise <code>cppcheck src --xml 2>check-result.xml</code>. Verwenden Sie * oder ? für Musterabgleich.");
		...
		m.put("Specify directory relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to store OCI layout", 
			"Geben Sie ein Verzeichnis relativ zum <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job-Arbeitsbereich</a> an, um das OCI-Layout zu speichern.");
		...
		m.put("Specify files relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be published. Use * or ? for pattern match", 
			"Geben Sie Dateien relativ zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, die veröffentlicht werden sollen. Verwenden Sie * oder ? für Musterabgleich.");
		...
		m.put("Specify how to map GitHub issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Geben Sie an, wie GitHub-Issue-Labels auf CodiBase-Benutzerdefinierte Felder abgebildet werden sollen.<br><b>HINWEIS: </b> Sie können CodiBase-Issue-Felder anpassen, falls hier keine geeignete Option vorhanden ist.");
		m.put("Specify how to map GitLab issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Geben Sie an, wie GitLab-Issue-Labels auf CodiBase-Benutzerdefinierte Felder abgebildet werden sollen.<br><b>HINWEIS: </b> Sie können CodiBase-Issue-Felder anpassen, falls hier keine geeignete Option vorhanden ist.");
		m.put("Specify how to map Gitea issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Geben Sie an, wie Gitea-Issue-Labels auf CodiBase-Benutzerdefinierte Felder abgebildet werden sollen.<br><b>HINWEIS: </b> Sie können CodiBase-Issue-Felder anpassen, falls hier keine geeignete Option vorhanden ist.");
		m.put("Specify how to map JIRA issue priorities to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Geben Sie an, wie JIRA-Issue-Prioritäten auf CodiBase-Benutzerdefinierte Felder abgebildet werden sollen.<br><b>HINWEIS: </b> Sie können CodiBase-Issue-Felder anpassen, falls hier keine geeignete Option vorhanden ist.");
		m.put("Specify how to map JIRA issue statuses to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Geben Sie an, wie JIRA-Issue-Status auf CodiBase-Benutzerdefinierte Felder abgebildet werden sollen.<br><b>HINWEIS: </b> Sie können CodiBase-Issue-Zustände anpassen, falls hier keine geeignete Option vorhanden ist.");
		m.put("Specify how to map JIRA issue types to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Geben Sie an, wie JIRA-Issue-Typen auf CodiBase-Benutzerdefinierte Felder abgebildet werden sollen.<br><b>HINWEIS: </b> Sie können CodiBase-Issue-Felder anpassen, falls hier keine geeignete Option vorhanden ist.");
		m.put("Specify how to map YouTrack issue fields to CodiBase. Unmapped fields will be reflected in issue description.<br><b>Note: </b><ul><li>Enum field needs to be mapped in form of <tt>&lt;Field Name&gt;::&lt;Field Value&gt;</tt>, for instance <tt>Priority::Critical</tt><li>You may customize CodiBase issue fields in case there is no appropriate option here</ul>", 
			"Geben Sie an, wie YouTrack-Issue-Felder auf CodiBase abgebildet werden sollen. Nicht abgebildete Felder werden in der Problembeschreibung reflektiert.<br><b>Hinweis: </b><ul><li>Enum-Felder müssen in der Form <tt>&lt;Field Name&gt;::&lt;Field Value&gt;</tt> abgebildet werden, beispielsweise <tt>Priority::Critical</tt><li>Sie können CodiBase-Issue-Felder anpassen, falls hier keine geeignete Option vorhanden ist</ul>.");
		m.put("Specify how to map YouTrack issue links to CodiBase issue links.<br><b>NOTE: </b> You may customize CodiBase issue links in case there is no appropriate option here", 
			"Geben Sie an, wie YouTrack-Issue-Links auf CodiBase-Issue-Links abgebildet werden sollen.<br><b>HINWEIS: </b> Sie können CodiBase-Issue-Links anpassen, falls hier keine geeignete Option vorhanden ist.");
		m.put("Specify how to map YouTrack issue state to CodiBase issue state. Unmapped states will use the initial state in CodiBase.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Geben Sie an, wie YouTrack-Issue-Zustände auf CodiBase-Issue-Zustände abgebildet werden sollen. Nicht abgebildete Zustände verwenden den Anfangszustand in CodiBase.<br><b>HINWEIS: </b> Sie können CodiBase-Issue-Zustände anpassen, falls hier keine geeignete Option vorhanden ist.");
		m.put("Specify how to map YouTrack issue tags to CodiBase issue custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Geben Sie an, wie YouTrack-Issue-Tags auf CodiBase-Benutzerdefinierte Felder abgebildet werden sollen.<br><b>HINWEIS: </b> Sie können CodiBase-Issue-Felder anpassen, falls hier keine geeignete Option vorhanden ist.");
		...
		m.put("Specify manager DN to authenticate CodiBase itself to Active Directory. The manager DN should be specified in form of <i>&lt;account name&gt;@&lt;domain&gt;</i>, for instance: <i>manager@example.com</i>", 
			"Geben Sie den Manager-DN an, um CodiBase selbst gegenüber Active Directory zu authentifizieren. Der Manager-DN sollte in der Form <i>&lt;account name&gt;@&lt;domain&gt;</i> angegeben werden, beispielsweise: <i>manager@example.com</i>.");
		m.put("Specify manager DN to authenticate CodiBase itself to LDAP server", "Geben Sie den Manager-DN an, um CodiBase selbst gegenüber dem LDAP-Server zu authentifizieren.");
		m.put("Specify markdown file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be published", 
			"Geben Sie die Markdown-Datei relativ zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, die veröffentlicht werden soll.");
		...
		m.put("Specify mypy output file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated by redirecting mypy output <b>without option '--pretty'</b>, for instance <code>mypy --exclude=.git --exclude=.venv . > mypy-output</code>. Use * or ? for pattern match", 
			"Geben Sie die mypy-Ausgabedatei relativ zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an. Diese Datei kann durch Umleitung der mypy-Ausgabe <b>ohne die Option '--pretty'</b> generiert werden, beispielsweise <code>mypy --exclude=.git --exclude=.venv . > mypy-output</code>. Verwenden Sie * oder ? für Musterabgleich.");
		...
		m.put("Specify project to import into at CodiBase side", "Geben Sie das Projekt an, in das auf der CodiBase-Seite importiert werden soll.");
		...
		m.put("Specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to store OCI layout", 
			"Geben Sie den relativen Pfad unter <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job-Arbeitsbereich</a> an, um das OCI-Layout zu speichern.");
		...
		m.put("Specify shell commands (on Linux/Unix) or batch commands (on Windows) to execute under the <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Geben Sie Shell-Befehle (auf Linux/Unix) oder Batch-Befehle (auf Windows) an, die unter dem <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job-Arbeitsbereich</a> ausgeführt werden sollen.");
		m.put("Specify shell commands to execute under the <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Geben Sie Shell-Befehle an, die unter dem <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job-Arbeitsbereich</a> ausgeführt werden sollen.");
		...
		m.put("Specify space-separated branches to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Geben Sie durch Leerzeichen getrennte Branches an, die geschützt werden sollen. Verwenden Sie '**', '*' oder '?' für <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>Pfad-Wildcard-Abgleich</a>. Präfix mit '-', um auszuschließen.");
		...
		m.put("Specify space-separated paths to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Geben Sie durch Leerzeichen getrennte Pfade an, die geschützt werden sollen. Verwenden Sie '**', '*' oder '?' für <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>Pfad-Wildcard-Abgleich</a>. Präfix mit '-', um auszuschließen.");
		...
		m.put("Specify space-separated tags to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Geben Sie durch Leerzeichen getrennte Tags an, die geschützt werden sollen. Verwenden Sie '**', '*' oder '?' für <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>Pfad-Wildcard-Abgleich</a>. Präfix mit '-', um auszuschließen.");
		m.put("Specify start page of the report relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance: <tt>manual/index.md</tt>", 
			"Geben Sie die Startseite des Berichts relativ zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, beispielsweise: <tt>manual/index.md</tt>.");
		m.put("Specify start page of the report relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance: api/index.html", 
			"Geben Sie die Startseite des Berichts relativ zum <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a> an, beispielsweise: api/index.html.");
		...
		m.put("Specify the strategy to retrieve group membership information. To give appropriate permissions to a LDAP group, a CodiBase group with same name should be defined. Use strategy <tt>Do Not Retrieve Groups</tt> if you want to manage group memberships at CodiBase side", 
			"Geben Sie die Strategie an, um Informationen zur Gruppenmitgliedschaft abzurufen. Um einer LDAP-Gruppe entsprechende Berechtigungen zu erteilen, sollte eine CodiBase-Gruppe mit demselben Namen definiert werden. Verwenden Sie die Strategie <tt>Gruppen nicht abrufen</tt>, wenn Sie die Gruppenmitgliedschaften auf der CodiBase-Seite verwalten möchten");
		...
		m.put("Specify which issue state to use for closed GitHub issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Geben Sie den Problemstatus an, der für geschlossene GitHub-Probleme verwendet werden soll.<br><b>HINWEIS: </b> Sie können die CodiBase-Problemstatus anpassen, falls hier keine geeignete Option vorhanden ist");
		m.put("Specify which issue state to use for closed GitLab issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Geben Sie den Problemstatus an, der für geschlossene GitLab-Probleme verwendet werden soll.<br><b>HINWEIS: </b> Sie können die CodiBase-Problemstatus anpassen, falls hier keine geeignete Option vorhanden ist");
		m.put("Specify which issue state to use for closed Gitea issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Geben Sie den Problemstatus an, der für geschlossene Gitea-Probleme verwendet werden soll.<br><b>HINWEIS: </b> Sie können die CodiBase-Problemstatus anpassen, falls hier keine geeignete Option vorhanden ist");
		m.put("Specify which states are considered as closed for various issues created by Renovate to orchestrate dependency update. Additionally, when Renovate closes the issue, CodiBase will transit the issue to first state specified here", 
			"Geben Sie an, welche Status als geschlossen für verschiedene Probleme betrachtet werden, die von Renovate zur Orchestrierung von Abhängigkeitsaktualisierungen erstellt wurden. Zusätzlich wird CodiBase das Problem in den ersten hier angegebenen Status versetzen, wenn Renovate das Problem schließt");
		...
		m.put("Steps will be executed serially on same node, sharing the same <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>", 
			"Schritte werden seriell auf demselben Knoten ausgeführt und teilen sich denselben <a href='https://docs.codibase.io/concepts#job-workspace'>Job-Arbeitsbereich</a>");
		...
		m.put("System email address defined in mail setting should be used as recipient of such email, and project name may be appended to this address using to indicate where to create issues. For instance, if system email address is specified as <tt>support@example.com</tt>, sending email to <tt>support+myproject@example.com</tt> will create issue in <tt>myproject</tt>. If project name is not appended, CodiBase will look up the project using project designation information below", 
			"Die in den Mail-Einstellungen definierte System-E-Mail-Adresse sollte als Empfänger solcher E-Mails verwendet werden, und der Projektname kann an diese Adresse angehängt werden, um anzugeben, wo Issues erstellt werden sollen. Wenn beispielsweise die System-E-Mail-Adresse als <tt>support@example.com</tt> angegeben ist, wird durch das Senden einer E-Mail an <tt>support+myproject@example.com</tt> ein Issue in <tt>myproject</tt> erstellt. Wenn der Projektname nicht angehängt wird, sucht CodiBase das Projekt anhand der unten angegebenen Projektbezeichnungsinformationen.");
		...
		m.put("The secret which allows you to ensure that POST requests sent to the payload URL are from CodiBase. When you set a secret you'll receive the X-CodiBase-Signature header in the webhook POST request", 
			"Das Geheimnis, mit dem Sie sicherstellen können, dass die an die Payload-URL gesendeten POST-Anfragen von CodiBase stammen. Wenn Sie ein Geheimnis festlegen, erhalten Sie den X-CodiBase-Signature-Header in der Webhook-POST-Anfrage");
		m.put("The service desk feature enables user to create issues by sending emails to CodiBase. Issues can be discussed over email completely, without the need of logging to CodiBase.", 
			"Die Service-Desk-Funktion ermöglicht es Benutzern, Issues zu erstellen, indem sie E-Mails an CodiBase senden. Issues können vollständig per E-Mail diskutiert werden, ohne dass eine Anmeldung bei CodiBase erforderlich ist.");
		...
		m.put("This executor runs build jobs as docker containers on CodiBase server", "Dieser Executor führt Build-Jobs als Docker-Container auf dem CodiBase-Server aus");
		...
		m.put("This executor runs build jobs with CodiBase server's shell facility.<br><b class='text-danger'>WARNING</b>: Jobs running with this executor has same permission as CodiBase server process. Make sure it can only be used by trusted jobs", 
			"Dieser Executor führt Build-Jobs mit der Shell-Funktionalität des CodiBase-Servers aus.<br><b class='text-danger'>WARNUNG</b>: Jobs, die mit diesem Executor ausgeführt werden, haben dieselben Berechtigungen wie der CodiBase-Serverprozess. Stellen Sie sicher, dass er nur von vertrauenswürdigen Jobs verwendet werden kann");
		...
		m.put("This installation does not have an active subscription and runs as community edition. To access <a href=\"https://codibase.io/pricing\">enterprise features</a>, an active subscription is required", 
			"Diese Installation hat kein aktives Abonnement und läuft als Community-Edition. Um auf <a href=\"https://codibase.io/pricing\">Enterprise-Funktionen</a> zuzugreifen, ist ein aktives Abonnement erforderlich");
		...
		m.put("This is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Dies ist eine Enterprise-Funktion. <a href='https://codibase.io/pricing' target='_blank'>30 Tage kostenlos testen</a>");
		...
		m.put("This page lists changes since previous build on <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">same stream</a>", 
			"Diese Seite listet Änderungen seit dem vorherigen Build auf <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">dem gleichen Stream</a> auf");
		...
		m.put("This server is currently accessed via http protocol, please configure your docker daemon or buildx builder to <a href=\"https://docs.codibase.io/tutorials/cicd/insecure-docker-registry\" target=\"_blank\">work with insecure registry</a>", 
			"Dieser Server wird derzeit über das HTTP-Protokoll aufgerufen. Bitte konfigurieren Sie Ihren Docker-Daemon oder Buildx-Builder, um <a href=\"https://docs.codibase.io/tutorials/cicd/insecure-docker-registry\" target=\"_blank\">mit einem unsicheren Registry</a> zu arbeiten");
		...
		m.put("This step can only be executed by a docker aware executor. It runs under <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Dieser Schritt kann nur von einem Docker-fähigen Executor ausgeführt werden. Er läuft unter <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job-Arbeitsbereich</a>");
		...
		m.put("This step publishes specified files to be served as project web site. Project web site can be accessed publicly via <code>http://&lt;codibase base url&gt;/path/to/project/~site</code>", 
			"Dieser Schritt veröffentlicht die angegebenen Dateien, um als Projekt-Webseite bereitgestellt zu werden. Die Projekt-Webseite kann öffentlich über <code>http://&lt;codibase base url&gt;/path/to/project/~site</code> aufgerufen werden");
		...
		m.put("This tab shows the pipeline containing current build. Check <a href=\"https://robinshen.medium.com/understanding-codibase-pipeline-db0bb0e54aa7\" target=\"_blank\">this article</a> to understand how build pipeline works", 
			"Dieser Tab zeigt die Pipeline, die den aktuellen Build enthält. Lesen Sie <a href=\"https://robinshen.medium.com/understanding-codibase-pipeline-db0bb0e54aa7\" target=\"_blank\">diesen Artikel</a>, um zu verstehen, wie die Build-Pipeline funktioniert");
		...
		m.put("Two-factor authentication is enabled. Please input passcode displayed on your TOTP authenticator. If you encounter problems, make sure time of CodiBase server and your device running TOTP authenticator is in sync", 
			"Zwei-Faktor-Authentifizierung ist aktiviert. Bitte geben Sie den Passcode ein, der auf Ihrem TOTP-Authenticator angezeigt wird. Wenn Sie Probleme haben, stellen Sie sicher, dass die Zeit des CodiBase-Servers und Ihres Geräts mit dem TOTP-Authenticator synchronisiert ist.");
		...
		m.put("Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>", 
			"Verwenden Sie '**', '*' oder '?' für <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>Pfad-Wildcard-Matching</a>");
		m.put("Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Verwenden Sie '**', '*' oder '?' für <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>Pfad-Wildcard-Matching</a>. Mit '-' voranstellen, um auszuschließen");
		m.put("Use '**', '*', or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>", 
			"Verwenden Sie '**', '*', oder '?' für <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>Pfad-Wildcard-Matching</a>");
		...
		m.put("Use job token as user name so that CodiBase can know which build is ${permission.equals(\"write\")? \"deploying\": \"using\"} packages", 
			"Verwenden Sie das Job-Token als Benutzernamen, damit CodiBase weiß, welcher Build ${permission.equals(\"write\")? \"bereitstellt\": \"verwendet\"} Pakete");
		m.put("Use job token to tell CodiBase the build publishing the package", "Verwenden Sie das Job-Token, um CodiBase den Build mitzuteilen, der das Paket veröffentlicht");
		m.put("Use job token to tell CodiBase the build pushing the chart", "Verwenden Sie das Job-Token, um CodiBase den Build mitzuteilen, der das Chart pusht");
		m.put("Use job token to tell CodiBase the build pushing the package", "Verwenden Sie das Job-Token, um CodiBase den Build mitzuteilen, der das Paket pusht");
		m.put("Use job token to tell CodiBase the build using the package", "Verwenden Sie das Job-Token, um CodiBase den Build mitzuteilen, der das Paket verwendet");
		...
		m.put("When login via CodiBase's built-in form, submitted user credentials can be checked against authenticator defined here, besides the internal database", 
			"Beim Login über das integrierte Formular von CodiBase können die eingegebenen Benutzeranmeldedaten zusätzlich zur internen Datenbank gegen den hier definierten Authenticator überprüft werden");
		...
		m.put("Whether or not to fetch LFS objects if pull request is opened from a different project. If this option is enabled, git lfs command needs to be installed on CodiBase server", 
			"Ob LFS-Objekte abgerufen werden sollen, wenn der Pull-Request von einem anderen Projekt geöffnet wird. Wenn diese Option aktiviert ist, muss der Git-LFS-Befehl auf dem CodiBase-Server installiert sein");
		...
		m.put("Whether or not to retrieve submodules. Refer to <a href='https://docs.codibase.io/tutorials/cicd/clone-submodules' target='_blank'>this tutorial</a> on how to set up clone credential above to retrieve submodules", 
			"Ob Untermodule abgerufen werden sollen oder nicht. Siehe <a href='https://docs.codibase.io/tutorials/cicd/clone-submodules' target='_blank'>dieses Tutorial</a>, wie Sie oben Anmeldeinformationen für das Klonen einrichten, um Untermodule abzurufen");
		...
		m.put("[Reset Password] Please Reset Your CodiBase Password", "[Passwort zurücksetzen] Bitte setzen Sie Ihr CodiBase-Passwort zurück");
		...
		m.put("adding .codibase-buildspec.yml", "Hinzufügen von .codibase-buildspec.yml");
		...
		m.put("an <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/notification/Unsubscribable.java' target='_blank'>object</a> holding unsubscribe information.  A <code>null</code> value means that the notification can not be unsubscribed", 
			"Ein <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/notification/Unsubscribable.java' target='_blank'>Objekt</a>, das Abmeldeinformationen enthält. Ein <code>null</code>-Wert bedeutet, dass die Benachrichtigung nicht abgemeldet werden kann");
		...
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Build.java' target='_blank'>build</a> object to be notified", 
			"repräsentiert das <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Build.java' target='_blank'>Build</a>-Objekt, das benachrichtigt werden soll");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a> being opened via service desk", 
			"repräsentiert das <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>Problem</a>, das über den Service Desk geöffnet wird");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a> object to be notified", 
			"repräsentiert das <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>Problem</a>-Objekt, das benachrichtigt werden soll");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Pack.java' target='_blank'>package</a> object to be notified", 
			"repräsentiert das <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Pack.java' target='_blank'>Paket</a>-Objekt, das benachrichtigt werden soll");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a> object to be notified", 
			"repräsentiert das <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>Pull-Request</a>-Objekt, das benachrichtigt werden soll");
		...
		m.put("represents the unsubscribed <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a>", 
			"repräsentiert das abgemeldete <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>Problem</a>");
		m.put("represents the unsubscribed <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a>", 
			"repräsentiert den abgemeldeten <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>Pull-Request</a>");
		m.put("request to change", "Anfrage zur Änderung");
		m.put("root", "Root");
		m.put("root url of CodiBase server", "Root-URL des CodiBase-Servers");
		m.put("run job", "Job ausführen");
