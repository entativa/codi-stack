package io.codibase.server.web.page.error;
...
import io.codibase.server.exception.ServerNotFoundException;
	...
	protected void onInitialize() {
		...
		if (serverNotFound) {
			container.add(new Link<Void>("home") {
				...
				@Override
				public void onClick() {
					CodiBase.getInstance(ProjectService.class).updateActiveServers();
