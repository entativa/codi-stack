...
import io.codibase.server.web.component.issue.editabletitle.IssueEditableTitlePanel;
import io.codibase.server.web.component.issue.operation.IssueOperationsPanel;
import io.codibase.server.web.component.issue.primary.IssuePrimaryPanel;
import io.codibase.server.web.component.issue.side.IssueSidePanel;
...
import io.codibase.server.web.page.project.issues.ProjectIssuesPage;
...
public abstract class IssueDetailPage extends ProjectIssuesPage implements InputContext {
	...
	private static final String KEY_SCROLL_TOP = "codibase.issue.scrollTop";
		...
		issueModel = new LoadableDetachableModel<Issue>() {
			...
			protected Issue load() {
				...
				if (issue == null) { 
					...
					CodiBase.getInstance(IssueLinkService.class).loadDeepLinks(issue);
		...
		RequestCycle.get().getListeners().add(new AbstractRequestCycleListener() {
			...
			public void onEndRequest(RequestCycle cycle) {
				if (SecurityUtils.getAuthUser() != null) 
					CodiBase.getInstance(VisitInfoService.class).visitIssue(SecurityUtils.getAuthUser(), getIssue());
			}
	...
	public void renderHead(IHeaderResponse response) {
		...
		response.render(OnDomReadyHeaderItem.forScript(String.format( "codibase.server.issueDetail.onDomReady('%s');", KEY_SCROLL_TOP)));
	}
