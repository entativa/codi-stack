...
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryLexer.Is;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryLexer.IsSince;
import static io.codibase.server.search.entity.pullrequest.PullRequestQueryLexer.IsUntil;
...
import io.codibase.server.search.entity.pullrequest.AssignedToCriteria;
import io.codibase.server.search.entity.pullrequest.AssignedToUserCriteria;
import io.codibase.server.search.entity.pullrequest.DiscardedCriteria;
import io.codibase.server.search.entity.pullrequest.LabelCriteria;
import io.codibase.server.search.entity.pullrequest.LastActivityDateCriteria;
import io.codibase.server.search.entity.pullrequest.MergedCriteria;
import io.codibase.server.search.entity.pullrequest.OpenCriteria;
import io.codibase.server.search.entity.pullrequest.StatusCriteria;
import io.codibase.server.search.entity.pullrequest.SubmittedByCriteria;
import io.codibase.server.search.entity.pullrequest.SubmittedByUserCriteria;
import io.codibase.server.util.DateUtils;
import io.codibase.server.util.criteria.Criteria;
import io.codibase.server.web.component.datepicker.DatePicker;
import io.codibase.server.web.component.filteredit.FilterEditPanel;
import io.codibase.server.web.component.stringchoice.StringMultiChoice;
import io.codibase.server.web.component.user.choice.UserMultiChoice;
