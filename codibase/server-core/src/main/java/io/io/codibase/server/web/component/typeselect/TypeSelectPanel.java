package io.codibase.server.web.component.typeselect;

import static io.codibase.server.util.HtmlUtils.getText;
import static io.codibase.server.web.editable.EditableUtils.getDescription;
