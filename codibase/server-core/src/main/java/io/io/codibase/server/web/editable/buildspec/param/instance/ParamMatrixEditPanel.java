...
import io.codibase.server.buildspec.param.instance.*;
...
import io.codibase.server.web.behavior.InterpolativeAssistBehavior;
import io.codibase.server.web.editable.*;
		...
		item.add(new AjaxLink<Void>("delete") {
			...
			public void onClick(AjaxRequestTarget target) {
				...
				String script = String.format(""
						+ "var $item=$('#%s');"
						+ "codibase.server.form.markDirty($item.closest('form'));" 
						+ "$item.remove();",
						item.getMarkupId());
			...
			fragment.add(new AjaxLink<Void>("add") {
				...
				public void onClick(AjaxRequestTarget target) {
					...
					String script = String.format(""
							...
							+ "codibase.server.form.markDirty($editor.closest('form'));", 
