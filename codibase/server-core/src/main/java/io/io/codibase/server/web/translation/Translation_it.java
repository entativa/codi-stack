...
public class Translation_it extends TranslationResourceBundle {
	...
	public static void init(Map<String, String> m) {
		...
		m.put("** Enterprise edition is disabled as the trial subscription was expired, order subscription to enable or contact support@codibase.io if you need to extend your trial **", 
			"** L'edizione Enterprise è disabilitata poiché l'abbonamento di prova è scaduto, ordina un abbonamento per abilitarla o contatta support@codibase.io se hai bisogno di estendere la prova **");
		...
		m.put("<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">user</a> to reset password for", 
			"<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">utente</a> per reimpostare la password");
		m.put("<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">user</a> to verify email for", 
			"<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">utente</a> per verificare l'email");
		m.put("<a href=\"https://guides.github.com/features/mastering-markdown/\" target=\"_blank\">GitHub flavored markdown</a> is accepted, with <a href=\"https://docs.codibase.io/appendix/markdown-syntax\" target=\"_blank\">mermaid and katex support</a>.", 
			"<a href=\"https://guides.github.com/features/mastering-markdown/\" target=\"_blank\">Markdown stile GitHub</a> è accettato, con <a href=\"https://docs.codibase.io/appendix/markdown-syntax\" target=\"_blank\">supporto mermaid e katex</a>.");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/event/Event.java' target='_blank'>event object</a> triggering the notification", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/event/Event.java' target='_blank'>oggetto evento</a> che ha attivato la notifica");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Alert.java'>alert</a> to display", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Alert.java'>alert</a> da visualizzare");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Stopwatch.java'>Stopwatch</a> overdue", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Stopwatch.java'>cronometro</a> scaduto");
		...
		m.put("<b class='text-danger'>NOTE: </b> This requires an enterprise subscription. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>NOTA: </b> Questo richiede un abbonamento Enterprise. <a href='https://codibase.io/pricing' target='_blank'>Prova gratis</a> per 30 giorni");
		m.put("<b class='text-danger'>NOTE: </b> This step requires an enterprise subscription. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>NOTA: </b> Questo step richiede un abbonamento Enterprise. <a href='https://codibase.io/pricing' target='_blank'>Prova gratis</a> per 30 giorni");
		m.put("<b class='text-danger'>NOTE: </b>SendGrid integration is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>NOTA: </b>L'integrazione con SendGrid è una funzionalità Enterprise. <a href='https://codibase.io/pricing' target='_blank'>Prova gratis</a> per 30 giorni");
		m.put("<b class='text-warning'>NOTE: </b><a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>Time tracking</a> is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-warning'>NOTA: </b><a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>Il tracciamento del tempo</a> è una funzionalità Enterprise. <a href='https://codibase.io/pricing' target='_blank'>Prova gratis</a> per 30 giorni");
		...
		m.put("<b>Tips: </b> Type <tt>@</tt> to <a href='https://docs.codibase.io/appendix/job-variables' target='_blank' tabindex='-1'>insert variable</a>. Use <tt>@@</tt> for literal <tt>@</tt>", 
			"<b>Consigli: </b> Digita <tt>@</tt> per <a href='https://docs.codibase.io/appendix/job-variables' target='_blank' tabindex='-1'>inserire una variabile</a>. Usa <tt>@@</tt> per il simbolo <tt>@</tt> letterale");
		...
		m.put("Build statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Le statistiche di build sono una funzionalità enterprise. <a href='https://codibase.io/pricing' target='_blank'>Prova gratis</a> per 30 giorni");
		...
		m.put("Change property <code>serverUrl</code> in file <code>conf/agent.properties</code> if necessary. The default value is taken from CodiBase server url specified in <i>Administration / System Setting</i>", 
			"Modifica la proprietà <code>serverUrl</code> nel file <code>conf/agent.properties</code> se necessario. Il valore predefinito è preso dall'URL del server CodiBase specificato in <i>Amministrazione / Impostazioni di sistema</i>");
		...
		m.put("Check <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">agent management</a> for details, including instructions on how to run agent as service", 
			"Consulta <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">la gestione degli agenti</a> per i dettagli, incluse le istruzioni su come eseguire l'agente come servizio");
		m.put("Check <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">agent management</a> for details, including list of supported environment variables", 
			"Consulta <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">la gestione degli agenti</a> per i dettagli, inclusa la lista delle variabili di ambiente supportate");
		...
		m.put("Client ID of this CodiBase instance registered in Google cloud", "ID client di questa istanza di CodiBase registrata nel cloud di Google");
		m.put("Client Id", "ID client");
		m.put("Client Secret", "Segreto client");
		m.put("Client secret of this CodiBase instance registered in Google cloud", "Segreto client di questa istanza di CodiBase registrata nel cloud di Google");
		...
		m.put("Commits generated by CodiBase previously will be shown as unverified if this key is deleted. Type <code>yes</code> below if you want to continue.", 
			"I commit generati precedentemente da CodiBase saranno mostrati come non verificati se questa chiave viene eliminata. Digita <code>yes</code> qui sotto se vuoi continuare.");
		...
		m.put("Enable <a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>time tracking</a> for this project to track progress and generate timesheets", 
			"Abilita <a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>il monitoraggio del tempo</a> per questo progetto per monitorare i progressi e generare timesheet");
		m.put("Enable <a href='https://docs.codibase.io/tutorials/package/working-with-packages' target='_blank'>package management</a> for this project", 
			"Abilita <a href='https://docs.codibase.io/tutorials/package/working-with-packages' target='_blank'>gestione dei pacchetti</a> per questo progetto");
		...
		m.put("Enable this to allow to run site publish step. CodiBase will serve project site files as is. To avoid XSS attack, make sure this executor can only be used by trusted jobs", 
			"Abilita questa opzione per consentire l'esecuzione del passaggio di pubblicazione del sito. CodiBase servirà i file del sito del progetto così come sono. Per evitare attacchi XSS, assicurati che questo executor possa essere utilizzato solo da lavori fidati");
		...
		m.put("Environment variable <code>serverUrl</code> in above command is taken from CodiBase server url specified in <i>Administration / System Setting</i>. Change it if necessary", 
			"La variabile d'ambiente <code>serverUrl</code> nel comando sopra è presa dall'URL del server CodiBase specificato in <i>Amministrazione / Impostazioni di Sistema</i>. Modificala se necessario");
		m.put("Equal", "Uguale");
		...
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with create branch permission", 
			"Per il commit di build non raggiungibile dal ramo predefinito, un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segreto di lavoro</a> dovrebbe essere specificato come token di accesso con permesso di creare rami");
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with create tag permission", 
			"Per il commit di build non raggiungibile dal ramo predefinito, un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segreto di lavoro</a> dovrebbe essere specificato come token di accesso con permesso di creare tag");
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with manage issue permission", 
			"Per il commit di build non raggiungibile dal ramo predefinito, un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segreto di lavoro</a> dovrebbe essere specificato come token di accesso con permesso di gestire problemi");
		m.put("For docker aware executors, this path is inside container, and accepts both absolute path and relative path (relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>). For shell related executors which runs on host machine directly, only relative path is accepted", 
			"Per gli esecutori consapevoli di Docker, questo percorso è all'interno del container e accetta sia percorsi assoluti che relativi (relativi a <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>spazio di lavoro del lavoro</a>). Per gli esecutori correlati alla shell che funzionano direttamente sulla macchina host, è accettato solo il percorso relativo");
		m.put("For each build, CodiBase calculates a list of fixed issues since previous build automatically. This setting provides a default query to further filter/order this list. For a given job, the first matching entry will be used.", 
			"Per ogni build, CodiBase calcola automaticamente un elenco di problemi risolti dalla build precedente. Questa impostazione fornisce una query predefinita per filtrare/ordinare ulteriormente questo elenco. Per un determinato lavoro, verrà utilizzata la prima voce corrispondente.");
		...
		m.put("For web hooks defined here and in parent projects, CodiBase will post event data in JSON format to specified URLs when subscribed events happen", 
			"Per i webhook definiti qui e nei progetti principali, CodiBase invierà i dati dell'evento in formato JSON agli URL specificati quando si verificano eventi sottoscritti");
		m.put("Force", "Forza");
		...
		m.put("GPG signing key will be used to sign commits generated by CodiBase, including pull request merge commits, user commits created via web UI or RESTful api.", 
			"La chiave di firma GPG verrà utilizzata per firmare i commit generati da CodiBase, inclusi i commit di merge delle richieste di pull, i commit utente creati tramite l'interfaccia web o l'API RESTful.");
		...
		m.put("Groovy script to be evaluated. It should return a <i>Date</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy da valutare. Dovrebbe restituire un valore <i>Date</i>. Controlla <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>aiuto scripting</a> per i dettagli");
		m.put("Groovy script to be evaluated. It should return a <i>Float</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy da valutare. Dovrebbe restituire un valore <i>Float</i>. Controlla <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>aiuto scripting</a> per i dettagli");
		m.put("Groovy script to be evaluated. It should return a <i>Integer</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy da valutare. Dovrebbe restituire un valore <i>Integer</i>. Controlla <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>aiuto scripting</a> per i dettagli");
		m.put("Groovy script to be evaluated. It should return a <i>String</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy da valutare. Dovrebbe restituire un valore <i>String</i>. Controlla <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>aiuto scripting</a> per i dettagli");
		m.put("Groovy script to be evaluated. It should return a <i>boolean</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy da valutare. Dovrebbe restituire un valore <i>boolean</i>. Controlla <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>aiuto scripting</a> per i dettagli");
		m.put("Groovy script to be evaluated. It should return a <i>string</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy da valutare. Dovrebbe restituire un valore <i>string</i>. Controlla <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>aiuto scripting</a> per i dettagli");
		m.put("Groovy script to be evaluated. It should return name of a group. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy da valutare. Dovrebbe restituire il nome di un gruppo. Controlla <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>aiuto scripting</a> per i dettagli");
		m.put("Groovy script to be evaluated. It should return string or list of string. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy da valutare. Dovrebbe restituire una stringa o un elenco di stringhe. Controlla <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>aiuto scripting</a> per i dettagli");
		m.put("Groovy script to be evaluated. The return value should be a list of group facade object to be used as choices. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy da valutare. Il valore restituito dovrebbe essere un elenco di oggetti facciata di gruppo da utilizzare come scelte. Controlla <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>aiuto scripting</a> per i dettagli");
		m.put("Groovy script to be evaluated. The return value should be a list of user login names to be used as choices. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy da valutare. Il valore restituito dovrebbe essere un elenco di nomi di login utente da utilizzare come scelte. Controlla <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>aiuto scripting</a> per i dettagli");
		m.put("Groovy script to be evaluated. The return value should be a value to color map, for instance:<br><code>return [\"Successful\":\"#00ff00\", \"Failed\":\"#ff0000\"]</code>, Use <tt>null</tt> if the value does not have a color. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy da valutare. Il valore restituito dovrebbe essere una mappa valore-colore, ad esempio:<br><code>return [\"Successful\":\"#00ff00\", \"Failed\":\"#ff0000\"]</code>, Usa <tt>null</tt> se il valore non ha un colore. Controlla <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>aiuto scripting</a> per i dettagli");
		m.put("Groovy scripts", "Script Groovy");
		m.put("Group", "Gruppo");
		...
		m.put("If specified, CodiBase will only display iterations with this prefix", "Se specificato, CodiBase mostrerà solo le iterazioni con questo prefisso");
		...
		m.put("If this option is enabled, git lfs command needs to be installed on CodiBase server (even this step runs on other node)", 
			"Se questa opzione è abilitata, il comando git lfs deve essere installato sul server CodiBase (anche se questo passaggio viene eseguito su un altro nodo)");
		...
		m.put("In case IMAP host certificate is self-signed or its CA root is not accepted, you may tell CodiBase to bypass certificate check. <b class='text-danger'>WARNING: </b> In an untrusted network, this may lead to man-in-the-middle attack, and you should <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>import the certificate into CodiBase</a> instead", 
			"Nel caso in cui il certificato host IMAP sia autofirmato o la sua radice CA non sia accettata, puoi dire a CodiBase di ignorare il controllo del certificato. <b class='text-danger'>ATTENZIONE: </b> In una rete non affidabile, ciò potrebbe portare ad un attacco man-in-the-middle, e dovresti <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>importare il certificato in CodiBase</a> invece");
		m.put("In case SMTP host certificate is self-signed or its CA root is not accepted, you may tell CodiBase to bypass certificate check. <b class='text-danger'>WARNING: </b> In an untrusted network, this may lead to man-in-the-middle attack, and you should <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>import the certificate into CodiBase</a> instead", 
			"Nel caso in cui il certificato host SMTP sia autofirmato o la sua radice CA non sia accettata, puoi dire a CodiBase di ignorare il controllo del certificato. <b class='text-danger'>ATTENZIONE: </b> In una rete non affidabile, ciò potrebbe portare ad un attacco man-in-the-middle, e dovresti <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>importare il certificato in CodiBase</a> invece");
		...
		m.put("Interactive web shell access to running jobs is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Accesso alla shell web interattiva per i lavori in esecuzione è una funzionalità aziendale. <a href='https://codibase.io/pricing' target='_blank'>Prova gratis</a> per 30 giorni");
		...
		m.put("Invalid state. Please make sure you are visiting CodiBase using server url specified in system setting", 
			"Stato non valido. Assicurati di visitare CodiBase utilizzando l'url del server specificato nelle impostazioni di sistema");
		...
		m.put("Issue statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Le statistiche dei problemi sono una funzionalità aziendale. <a href='https://codibase.io/pricing' target='_blank'>Prova gratis</a> per 30 giorni");
		...
		m.put("Login to CodiBase docker registry", "Accedi al registro docker di CodiBase");
		...
		m.put("No previous successful build on <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">same stream</a> to calculate fixed issues since", 
			"Nessuna build precedente riuscita su <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">stesso stream</a> per calcolare i problemi risolti da allora");
		...
		m.put("CodiBase Issue Field", "Campo Problema CodiBase");
		m.put("CodiBase Issue Link", "Collegamento Problema CodiBase");
		m.put("CodiBase Issue State", "Stato Problema CodiBase");
		m.put("CodiBase analyzes repository files for code search, line statistics, and code contribution statistics. This setting tells which files should be analyzed, and expects space-separated <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path patterns</a>. A pattern can be excluded by prefixing with '-', for instance <code>-**/vendors/**</code> will exclude all files with vendors in path. <b>NOTE: </b> Changing this setting only affects new commits. To apply the change to history commits, please stop the server and delete folder <code>index</code> and <code>info/commit</code> under <a href='https://docs.codibase.io/concepts#project-storage' target='_blank'>project's storage directory</a>. The repository will be re-analyzed when server is started", 
			"CodiBase analizza i file del repository per la ricerca del codice, statistiche di linea e statistiche di contributo al codice. Questa impostazione indica quali file devono essere analizzati e si aspetta <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>pattern di percorso</a> separati da spazi. Un pattern può essere escluso anteponendo '-', ad esempio <code>-**/vendors/**</code> escluderà tutti i file con vendors nel percorso. <b>NOTA: </b> Cambiare questa impostazione influisce solo sui nuovi commit. Per applicare la modifica ai commit storici, interrompere il server ed eliminare la cartella <code>index</code> e <code>info/commit</code> sotto la <a href='https://docs.codibase.io/concepts#project-storage' target='_blank'>directory di archiviazione del progetto</a>. Il repository sarà rianalizzato quando il server verrà avviato");
		m.put("CodiBase configures git hooks to communicate with itself via curl", "CodiBase configura i git hooks per comunicare con se stesso tramite curl");
		m.put("CodiBase needs to search and determine user DN, as well as searching user group information if group retrieval is enabled. Tick this option and specify 'manager' DN and password if these operations needs to be authenticated", 
			"CodiBase deve cercare e determinare il DN dell'utente, oltre a cercare informazioni sul gruppo utente se il recupero del gruppo è abilitato. Seleziona questa opzione e specifica il DN e la password del 'manager' se queste operazioni devono essere autenticate");
		m.put("CodiBase requires git command line to manage repositories. The minimum required version is 2.11.1. Also make sure that git-lfs is installed if you want to retrieve LFS files in build job", 
			"CodiBase richiede la linea di comando git per gestire i repository. La versione minima richiesta è 2.11.1. Assicurati anche che git-lfs sia installato se desideri recuperare file LFS nel job di build");
		m.put("Online", "Online");
		...
		m.put("OpenID client identification will be assigned by your OpenID provider when registering this CodiBase instance as client application", 
			"L'identificazione del client OpenID sarà assegnata dal tuo provider OpenID durante la registrazione di questa istanza CodiBase come applicazione client");
		m.put("OpenID client secret will be generated by your OpenID provider when registering this CodiBase instance as client application", 
			"Il segreto del client OpenID sarà generato dal tuo provider OpenID durante la registrazione di questa istanza CodiBase come applicazione client");
		...
		m.put("Optionally specify Dockerfile relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Leave empty to use file <tt>Dockerfile</tt> under build path specified above", 
			"Specifica facoltativamente il Dockerfile relativo a <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Lascia vuoto per utilizzare il file <tt>Dockerfile</tt> sotto il percorso di build specificato sopra");
		...
		m.put("Optionally specify a CodiBase project to be used as parent of imported projects. Leave empty to import as root projects", 
			"Specifica facoltativamente un progetto CodiBase da utilizzare come genitore dei progetti importati. Lascia vuoto per importare come progetti root");
		m.put("Optionally specify a CodiBase project to be used as parent of imported repositories. Leave empty to import as root projects", 
			"Specifica facoltativamente un progetto CodiBase da utilizzare come genitore dei repository importati. Lascia vuoto per importare come progetti root");
		...
		m.put("Optionally specify a date field to hold due date information.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Specifica facoltativamente un campo data per contenere informazioni sulla data di scadenza.<br><b>NOTA: </b> Puoi personalizzare i campi dei problemi di CodiBase nel caso non ci sia un'opzione appropriata qui");
		m.put("Optionally specify a path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to put retrieved artifacts. Leave empty to use job workspace itself", 
			"Specifica facoltativamente un percorso relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> per posizionare gli artefatti recuperati. Lascia vuoto per utilizzare il job workspace stesso");
		...
		m.put("Optionally specify a working period field to hold estimated time infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Specifica facoltativamente un campo di periodo lavorativo per contenere informazioni sul tempo stimato.<br><b>NOTA: </b> Puoi personalizzare i campi dei problemi di CodiBase nel caso non ci sia un'opzione appropriata qui");
		m.put("Optionally specify a working period field to hold spent time infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Specifica facoltativamente un campo di periodo lavorativo per contenere informazioni sul tempo trascorso.<br><b>NOTA: </b> Puoi personalizzare i campi dei problemi di CodiBase nel caso non ci sia un'opzione appropriata qui");
		m.put("Optionally specify a working period field to hold time estimate infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Specifica facoltativamente un campo di periodo lavorativo per contenere informazioni sulla stima del tempo.<br><b>NOTA: </b> Puoi personalizzare i campi dei problemi di CodiBase nel caso non ci sia un'opzione appropriata qui");
		...
		m.put("Optionally specify artifacts to retrieve from the dependency into <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Only published artifacts (via artifact publish step) can be retrieved. Leave empty to not retrieve any artifacts", 
			"Specifica facoltativamente gli artefatti da recuperare dalla dipendenza in <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Possono essere recuperati solo artefatti pubblicati (tramite il passaggio di pubblicazione degli artefatti). Lascia vuoto per non recuperare alcun artefatto");
		...
		m.put("Optionally specify build context path relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Leave empty to use job workspace itself. The file <code>Dockerfile</code> is expected to exist in build context directory, unless you specify a different location with option <code>--dockerfile</code>", 
			"Specifica facoltativamente il percorso del contesto di build relativo a <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Lascia vuoto per utilizzare il job workspace stesso. Il file <code>Dockerfile</code> dovrebbe esistere nella directory del contesto di build, a meno che tu non specifichi una posizione diversa con l'opzione <code>--dockerfile</code>");
		m.put("Optionally specify build path relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Leave empty to use job workspace itself", 
			"Specifica facoltativamente il percorso di build relativo a <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Lascia vuoto per utilizzare il job workspace stesso");
		...
		m.put("Optionally specify group search base if you want to retrieve group membership information of the user. For example: <i>cn=Users, dc=example, dc=com</i>. To give appropriate permissions to a Active Directory group, a CodiBase group with same name should be defined. Leave empty to manage group memberships at CodiBase side", 
			"Specifica facoltativamente la base di ricerca del gruppo se vuoi recuperare informazioni sull'appartenenza al gruppo dell'utente. Ad esempio: <i>cn=Users, dc=example, dc=com</i>. Per assegnare permessi appropriati a un gruppo di Active Directory, dovrebbe essere definito un gruppo CodiBase con lo stesso nome. Lascia vuoto per gestire le appartenenze ai gruppi sul lato CodiBase");
		...
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be used as trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/configuration/filtering/#by-finding-ids' target='_blank'>ignore file</a>", 
			"Specifica facoltativamente il percorso relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> da utilizzare come file di ignoranza di trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/configuration/filtering/#by-finding-ids' target='_blank'>ignore file</a>");
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be used as trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/scanner/secret/#configuration' target='_blank'>secret config</a>", 
			"Specifica facoltativamente il percorso relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> da utilizzare come configurazione segreta di trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/scanner/secret/#configuration' target='_blank'>secret config</a>");
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to publish artifacts from. Leave empty to use job workspace itself", 
			"Specifica facoltativamente il percorso relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> per pubblicare gli artefatti. Lascia vuoto per utilizzare il job workspace stesso");
		...
		m.put("Optionally specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to clone code into. Leave empty to use job workspace itself", 
			"Specifica facoltativamente il percorso relativo sotto <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> per clonare il codice. Lascia vuoto per utilizzare il job workspace stesso");
		m.put("Optionally specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to scan. Leave empty to use job workspace itself", 
			"Specifica facoltativamente il percorso relativo sotto <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> per scansionare. Lascia vuoto per utilizzare il job workspace stesso");
		...
		m.put("Optionally specify space-separated branches applicable for this transition. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all", 
			"Specifica facoltativamente i rami separati da spazio applicabili per questa transizione. Usa '**', '*' o '?' per <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la corrispondenza dei modelli di percorso</a>. Prefissa con '-' per escludere. Lascia vuoto per corrispondere a tutti");
		m.put("Optionally specify space-separated branches applicable for this trigger. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty for default branch", 
			"Specifica facoltativamente i rami separati da spazio applicabili per questo trigger. Usa '**', '*' o '?' per <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la corrispondenza dei modelli di percorso</a>. Prefissa con '-' per escludere. Lascia vuoto per il ramo predefinito");
		m.put("Optionally specify space-separated branches to check. Use '**' or '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all branches", 
			"Specifica facoltativamente i rami separati da spazio da controllare. Usa '**' o '*' o '?' per <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la corrispondenza dei modelli di percorso</a>. Prefissa con '-' per escludere. Lascia vuoto per corrispondere a tutti i rami");
		...
		m.put("Optionally specify space-separated files to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all files", 
			"Specifica facoltativamente i file separati da spazio da controllare. Usa '**', '*' o '?' per <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la corrispondenza dei modelli di percorso</a>. Prefissa con '-' per escludere. Lascia vuoto per corrispondere a tutti i file");
		...
		m.put("Optionally specify space-separated projects to search in. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to search in all projects with code read permission", 
			"Specifica facoltativamente i progetti separati da spazio in cui cercare. Usa '**', '*' o '?' per <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la corrispondenza dei modelli di percorso</a>. Prefissa con '-' per escludere. Lascia vuoto per cercare in tutti i progetti con permesso di lettura del codice");
		...
		m.put("Optionally specify space-separated service images applicable for this locator. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all", 
			"Specifica facoltativamente immagini di servizio separati da spazio applicabili per questo localizzatore. Usa '**', '*' o '?' per <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>corrispondenza con caratteri jolly nel percorso</a>. Prefissa con '-' per escludere. Lascia vuoto per corrispondere a tutti");
		...
		m.put("Optionally specify space-separated tags to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all tags", 
			"Specifica facoltativamente tag separati da spazio da controllare. Usa '**', '*' o '?' per <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>corrispondenza con caratteri jolly nel percorso</a>. Prefissa con '-' per escludere. Lascia vuoto per corrispondere a tutti i tag");
		m.put("Optionally specify space-separated target branches of the pull requests to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all branches", 
			"Specifica facoltativamente rami di destinazione separati da spazio delle pull request da controllare. Usa '**', '*' o '?' per <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>corrispondenza con caratteri jolly nel percorso</a>. Prefissa con '-' per escludere. Lascia vuoto per corrispondere a tutti i rami");
		...
		m.put("Parent CodiBase Project", "Progetto CodiBase Genitore");
		...
		m.put("Projects need to be redistributed when cluster members are added/removed. CodiBase does not do this automatically as this is resource intensive, and you may only want to do it after cluster is finalized and stable.", 
			"I progetti devono essere ridistribuiti quando i membri del cluster vengono aggiunti/rimossi. CodiBase non lo fa automaticamente poiché è intensivo in termini di risorse, e potresti volerlo fare solo dopo che il cluster è stato finalizzato e stabilizzato.");
		...
		m.put("Pull request statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Le statistiche delle pull request sono una funzionalità aziendale. <a href='https://codibase.io/pricing' target='_blank'>Prova gratis</a> per 30 giorni");
		...
		m.put("Refer to this <a href='https://docs.codibase.io/tutorials/security/sso-with-github' target='_blank'>tutorial</a> for an example setup", 
			"Consulta questo <a href='https://docs.codibase.io/tutorials/security/sso-with-github' target='_blank'>tutorial</a> per un esempio di configurazione");
		m.put("Refer to this <a href='https://docs.codibase.io/tutorials/security/sso-with-okta' target='_blank'>tutorial</a> for an example setup", 
			"Consulta questo <a href='https://docs.codibase.io/tutorials/security/sso-with-okta' target='_blank'>tutorial</a> per un esempio di configurazione");
		...
		m.put("Run specified docker container. <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job workspace</a> is mounted into the container and its path is placed in environment variable <code>CODIBASE_WORKSPACE</code>. <b class='text-warning'>Note: </b> this step can only be executed by server docker executor or remote docker executor", 
			"Esegui il contenitore Docker specificato. <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Workspace del lavoro</a> è montato nel contenitore e il suo percorso è posizionato nella variabile di ambiente <code>CODIBASE_WORKSPACE</code>. <b class='text-warning'>Nota: </b> questo passaggio può essere eseguito solo dall'esecutore docker del server o dall'esecutore docker remoto");
		...
		m.put("Set up job cache to speed up job execution. Check <a href='https://docs.codibase.io/tutorials/cicd/job-cache' target='_blank'>this tutorial</a> on how to use job cache", 
			"Configura la cache dei job per velocizzare l'esecuzione dei job. Consulta <a href='https://docs.codibase.io/tutorials/cicd/job-cache' target='_blank'>questo tutorial</a> per sapere come utilizzare la cache dei job.");
		...
		m.put("Signature verified successfully with CodiBase GPG key", "Firma verificata con successo con la chiave GPG di CodiBase");
		...
		m.put("Specifies the attribute containing group name inside the found group LDAP entry. Value of this attribute will be mapped to a CodiBase group. This attribute is normally set to <i>cn</i>", 
			"Specifica l'attributo contenente il nome del gruppo all'interno della voce LDAP del gruppo trovato. Il valore di questo attributo sarà mappato a un gruppo CodiBase. Questo attributo è normalmente impostato su <i>cn</i>");
		m.put("Specify .net TRX test result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>TestResults/*.trx</tt>. Use * or ? for pattern match", 
			"Specifica il file di risultati del test .net TRX relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, ad esempio <tt>TestResults/*.trx</tt>. Usa * o ? per la corrispondenza del pattern");
		...
		m.put("Specify CPD result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/cpd.xml</tt>. Use * or ? for pattern match", 
			"Specifica il file xml dei risultati CPD relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, ad esempio, <tt>target/cpd.xml</tt>. Usa * o ? per la corrispondenza del pattern");
		...
		m.put("Specify ESLint report file in checkstyle format under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with ESLint option <tt>'-f checkstyle'</tt> and <tt>'-o'</tt>. Use * or ? for pattern match", 
			"Specifica il file di report ESLint in formato checkstyle sotto <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Questo file può essere generato con l'opzione ESLint <tt>'-f checkstyle'</tt> e <tt>'-o'</tt>. Usa * o ? per la corrispondenza del pattern");
		...
		m.put("Specify JUnit test result file in XML format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>target/surefire-reports/TEST-*.xml</tt>. Use * or ? for pattern match", 
			"Specifica il file dei risultati del test JUnit in formato XML relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, ad esempio <tt>target/surefire-reports/TEST-*.xml</tt>. Usa * o ? per la corrispondenza del pattern");
		m.put("Specify JaCoCo coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/jacoco/jacoco.xml</tt>. Use * or ? for pattern match", 
			"Specifica il file di report di copertura xml JaCoCo relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, ad esempio, <tt>target/site/jacoco/jacoco.xml</tt>. Usa * o ? per la corrispondenza del pattern");
		m.put("Specify Jest coverage report file in clover format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>coverage/clover.xml</tt>. This file can be generated with Jest option <tt>'--coverage'</tt>. Use * or ? for pattern match", 
			"Specifica il file di report di copertura Jest in formato clover relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, ad esempio <tt>coverage/clover.xml</tt>. Questo file può essere generato con l'opzione Jest <tt>'--coverage'</tt>. Usa * o ? per la corrispondenza del pattern");
		m.put("Specify Jest test result file in json format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated via Jest option <tt>'--json'</tt> and <tt>'--outputFile'</tt>. Use * or ? for pattern match", 
			"Specifica il file dei risultati del test Jest in formato json relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Questo file può essere generato tramite l'opzione Jest <tt>'--json'</tt> e <tt>'--outputFile'</tt>. Usa * o ? per la corrispondenza del pattern");
		m.put("Specify OCI layout directory of the image to scan. This directory can be generated via build image step or pull image step. It should be relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Specifica la directory di layout OCI dell'immagine da scansionare. Questa directory può essere generata tramite il passaggio di build dell'immagine o il passaggio di pull dell'immagine. Dovrebbe essere relativa a <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>");
		m.put("Specify OCI layout directory relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to push from", 
			"Specifica la directory di layout OCI relativa a <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> da cui eseguire il push");
		...
		m.put("Specify PMD result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/pmd.xml</tt>. Use * or ? for pattern match", 
			"Specifica il file xml dei risultati PMD relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, ad esempio, <tt>target/pmd.xml</tt>. Usa * o ? per la corrispondenza del pattern");
		m.put("Specify PowerShell commands to execute under the <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>.<br><b class='text-warning'>NOTE: </b> CodiBase checks exit code of the script to determine if step is successful. Since PowerShell always exit with 0 even if there are script errors, you should handle errors in the script and exit with non-zero code, or add line <code>$ErrorActionPreference = &quot;Stop&quot;</code> at start of your script<br>", 
			"Specifica i comandi PowerShell da eseguire sotto <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>.<br><b class='text-warning'>NOTA: </b> CodiBase controlla il codice di uscita dello script per determinare se il passaggio è riuscito. Poiché PowerShell esce sempre con 0 anche se ci sono errori nello script, dovresti gestire gli errori nello script e uscire con un codice diverso da zero, o aggiungere la riga <code>$ErrorActionPreference = &quot;Stop&quot;</code> all'inizio del tuo script<br>");
		m.put("Specify Roslynator diagnostics output file in XML format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with <i>-o</i> option. Use * or ? for pattern match", 
			"Specifica il file di output delle diagnosi Roslynator in formato XML relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Questo file può essere generato con l'opzione <i>-o</i>. Usa * o ? per la corrispondenza del pattern");
		...
		m.put("Specify SpotBugs result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/spotbugsXml.xml</tt>. Use * or ? for pattern match", 
			"Specifica il file xml dei risultati SpotBugs relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, ad esempio, <tt>target/spotbugsXml.xml</tt>. Usa * o ? per la corrispondenza del pattern");
		...
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as SSH private key", 
			"Specifica un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segreto di lavoro</a> da utilizzare come chiave privata SSH");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as access token", 
			"Specifica un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segreto di lavoro</a> da utilizzare come token di accesso");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as access token to import build spec from above project if its code is not publicly accessible", 
			"Specifica un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segreto di lavoro</a> da utilizzare come token di accesso per importare la specifica di build dal progetto sopra indicato se il suo codice non è accessibile pubblicamente");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as password or access token of the registry", 
			"Specifica un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segreto di lavoro</a> da utilizzare come password o token di accesso del registro");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as password or access token to access remote repository", 
			"Specifica un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segreto di lavoro</a> da utilizzare come password o token di accesso per accedere al repository remoto");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as private key for SSH authentication. <b class='text-info'>NOTE:</b> Private key with passphrase is not supported", 
			"Specifica un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segreto di lavoro</a> da utilizzare come chiave privata per l'autenticazione SSH. <b class='text-info'>NOTA:</b> La chiave privata con passphrase non è supportata");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as private key of above user for SSH authentication. <b class='text-info'>NOTE:</b> Private key with passphrase is not supported", 
			"Specifica un <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segreto di lavoro</a> da utilizzare come chiave privata dell'utente sopra indicato per l'autenticazione SSH. <b class='text-info'>NOTA:</b> La chiave privata con passphrase non è supportata");
		...
		m.put("Specify a file relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to write checksum into", 
			"Specifica un file relativo a <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> in cui scrivere il checksum");
		m.put("Specify a multi-value user field to hold assignees information.<b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Specifica un campo utente multi-valore per contenere le informazioni sugli assegnatari.<b>NOTA: </b> Puoi personalizzare i campi dei problemi di CodiBase nel caso in cui non ci sia un'opzione appropriata qui");
		m.put("Specify a multi-value user field to hold assignees information.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Specifica un campo utente multi-valore per contenere le informazioni sugli assegnatari.<br><b>NOTA: </b> Puoi personalizzare i campi dei problemi di CodiBase nel caso in cui non ci sia un'opzione appropriata qui");
		...
		m.put("Specify absolute path to the kubectl utility, for instance: <i>/usr/bin/kubectl</i>. If left empty, CodiBase will try to find the utility from system path", 
			"Specifica il percorso assoluto all'utilità kubectl, ad esempio: <i>/usr/bin/kubectl</i>. Se lasciato vuoto, CodiBase cercherà di trovare l'utilità dal percorso di sistema");
		...
		m.put("Specify applicable projects for above option. Multiple projects should be separated by space. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty for all projects", 
			"Specifica i progetti applicabili per l'opzione sopra indicata. Più progetti dovrebbero essere separati da spazio. Usa '**', '*' o '?' per <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>corrispondenza del pattern del percorso</a>. Prefisso con '-' per escludere. Lascia vuoto per tutti i progetti");
		m.put("Specify applicable projects separated by space. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty for all projects", 
			"Specifica i progetti applicabili separati da spazio. Usa '**', '*' o '?' per <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>corrispondenza del pattern del percorso</a>. Prefisso con '-' per escludere. Lascia vuoto per tutti i progetti");
		...
		m.put("Specify artifacts to retrieve into <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Only published artifacts (via artifact publish step) can be retrieved.", 
			"Specifica gli artefatti da recuperare in <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Solo gli artefatti pubblicati (tramite il passaggio di pubblicazione degli artefatti) possono essere recuperati.");
		m.put("Specify at least 10 alphanumeric chars to be used as secret, and then add an inbound parse entry at SendGrid side:<ul><li><code>Destination URL</code> should be set to <i>&lt;CodiBase root url&gt;/~sendgrid/&lt;secret&gt;</i>, for instance, <i>https://codibase.example.com/~sendgrid/1234567890</i>. Note that in production environment, <a href='https://docs.codibase.io/administration-guide/https-setup' target='_blank'>https should be enabled</a> to protect the secret</li><li><code>Receiving domain</code> should be the same as domain part of system email address specified above</li><li>Option <code>POST the raw, full MIME message</code> is enabled</li></ul>", 
			"Specifica almeno 10 caratteri alfanumerici da utilizzare come segreto, e poi aggiungi una voce di analisi in entrata sul lato SendGrid:<ul><li><code>URL di destinazione</code> dovrebbe essere impostato su <i>&lt;URL root di CodiBase&gt;/~sendgrid/&lt;segreto&gt;</i>, ad esempio, <i>https://codibase.example.com/~sendgrid/1234567890</i>. Nota che in ambiente di produzione, <a href='https://docs.codibase.io/administration-guide/https-setup' target='_blank'>https dovrebbe essere abilitato</a> per proteggere il segreto</li><li><code>Dominio di ricezione</code> dovrebbe essere lo stesso della parte di dominio dell'indirizzo email di sistema specificato sopra</li><li>L'opzione <code>POST il messaggio MIME completo e grezzo</code> è abilitata</li></ul>");
		...
		m.put("Specify clover coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/clover/clover.xml</tt>. Refer to <a href='https://openclover.org/documentation'>OpenClover documentation</a> on how to generate clover xml file. Use * or ? for pattern match", 
			"Specifica il file di report di copertura xml clover relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, ad esempio, <tt>target/site/clover/clover.xml</tt>. Consulta la <a href='https://openclover.org/documentation'>documentazione di OpenClover</a> su come generare il file xml clover. Usa * o ? per la corrispondenza del pattern");
		m.put("Specify cobertura coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/cobertura/coverage.xml</tt>. Use * or ? for pattern match", 
			"Specifica il file di report di copertura xml cobertura relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, ad esempio, <tt>target/site/cobertura/coverage.xml</tt>. Usa * o ? per la corrispondenza del pattern");
		...
		m.put("Specify configuration discovery url of your OpenID provider, for instance: <code>https://openid.example.com/.well-known/openid-configuration</code>. Make sure to use HTTPS protocol as CodiBase relies on TLS encryption to ensure token validity", 
			"Specifica l'URL di scoperta della configurazione del tuo provider OpenID, ad esempio: <code>https://openid.example.com/.well-known/openid-configuration</code>. Assicurati di utilizzare il protocollo HTTPS poiché CodiBase si basa sulla crittografia TLS per garantire la validità del token");
		...
		m.put("Specify cppcheck xml result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with cppcheck xml output option, for instance <code>cppcheck src --xml 2>check-result.xml</code>. Use * or ? for pattern match", 
			"Specifica il file di risultati xml di cppcheck relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Questo file può essere generato con l'opzione di output xml di cppcheck, ad esempio <code>cppcheck src --xml 2>check-result.xml</code>. Usa * o ? per la corrispondenza dei pattern");
		...
		m.put("Specify directory relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to store OCI layout", 
			"Specifica la directory relativa a <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> per archiviare il layout OCI");
		...
		m.put("Specify files relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be published. Use * or ? for pattern match", 
			"Specifica i file relativi a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> da pubblicare. Usa * o ? per la corrispondenza dei pattern");
		...
		m.put("Specify how to map GitHub issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Specifica come mappare le etichette dei problemi di GitHub ai campi personalizzati di CodiBase.<br><b>NOTA: </b> Puoi personalizzare i campi dei problemi di CodiBase nel caso non ci sia un'opzione appropriata qui");
		m.put("Specify how to map GitLab issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Specifica come mappare le etichette dei problemi di GitLab ai campi personalizzati di CodiBase.<br><b>NOTA: </b> Puoi personalizzare i campi dei problemi di CodiBase nel caso non ci sia un'opzione appropriata qui");
		m.put("Specify how to map Gitea issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Specifica come mappare le etichette dei problemi di Gitea ai campi personalizzati di CodiBase.<br><b>NOTA: </b> Puoi personalizzare i campi dei problemi di CodiBase nel caso non ci sia un'opzione appropriata qui");
		m.put("Specify how to map JIRA issue priorities to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Specifica come mappare le priorità dei problemi di JIRA ai campi personalizzati di CodiBase.<br><b>NOTA: </b> Puoi personalizzare i campi dei problemi di CodiBase nel caso non ci sia un'opzione appropriata qui");
		m.put("Specify how to map JIRA issue statuses to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Specifica come mappare gli stati dei problemi di JIRA ai campi personalizzati di CodiBase.<br><b>NOTA: </b> Puoi personalizzare gli stati dei problemi di CodiBase nel caso non ci sia un'opzione appropriata qui");
		m.put("Specify how to map JIRA issue types to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Specifica come mappare i tipi di problemi di JIRA ai campi personalizzati di CodiBase.<br><b>NOTA: </b> Puoi personalizzare i campi dei problemi di CodiBase nel caso non ci sia un'opzione appropriata qui");
		m.put("Specify how to map YouTrack issue fields to CodiBase. Unmapped fields will be reflected in issue description.<br><b>Note: </b><ul><li>Enum field needs to be mapped in form of <tt>&lt;Field Name&gt;::&lt;Field Value&gt;</tt>, for instance <tt>Priority::Critical</tt><li>You may customize CodiBase issue fields in case there is no appropriate option here</ul>", 
			"Specifica come mappare i campi dei problemi di YouTrack a CodiBase. I campi non mappati saranno riflessi nella descrizione del problema.<br><b>Nota: </b><ul><li>Il campo Enum deve essere mappato nella forma <tt>&lt;Field Name&gt;::&lt;Field Value&gt;</tt>, ad esempio <tt>Priority::Critical</tt><li>Puoi personalizzare i campi dei problemi di CodiBase nel caso non ci sia un'opzione appropriata qui</ul>");
		m.put("Specify how to map YouTrack issue links to CodiBase issue links.<br><b>NOTE: </b> You may customize CodiBase issue links in case there is no appropriate option here", 
			"Specifica come mappare i collegamenti dei problemi di YouTrack ai collegamenti dei problemi di CodiBase.<br><b>NOTA: </b> Puoi personalizzare i collegamenti dei problemi di CodiBase nel caso non ci sia un'opzione appropriata qui");
		m.put("Specify how to map YouTrack issue state to CodiBase issue state. Unmapped states will use the initial state in CodiBase.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Specifica come mappare lo stato dei problemi di YouTrack allo stato dei problemi di CodiBase. Gli stati non mappati utilizzeranno lo stato iniziale in CodiBase.<br><b>NOTA: </b> Puoi personalizzare gli stati dei problemi di CodiBase nel caso non ci sia un'opzione appropriata qui");
		m.put("Specify how to map YouTrack issue tags to CodiBase issue custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Specifica come mappare i tag dei problemi di YouTrack ai campi personalizzati dei problemi di CodiBase.<br><b>NOTA: </b> Puoi personalizzare i campi dei problemi di CodiBase nel caso non ci sia un'opzione appropriata qui");
		...
		m.put("Specify manager DN to authenticate CodiBase itself to Active Directory. The manager DN should be specified in form of <i>&lt;account name&gt;@&lt;domain&gt;</i>, for instance: <i>manager@example.com</i>", 
			"Specifica il DN del manager per autenticare CodiBase stesso con Active Directory. Il DN del manager deve essere specificato nella forma <i>&lt;account name&gt;@&lt;domain&gt;</i>, ad esempio: <i>manager@example.com</i>");
		m.put("Specify manager DN to authenticate CodiBase itself to LDAP server", "Specifica il DN del manager per autenticare CodiBase stesso con il server LDAP");
		m.put("Specify markdown file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be published", 
			"Specifica il file markdown relativo a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> da pubblicare");
		...
		m.put("Specify project to import into at CodiBase side", "Specifica il progetto da importare nel lato CodiBase");
		...
		m.put("Specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to store OCI layout", 
			"Specifica il percorso relativo sotto <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> per archiviare il layout OCI");
		...
		m.put("Specify shell commands (on Linux/Unix) or batch commands (on Windows) to execute under the <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Specifica i comandi shell (su Linux/Unix) o batch (su Windows) da eseguire sotto <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>");
		m.put("Specify shell commands to execute under the <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Specifica i comandi shell da eseguire sotto <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>");
		...
		m.put("Specify space-separated branches to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Specifica i branch separati da spazio da proteggere. Usa '**', '*' o '?' per <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la corrispondenza con caratteri jolly</a>. Prefissa con '-' per escludere");
		...
		m.put("Specify space-separated paths to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Specifica i percorsi separati da spazio da proteggere. Usa '**', '*' o '?' per <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la corrispondenza con caratteri jolly</a>. Prefissa con '-' per escludere");
		...
		m.put("Specify space-separated tags to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Specifica i tag separati da spazio da proteggere. Usa '**', '*' o '?' per <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la corrispondenza con caratteri jolly</a>. Prefissa con '-' per escludere");
		m.put("Specify start page of the report relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance: <tt>manual/index.md</tt>", 
			"Specifica la pagina iniziale del report relativa a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, ad esempio: <tt>manual/index.md</tt>");
		m.put("Specify start page of the report relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance: api/index.html", 
			"Specifica la pagina iniziale del report relativa a <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, ad esempio: api/index.html");
		...
		m.put("Specify the strategy to retrieve group membership information. To give appropriate permissions to a LDAP group, a CodiBase group with same name should be defined. Use strategy <tt>Do Not Retrieve Groups</tt> if you want to manage group memberships at CodiBase side", 
			"Specifica la strategia per recuperare informazioni sull'appartenenza ai gruppi. Per assegnare permessi appropriati a un gruppo LDAP, deve essere definito un gruppo CodiBase con lo stesso nome. Usa la strategia <tt>Non Recuperare Gruppi</tt> se desideri gestire le appartenenze ai gruppi sul lato CodiBase");
		...
		m.put("Specify which issue state to use for closed GitHub issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Specifica quale stato dell'issue utilizzare per le issue chiuse su GitHub.<br><b>NOTA: </b> Puoi personalizzare gli stati delle issue di CodiBase nel caso non ci sia un'opzione appropriata qui");
		m.put("Specify which issue state to use for closed GitLab issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Specifica quale stato dell'issue utilizzare per le issue chiuse su GitLab.<br><b>NOTA: </b> Puoi personalizzare gli stati delle issue di CodiBase nel caso non ci sia un'opzione appropriata qui");
		m.put("Specify which issue state to use for closed Gitea issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Specifica quale stato dell'issue utilizzare per le issue chiuse su Gitea.<br><b>NOTA: </b> Puoi personalizzare gli stati delle issue di CodiBase nel caso non ci sia un'opzione appropriata qui");
		m.put("Specify which states are considered as closed for various issues created by Renovate to orchestrate dependency update. Additionally, when Renovate closes the issue, CodiBase will transit the issue to first state specified here", 
			"Specifica quali stati sono considerati chiusi per le varie issue create da Renovate per orchestrare l'aggiornamento delle dipendenze. Inoltre, quando Renovate chiude l'issue, CodiBase transiterà l'issue al primo stato specificato qui");
		...
		m.put("Steps will be executed serially on same node, sharing the same <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>", 
			"I passaggi verranno eseguiti in serie sullo stesso nodo, condividendo lo stesso <a href='https://docs.codibase.io/concepts#job-workspace'>workspace del job</a>");
		...
		m.put("The secret which allows you to ensure that POST requests sent to the payload URL are from CodiBase. When you set a secret you'll receive the X-CodiBase-Signature header in the webhook POST request", 
			"Il segreto che ti permette di garantire che le richieste POST inviate all'URL del payload provengano da CodiBase. Quando imposti un segreto, riceverai l'intestazione X-CodiBase-Signature nella richiesta POST del webhook");
		m.put("The service desk feature enables user to create issues by sending emails to CodiBase. Issues can be discussed over email completely, without the need of logging to CodiBase.", 
			"La funzione del service desk consente agli utenti di creare questioni inviando email a CodiBase. Le questioni possono essere discusse completamente via email, senza la necessità di accedere a CodiBase.");
		...
		m.put("This executor runs build jobs as docker containers on CodiBase server", "Questo executor esegue i lavori di build come container docker sul server CodiBase");
		...
		m.put("This executor runs build jobs with CodiBase server's shell facility.<br><b class='text-danger'>WARNING</b>: Jobs running with this executor has same permission as CodiBase server process. Make sure it can only be used by trusted jobs", 
			"Questo executor esegue lavori di build con la funzionalità shell del server CodiBase.<br><b class='text-danger'>ATTENZIONE</b>: I lavori eseguiti con questo executor hanno gli stessi permessi del processo del server CodiBase. Assicurati che possa essere utilizzato solo da lavori fidati");
		...
		m.put("This installation does not have an active subscription and runs as community edition. To access <a href=\"https://codibase.io/pricing\">enterprise features</a>, an active subscription is required", 
			"Questa installazione non ha un abbonamento attivo e funziona come edizione comunitaria. Per accedere alle <a href=\"https://codibase.io/pricing\">funzionalità enterprise</a>, è necessario un abbonamento attivo");
		...
		m.put("This is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Questa è una funzionalità enterprise. <a href='https://codibase.io/pricing' target='_blank'>Prova gratis</a> per 30 giorni");
		...
		m.put("This page lists changes since previous build on <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">same stream</a>", 
			"Questa pagina elenca le modifiche rispetto alla build precedente sul <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">stesso stream</a>");
		...
		m.put("This server is currently accessed via http protocol, please configure your docker daemon or buildx builder to <a href=\"https://docs.codibase.io/tutorials/cicd/insecure-docker-registry\" target=\"_blank\">work with insecure registry</a>", 
			"Questo server è attualmente accessibile tramite protocollo http, configura il tuo demone docker o builder buildx per <a href=\"https://docs.codibase.io/tutorials/cicd/insecure-docker-registry\" target=\"_blank\">lavorare con un registro non sicuro</a>");
		...
		m.put("This step can only be executed by a docker aware executor. It runs under <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Questo step può essere eseguito solo da un executor compatibile con docker. Viene eseguito sotto <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>workspace del lavoro</a>");
		...
		m.put("This step publishes specified files to be served as project web site. Project web site can be accessed publicly via <code>http://&lt;codibase base url&gt;/path/to/project/~site</code>", 
			"Questo step pubblica i file specificati per essere serviti come sito web del progetto. Il sito web del progetto può essere accessibile pubblicamente tramite <code>http://&lt;codibase base url&gt;/path/to/project/~site</code>");
		...
		m.put("This tab shows the pipeline containing current build. Check <a href=\"https://robinshen.medium.com/understanding-codibase-pipeline-db0bb0e54aa7\" target=\"_blank\">this article</a> to understand how build pipeline works", 
			"Questa scheda mostra la pipeline contenente la build corrente. Consulta <a href=\"https://robinshen.medium.com/understanding-codibase-pipeline-db0bb0e54aa7\" target=\"_blank\">questo articolo</a> per capire come funziona la pipeline di build");
		...
		m.put("Two-factor authentication is enabled. Please input passcode displayed on your TOTP authenticator. If you encounter problems, make sure time of CodiBase server and your device running TOTP authenticator is in sync", 
			"L'autenticazione a due fattori è abilitata. Inserisci il codice visualizzato sul tuo autenticatore TOTP. Se riscontri problemi, assicurati che l'orario del server CodiBase e del tuo dispositivo con l'autenticatore TOTP siano sincronizzati");
		...
		m.put("Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>", 
			"Usa '**', '*' o '?' per <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la corrispondenza wildcard del percorso</a>");
		m.put("Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Usa '**', '*' o '?' per <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la corrispondenza wildcard del percorso</a>. Prefisso con '-' per escludere");
		m.put("Use '**', '*', or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>", 
			"Usa '**', '*', o '?' per <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>la corrispondenza wildcard del percorso</a>");
		...
		m.put("Use job token as user name so that CodiBase can know which build is ${permission.equals(\"write\")? \"deploying\": \"using\"} packages", 
			"Usa il token di lavoro come nome utente in modo che CodiBase possa sapere quale build sta ${permission.equals(\"write\")? \"distribuendo\": \"utilizzando\"} i pacchetti");
		m.put("Use job token to tell CodiBase the build publishing the package", "Usa il token di lavoro per dire a CodiBase la build che pubblica il pacchetto");
		m.put("Use job token to tell CodiBase the build pushing the chart", "Usa il token di lavoro per dire a CodiBase la build che spinge il grafico");
		m.put("Use job token to tell CodiBase the build pushing the package", "Usa il token di lavoro per dire a CodiBase la build che spinge il pacchetto");
		m.put("Use job token to tell CodiBase the build using the package", "Usa il token di lavoro per dire a CodiBase la build che utilizza il pacchetto");
		...
		m.put("When login via CodiBase's built-in form, submitted user credentials can be checked against authenticator defined here, besides the internal database", 
			"Quando si accede tramite il modulo integrato di CodiBase, le credenziali utente inviate possono essere verificate contro l'autenticatore definito qui, oltre al database interno");
		...
		m.put("Whether or not to create as a service account for task automation purpose. Service account does not have password and email addresses, and will not generate notifications for its activities. <b class='text-warning'>NOTE:</b> Service account is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Se creare come account di servizio per scopi di automazione delle attività o meno. L'account di servizio non ha password e indirizzi email, e non genererà notifiche per le sue attività. <b class='text-warning'>NOTA:</b> L'account di servizio è una funzionalità aziendale. <a href='https://codibase.io/pricing' target='_blank'>Prova gratis</a> per 30 giorni");
		...
		m.put("Whether or not to fetch LFS objects if pull request is opened from a different project. If this option is enabled, git lfs command needs to be installed on CodiBase server", 
			"Se recuperare oggetti LFS se la richiesta di pull è aperta da un progetto diverso o meno. Se questa opzione è abilitata, il comando git lfs deve essere installato sul server CodiBase");
		...
		m.put("Whether or not to mount docker sock into job container to support docker operations in job commands<br><b class='text-danger'>WARNING</b>: Malicious jobs can take control of whole CodiBase by operating the mounted docker sock. Make sure this executor can only be used by trusted jobs if this option is enabled", 
			"Se montare o meno il socket docker nel container del lavoro per supportare le operazioni docker nei comandi del lavoro<br><b class='text-danger'>ATTENZIONE</b>: I lavori dannosi possono prendere il controllo dell'intero CodiBase operando sul socket docker montato. Assicurati che questo executor possa essere utilizzato solo da lavori fidati se questa opzione è abilitata");
		...
		m.put("Whether or not to retrieve submodules. Refer to <a href='https://docs.codibase.io/tutorials/cicd/clone-submodules' target='_blank'>this tutorial</a> on how to set up clone credential above to retrieve submodules", 
			"Se recuperare i sottomoduli o meno. Consulta <a href='https://docs.codibase.io/tutorials/cicd/clone-submodules' target='_blank'>questo tutorial</a> su come configurare le credenziali di clone sopra per recuperare i sottomoduli");
		...
		m.put("[Any state]", "[Qualsiasi stato]");
		m.put("[Reset Password] Please Reset Your CodiBase Password", "[Reset Password] Per favore reimposta la tua password di CodiBase");
		...
		m.put("adding .codibase-buildspec.yml", "aggiungendo .codibase-buildspec.yml");
		...
		m.put("an <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/notification/Unsubscribable.java' target='_blank'>object</a> holding unsubscribe information.  A <code>null</code> value means that the notification can not be unsubscribed", 
			"un <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/notification/Unsubscribable.java' target='_blank'>oggetto</a> che contiene informazioni di disiscrizione. Un valore <code>null</code> significa che la notifica non può essere disiscritta");
		...
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Build.java' target='_blank'>build</a> object to be notified", 
			"rappresenta l'oggetto <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Build.java' target='_blank'>build</a> da notificare");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a> being opened via service desk", 
			"rappresenta il <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>problema</a> aperto tramite il service desk");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a> object to be notified", 
			"rappresenta l'oggetto <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>problema</a> da notificare");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Pack.java' target='_blank'>package</a> object to be notified", 
			"rappresenta l'oggetto <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Pack.java' target='_blank'>pacchetto</a> da notificare");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a> object to be notified", 
			"rappresenta l'oggetto <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a> da notificare");
		...
		m.put("represents the unsubscribed <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a>", 
			"rappresenta il <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>problema</a> non sottoscritto");
		m.put("represents the unsubscribed <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a>", 
			"rappresenta la <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a> non sottoscritta");
		m.put("request to change", "richiesta di modifica");
		m.put("root", "radice");
		m.put("root url of CodiBase server", "url radice del server CodiBase");
		m.put("run job", "esegui lavoro");
