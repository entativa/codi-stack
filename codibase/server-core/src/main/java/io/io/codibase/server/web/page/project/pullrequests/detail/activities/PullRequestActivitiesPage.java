package io.codibase.server.web.page.project.pullrequests.detail.activities;
...
import io.codibase.server.model.support.pullrequest.changedata.PullRequestDescriptionChangeData;
...
import io.codibase.server.web.page.project.pullrequests.detail.activities.activity.PullRequestChangeActivity;
import io.codibase.server.web.page.project.pullrequests.detail.activities.activity.PullRequestCommentActivity;
import io.codibase.server.web.page.project.pullrequests.detail.activities.activity.PullRequestUpdateActivity;
...
public class PullRequestActivitiesPage extends PullRequestDetailPage {
	...
	private static final String COOKIE_SHOW_COMMENTS = "codibase.server.pullRequest.showComments";
	
	private static final String COOKIE_SHOW_COMMITS = "codibase.server.pullRequest.showCommits";
	
	private static final String COOKIE_SHOW_CHANGE_HISTORY = "codibase.server.pullRequest.showChangeHistory";
			...
			form.add(new AjaxSubmitLink("save") {
				...
				protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
					...
					if (content.length() > PullRequestComment.MAX_CONTENT_LEN) {
						...
						CodiBase.getInstance(PullRequestCommentService.class).create(comment, new ArrayList<>());
