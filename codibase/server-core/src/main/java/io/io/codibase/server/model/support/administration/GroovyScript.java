...
import io.codibase.server.annotation.JobMatch;
...
public class GroovyScript implements Serializable {
	...
	public Usage onDeleteProject(String projectPath) {
		...
		if (authorization != null && io.codibase.server.job.match.JobMatch.parse(authorization, true, false).isUsingProject(projectPath))
	...
	public void onMoveProject(String oldPath, String newPath) {
		if (authorization != null) {
			var jobMatch = io.codibase.server.job.match.JobMatch.parse(authorization, true, false);
