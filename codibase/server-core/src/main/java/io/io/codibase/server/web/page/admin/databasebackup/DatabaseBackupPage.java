package io.codibase.server.web.page.admin.databasebackup;
...
public class DatabaseBackupPage extends AdministrationPage {
	...
	protected void onInitialize() {
		...
		backupSettingHolder.setBackupSetting(CodiBase.getInstance(SettingService.class).getBackupSetting());
		Form<?> form = new Form<Void>("backupSetting") {

			@Override
			protected void onSubmit() {
				super.onSubmit();
				CodiBase.getInstance(SettingService.class).saveBackupSetting(backupSettingHolder.getBackupSetting());
			...
			protected ResourceResponse newResourceResponse(Attributes attributes) {
				...
				response.setWriteCallback(new WriteCallback() {
					...
					public void writeData(Attributes attributes) throws IOException {
						...
						try {
							DataService databaseManager = CodiBase.getInstance(DataService.class);
