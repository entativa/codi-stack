package io.codibase.server.web.page;
...
import io.codibase.server.web.page.layout.MainMenuCustomization;
...
public class HomePage extends LayoutPage {
	...
	public HomePage(PageParameters params) {
		...
		PageProvider pageProvider = CodiBase.getInstance(MainMenuCustomization.class).getHomePage(failsafe);
