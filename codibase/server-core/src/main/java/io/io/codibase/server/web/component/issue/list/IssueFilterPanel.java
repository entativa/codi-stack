...
import static io.codibase.server.search.entity.issue.IssueQueryLexer.IsSince;
import static io.codibase.server.search.entity.issue.IssueQueryLexer.IsUntil;
...
import io.codibase.server.search.entity.issue.BooleanFieldCriteria;
import io.codibase.server.search.entity.issue.ChoiceFieldCriteria;
import io.codibase.server.search.entity.issue.ConfidentialCriteria;
import io.codibase.server.search.entity.issue.FieldCriteria;
import io.codibase.server.search.entity.issue.FieldOperatorCriteria;
...
import io.codibase.server.search.entity.issue.SubmittedByCriteria;
import io.codibase.server.search.entity.issue.SubmittedByUserCriteria;
...
import io.codibase.server.web.component.groupchoice.GroupMultiChoice;
...
abstract class IssueFilterPanel extends FilterEditPanel<Issue> {
	...
	protected void onInitialize() {
		...
		var issueSetting = CodiBase.getInstance(SettingService.class).getIssueSetting();
	...
	private GroupService getGroupService() {
		return CodiBase.getInstance(GroupService.class);
	}
