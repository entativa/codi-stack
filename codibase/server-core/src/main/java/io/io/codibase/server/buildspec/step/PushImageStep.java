...
public class PushImageStep extends CraneStep {
	...
	@Editable(order=100, name="OCI Layout Directory", description = "Specify OCI layout directory relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to push from")
	...
	public String getCommand() {
		...
		builder.append(" /codibase-build/workspace/").append(getSrcPath()).append(" ").append(getDestImage());
