...
import static io.codibase.server.search.commit.CommitCriteria.getRuleName;
import static io.codibase.server.search.commit.CommitQueryLexer.BRANCH;
import static io.codibase.server.search.commit.CommitQueryLexer.BUILD;
import static io.codibase.server.search.commit.CommitQueryLexer.COMMIT;
import static io.codibase.server.search.commit.CommitQueryLexer.DefaultBranch;
import static io.codibase.server.search.commit.CommitQueryLexer.SINCE;
import static io.codibase.server.search.commit.CommitQueryLexer.TAG;
import static io.codibase.server.search.commit.CommitQueryLexer.UNTIL;
...
public class Revision implements Serializable {
	...
	public Build getValueAsBuild(Project project) {
		...
		var buildService = CodiBase.getInstance(BuildService.class);
