...
import io.codibase.server.web.behavior.DisplayNoneBehavior;
import io.codibase.server.web.page.base.BasePage;
import io.codibase.server.web.util.Animation;
	...
	protected void onInitialize() {
		...
		add(new AbstractPostAjaxBehavior() {
			...
			protected void respond(AjaxRequestTarget target) {
				...
				String script = String.format("codibase.server.floating.close('%s');", getMarkupId(true));
				target.appendJavaScript(script);
				onClosed();
			}
			...
			public void renderHead(Component component, IHeaderResponse response) {
				...
				String script = String.format("codibase.server.floating.init('%s', %s, %b, %b, %s, %s);", 
