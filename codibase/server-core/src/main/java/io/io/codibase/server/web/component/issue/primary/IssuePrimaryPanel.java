...
import io.codibase.server.util.EmailAddressUtils;
import io.codibase.server.util.LinkDescriptor;
import io.codibase.server.util.LinkGroup;
	...
	protected void onInitialize() {
		...
		add(new CommentPanel("description") {
			...
			protected void onSaveComment(AjaxRequestTarget target, String comment) {
				...
				CodiBase.getInstance(IssueChangeService.class).changeDescription(user, getIssue(), comment);
			...
			protected ReactionSupport getReactionSupport() {
				return new ReactionSupport() {
					...
					public void onToggleEmoji(AjaxRequestTarget target, String emoji) {
						CodiBase.getInstance(IssueReactionService.class).toggleEmoji(
