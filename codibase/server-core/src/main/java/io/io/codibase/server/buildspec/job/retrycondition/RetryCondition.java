...
import static io.codibase.server.buildspec.job.retrycondition.RetryConditionLexer.Contains;
import static io.codibase.server.buildspec.job.retrycondition.RetryConditionLexer.Is;
import static io.codibase.server.buildspec.job.retrycondition.RetryConditionLexer.IsEmpty;
import static io.codibase.server.buildspec.job.retrycondition.RetryConditionLexer.IsNot;
import static io.codibase.server.buildspec.job.retrycondition.RetryConditionLexer.IsNotEmpty;
...
import io.codibase.server.buildspec.job.retrycondition.RetryConditionParser.AndCriteriaContext;
import io.codibase.server.buildspec.job.retrycondition.RetryConditionParser.ConditionContext;
import io.codibase.server.buildspec.job.retrycondition.RetryConditionParser.CriteriaContext;
import io.codibase.server.buildspec.job.retrycondition.RetryConditionParser.FieldOperatorCriteriaContext;
import io.codibase.server.buildspec.job.retrycondition.RetryConditionParser.FieldOperatorValueCriteriaContext;
import io.codibase.server.buildspec.job.retrycondition.RetryConditionParser.NotCriteriaContext;
import io.codibase.server.buildspec.job.retrycondition.RetryConditionParser.OrCriteriaContext;
import io.codibase.server.buildspec.job.retrycondition.RetryConditionParser.ParensCriteriaContext;
