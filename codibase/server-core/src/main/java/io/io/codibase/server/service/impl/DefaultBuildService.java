...
import static io.codibase.server.model.Build.ARTIFACTS_DIR;
import static io.codibase.server.model.Build.LOG_FILE;
import static io.codibase.server.model.Build.PROP_FINISH_DATE;
import static io.codibase.server.model.Build.PROP_FINISH_TIME_GROUPS;
import static io.codibase.server.model.Build.PROP_PENDING_DURATION;
import static io.codibase.server.model.Build.PROP_RUNNING_DURATION;
import static io.codibase.server.model.Build.PROP_STATUS;
import static io.codibase.server.model.Build.SORT_FIELDS;
import static io.codibase.server.model.Build.getArtifactsLockName;
import static io.codibase.server.model.Build.getLogLockName;
import static io.codibase.server.model.Build.getProjectRelativeDirPath;
import static io.codibase.server.model.Build.Status.SUCCESSFUL;
