package io.codibase.server.web.page.admin.groovyscript;
		...
		form.add(new AjaxButton("save") {
			...
			protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
				...
				if (editor.isValid()) {
					...
					CodiBase.getInstance(SettingService.class).saveGroovyScripts(getScripts());
					CodiBase.getInstance(AuditService.class).audit(null, verb + " groovy script \"" + script.getName() + "\"", oldAuditContent, newAuditContent);
					onSave(target);
				} else {
					target.add(form);
				}
