package io.codibase.server.web.component.pullrequest.choice;
...
public class PullRequestSingleChoice extends Select2Choice<PullRequest> {
	...
	protected void onInitialize() {
		...
		getSettings().setFormatResult("codibase.server.pullRequestChoiceFormatter.formatResult");
		getSettings().setFormatSelection("codibase.server.pullRequestChoiceFormatter.formatSelection");
		getSettings().setEscapeMarkup("codibase.server.pullRequestChoiceFormatter.escapeMarkup");
