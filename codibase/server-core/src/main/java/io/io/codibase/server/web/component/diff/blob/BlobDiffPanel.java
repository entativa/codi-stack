package io.codibase.server.web.component.diff.blob;

import static io.codibase.server.util.diff.DiffUtils.MAX_LINE_LEN;
...
import io.codibase.server.web.component.diff.blob.text.BlobTextDiffPanel;
import io.codibase.server.web.component.diff.diffstat.DiffStatBar;
import io.codibase.server.web.component.diff.difftitle.BlobDiffTitle;
...
public class BlobDiffPanel extends Panel {
	...
	private void showBlob(Blob blob) {
		...
		for (DiffRenderer renderer : CodiBase.getExtensions(DiffRenderer.class)) {
