...
import static io.codibase.server.model.Project.SORT_FIELDS;
...
import static io.codibase.server.search.entity.project.ProjectQueryParser.ChildrenOf;
import static io.codibase.server.search.entity.project.ProjectQueryParser.Contains;
import static io.codibase.server.search.entity.project.ProjectQueryParser.ForkRoots;
import static io.codibase.server.search.entity.project.ProjectQueryParser.ForksOf;
import static io.codibase.server.search.entity.project.ProjectQueryParser.HasOutdatedReplicas;
import static io.codibase.server.search.entity.project.ProjectQueryParser.Is;
import static io.codibase.server.search.entity.project.ProjectQueryParser.IsNot;
import static io.codibase.server.search.entity.project.ProjectQueryParser.IsSince;
import static io.codibase.server.search.entity.project.ProjectQueryParser.IsUntil;
import static io.codibase.server.search.entity.project.ProjectQueryParser.Leafs;
import static io.codibase.server.search.entity.project.ProjectQueryParser.MissingStorage;
import static io.codibase.server.search.entity.project.ProjectQueryParser.OwnedByMe;
import static io.codibase.server.search.entity.project.ProjectQueryParser.OwnedByNone;
import static io.codibase.server.search.entity.project.ProjectQueryParser.Roots;
import static io.codibase.server.search.entity.project.ProjectQueryParser.WithoutEnoughReplicas;
...
import io.codibase.server.search.entity.project.ProjectQueryParser.AndCriteriaContext;
import io.codibase.server.search.entity.project.ProjectQueryParser.CriteriaContext;
import io.codibase.server.search.entity.project.ProjectQueryParser.FieldOperatorValueCriteriaContext;
import io.codibase.server.search.entity.project.ProjectQueryParser.FuzzyCriteriaContext;
import io.codibase.server.search.entity.project.ProjectQueryParser.NotCriteriaContext;
import io.codibase.server.search.entity.project.ProjectQueryParser.OperatorCriteriaContext;
import io.codibase.server.search.entity.project.ProjectQueryParser.OperatorValueCriteriaContext;
import io.codibase.server.search.entity.project.ProjectQueryParser.OrCriteriaContext;
import io.codibase.server.search.entity.project.ProjectQueryParser.OrderContext;
import io.codibase.server.search.entity.project.ProjectQueryParser.ParensCriteriaContext;
import io.codibase.server.search.entity.project.ProjectQueryParser.QueryContext;
