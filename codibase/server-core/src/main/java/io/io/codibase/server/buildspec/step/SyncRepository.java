...
public abstract class SyncRepository extends ServerSideStep {
	...
	@Editable(order=400, name="Password or Access Token for Remote Repository", 
			description="Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as password or access token to access remote repository")
