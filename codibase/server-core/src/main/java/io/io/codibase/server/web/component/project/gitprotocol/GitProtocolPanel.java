package io.codibase.server.web.component.project.gitprotocol;
...
public abstract class GitProtocolPanel extends Panel {
	...
	protected void onInitialize() {
		...
		SshSetting sshSetting = CodiBase.getInstance(SettingService.class).getSshSetting();
	...
	private int getSshPort() {
		return CodiBase.getInstance(ServerConfig.class).getSshPort();
	}
	...
	public String getProtocolUrl() {
		UrlService urlService = CodiBase.getInstance(UrlService.class);
