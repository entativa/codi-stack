package io.codibase.server.web.page.admin.issuesetting.transitionspec;
	...
	protected void onInitialize() {
		...
		form.add(new AjaxButton("save") {
			...
			protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
				...
				CodiBase.getInstance(AuditService.class).audit(null, verb + " issue transition", oldAuditContent, newAuditContent);
				onSave(target);
			}
