package io.codibase.server.web.component.pagenavigator;

import io.codibase.server.web.util.paginghistory.AjaxPagingHistorySupport;
...
public class OnePagingNavigator extends AjaxPagingNavigator {
	...
	public void renderHead(IHeaderResponse response) {
		...
		String script = String.format("codibase.server.pagingNavigator.onDomReady('%s');", getMarkupId());
