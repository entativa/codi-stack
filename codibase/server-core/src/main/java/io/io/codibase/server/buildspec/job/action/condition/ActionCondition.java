...
import static io.codibase.server.buildspec.job.action.condition.ActionConditionLexer.Contains;
import static io.codibase.server.buildspec.job.action.condition.ActionConditionLexer.Is;
import static io.codibase.server.buildspec.job.action.condition.ActionConditionLexer.IsEmpty;
import static io.codibase.server.buildspec.job.action.condition.ActionConditionLexer.IsNot;
import static io.codibase.server.buildspec.job.action.condition.ActionConditionLexer.IsNotEmpty;
...
import io.codibase.server.buildspec.job.action.condition.ActionConditionParser.AndCriteriaContext;
import io.codibase.server.buildspec.job.action.condition.ActionConditionParser.ConditionContext;
import io.codibase.server.buildspec.job.action.condition.ActionConditionParser.CriteriaContext;
import io.codibase.server.buildspec.job.action.condition.ActionConditionParser.FieldOperatorCriteriaContext;
import io.codibase.server.buildspec.job.action.condition.ActionConditionParser.FieldOperatorValueCriteriaContext;
import io.codibase.server.buildspec.job.action.condition.ActionConditionParser.NotCriteriaContext;
import io.codibase.server.buildspec.job.action.condition.ActionConditionParser.OperatorCriteriaContext;
import io.codibase.server.buildspec.job.action.condition.ActionConditionParser.OperatorValueCriteriaContext;
import io.codibase.server.buildspec.job.action.condition.ActionConditionParser.OrCriteriaContext;
import io.codibase.server.buildspec.job.action.condition.ActionConditionParser.ParensCriteriaContext;
