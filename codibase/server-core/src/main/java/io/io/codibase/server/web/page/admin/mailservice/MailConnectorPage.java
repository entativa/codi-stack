package io.codibase.server.web.page.admin.mailservice;
...
import io.codibase.server.web.component.DisableAwareButton;
				...
				return CodiBase.getInstance(SessionService.class).call(() -> {
					...
					if (inboxMonitor != null) {
						...
						mailConnector.sendMail(Sets.newHashSet(subAddressed), Sets.newHashSet(), 
								Sets.newHashSet(), uuid, "[Test] Test Email From CodiBase", 
								"This is a test email from CodiBase", null, 
								null, null, true);
						...
						if (emailAddress != null) {
							...
							mailConnector.sendMail(Sets.newHashSet(emailAddress.getValue()),
									Sets.newHashSet(), Sets.newHashSet(), "[Test] Test Email From CodiBase",
