package io.codibase.server.web.editable.issue.choice;
...
import io.codibase.server.web.util.IssueQueryAware;
...
public class IssueChoiceEditor extends PropertyEditor<Long> {
	...
	protected void onInitialize() {
		...
		if (getModelObject() != null)
			issue = CodiBase.getInstance(IssueService.class).get(getModelObject());
		else
			issue = null;
