...
import static io.codibase.server.util.IOUtils.copy;

@Api(description="In most cases, artifact resource is operated with build id, which is different from build number. "
		+ "To get build id of a particular build number, use the <a href='/~help/api/io.codibase.server.rest.BuildResource/queryBasicInfo'>Query Basic Info</a> operation with query for "
