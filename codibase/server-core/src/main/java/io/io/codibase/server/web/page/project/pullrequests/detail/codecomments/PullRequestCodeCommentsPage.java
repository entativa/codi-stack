package io.codibase.server.web.page.project.pullrequests.detail.codecomments;
...
import io.codibase.server.web.component.codecomment.CodeCommentListPanel;
		...
		RequestCycle.get().getListeners().add(new IRequestCycleListener() {
			...
			public void onEndRequest(RequestCycle cycle) {
				if (SecurityUtils.getAuthUser() != null) 
					CodiBase.getInstance(VisitInfoService.class).visitPullRequestCodeComments(SecurityUtils.getAuthUser(), getPullRequest());
			}
