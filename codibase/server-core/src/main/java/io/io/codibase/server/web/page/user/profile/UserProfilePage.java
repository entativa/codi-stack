package io.codibase.server.web.page.user.profile;
...
import io.codibase.server.web.component.user.profile.UserProfilePanel;
...
public class UserProfilePage extends UserPage {
    ...
    protected boolean isPermitted() {
        return SecurityUtils.getAuthUser() != null 
                || CodiBase.getInstance(SettingService.class).getSecuritySetting().isEnableAnonymousAccess();
    }
