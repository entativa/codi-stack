...
public class ProjectDependency implements Serializable {
	...
	@Editable(order=400, name="Artifacts to Retrieve", description="Specify artifacts to retrieve into <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. "
	...
	@Editable(order=500, placeholder="Job workspace", description=""
			+ "Optionally specify a path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> "
