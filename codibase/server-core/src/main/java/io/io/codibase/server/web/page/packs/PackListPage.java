package io.codibase.server.web.page.packs;
...
import io.codibase.server.web.component.pack.list.PackListPanel;
...
import io.codibase.server.web.util.NamedPackQueriesBean;
...
public class PackListPage extends LayoutPage {
	...
	private static GlobalPackSetting getPackSetting() {
		return CodiBase.getInstance(SettingService.class).getPackSetting();
	}
	...
	protected void onInitialize() {
		...
		add(savedQueries = new SavedQueriesPanel<>("savedQueries") {
			...
			protected void onSaveCommonQueries(ArrayList<NamedPackQuery> namedQueries) {
				...
				CodiBase.getInstance(SettingService.class).savePackSetting(getPackSetting());
							...
							protected Component newContent(String id) {
								return new SaveQueryPanel(id, new PersonalQuerySupport() {
									...
									protected void onSave(AjaxRequestTarget target, String name) {
										...
										CodiBase.getInstance(SettingService.class).savePackSetting(packSetting);
	...
	protected String getPageTitle() {
		return _T("Packages") + " - " + CodiBase.getInstance(SettingService.class).getBrandingSetting().getName();
	}
