package io.codibase.server.web.page.issues;
...
public class IssueListPage extends LayoutPage {
	...
	protected void onInitialize() {
		...
		add(savedQueries = new SavedQueriesPanel<NamedIssueQuery>("savedQueries") {
			...
			protected void onSaveCommonQueries(ArrayList<NamedIssueQuery> queries) {
				...
				CodiBase.getInstance(SettingService.class).saveIssueSetting(getIssueSetting());
							...
							protected Component newContent(String id) {
								return new SaveQueryPanel(id, new PersonalQuerySupport() {
									...
									protected void onSave(AjaxRequestTarget target, String name) {
										...
										CodiBase.getInstance(SettingService.class).saveIssueSetting(issueSetting);
	...
	protected String getPageTitle() {
		return _T("Issues") + " - " + CodiBase.getInstance(SettingService.class).getBrandingSetting().getName();
	}
