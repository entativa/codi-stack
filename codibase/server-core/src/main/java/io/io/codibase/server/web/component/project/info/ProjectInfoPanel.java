package io.codibase.server.web.component.project.info;
...
import io.codibase.server.web.component.project.forkoption.ForkOptionPanel;
...
public abstract class ProjectInfoPanel extends Panel {
	...
	protected void onInitialize() {
		...
		add(new ListView<Map.Entry<String, ProjectReplica>>("replicas", new LoadableDetachableModel<>() {
			...
			protected void onConfigure() {
				super.onConfigure();
				setVisible(latestVersion != -1 && CodiBase.getInstance(ClusterService.class).isClusteringSupported());
			}
		});
	}
