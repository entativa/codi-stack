...
import io.codibase.server.search.entity.agent.AgentQueryLexer;
import io.codibase.server.search.entity.agent.EverUsedSinceCriteria;
import io.codibase.server.search.entity.agent.HasRunningBuildsCriteria;
import io.codibase.server.search.entity.agent.NotUsedSinceCriteria;
import io.codibase.server.search.entity.agent.OfflineCriteria;
import io.codibase.server.search.entity.agent.OnlineCriteria;
import io.codibase.server.search.entity.agent.OsArchCriteria;
import io.codibase.server.search.entity.agent.OsCriteria;
import io.codibase.server.search.entity.agent.PausedCriteria;
import io.codibase.server.search.entity.agent.StatusCriteria;
