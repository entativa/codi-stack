...
public class PullImageStep extends CraneStep {
	...
	@Editable(order=200, name="OCI Layout Directory", description = "Specify directory relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to store OCI layout")
	@Interpolative(variableSuggester="suggestVariables")
	@SubPath
	@NoSpace
	@NotEmpty
	...
	public String getCommand() {
		...
		builder.append(getSrcImage()).append(" /codibase-build/workspace/").append(getDestPath());
