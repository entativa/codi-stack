...
public class LineSeries implements Serializable {
	...
	public static final String SECONDS_FORMATTER = "function(seconds) {return codibase.server.formatBriefDuration(seconds);}";

	public static final String MINUTES_FORMATTER = "function(minutes) {return codibase.server.formatBriefDuration(minutes*60);}";
