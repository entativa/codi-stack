...
public class TagProtection implements Serializable {
	...
	@Editable(order=100, description="Specify space-separated tags to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. "
