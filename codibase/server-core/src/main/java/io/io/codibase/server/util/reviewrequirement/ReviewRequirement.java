package io.codibase.server.util.reviewrequirement;
...
import io.codibase.server.util.reviewrequirement.ReviewRequirementParser.CriteriaContext;
import io.codibase.server.util.reviewrequirement.ReviewRequirementParser.RequirementContext;
		...
		if (requirementString != null) {
			...
			for (CriteriaContext criteria: requirementContext.criteria()) {
				if (criteria.userCriteria() != null) {
					...
					User user = CodiBase.getInstance(UserService.class).findByName(userName);
					if (user != null) {
					...
					Group group = CodiBase.getInstance(GroupService.class).find(groupName);
					if (group != null) {
