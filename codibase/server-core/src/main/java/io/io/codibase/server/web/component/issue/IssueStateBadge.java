package io.codibase.server.web.component.issue;
...
public class IssueStateBadge extends Label {
	...
	protected void onComponentTag(ComponentTag tag) {
		...
		StateSpec stateSpec = CodiBase.getInstance(SettingService.class).getIssueSetting().getStateSpec(issue.getState());
		if (stateSpec != null) {
