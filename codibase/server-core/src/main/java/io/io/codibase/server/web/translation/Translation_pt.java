...
public class Translation_pt extends TranslationResourceBundle {
	...
	public static void init(Map<String, String> m) {
		...
		m.put("** Enterprise edition is disabled as the trial subscription was expired, order subscription to enable or contact support@codibase.io if you need to extend your trial **", 
			"** A edição Enterprise está desativada porque a assinatura de teste expirou, solicite uma assinatura para ativar ou entre em contato com support@codibase.io se precisar estender seu teste **");
		...
		m.put("<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">user</a> to reset password for", 
			"<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">usuário</a> para redefinir a senha");
		m.put("<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">user</a> to verify email for", 
			"<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">usuário</a> para verificar o e-mail");
		m.put("<a href=\"https://guides.github.com/features/mastering-markdown/\" target=\"_blank\">GitHub flavored markdown</a> is accepted, with <a href=\"https://docs.codibase.io/appendix/markdown-syntax\" target=\"_blank\">mermaid and katex support</a>.", 
			"<a href=\"https://guides.github.com/features/mastering-markdown/\" target=\"_blank\">Markdown com estilo GitHub</a> é aceito, com <a href=\"https://docs.codibase.io/appendix/markdown-syntax\" target=\"_blank\">suporte a mermaid e katex</a>.");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/event/Event.java' target='_blank'>event object</a> triggering the notification", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/event/Event.java' target='_blank'>objeto de evento</a> que dispara a notificação");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Alert.java'>alert</a> to display", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Alert.java'>alerta</a> para exibir");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Stopwatch.java'>Stopwatch</a> overdue", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Stopwatch.java'>Cronômetro</a> vencido");
		...
		m.put("<b class='text-danger'>NOTE: </b> This requires an enterprise subscription. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>NOTA: </b> Isso requer uma assinatura empresarial. <a href='https://codibase.io/pricing' target='_blank'>Experimente grátis</a> por 30 dias");
		m.put("<b class='text-danger'>NOTE: </b> This step requires an enterprise subscription. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>NOTA: </b> Este passo requer uma assinatura empresarial. <a href='https://codibase.io/pricing' target='_blank'>Experimente grátis</a> por 30 dias");
		m.put("<b class='text-danger'>NOTE: </b>SendGrid integration is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>NOTA: </b>A integração com SendGrid é um recurso empresarial. <a href='https://codibase.io/pricing' target='_blank'>Experimente grátis</a> por 30 dias");
		m.put("<b class='text-warning'>NOTE: </b><a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>Time tracking</a> is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-warning'>NOTA: </b><a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>Rastreamento de tempo</a> é um recurso empresarial. <a href='https://codibase.io/pricing' target='_blank'>Experimente grátis</a> por 30 dias");
		...
		m.put("<b>Tips: </b> Type <tt>@</tt> to <a href='https://docs.codibase.io/appendix/job-variables' target='_blank' tabindex='-1'>insert variable</a>. Use <tt>@@</tt> for literal <tt>@</tt>", 
			"<b>Dicas: </b> Digite <tt>@</tt> para <a href='https://docs.codibase.io/appendix/job-variables' target='_blank' tabindex='-1'>inserir variável</a>. Use <tt>@@</tt> para literal <tt>@</tt>");
		...
		m.put("Build statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Estatísticas de build são um recurso empresarial. <a href='https://codibase.io/pricing' target='_blank'>Experimente grátis</a> por 30 dias");
		...
		m.put("Change property <code>serverUrl</code> in file <code>conf/agent.properties</code> if necessary. The default value is taken from CodiBase server url specified in <i>Administration / System Setting</i>", 
			"Altere a propriedade <code>serverUrl</code> no arquivo <code>conf/agent.properties</code> se necessário. O valor padrão é obtido da URL do servidor CodiBase especificada em <i>Administração / Configuração do Sistema</i>");
		...
		m.put("Check <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">agent management</a> for details, including instructions on how to run agent as service", 
			"Confira <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">gerenciamento de agentes</a> para detalhes, incluindo instruções sobre como executar o agente como serviço");
		m.put("Check <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">agent management</a> for details, including list of supported environment variables", 
			"Confira <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">gerenciamento de agentes</a> para detalhes, incluindo lista de variáveis de ambiente suportadas");
		...
		m.put("Client ID of this CodiBase instance registered in Google cloud", "ID do cliente desta instância do CodiBase registrada na nuvem do Google");
		m.put("Client Id", "ID do cliente");
		m.put("Client Secret", "Segredo do cliente");
		m.put("Client secret of this CodiBase instance registered in Google cloud", "Segredo do cliente desta instância do CodiBase registrada na nuvem do Google");
		...
		m.put("Commits generated by CodiBase previously will be shown as unverified if this key is deleted. Type <code>yes</code> below if you want to continue.", 
			"Commits gerados anteriormente pelo CodiBase serão exibidos como não verificados se esta chave for excluída. Digite <code>yes</code> abaixo se desejar continuar.");
		...
		m.put("Enable <a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>time tracking</a> for this project to track progress and generate timesheets", 
			"Ative <a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>rastreamento de tempo</a> para este projeto para acompanhar o progresso e gerar folhas de horas");
		m.put("Enable <a href='https://docs.codibase.io/tutorials/package/working-with-packages' target='_blank'>package management</a> for this project", 
			"Habilitar <a href='https://docs.codibase.io/tutorials/package/working-with-packages' target='_blank'>gerenciamento de pacotes</a> para este projeto");
		...
		m.put("Enable this to allow to run site publish step. CodiBase will serve project site files as is. To avoid XSS attack, make sure this executor can only be used by trusted jobs", 
			"Habilitar isto para permitir a execução da etapa de publicação de site. O CodiBase servirá os arquivos do site do projeto como estão. Para evitar ataques XSS, certifique-se de que este executor só possa ser usado por trabalhos confiáveis");
		...
		m.put("Environment variable <code>serverUrl</code> in above command is taken from CodiBase server url specified in <i>Administration / System Setting</i>. Change it if necessary", 
			"A variável de ambiente <code>serverUrl</code> no comando acima é retirada da URL do servidor CodiBase especificada em <i>Administração / Configuração do Sistema</i>. Altere se necessário");
		m.put("Equal", "Igual");
		...
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with create branch permission", 
			"Para commit de build não alcançável a partir do branch padrão, um <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segredo de trabalho</a> deve ser especificado como token de acesso com permissão para criar branch");
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with create tag permission", 
			"Para commit de build não alcançável a partir do branch padrão, um <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segredo de trabalho</a> deve ser especificado como token de acesso com permissão para criar tag");
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with manage issue permission", 
			"Para commit de build não alcançável a partir do branch padrão, um <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segredo de trabalho</a> deve ser especificado como token de acesso com permissão para gerenciar problema");
		...
		m.put("For each build, CodiBase calculates a list of fixed issues since previous build automatically. This setting provides a default query to further filter/order this list. For a given job, the first matching entry will be used.", 
			"Para cada build, o CodiBase calcula automaticamente uma lista de problemas corrigidos desde o build anterior. Esta configuração fornece uma consulta padrão para filtrar/ordenar ainda mais esta lista. Para um trabalho específico, a primeira entrada correspondente será usada.");
		...
		m.put("For web hooks defined here and in parent projects, CodiBase will post event data in JSON format to specified URLs when subscribed events happen", 
			"Para web hooks definidos aqui e em projetos pai, o CodiBase enviará dados de eventos em formato JSON para URLs especificadas quando eventos assinados ocorrerem");
		m.put("Force", "Forçar");
		...
		m.put("GPG signing key will be used to sign commits generated by CodiBase, including pull request merge commits, user commits created via web UI or RESTful api.", 
			"A chave de assinatura GPG será usada para assinar commits gerados pelo CodiBase, incluindo commits de merge de pull request, commits de usuário criados via interface web ou API RESTful.");
		...
		m.put("Groovy script to be evaluated. It should return a <i>Date</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy a ser avaliado. Deve retornar um valor <i>Date</i>. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ajuda de script</a> para detalhes");
		m.put("Groovy script to be evaluated. It should return a <i>Float</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy a ser avaliado. Deve retornar um valor <i>Float</i>. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ajuda de script</a> para detalhes");
		m.put("Groovy script to be evaluated. It should return a <i>Integer</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy a ser avaliado. Deve retornar um valor <i>Integer</i>. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ajuda de script</a> para detalhes");
		m.put("Groovy script to be evaluated. It should return a <i>String</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy a ser avaliado. Deve retornar um valor <i>String</i>. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ajuda de script</a> para detalhes");
		m.put("Groovy script to be evaluated. It should return a <i>boolean</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy a ser avaliado. Deve retornar um valor <i>boolean</i>. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ajuda de script</a> para detalhes");
		m.put("Groovy script to be evaluated. It should return a <i>string</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy a ser avaliado. Deve retornar um valor <i>string</i>. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ajuda de script</a> para detalhes");
		m.put("Groovy script to be evaluated. It should return name of a group. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy a ser avaliado. Deve retornar o nome de um grupo. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ajuda de script</a> para detalhes");
		m.put("Groovy script to be evaluated. It should return string or list of string. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy a ser avaliado. Deve retornar uma string ou lista de strings. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ajuda de script</a> para detalhes");
		m.put("Groovy script to be evaluated. The return value should be a list of group facade object to be used as choices. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy a ser avaliado. O valor retornado deve ser uma lista de objetos de fachada de grupo para ser usada como escolhas. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ajuda de script</a> para detalhes");
		m.put("Groovy script to be evaluated. The return value should be a list of user login names to be used as choices. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy a ser avaliado. O valor retornado deve ser uma lista de nomes de login de usuários para ser usada como escolhas. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ajuda de script</a> para detalhes");
		m.put("Groovy script to be evaluated. The return value should be a value to color map, for instance:<br><code>return [\"Successful\":\"#00ff00\", \"Failed\":\"#ff0000\"]</code>, Use <tt>null</tt> if the value does not have a color. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"Script Groovy a ser avaliado. O valor retornado deve ser um mapa de valor para cor, por exemplo:<br><code>return [\"Successful\":\"#00ff00\", \"Failed\":\"#ff0000\"]</code>, Use <tt>null</tt> se o valor não tiver uma cor. Consulte <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>ajuda de script</a> para detalhes");
		m.put("Groovy scripts", "Scripts Groovy");
		m.put("Group", "Grupo");
		...
		m.put("If specified, CodiBase will only display iterations with this prefix", "Se especificado, o CodiBase exibirá apenas iterações com este prefixo");
		...
		m.put("If this option is enabled, git lfs command needs to be installed on CodiBase server (even this step runs on other node)", 
			"Se esta opção estiver habilitada, o comando git lfs precisa estar instalado no servidor CodiBase (mesmo que esta etapa seja executada em outro nó)");
		...
		m.put("In case IMAP host certificate is self-signed or its CA root is not accepted, you may tell CodiBase to bypass certificate check. <b class='text-danger'>WARNING: </b> In an untrusted network, this may lead to man-in-the-middle attack, and you should <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>import the certificate into CodiBase</a> instead", 
			"Caso o certificado do host IMAP seja autoassinado ou sua raiz CA não seja aceita, você pode instruir o CodiBase a ignorar a verificação do certificado. <b class='text-danger'>AVISO: </b> Em uma rede não confiável, isso pode levar a um ataque man-in-the-middle, e você deve <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>importar o certificado para o CodiBase</a> em vez disso");
		...
		m.put("In case cache is not hit via above key, CodiBase will loop through load keys defined here in order until a matching cache is found in project hierarchy. A cache is considered matching if its key is prefixed with the load key. If multiple caches matches, the most recent cache will be returned", 
			"Caso o cache não seja encontrado via a chave acima, o CodiBase percorrerá as chaves de carregamento definidas aqui em ordem até encontrar um cache correspondente na hierarquia do projeto. Um cache é considerado correspondente se sua chave for prefixada com a chave de carregamento. Se vários caches corresponderem, o cache mais recente será retornado");
		...
		m.put("Interactive web shell access to running jobs is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Acesso ao shell web interativo para trabalhos em execução é um recurso empresarial. <a href='https://codibase.io/pricing' target='_blank'>Experimente grátis</a> por 30 dias");
		...
		m.put("Invalid state. Please make sure you are visiting CodiBase using server url specified in system setting", 
			"Estado inválido. Por favor, certifique-se de que está visitando o CodiBase usando a URL do servidor especificada na configuração do sistema");
		...
		m.put("Issue statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Estatísticas de problema são um recurso empresarial. <a href='https://codibase.io/pricing' target='_blank'>Experimente grátis</a> por 30 dias");
		...
		m.put("Login to CodiBase docker registry", "Login no registro docker do CodiBase");
		...
		m.put("No previous successful build on <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">same stream</a> to calculate fixed issues since", 
			"Sem build anterior bem-sucedido no <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">mesmo stream</a> para calcular problemas corrigidos desde então");
		...
		m.put("CodiBase Issue Field", "Campo de Problema do CodiBase");
		m.put("CodiBase Issue Link", "Link de Problema do CodiBase");
		m.put("CodiBase Issue State", "Estado de Problema do CodiBase");
		m.put("CodiBase analyzes repository files for code search, line statistics, and code contribution statistics. This setting tells which files should be analyzed, and expects space-separated <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path patterns</a>. A pattern can be excluded by prefixing with '-', for instance <code>-**/vendors/**</code> will exclude all files with vendors in path. <b>NOTE: </b> Changing this setting only affects new commits. To apply the change to history commits, please stop the server and delete folder <code>index</code> and <code>info/commit</code> under <a href='https://docs.codibase.io/concepts#project-storage' target='_blank'>project's storage directory</a>. The repository will be re-analyzed when server is started", 
			"O CodiBase analisa arquivos do repositório para busca de código, estatísticas de linha e estatísticas de contribuição de código. Esta configuração indica quais arquivos devem ser analisados e espera <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>padrões de caminho</a> separados por espaço. Um padrão pode ser excluído prefixando com '-', por exemplo <code>-**/vendors/**</code> excluirá todos os arquivos com vendors no caminho. <b>NOTA: </b> Alterar esta configuração afeta apenas novos commits. Para aplicar a alteração a commits históricos, pare o servidor e exclua a pasta <code>index</code> e <code>info/commit</code> no <a href='https://docs.codibase.io/concepts#project-storage' target='_blank'>diretório de armazenamento do projeto</a>. O repositório será reanalisado quando o servidor for iniciado");
		m.put("CodiBase configures git hooks to communicate with itself via curl", "O CodiBase configura hooks do git para se comunicar consigo mesmo via curl");
		m.put("CodiBase needs to search and determine user DN, as well as searching user group information if group retrieval is enabled. Tick this option and specify 'manager' DN and password if these operations needs to be authenticated", 
			"O CodiBase precisa buscar e determinar o DN do usuário, bem como buscar informações do grupo do usuário se a recuperação de grupo estiver habilitada. Marque esta opção e especifique o DN e senha do 'gerente' se essas operações precisarem ser autenticadas");
		m.put("CodiBase requires git command line to manage repositories. The minimum required version is 2.11.1. Also make sure that git-lfs is installed if you want to retrieve LFS files in build job", 
			"O CodiBase requer a linha de comando do git para gerenciar repositórios. A versão mínima necessária é 2.11.1. Certifique-se também de que o git-lfs esteja instalado se você quiser recuperar arquivos LFS no trabalho de build");
		m.put("Online", "Online");
		...
		m.put("OpenID client identification will be assigned by your OpenID provider when registering this CodiBase instance as client application", 
			"A identificação do cliente OpenID será atribuída pelo seu provedor OpenID ao registrar esta instância do CodiBase como aplicação cliente");
		m.put("OpenID client secret will be generated by your OpenID provider when registering this CodiBase instance as client application", 
			"O segredo do cliente OpenID será gerado pelo seu provedor OpenID ao registrar esta instância do CodiBase como aplicação cliente");
		...
		m.put("Optionally specify Dockerfile relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Leave empty to use file <tt>Dockerfile</tt> under build path specified above", 
			"Opcionalmente especifique o Dockerfile relativo ao <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>espaço de trabalho do trabalho</a>. Deixe vazio para usar o arquivo <tt>Dockerfile</tt> no caminho de construção especificado acima");
		...
		m.put("Optionally specify a CodiBase project to be used as parent of imported projects. Leave empty to import as root projects", 
			"Opcionalmente especifique um projeto CodiBase para ser usado como pai dos projetos importados. Deixe vazio para importar como projetos raiz");
		m.put("Optionally specify a CodiBase project to be used as parent of imported repositories. Leave empty to import as root projects", 
			"Opcionalmente especifique um projeto CodiBase para ser usado como pai dos repositórios importados. Deixe vazio para importar como projetos raiz");
		...
		m.put("Optionally specify a date field to hold due date information.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Opcionalmente especifique um campo de data para armazenar informações de data de vencimento.<br><b>NOTA: </b> Você pode personalizar os campos de problemas do CodiBase caso não haja uma opção apropriada aqui");
		m.put("Optionally specify a path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to put retrieved artifacts. Leave empty to use job workspace itself", 
			"Opcionalmente especifique um caminho relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>espaço de trabalho do trabalho</a> para colocar artefatos recuperados. Deixe vazio para usar o próprio espaço de trabalho do trabalho");
		...
		m.put("Optionally specify a working period field to hold estimated time infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Opcionalmente especifique um campo de período de trabalho para armazenar informações de tempo estimado.<br><b>NOTA: </b> Você pode personalizar os campos de problemas do CodiBase caso não haja uma opção apropriada aqui");
		m.put("Optionally specify a working period field to hold spent time infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Opcionalmente especifique um campo de período de trabalho para armazenar informações de tempo gasto.<br><b>NOTA: </b> Você pode personalizar os campos de problemas do CodiBase caso não haja uma opção apropriada aqui");
		m.put("Optionally specify a working period field to hold time estimate infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Opcionalmente especifique um campo de período de trabalho para armazenar informações de estimativa de tempo.<br><b>NOTA: </b> Você pode personalizar os campos de problemas do CodiBase caso não haja uma opção apropriada aqui");
		...
		m.put("Optionally specify artifacts to retrieve from the dependency into <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Only published artifacts (via artifact publish step) can be retrieved. Leave empty to not retrieve any artifacts", 
			"Opcionalmente especifique artefatos para recuperar da dependência no <a href='https://docs.codibase.io/concepts#job-workspace'>espaço de trabalho do trabalho</a>. Apenas artefatos publicados (via etapa de publicação de artefatos) podem ser recuperados. Deixe vazio para não recuperar nenhum artefato");
		...
		m.put("Optionally specify build path relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Leave empty to use job workspace itself", 
			"Opcionalmente especifique o caminho de construção relativo ao <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>espaço de trabalho do trabalho</a>. Deixe vazio para usar o próprio espaço de trabalho do trabalho");
		...
		m.put("Optionally specify files relative to cache path to ignore when detect cache changes. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Multiple files should be separated by space, and single file containing space should be quoted", 
			"Opcionalmente especifique arquivos relativos ao caminho de cache para ignorar ao detectar mudanças no cache. Use '**', '*' ou '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondência de curinga de caminho</a>. Múltiplos arquivos devem ser separados por espaço, e arquivo único contendo espaço deve ser citado");
		m.put("Optionally specify group search base if you want to retrieve group membership information of the user. For example: <i>cn=Users, dc=example, dc=com</i>. To give appropriate permissions to a Active Directory group, a CodiBase group with same name should be defined. Leave empty to manage group memberships at CodiBase side", 
			"Opcionalmente especifique base de pesquisa de grupo se você quiser recuperar informações de associação de grupo do usuário. Por exemplo: <i>cn=Users, dc=example, dc=com</i>. Para dar permissões apropriadas a um grupo do Active Directory, um grupo do CodiBase com o mesmo nome deve ser definido. Deixe vazio para gerenciar associações de grupo no lado do CodiBase");
		...
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be used as trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/configuration/filtering/#by-finding-ids' target='_blank'>ignore file</a>", 
			"Opcionalmente especifique caminho relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>espaço de trabalho do trabalho</a> para ser usado como arquivo de ignorar do trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/configuration/filtering/#by-finding-ids' target='_blank'>ignore file</a>");
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be used as trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/scanner/secret/#configuration' target='_blank'>secret config</a>", 
			"Opcionalmente especifique caminho relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>espaço de trabalho do trabalho</a> para ser usado como configuração de segredo do trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/scanner/secret/#configuration' target='_blank'>secret config</a>");
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to publish artifacts from. Leave empty to use job workspace itself", 
			"Opcionalmente especifique caminho relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>espaço de trabalho do trabalho</a> para publicar artefatos. Deixe vazio para usar o próprio espaço de trabalho do trabalho");
		...
		m.put("Optionally specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to clone code into. Leave empty to use job workspace itself", 
			"Opcionalmente especifique caminho relativo sob <a href='https://docs.codibase.io/concepts#job-workspace'>espaço de trabalho do trabalho</a> para clonar código. Deixe vazio para usar o próprio espaço de trabalho do trabalho");
		m.put("Optionally specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to scan. Leave empty to use job workspace itself", 
			"Opcionalmente especifique caminho relativo sob <a href='https://docs.codibase.io/concepts#job-workspace'>espaço de trabalho do trabalho</a> para escanear. Deixe vazio para usar o próprio espaço de trabalho do trabalho");
		...
		m.put("Optionally specify space-separated branches applicable for this transition. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all", 
			"Opcionalmente especifique branches separados por espaço aplicáveis para esta transição. Use '**', '*' ou '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondência de curinga de caminho</a>. Prefixe com '-' para excluir. Deixe vazio para corresponder a todos");
		m.put("Optionally specify space-separated branches applicable for this trigger. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty for default branch", 
			"Opcionalmente especifique branches separados por espaço aplicáveis para este gatilho. Use '**', '*' ou '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondência de curinga de caminho</a>. Prefixe com '-' para excluir. Deixe vazio para o branch padrão");
		m.put("Optionally specify space-separated branches to check. Use '**' or '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all branches", 
			"Opcionalmente especifique branches separados por espaço para verificar. Use '**' ou '*' ou '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondência de curinga de caminho</a>. Prefixe com '-' para excluir. Deixe vazio para corresponder a todos os branches");
		...
		m.put("Optionally specify space-separated files to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all files", 
			"Opcionalmente especifique arquivos separados por espaço para verificar. Use '**', '*' ou '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondência de curinga de caminho</a>. Prefixe com '-' para excluir. Deixe vazio para corresponder a todos os arquivos");
		...
		m.put("Optionally specify space-separated projects to search in. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to search in all projects with code read permission", 
			"Opcionalmente especifique projetos separados por espaço para pesquisar. Use '**', '*' ou '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondência de curinga de caminho</a>. Prefixe com '-' para excluir. Deixe vazio para pesquisar em todos os projetos com permissão de leitura de código");
		...
		m.put("Optionally specify space-separated service images applicable for this locator. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all", 
			"Opcionalmente especifique imagens de serviço separadas por espaço aplicáveis para este localizador. Use '**', '*' ou '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondência de caracteres curinga de caminho</a>. Prefixe com '-' para excluir. Deixe vazio para corresponder a todos");
		...
		m.put("Optionally specify space-separated tags to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all tags", 
			"Opcionalmente especifique tags separadas por espaço para verificar. Use '**', '*' ou '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondência de caracteres curinga de caminho</a>. Prefixe com '-' para excluir. Deixe vazio para corresponder a todas as tags");
		m.put("Optionally specify space-separated target branches of the pull requests to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all branches", 
			"Opcionalmente especifique os ramos de destino separados por espaço dos pull requests para verificar. Use '**', '*' ou '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondência de caracteres curinga de caminho</a>. Prefixe com '-' para excluir. Deixe vazio para corresponder a todos os ramos");
		...
		m.put("Parent CodiBase Project", "Projeto Pai CodiBase");
		...
		m.put("Projects need to be redistributed when cluster members are added/removed. CodiBase does not do this automatically as this is resource intensive, and you may only want to do it after cluster is finalized and stable.", 
			"Os projetos precisam ser redistribuídos quando membros do cluster são adicionados/removidos. O CodiBase não faz isso automaticamente, pois é intensivo em recursos, e você pode querer fazer isso apenas após o cluster estar finalizado e estável.");
		...
		m.put("Pull request statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Estatísticas de pull request são um recurso empresarial. <a href='https://codibase.io/pricing' target='_blank'>Experimente grátis</a> por 30 dias");
		...
		m.put("Refer to this <a href='https://docs.codibase.io/tutorials/security/sso-with-github' target='_blank'>tutorial</a> for an example setup", 
			"Consulte este <a href='https://docs.codibase.io/tutorials/security/sso-with-github' target='_blank'>tutorial</a> para um exemplo de configuração");
		m.put("Refer to this <a href='https://docs.codibase.io/tutorials/security/sso-with-okta' target='_blank'>tutorial</a> for an example setup", 
			"Consulte este <a href='https://docs.codibase.io/tutorials/security/sso-with-okta' target='_blank'>tutorial</a> para um exemplo de configuração");
		...
		m.put("Run specified docker container. <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job workspace</a> is mounted into the container and its path is placed in environment variable <code>CODIBASE_WORKSPACE</code>. <b class='text-warning'>Note: </b> this step can only be executed by server docker executor or remote docker executor", 
			"Execute o contêiner Docker especificado. <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>O espaço de trabalho do trabalho</a> é montado no contêiner e seu caminho é colocado na variável de ambiente <code>CODIBASE_WORKSPACE</code>. <b class='text-warning'>Nota: </b> esta etapa só pode ser executada pelo executor docker do servidor ou executor docker remoto");
		...
		m.put("Set up job cache to speed up job execution. Check <a href='https://docs.codibase.io/tutorials/cicd/job-cache' target='_blank'>this tutorial</a> on how to use job cache", 
			"Configurar cache de trabalho para acelerar a execução de tarefas. Confira <a href='https://docs.codibase.io/tutorials/cicd/job-cache' target='_blank'>este tutorial</a> sobre como usar o cache de trabalho.");
		...
		m.put("Signature verified successfully with CodiBase GPG key", "Assinatura verificada com sucesso com a chave GPG do CodiBase");
		...
		m.put("Specifies the attribute containing group name inside the found group LDAP entry. Value of this attribute will be mapped to a CodiBase group. This attribute is normally set to <i>cn</i>", 
			"Especifica o atributo que contém o nome do grupo dentro da entrada LDAP do grupo encontrado. O valor deste atributo será mapeado para um grupo do CodiBase. Este atributo normalmente é definido como <i>cn</i>");
		m.put("Specify .net TRX test result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>TestResults/*.trx</tt>. Use * or ? for pattern match", 
			"Especifique o arquivo de resultado de teste .net TRX relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>workspace do job</a>, por exemplo <tt>TestResults/*.trx</tt>. Use * ou ? para correspondência de padrão");
		m.put("Specify <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> whose value is access token with code write permission over above projects. Commits, issues, and pull requests will also be created under name of the access token owner", 
			"Especifique o <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segredo do job</a> cujo valor é um token de acesso com permissão de escrita de código sobre os projetos acima. Commits, issues e pull requests também serão criados sob o nome do proprietário do token de acesso");
		m.put("Specify <a href='https://github.com/rust-lang/rust-clippy'>rust clippy</a> json output file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with clippy json output option, for instance <code>cargo clippy --message-format json>check-result.json</code>. Use * or ? for pattern match", 
			"Especifique o arquivo de saída json do <a href='https://github.com/rust-lang/rust-clippy'>rust clippy</a> relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>workspace do job</a>. Este arquivo pode ser gerado com a opção de saída json do clippy, por exemplo <code>cargo clippy --message-format json>check-result.json</code>. Use * ou ? para correspondência de padrão");
		...
		m.put("Specify CPD result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/cpd.xml</tt>. Use * or ? for pattern match", 
			"Especifique o arquivo xml de resultado CPD relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>workspace do job</a>, por exemplo, <tt>target/cpd.xml</tt>. Use * ou ? para correspondência de padrão");
		...
		m.put("Specify ESLint report file in checkstyle format under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with ESLint option <tt>'-f checkstyle'</tt> and <tt>'-o'</tt>. Use * or ? for pattern match", 
			"Especifique o arquivo de relatório ESLint no formato checkstyle no <a href='https://docs.codibase.io/concepts#job-workspace'>workspace do job</a>. Este arquivo pode ser gerado com a opção ESLint <tt>'-f checkstyle'</tt> e <tt>'-o'</tt>. Use * ou ? para correspondência de padrão");
		...
		m.put("Specify GoogleTest XML result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This report can be generated with environment variable <tt>GTEST_OUTPUT</tt> when running tests, For instance, <code>export GTEST_OUTPUT=&quot;xml:gtest-result.xml&quot;</code>. Use * or ? for pattern match", 
			"Especifique o arquivo XML de resultado do GoogleTest relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>workspace do job</a>. Este relatório pode ser gerado com a variável de ambiente <tt>GTEST_OUTPUT</tt> ao executar testes, por exemplo, <code>export GTEST_OUTPUT=&quot;xml:gtest-result.xml&quot;</code>. Use * ou ? para correspondência de padrão");
		...
		m.put("Specify JUnit test result file in XML format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>target/surefire-reports/TEST-*.xml</tt>. Use * or ? for pattern match", 
			"Especifique o arquivo de resultado de teste JUnit no formato XML relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>workspace do job</a>, por exemplo <tt>target/surefire-reports/TEST-*.xml</tt>. Use * ou ? para correspondência de padrão");
		m.put("Specify JaCoCo coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/jacoco/jacoco.xml</tt>. Use * or ? for pattern match", 
			"Especifique o arquivo de relatório de cobertura xml do JaCoCo relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>workspace do job</a>, por exemplo, <tt>target/site/jacoco/jacoco.xml</tt>. Use * ou ? para correspondência de padrão");
		m.put("Specify Jest coverage report file in clover format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>coverage/clover.xml</tt>. This file can be generated with Jest option <tt>'--coverage'</tt>. Use * or ? for pattern match", 
			"Especifique o arquivo de relatório de cobertura do Jest no formato clover relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>workspace do job</a>, por exemplo <tt>coverage/clover.xml</tt>. Este arquivo pode ser gerado com a opção Jest <tt>'--coverage'</tt>. Use * ou ? para correspondência de padrão");
		m.put("Specify Jest test result file in json format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated via Jest option <tt>'--json'</tt> and <tt>'--outputFile'</tt>. Use * or ? for pattern match", 
			"Especifique o arquivo de resultado de teste do Jest no formato json relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>workspace do job</a>. Este arquivo pode ser gerado via opção Jest <tt>'--json'</tt> e <tt>'--outputFile'</tt>. Use * ou ? para correspondência de padrão");
		m.put("Specify OCI layout directory of the image to scan. This directory can be generated via build image step or pull image step. It should be relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Especifique o diretório de layout OCI da imagem para escanear. Este diretório pode ser gerado via etapa de build de imagem ou etapa de pull de imagem. Deve ser relativo ao <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>workspace do job</a>");
		m.put("Specify OCI layout directory relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to push from", 
			"Especifique o diretório de layout OCI relativo ao <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>workspace do job</a> para fazer o push");
		...
		m.put("Specify PMD result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/pmd.xml</tt>. Use * or ? for pattern match", 
			"Especifique o arquivo xml de resultado PMD relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>workspace do job</a>, por exemplo, <tt>target/pmd.xml</tt>. Use * ou ? para correspondência de padrão");
		m.put("Specify PowerShell commands to execute under the <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>.<br><b class='text-warning'>NOTE: </b> CodiBase checks exit code of the script to determine if step is successful. Since PowerShell always exit with 0 even if there are script errors, you should handle errors in the script and exit with non-zero code, or add line <code>$ErrorActionPreference = &quot;Stop&quot;</code> at start of your script<br>", 
			"Especifique os comandos PowerShell para executar no <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>workspace do job</a>.<br><b class='text-warning'>NOTA: </b> O CodiBase verifica o código de saída do script para determinar se a etapa foi bem-sucedida. Como o PowerShell sempre sai com 0 mesmo que haja erros no script, você deve lidar com erros no script e sair com um código diferente de zero, ou adicionar a linha <code>$ErrorActionPreference = &quot;Stop&quot;</code> no início do seu script<br>");
		m.put("Specify Roslynator diagnostics output file in XML format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with <i>-o</i> option. Use * or ? for pattern match", 
			"Especifique o arquivo de saída de diagnósticos Roslynator no formato XML relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>workspace do job</a>. Este arquivo pode ser gerado com a opção <i>-o</i>. Use * ou ? para correspondência de padrão");
		...
		m.put("Specify SpotBugs result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/spotbugsXml.xml</tt>. Use * or ? for pattern match", 
			"Especifique o arquivo xml de resultado SpotBugs relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>workspace do job</a>, por exemplo, <tt>target/spotbugsXml.xml</tt>. Use * ou ? para correspondência de padrão");
		...
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as SSH private key", 
			"Especifique um <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segredo do job</a> para ser usado como chave privada SSH");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as access token", 
			"Especifique um <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segredo do job</a> para ser usado como token de acesso");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as access token to import build spec from above project if its code is not publicly accessible", 
			"Especifique um <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segredo do job</a> para ser usado como token de acesso para importar a especificação de build do projeto acima, caso seu código não seja publicamente acessível");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as password or access token of the registry", 
			"Especifique um <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segredo do job</a> para ser usado como senha ou token de acesso do registro");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as password or access token to access remote repository", 
			"Especifique um <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segredo do job</a> para ser usado como senha ou token de acesso para acessar o repositório remoto");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as private key for SSH authentication. <b class='text-info'>NOTE:</b> Private key with passphrase is not supported", 
			"Especifique um <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segredo do job</a> para ser usado como chave privada para autenticação SSH. <b class='text-info'>NOTA:</b> Chave privada com frase secreta não é suportada");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as private key of above user for SSH authentication. <b class='text-info'>NOTE:</b> Private key with passphrase is not supported", 
			"Especifique um <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>segredo do job</a> para ser usado como chave privada do usuário acima para autenticação SSH. <b class='text-info'>NOTA:</b> Chave privada com frase secreta não é suportada");
		...
		m.put("Specify a file relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to write checksum into", 
			"Especifique um arquivo relativo ao <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>workspace do job</a> para gravar o checksum");
		m.put("Specify a multi-value user field to hold assignees information.<b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Especifique um campo de usuário multi-valor para armazenar informações de responsáveis.<b>NOTA: </b> Você pode personalizar os campos de issues do CodiBase caso não haja uma opção apropriada aqui");
		m.put("Specify a multi-value user field to hold assignees information.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Especifique um campo de usuário multi-valor para armazenar informações de responsáveis.<br><b>NOTA: </b> Você pode personalizar os campos de issues do CodiBase caso não haja uma opção apropriada aqui");
		...
		m.put("Specify absolute path to the kubectl utility, for instance: <i>/usr/bin/kubectl</i>. If left empty, CodiBase will try to find the utility from system path", 
			"Especifique o caminho absoluto para a utilidade kubectl, por exemplo: <i>/usr/bin/kubectl</i>. Se deixado vazio, o CodiBase tentará encontrar a utilidade no caminho do sistema");
		...
		m.put("Specify applicable projects for above option. Multiple projects should be separated by space. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty for all projects", 
			"Especifique projetos aplicáveis para a opção acima. Múltiplos projetos devem ser separados por espaço. Use '**', '*' ou '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondência de padrão de caminho</a>. Prefixe com '-' para excluir. Deixe vazio para todos os projetos");
		m.put("Specify applicable projects separated by space. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty for all projects", 
			"Especifique projetos aplicáveis separados por espaço. Use '**', '*' ou '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondência de padrão de caminho</a>. Prefixe com '-' para excluir. Deixe vazio para todos os projetos");
		...
		m.put("Specify artifacts to retrieve into <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Only published artifacts (via artifact publish step) can be retrieved.", 
			"Especifique artefatos para recuperar no <a href='https://docs.codibase.io/concepts#job-workspace'>workspace do job</a>. Apenas artefatos publicados (via etapa de publicação de artefatos) podem ser recuperados.");
		m.put("Specify at least 10 alphanumeric chars to be used as secret, and then add an inbound parse entry at SendGrid side:<ul><li><code>Destination URL</code> should be set to <i>&lt;CodiBase root url&gt;/~sendgrid/&lt;secret&gt;</i>, for instance, <i>https://codibase.example.com/~sendgrid/1234567890</i>. Note that in production environment, <a href='https://docs.codibase.io/administration-guide/https-setup' target='_blank'>https should be enabled</a> to protect the secret</li><li><code>Receiving domain</code> should be the same as domain part of system email address specified above</li><li>Option <code>POST the raw, full MIME message</code> is enabled</li></ul>", 
			"Especifique pelo menos 10 caracteres alfanuméricos para serem usados como segredo e, em seguida, adicione uma entrada de análise de entrada no lado do SendGrid:<ul><li><code>URL de Destino</code> deve ser configurado como <i>&lt;URL raiz do CodiBase&gt;/~sendgrid/&lt;segredo&gt;</i>, por exemplo, <i>https://codibase.example.com/~sendgrid/1234567890</i>. Note que em ambiente de produção, <a href='https://docs.codibase.io/administration-guide/https-setup' target='_blank'>https deve ser habilitado</a> para proteger o segredo</li><li><code>Domínio de Recebimento</code> deve ser o mesmo que a parte do domínio do endereço de email do sistema especificado acima</li><li>Opção <code>POST the raw, full MIME message</code> está habilitada</li></ul>");
		...
		m.put("Specify clover coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/clover/clover.xml</tt>. Refer to <a href='https://openclover.org/documentation'>OpenClover documentation</a> on how to generate clover xml file. Use * or ? for pattern match", 
			"Especifique o arquivo de relatório de cobertura xml do clover relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>workspace do job</a>, por exemplo, <tt>target/site/clover/clover.xml</tt>. Consulte a <a href='https://openclover.org/documentation'>documentação do OpenClover</a> sobre como gerar o arquivo xml do clover. Use * ou ? para correspondência de padrão");
		m.put("Specify cobertura coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/cobertura/coverage.xml</tt>. Use * or ? for pattern match", 
			"Especifique o arquivo de relatório de cobertura xml do cobertura relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>workspace do job</a>, por exemplo, <tt>target/site/cobertura/coverage.xml</tt>. Use * ou ? para correspondência de padrão");
		...
		m.put("Specify configuration discovery url of your OpenID provider, for instance: <code>https://openid.example.com/.well-known/openid-configuration</code>. Make sure to use HTTPS protocol as CodiBase relies on TLS encryption to ensure token validity", 
			"Especifique a URL de descoberta de configuração do seu provedor OpenID, por exemplo: <code>https://openid.example.com/.well-known/openid-configuration</code>. Certifique-se de usar o protocolo HTTPS, pois o CodiBase depende da criptografia TLS para garantir a validade do token");
		...
		m.put("Specify directory relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to store OCI layout", 
			"Especifique o diretório relativo ao <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>espaço de trabalho do trabalho</a> para armazenar o layout OCI");
		...
		m.put("Specify dockerx builder used to build docker image. CodiBase will create the builder automatically if it does not exist. Check <a href='https://docs.codibase.io/tutorials/cicd/insecure-docker-registry' target='_blank'>this tutorial</a> on how to customize the builder for instance to allow publishing to insecure registries", 
			"Especifique o builder dockerx usado para construir a imagem do docker. O CodiBase criará o builder automaticamente se ele não existir. Verifique <a href='https://docs.codibase.io/tutorials/cicd/insecure-docker-registry' target='_blank'>este tutorial</a> sobre como personalizar o builder, por exemplo, para permitir a publicação em registros inseguros");
		...
		m.put("Specify files relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be published. Use * or ? for pattern match", 
			"Especifique os arquivos relativos ao <a href='https://docs.codibase.io/concepts#job-workspace'>espaço de trabalho do trabalho</a> a serem publicados. Use * ou ? para correspondência de padrão");
		...
		m.put("Specify how to map GitHub issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Especifique como mapear os rótulos de problemas do GitHub para os campos personalizados do CodiBase.<br><b>NOTA: </b> Você pode personalizar os campos de problemas do CodiBase caso não haja uma opção apropriada aqui");
		m.put("Specify how to map GitLab issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Especifique como mapear os rótulos de problemas do GitLab para os campos personalizados do CodiBase.<br><b>NOTA: </b> Você pode personalizar os campos de problemas do CodiBase caso não haja uma opção apropriada aqui");
		m.put("Specify how to map Gitea issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Especifique como mapear os rótulos de problemas do Gitea para os campos personalizados do CodiBase.<br><b>NOTA: </b> Você pode personalizar os campos de problemas do CodiBase caso não haja uma opção apropriada aqui");
		m.put("Specify how to map JIRA issue priorities to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Especifique como mapear as prioridades de problemas do JIRA para os campos personalizados do CodiBase.<br><b>NOTA: </b> Você pode personalizar os campos de problemas do CodiBase caso não haja uma opção apropriada aqui");
		m.put("Specify how to map JIRA issue statuses to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Especifique como mapear os estados de problemas do JIRA para os campos personalizados do CodiBase.<br><b>NOTA: </b> Você pode personalizar os estados de problemas do CodiBase caso não haja uma opção apropriada aqui");
		m.put("Specify how to map JIRA issue types to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Especifique como mapear os tipos de problemas do JIRA para os campos personalizados do CodiBase.<br><b>NOTA: </b> Você pode personalizar os campos de problemas do CodiBase caso não haja uma opção apropriada aqui");
		...
		m.put("Specify how to map YouTrack issue links to CodiBase issue links.<br><b>NOTE: </b> You may customize CodiBase issue links in case there is no appropriate option here", 
			"Especifique como mapear os links de problemas do YouTrack para os links de problemas do CodiBase.<br><b>NOTA: </b> Você pode personalizar os links de problemas do CodiBase caso não haja uma opção apropriada aqui");
		m.put("Specify how to map YouTrack issue state to CodiBase issue state. Unmapped states will use the initial state in CodiBase.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Especifique como mapear o estado de problemas do YouTrack para o estado de problemas do CodiBase. Estados não mapeados usarão o estado inicial no CodiBase.<br><b>NOTA: </b> Você pode personalizar os estados de problemas do CodiBase caso não haja uma opção apropriada aqui");
		m.put("Specify how to map YouTrack issue tags to CodiBase issue custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Especifique como mapear as tags de problemas do YouTrack para os campos personalizados de problemas do CodiBase.<br><b>NOTA: </b> Você pode personalizar os campos de problemas do CodiBase caso não haja uma opção apropriada aqui");
		...
		m.put("Specify manager DN to authenticate CodiBase itself to Active Directory. The manager DN should be specified in form of <i>&lt;account name&gt;@&lt;domain&gt;</i>, for instance: <i>manager@example.com</i>", 
			"Especifique o DN do gerente para autenticar o próprio CodiBase no Active Directory. O DN do gerente deve ser especificado na forma de <i>&lt;account name&gt;@&lt;domain&gt;</i>, por exemplo: <i>manager@example.com</i>");
		m.put("Specify manager DN to authenticate CodiBase itself to LDAP server", "Especifique o DN do gerente para autenticar o próprio CodiBase no servidor LDAP");
		m.put("Specify markdown file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be published", 
			"Especifique o arquivo markdown relativo ao <a href='https://docs.codibase.io/concepts#job-workspace'>espaço de trabalho do trabalho</a> a ser publicado");
		...
		m.put("Specify project to import into at CodiBase side", "Especifique o projeto para importar no lado do CodiBase");
		...
		m.put("Specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to store OCI layout", 
			"Especifique o caminho relativo sob o <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>espaço de trabalho do trabalho</a> para armazenar o layout OCI");
		...
		m.put("Specify shell commands (on Linux/Unix) or batch commands (on Windows) to execute under the <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Especifique os comandos shell (em Linux/Unix) ou comandos batch (em Windows) para executar sob o <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>espaço de trabalho do trabalho</a>");
		m.put("Specify shell commands to execute under the <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Especifique os comandos shell para executar sob o <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>espaço de trabalho do trabalho</a>");
		...
		m.put("Specify space-separated branches to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Especifique os branches separados por espaço a serem protegidos. Use '**', '*' ou '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondência de curinga de caminho</a>. Prefixe com '-' para excluir");
		...
		m.put("Specify space-separated paths to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Especifique os caminhos separados por espaço a serem protegidos. Use '**', '*' ou '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondência de curinga de caminho</a>. Prefixe com '-' para excluir");
		...
		m.put("Specify space-separated tags to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Especifique as tags separadas por espaço a serem protegidas. Use '**', '*' ou '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondência de curinga de caminho</a>. Prefixe com '-' para excluir");
		m.put("Specify start page of the report relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance: <tt>manual/index.md</tt>", 
			"Especifique a página inicial do relatório relativa ao <a href='https://docs.codibase.io/concepts#job-workspace'>espaço de trabalho do trabalho</a>, por exemplo: <tt>manual/index.md</tt>");
		m.put("Specify start page of the report relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance: api/index.html", 
			"Especifique a página inicial do relatório relativa ao <a href='https://docs.codibase.io/concepts#job-workspace'>espaço de trabalho do trabalho</a>, por exemplo: api/index.html");
		...
		m.put("Specify the strategy to retrieve group membership information. To give appropriate permissions to a LDAP group, a CodiBase group with same name should be defined. Use strategy <tt>Do Not Retrieve Groups</tt> if you want to manage group memberships at CodiBase side", 
			"Especifique a estratégia para recuperar informações de associação de grupo. Para conceder permissões apropriadas a um grupo LDAP, um grupo CodiBase com o mesmo nome deve ser definido. Use a estratégia <tt>Não Recuperar Grupos</tt> se desejar gerenciar associações de grupo no lado do CodiBase");
		...
		m.put("Specify which issue state to use for closed GitHub issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Especifique qual estado de problema usar para problemas fechados no GitHub.<br><b>NOTA: </b> Você pode personalizar os estados de problemas do CodiBase caso não haja uma opção apropriada aqui");
		m.put("Specify which issue state to use for closed GitLab issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Especifique qual estado de problema usar para problemas fechados no GitLab.<br><b>NOTA: </b> Você pode personalizar os estados de problemas do CodiBase caso não haja uma opção apropriada aqui");
		m.put("Specify which issue state to use for closed Gitea issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"Especifique qual estado de problema usar para problemas fechados no Gitea.<br><b>NOTA: </b> Você pode personalizar os estados de problemas do CodiBase caso não haja uma opção apropriada aqui");
		m.put("Specify which states are considered as closed for various issues created by Renovate to orchestrate dependency update. Additionally, when Renovate closes the issue, CodiBase will transit the issue to first state specified here", 
			"Especifique quais estados são considerados como fechados para vários problemas criados pelo Renovate para orquestrar a atualização de dependências. Além disso, quando o Renovate fecha o problema, o CodiBase irá transitar o problema para o primeiro estado especificado aqui");
		...
		m.put("Steps will be executed serially on same node, sharing the same <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>", 
			"As etapas serão executadas sequencialmente no mesmo nó, compartilhando o mesmo <a href='https://docs.codibase.io/concepts#job-workspace'>workspace de trabalho</a>");
		...
		m.put("The secret which allows you to ensure that POST requests sent to the payload URL are from CodiBase. When you set a secret you'll receive the X-CodiBase-Signature header in the webhook POST request", 
			"O segredo que permite garantir que as solicitações POST enviadas para a URL de payload sejam do CodiBase. Quando você define um segredo, receberá o cabeçalho X-CodiBase-Signature na solicitação POST do webhook");
		m.put("The service desk feature enables user to create issues by sending emails to CodiBase. Issues can be discussed over email completely, without the need of logging to CodiBase.", 
			"O recurso de service desk permite ao usuário criar questões enviando emails para o CodiBase. As questões podem ser discutidas completamente por email, sem a necessidade de fazer login no CodiBase.");
		...
		m.put("This executor runs build jobs as docker containers on CodiBase server", "Este executor executa trabalhos de build como contêineres Docker no servidor CodiBase");
		...
		m.put("This executor runs build jobs with CodiBase server's shell facility.<br><b class='text-danger'>WARNING</b>: Jobs running with this executor has same permission as CodiBase server process. Make sure it can only be used by trusted jobs", 
			"Este executor executa trabalhos de construção com a funcionalidade de shell do servidor CodiBase.<br><b class='text-danger'>AVISO</b>: Trabalhos executados com este executor têm as mesmas permissões que o processo do servidor CodiBase. Certifique-se de que ele só possa ser usado por trabalhos confiáveis");
		...
		m.put("This installation does not have an active subscription and runs as community edition. To access <a href=\"https://codibase.io/pricing\">enterprise features</a>, an active subscription is required", 
			"Esta instalação não possui uma assinatura ativa e está sendo executada como edição comunitária. Para acessar <a href=\"https://codibase.io/pricing\">recursos empresariais</a>, é necessária uma assinatura ativa");
		...
		m.put("This is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Este é um recurso enterprise. <a href='https://codibase.io/pricing' target='_blank'>Experimente grátis</a> por 30 dias");
		...
		m.put("This page lists changes since previous build on <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">same stream</a>", 
			"Esta página lista as alterações desde a build anterior no <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">mesmo fluxo</a>");
		...
		m.put("This server is currently accessed via http protocol, please configure your docker daemon or buildx builder to <a href=\"https://docs.codibase.io/tutorials/cicd/insecure-docker-registry\" target=\"_blank\">work with insecure registry</a>", 
			"Este servidor está atualmente acessado via protocolo http, configure seu daemon Docker ou builder buildx para <a href=\"https://docs.codibase.io/tutorials/cicd/insecure-docker-registry\" target=\"_blank\">trabalhar com registro inseguro</a>");
		...
		m.put("This step can only be executed by a docker aware executor. It runs under <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"Esta etapa só pode ser executada por um executor compatível com Docker. Ela é executada sob <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>espaço de trabalho do trabalho</a>");
		...
		m.put("This step publishes specified files to be served as project web site. Project web site can be accessed publicly via <code>http://&lt;codibase base url&gt;/path/to/project/~site</code>", 
			"Esta etapa publica os arquivos especificados para serem servidos como site web do projeto. O site web do projeto pode ser acessado publicamente via <code>http://&lt;codibase base url&gt;/path/to/project/~site</code>");
		...
		m.put("This tab shows the pipeline containing current build. Check <a href=\"https://robinshen.medium.com/understanding-codibase-pipeline-db0bb0e54aa7\" target=\"_blank\">this article</a> to understand how build pipeline works", 
			"Esta aba mostra o pipeline contendo a build atual. Confira <a href=\"https://robinshen.medium.com/understanding-codibase-pipeline-db0bb0e54aa7\" target=\"_blank\">este artigo</a> para entender como funciona o pipeline de build");
		...
		m.put("Two-factor authentication is enabled. Please input passcode displayed on your TOTP authenticator. If you encounter problems, make sure time of CodiBase server and your device running TOTP authenticator is in sync", 
			"A autenticação de dois fatores está ativada. Insira o código exibido no seu autenticador TOTP. Se encontrar problemas, certifique-se de que o horário do servidor CodiBase e do seu dispositivo com o autenticador TOTP estão sincronizados");
		...
		m.put("Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>", 
			"Use '**', '*' ou '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondência de curinga de caminho</a>");
		m.put("Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"Use '**', '*' ou '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondência de curinga de caminho</a>. Prefixe com '-' para excluir");
		m.put("Use '**', '*', or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>", 
			"Use '**', '*', ou '?' para <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>correspondência de curinga de caminho</a>");
		...
		m.put("Use job token as user name so that CodiBase can know which build is ${permission.equals(\"write\")? \"deploying\": \"using\"} packages", 
			"Usar token de trabalho como nome de usuário para que o CodiBase saiba qual build está ${permission.equals(\"write\")? \"implantando\": \"usando\"} pacotes");
		m.put("Use job token to tell CodiBase the build publishing the package", "Usar token de trabalho para informar ao CodiBase o build que está publicando o pacote");
		m.put("Use job token to tell CodiBase the build pushing the chart", "Usar token de trabalho para informar ao CodiBase o build que está enviando o gráfico");
		m.put("Use job token to tell CodiBase the build pushing the package", "Usar token de trabalho para informar ao CodiBase o build que está enviando o pacote");
		m.put("Use job token to tell CodiBase the build using the package", "Usar token de trabalho para informar ao CodiBase o build que está usando o pacote");
		...
		m.put("When login via CodiBase's built-in form, submitted user credentials can be checked against authenticator defined here, besides the internal database", 
			"Ao fazer login via o formulário interno do CodiBase, as credenciais do usuário enviadas podem ser verificadas contra o autenticador definido aqui, além do banco de dados interno");
		...
		m.put("Whether or not to create as a service account for task automation purpose. Service account does not have password and email addresses, and will not generate notifications for its activities. <b class='text-warning'>NOTE:</b> Service account is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"Se criar como uma conta de serviço para fins de automação de tarefas ou não. Conta de serviço não tem senha e endereços de email, e não gerará notificações para suas atividades. <b class='text-warning'>NOTA:</b> Conta de serviço é um recurso empresarial. <a href='https://codibase.io/pricing' target='_blank'>Experimente grátis</a> por 30 dias");
		...
		m.put("Whether or not to fetch LFS objects if pull request is opened from a different project. If this option is enabled, git lfs command needs to be installed on CodiBase server", 
			"Se buscar objetos LFS se o pull request for aberto de um projeto diferente ou não. Se esta opção estiver habilitada, o comando git lfs precisa estar instalado no servidor CodiBase");
		...
		m.put("Whether or not to mount docker sock into job container to support docker operations in job commands<br><b class='text-danger'>WARNING</b>: Malicious jobs can take control of whole CodiBase by operating the mounted docker sock. Make sure this executor can only be used by trusted jobs if this option is enabled", 
			"Se deve ou não montar o docker sock no contêiner do trabalho para suportar operações docker nos comandos do trabalho<br><b class='text-danger'>AVISO</b>: Trabalhos maliciosos podem assumir o controle de todo o CodiBase operando o docker sock montado. Certifique-se de que este executor só possa ser usado por trabalhos confiáveis se esta opção estiver habilitada");
		...
		m.put("Whether or not to retrieve submodules. Refer to <a href='https://docs.codibase.io/tutorials/cicd/clone-submodules' target='_blank'>this tutorial</a> on how to set up clone credential above to retrieve submodules", 
			"Se recuperar submódulos ou não. Consulte <a href='https://docs.codibase.io/tutorials/cicd/clone-submodules' target='_blank'>este tutorial</a> sobre como configurar a credencial de clone acima para recuperar submódulos");
		...
		m.put("[Any state]", "[Qualquer estado]");
		m.put("[Reset Password] Please Reset Your CodiBase Password", "[Redefinir Senha] Por favor, redefina sua senha do CodiBase");
		...
		m.put("adding .codibase-buildspec.yml", "adicionando .codibase-buildspec.yml");
		...
		m.put("an <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/notification/Unsubscribable.java' target='_blank'>object</a> holding unsubscribe information.  A <code>null</code> value means that the notification can not be unsubscribed", 
			"um <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/notification/Unsubscribable.java' target='_blank'>objeto</a> contendo informações de cancelamento de inscrição. Um valor <code>null</code> significa que a notificação não pode ser cancelada");
		...
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Build.java' target='_blank'>build</a> object to be notified", 
			"representa o objeto <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Build.java' target='_blank'>build</a> a ser notificado");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a> being opened via service desk", 
			"representa o <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>problema</a> sendo aberto via service desk");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a> object to be notified", 
			"representa o objeto <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>problema</a> a ser notificado");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Pack.java' target='_blank'>package</a> object to be notified", 
			"representa o objeto <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Pack.java' target='_blank'>pacote</a> a ser notificado");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a> object to be notified", 
			"representa o objeto <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a> a ser notificado");
		...
		m.put("represents the unsubscribed <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a>", 
			"representa o <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>problema</a> não inscrito");
		m.put("represents the unsubscribed <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a>", 
			"representa o <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a> não inscrito");
		m.put("request to change", "solicitação de alteração");
		m.put("root", "raiz");
		m.put("root url of CodiBase server", "url raiz do servidor CodiBase");
