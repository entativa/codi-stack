...
import io.codibase.server.search.entity.build.FixedIssueCriteria;
					...
					protected Component newDeleteLink(String componentId) {
						return new AjaxLink<Void>(componentId) {
							...
							public void onClick(AjaxRequestTarget target) {
								CodiBase.getInstance(IssueService.class).delete(getIssue());
								var oldAuditContent = VersionedXmlDoc.fromBean(getIssue()).toXML();
								CodiBase.getInstance(AuditService.class).audit(getIssue().getProject(), "deleted issue \"" + getIssue().getReference().toString(getIssue().getProject()) + "\"", oldAuditContent, null);
