...
import io.codibase.server.web.component.AgentStatusBadge;
	...
	protected void onInitialize() {
		...
		add(new Link<Void>("regenerateAccessToken") {
			...
			public void onClick() {
				...
				CodiBase.getInstance(AgentService.class).disconnect(getAgent().getId());
		...
		if (getAgent().isOnline()) {
			...
			Form<?> form = new Form<Void>("form") {
				...
				protected void onSubmit() {
					...
					CodiBase.getInstance(AgentAttributeService.class).syncAttributes(getAgent(), attributeMap);
