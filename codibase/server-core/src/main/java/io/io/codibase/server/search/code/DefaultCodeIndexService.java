...
import static io.codibase.server.search.code.FieldConstants.BLOB_HASH;
import static io.codibase.server.search.code.FieldConstants.BLOB_INDEX_VERSION;
import static io.codibase.server.search.code.FieldConstants.BLOB_NAME;
import static io.codibase.server.search.code.FieldConstants.BLOB_PATH;
import static io.codibase.server.search.code.FieldConstants.BLOB_PRIMARY_SYMBOLS;
import static io.codibase.server.search.code.FieldConstants.BLOB_SECONDARY_SYMBOLS;
import static io.codibase.server.search.code.FieldConstants.BLOB_SYMBOL_LIST;
import static io.codibase.server.search.code.FieldConstants.BLOB_TEXT;
import static io.codibase.server.search.code.FieldConstants.COMMIT_HASH;
import static io.codibase.server.search.code.FieldConstants.COMMIT_INDEX_VERSION;
import static io.codibase.server.search.code.FieldConstants.LAST_COMMIT;
import static io.codibase.server.search.code.FieldConstants.LAST_COMMIT_HASH;
import static io.codibase.server.search.code.FieldConstants.LAST_COMMIT_INDEX_VERSION;
import static io.codibase.server.search.code.FieldConstants.META;
import static io.codibase.server.search.code.IndexConstants.MAX_INDEXABLE_BLOB_SIZE;
import static io.codibase.server.search.code.IndexConstants.MAX_INDEXABLE_LINE_LEN;
import static io.codibase.server.search.code.IndexConstants.NGRAM_SIZE;
...
import io.codibase.server.util.IndexResult;
