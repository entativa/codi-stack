...
import io.codibase.server.util.usage.InUseException;
import io.codibase.server.web.component.svg.SpriteImageResolver;
import io.codibase.server.web.mapper.BaseResourceMapper;
import io.codibase.server.web.mapper.BaseUrlMapper;
import io.codibase.server.web.page.HomePage;
import io.codibase.server.web.page.base.BasePage;
import io.codibase.server.web.page.error.GeneralErrorPage;
import io.codibase.server.web.page.error.InUseErrorPage;
import io.codibase.server.web.resource.SpriteResourceReference;
import io.codibase.server.web.resource.SpriteResourceStream;
import io.codibase.server.web.resourcebundle.ResourceBundleReferences;
import io.codibase.server.web.translation.TranslationResolver;
import io.codibase.server.web.translation.TranslationStringResourceLoader;
import io.codibase.server.web.translation.TranslationTagHandler;
import io.codibase.server.web.util.AbsoluteUrlRenderer;
		...
		getAjaxRequestTargetListeners().add(new AjaxRequestTarget.IListener() {
			...
			public void onAfterRespond(Map<String, Component> map, IJavaScriptResponse response) {
				if (!map.isEmpty()) {
					...
					if (target != null)
						CodiBase.getInstance(WebSocketService.class).observe((BasePage) target.getPage());
				}
			}
