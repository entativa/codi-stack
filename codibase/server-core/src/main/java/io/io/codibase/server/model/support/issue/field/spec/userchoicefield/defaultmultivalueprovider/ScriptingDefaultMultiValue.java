package io.codibase.server.model.support.issue.field.spec.userchoicefield.defaultmultivalueprovider;
...
public class ScriptingDefaultMultiValue implements DefaultMultiValueProvider {
	...
	@Editable(description="Groovy script to be evaluated. It should return string or list of string. "
			+ "Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details")
	@ScriptChoice
	@OmitName
	@NotEmpty
