...
import io.codibase.server.web.component.pullrequest.choice.PullRequestChoiceProvider;
import io.codibase.server.web.component.pullrequest.choice.PullRequestSingleChoice;
...
public class PullRequestChoiceEditor extends PropertyEditor<Long> {
	...
	protected void onInitialize() {
		...
		if (getModelObject() != null)
			request = CodiBase.getInstance(PullRequestService.class).get(getModelObject());
		else
			request = null;
