...
import static io.codibase.server.model.support.administration.emailtemplates.EmailTemplates.DEFAULT_EMAIL_VERIFICATION;
import static io.codibase.server.model.support.administration.emailtemplates.EmailTemplates.PROP_EMAIL_VERIFICATION;
...
public class EmailVerificationTemplatePage extends AbstractTemplatePage {
	...
	protected Map<String, String> getVariableHelp() {
		return CollectionUtils.newLinkedHashMap(
				"user", _T("<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">user</a> to verify email for"),
