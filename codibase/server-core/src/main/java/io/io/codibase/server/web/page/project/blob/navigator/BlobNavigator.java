package io.codibase.server.web.page.project.blob.navigator;
...
import io.codibase.server.util.ChildrenAggregator;
...
public class BlobNavigator extends Panel {
	...
	protected void onInitialize() {
		...
		if (context.getMode() == Mode.EDIT || context.getMode() == Mode.ADD) {
			...
			else if (file.path.equals(".codibase-buildspec"))
