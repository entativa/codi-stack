package io.codibase.server.web.avatar;
...
import static io.codibase.commons.utils.FileUtils.createDir;
import static io.codibase.commons.utils.LockUtils.read;
import static io.codibase.commons.utils.LockUtils.write;
import static io.codibase.server.web.avatar.AvatarGenerator.generate;
import static io.codibase.server.web.component.avatarupload.AvatarUploadField.writeToFile;
...
public class DefaultAvatarService implements AvatarService, Serializable {
	...
	public String getUserAvatarUrl(Long userId) {
		if (userId.equals(User.UNKNOWN_ID)) {
			...
			return AVATARS_BASE_URL + "codibase.png";
		} else {
