...
public class Translation_ja extends TranslationResourceBundle {
	...
	public static void init(Map<String, String> m) {
		...
		m.put("** Enterprise edition is disabled as the trial subscription was expired, order subscription to enable or contact support@codibase.io if you need to extend your trial **", 
			"** トライアルサブスクリプションが期限切れのため、エンタープライズ版は無効化されています。有効化するにはサブスクリプションを注文するか、トライアル延長が必要な場合は support@codibase.io にお問い合わせください **");
		...
		m.put("<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">user</a> to reset password for", 
			"<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">ユーザー</a>のパスワードをリセットするため");
		m.put("<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">user</a> to verify email for", 
			"<a href=\"https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/User.java\">ユーザー</a>のメールを確認するため");
		m.put("<a href=\"https://guides.github.com/features/mastering-markdown/\" target=\"_blank\">GitHub flavored markdown</a> is accepted, with <a href=\"https://docs.codibase.io/appendix/markdown-syntax\" target=\"_blank\">mermaid and katex support</a>.", 
			"<a href=\"https://guides.github.com/features/mastering-markdown/\" target=\"_blank\">GitHub フレーバードマークダウン</a>が使用可能で、<a href=\"https://docs.codibase.io/appendix/markdown-syntax\" target=\"_blank\">mermaid と katex のサポート</a>があります。");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/event/Event.java' target='_blank'>event object</a> triggering the notification", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/event/Event.java' target='_blank'>通知をトリガーするイベントオブジェクト</a>");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Alert.java'>alert</a> to display", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Alert.java'>表示するアラート</a>");
		m.put("<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Stopwatch.java'>Stopwatch</a> overdue", 
			"<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Stopwatch.java'>ストップウォッチ</a>が期限切れ");
		...
		m.put("<b class='text-danger'>NOTE: </b> This requires an enterprise subscription. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>注意: </b> これはエンタープライズサブスクリプションが必要です。<a href='https://codibase.io/pricing' target='_blank'>30日間無料で試す</a>");
		m.put("<b class='text-danger'>NOTE: </b> This step requires an enterprise subscription. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>注意: </b> このステップはエンタープライズサブスクリプションが必要です。<a href='https://codibase.io/pricing' target='_blank'>30日間無料で試す</a>");
		m.put("<b class='text-danger'>NOTE: </b>SendGrid integration is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-danger'>注意: </b>SendGridの統合はエンタープライズ機能です。<a href='https://codibase.io/pricing' target='_blank'>30日間無料で試す</a>");
		m.put("<b class='text-warning'>NOTE: </b><a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>Time tracking</a> is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"<b class='text-warning'>注意: </b><a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>タイムトラッキング</a>はエンタープライズ機能です。<a href='https://codibase.io/pricing' target='_blank'>30日間無料で試す</a>");
		...
		m.put("<b>Tips: </b> Type <tt>@</tt> to <a href='https://docs.codibase.io/appendix/job-variables' target='_blank' tabindex='-1'>insert variable</a>. Use <tt>@@</tt> for literal <tt>@</tt>", 
			"<b>ヒント: </b> <tt>@</tt> を入力して<a href='https://docs.codibase.io/appendix/job-variables' target='_blank' tabindex='-1'>変数を挿入</a>します。リテラル<tt>@</tt>には<tt>@@</tt>を使用してください");
		...
		m.put("Auto update check is performed by requesting an image in your browser from codibase.io indicating new version availability, with color indicating severity of the update. It works the same way as how gravatar requests avatar images. If disabled, you are highly recommended to check update manually from time to time (can be done via help menu on left bottom of the screen) to see if there are any security/critical fixes", 
			"自動更新チェックは、ブラウザでcodibase.ioから画像をリクエストすることで新しいバージョンの利用可能性を確認し、更新の重要度を色で示します。これは、Gravatarがアバター画像をリクエストする方法と同じです。無効にした場合は、セキュリティ/重要な修正があるかどうかを確認するために、定期的に手動で更新を確認することを強くお勧めします（画面左下のヘルプメニューから実行可能）。");
		...
		m.put("Build statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"ビルド統計はエンタープライズ機能です。<a href='https://codibase.io/pricing' target='_blank'>30日間無料でお試しください</a>");
		m.put("Build version", "ビルドバージョン");
		...
		m.put("By default code is cloned via an auto-generated credential, which only has read permission over current project. In case the job needs to <a href='https://docs.codibase.io/tutorials/cicd/commit-and-push' target='_blank'>push code to server</a>, you should supply custom credential with appropriate permissions here", 
			"デフォルトではコードは自動生成された資格情報を介してクローンされ、現在のプロジェクトに対して読み取り権限のみを持ちます。ジョブが<a href='https://docs.codibase.io/tutorials/cicd/commit-and-push' target='_blank'>コードをサーバーにプッシュ</a>する必要がある場合は、適切な権限を持つカスタム資格情報をここで提供してください");
		...
		m.put("Change property <code>serverUrl</code> in file <code>conf/agent.properties</code> if necessary. The default value is taken from CodiBase server url specified in <i>Administration / System Setting</i>", 
			"必要に応じてファイル<code>conf/agent.properties</code>のプロパティ<code>serverUrl</code>を変更してください。デフォルト値は<i>管理 / システム設定</i>で指定されたCodiBaseサーバーURLから取得されます");
		...
		m.put("Check <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">agent management</a> for details, including instructions on how to run agent as service", 
			"詳細については<a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">エージェント管理</a>を確認してください。サービスとしてエージェントを実行する方法を含む指示があります");
		m.put("Check <a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">agent management</a> for details, including list of supported environment variables", 
			"詳細については<a href=\"https://docs.codibase.io/administration-guide/agent-management\" target=\"_blank\">エージェント管理</a>を確認してください。サポートされている環境変数のリストを含みます");
		...
		m.put("Client ID of this CodiBase instance registered in Google cloud", "Googleクラウドに登録されたこのCodiBaseインスタンスのクライアントID");
		m.put("Client Id", "クライアントID");
		m.put("Client Secret", "クライアントシークレット");
		m.put("Client secret of this CodiBase instance registered in Google cloud", "Googleクラウドに登録されたこのCodiBaseインスタンスのクライアントシークレット");
		...
		m.put("Commits generated by CodiBase previously will be shown as unverified if this key is deleted. Type <code>yes</code> below if you want to continue.", 
			"以前にCodiBaseによって生成されたコミットは、このキーが削除されると未確認として表示されます。続行する場合は<code>yes</code>と入力してください。");
		...
		m.put("Enable <a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>time tracking</a> for this project to track progress and generate timesheets", 
			"このプロジェクトの進捗を追跡し、タイムシートを生成するために <a href='https://docs.codibase.io/tutorials/issue/time-tracking' target='_blank'>タイムトラッキング</a> を有効にしてください。");
		m.put("Enable <a href='https://docs.codibase.io/tutorials/package/working-with-packages' target='_blank'>package management</a> for this project", 
			"このプロジェクトの<a href='https://docs.codibase.io/tutorials/package/working-with-packages' target='_blank'>パッケージ管理</a>を有効にする");
		...
		m.put("Enable this to allow to run site publish step. CodiBase will serve project site files as is. To avoid XSS attack, make sure this executor can only be used by trusted jobs", 
			"サイト公開ステップを実行できるようにするにはこれを有効にします。CodiBaseはプロジェクトサイトファイルをそのまま提供します。XSS攻撃を防ぐため、このエグゼキュータが信頼できるジョブでのみ使用されることを確認してください");
		...
		m.put("Enable this to process issue or pull request comments posted via email. <b class='text-danger'>NOTE:</b> <a href='https://docs.microsoft.com/en-us/exchange/recipients-in-exchange-online/plus-addressing-in-exchange-online' target='_blank'>Sub addressing</a> needs to be enabled for system email address above, as CodiBase uses it to track issue and pull request contexts", 
			"メール経由で投稿された問題やプルリクエストのコメントを処理するにはこれを有効にします。<b class='text-danger'>注意:</b> <a href='https://docs.microsoft.com/en-us/exchange/recipients-in-exchange-online/plus-addressing-in-exchange-online' target='_blank'>サブアドレス</a>を上記のシステムメールアドレスに対して有効にする必要があります。CodiBaseはこれを使用して問題やプルリクエストのコンテキストを追跡します");
		m.put("Enable this to process issue or pull request comments posted via email. <b class='text-danger'>NOTE:</b> <a href='https://en.wikipedia.org/wiki/Email_address#Subaddressing' target='_blank'>Sub addressing</a> needs to be enabled for system email address above, as CodiBase uses it to track issue and pull request contexts", 
			"メール経由で投稿された問題やプルリクエストのコメントを処理するにはこれを有効にします。<b class='text-danger'>注意:</b> <a href='https://en.wikipedia.org/wiki/Email_address#Subaddressing' target='_blank'>サブアドレス</a>を上記のシステムメールアドレスに対して有効にする必要があります。CodiBaseはこれを使用して問題やプルリクエストのコンテキストを追跡します");
		...
		m.put("Environment variable <code>serverUrl</code> in above command is taken from CodiBase server url specified in <i>Administration / System Setting</i>. Change it if necessary", 
			"上記のコマンド内の環境変数<code>serverUrl</code>は、<i>管理 / システム設定</i>で指定されたCodiBaseサーバーURLから取得されます。必要に応じて変更してください");
		m.put("Equal", "等しい");
		...
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with create branch permission", 
			"デフォルトブランチから到達できないビルドコミットの場合、<a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>ジョブシークレット</a>を作成ブランチ権限付きのアクセストークンとして指定する必要があります");
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with create tag permission", 
			"デフォルトブランチから到達できないビルドコミットの場合、<a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>ジョブシークレット</a>を作成タグ権限付きのアクセストークンとして指定する必要があります");
		m.put("For build commit not reachable from default branch, a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> should be specified as access token with manage issue permission", 
			"デフォルトブランチから到達できないビルドコミットの場合、<a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>ジョブシークレット</a>を問題管理権限付きのアクセストークンとして指定する必要があります");
		m.put("For docker aware executors, this path is inside container, and accepts both absolute path and relative path (relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>). For shell related executors which runs on host machine directly, only relative path is accepted", 
			"Docker対応エグゼキューターの場合、このパスはコンテナ内にあり、絶対パスと相対パス（<a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>ジョブワークスペース</a>に対する相対パス）を受け入れます。ホストマシンで直接実行されるシェル関連エグゼキューターの場合、相対パスのみが受け入れられます");
		m.put("For each build, CodiBase calculates a list of fixed issues since previous build automatically. This setting provides a default query to further filter/order this list. For a given job, the first matching entry will be used.", 
			"各ビルドに対して、CodiBaseは前回のビルド以降に修正された問題のリストを自動的に計算します。この設定は、このリストをさらにフィルター/順序付けするためのデフォルトクエリを提供します。特定のジョブの場合、最初に一致するエントリが使用されます。");
		...
		m.put("For web hooks defined here and in parent projects, CodiBase will post event data in JSON format to specified URLs when subscribed events happen", 
			"ここおよび親プロジェクトで定義されたWebフックに対して、CodiBaseはJSON形式で指定されたURLにイベントデータを投稿します");
		m.put("Force", "強制");
		...
		m.put("GPG signing key will be used to sign commits generated by CodiBase, including pull request merge commits, user commits created via web UI or RESTful api.", 
			"GPG署名鍵は、CodiBaseによって生成されたコミット（プルリクエストのマージコミット、Web UIまたはRESTful APIを介して作成されたユーザーコミットを含む）を署名するために使用されます");
		...
		m.put("Groovy script to be evaluated. It should return a <i>Date</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"評価されるGroovyスクリプト。<i>Date</i>値を返す必要があります。詳細は<a href='https://docs.codibase.io/appendix/scripting' target='_blank'>スクリプトヘルプ</a>を確認してください");
		m.put("Groovy script to be evaluated. It should return a <i>Float</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"評価されるGroovyスクリプト。<i>Float</i>値を返す必要があります。詳細は<a href='https://docs.codibase.io/appendix/scripting' target='_blank'>スクリプトヘルプ</a>を確認してください");
		m.put("Groovy script to be evaluated. It should return a <i>Integer</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"評価されるGroovyスクリプト。<i>Integer</i>値を返す必要があります。詳細は<a href='https://docs.codibase.io/appendix/scripting' target='_blank'>スクリプトヘルプ</a>を確認してください");
		m.put("Groovy script to be evaluated. It should return a <i>String</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"評価されるGroovyスクリプト。<i>String</i>値を返す必要があります。詳細は<a href='https://docs.codibase.io/appendix/scripting' target='_blank'>スクリプトヘルプ</a>を確認してください");
		m.put("Groovy script to be evaluated. It should return a <i>boolean</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"評価されるGroovyスクリプト。<i>boolean</i>値を返す必要があります。詳細は<a href='https://docs.codibase.io/appendix/scripting' target='_blank'>スクリプトヘルプ</a>を確認してください");
		m.put("Groovy script to be evaluated. It should return a <i>string</i> value. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"評価されるGroovyスクリプト。<i>string</i>値を返す必要があります。詳細は<a href='https://docs.codibase.io/appendix/scripting' target='_blank'>スクリプトヘルプ</a>を確認してください");
		m.put("Groovy script to be evaluated. It should return name of a group. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"評価されるGroovyスクリプト。グループ名を返す必要があります。詳細は<a href='https://docs.codibase.io/appendix/scripting' target='_blank'>スクリプトヘルプ</a>を確認してください");
		m.put("Groovy script to be evaluated. It should return string or list of string. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"評価されるGroovyスクリプト。文字列または文字列のリストを返す必要があります。詳細は<a href='https://docs.codibase.io/appendix/scripting' target='_blank'>スクリプトヘルプ</a>を確認してください");
		m.put("Groovy script to be evaluated. The return value should be a list of group facade object to be used as choices. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"評価されるGroovyスクリプト。返される値は選択肢として使用されるグループファサードオブジェクトのリストである必要があります。詳細は<a href='https://docs.codibase.io/appendix/scripting' target='_blank'>スクリプトヘルプ</a>を確認してください");
		m.put("Groovy script to be evaluated. The return value should be a list of user login names to be used as choices. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"評価されるGroovyスクリプト。返される値は選択肢として使用されるユーザーログイン名のリストである必要があります。詳細は<a href='https://docs.codibase.io/appendix/scripting' target='_blank'>スクリプトヘルプ</a>を確認してください");
		m.put("Groovy script to be evaluated. The return value should be a value to color map, for instance:<br><code>return [\"Successful\":\"#00ff00\", \"Failed\":\"#ff0000\"]</code>, Use <tt>null</tt> if the value does not have a color. Check <a href='https://docs.codibase.io/appendix/scripting' target='_blank'>scripting help</a> for details", 
			"評価されるGroovyスクリプト。返される値は値と色のマップである必要があります。例えば:<br><code>return [\"Successful\":\"#00ff00\", \"Failed\":\"#ff0000\"]</code>、値に色がない場合は<tt>null</tt>を使用してください。詳細は<a href='https://docs.codibase.io/appendix/scripting' target='_blank'>スクリプトヘルプ</a>を確認してください");
		m.put("Groovy scripts", "Groovyスクリプト群");
		m.put("Group", "グループ");
		...
		m.put("If specified, CodiBase will only display iterations with this prefix", "指定されている場合、CodiBaseはこのプレフィックスを持つイテレーションのみを表示します");
		...
		m.put("If this option is enabled, git lfs command needs to be installed on CodiBase server (even this step runs on other node)", 
			"このオプションが有効化されている場合、git lfsコマンドはCodiBaseサーバーにインストールされている必要があります（このステップが他のノードで実行される場合でも）");
		...
		m.put("In case IMAP host certificate is self-signed or its CA root is not accepted, you may tell CodiBase to bypass certificate check. <b class='text-danger'>WARNING: </b> In an untrusted network, this may lead to man-in-the-middle attack, and you should <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>import the certificate into CodiBase</a> instead", 
			"IMAPホスト証明書が自己署名されている場合やCAルートが受け入れられていない場合、CodiBaseに証明書チェックをバイパスするよう指示できます。<b class='text-danger'>警告: </b>信頼できないネットワークでは、中間者攻撃につながる可能性があるため、代わりに<a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>証明書をCodiBaseにインポート</a>する必要があります");
		m.put("In case SMTP host certificate is self-signed or its CA root is not accepted, you may tell CodiBase to bypass certificate check. <b class='text-danger'>WARNING: </b> In an untrusted network, this may lead to man-in-the-middle attack, and you should <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>import the certificate into CodiBase</a> instead", 
			"SMTPホスト証明書が自己署名されている場合やCAルートが受け入れられていない場合、CodiBaseに証明書チェックをバイパスするよう指示できます。<b class='text-danger'>警告: </b>信頼できないネットワークでは、中間者攻撃につながる可能性があるため、代わりに<a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates#trust-self-signed-certificates-on-server' target='_blank'>証明書をCodiBaseにインポート</a>する必要があります");
		...
		m.put("In case cache is not hit via above key, CodiBase will loop through load keys defined here in order until a matching cache is found in project hierarchy. A cache is considered matching if its key is prefixed with the load key. If multiple caches matches, the most recent cache will be returned", 
			"上記のキーでキャッシュがヒットしない場合、CodiBaseはここで定義されたロードキーを順番にループして、プロジェクト階層内で一致するキャッシュを見つけます。キャッシュはそのキーがロードキーで始まる場合、一致していると見なされます。複数のキャッシュが一致する場合、最も最近のキャッシュが返されます");
		...
		m.put("Interactive web shell access to running jobs is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"実行中のジョブへのインタラクティブなウェブシェルアクセスはエンタープライズ機能です。<a href='https://codibase.io/pricing' target='_blank'>30日間無料でお試しください</a>");
		...
		m.put("Invalid state. Please make sure you are visiting CodiBase using server url specified in system setting", 
			"無効な状態です。システム設定で指定されたサーバーURLを使用してCodiBaseを訪問していることを確認してください");
		...
		m.put("Issue statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"課題統計はエンタープライズ機能です。<a href='https://codibase.io/pricing' target='_blank'>30日間無料でお試しください</a>");
		...
		m.put("Login to CodiBase docker registry", "CodiBase Dockerレジストリにログイン");
		...
		m.put("No previous successful build on <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">same stream</a> to calculate fixed issues since", 
			"<a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">同じストリーム</a>で以前の成功したビルドがなく、修正された課題を計算できません。");
		...
		m.put("CodiBase Issue Field", "CodiBase課題フィールド");
		m.put("CodiBase Issue Link", "CodiBase課題リンク");
		m.put("CodiBase Issue State", "CodiBase課題状態");
		m.put("CodiBase analyzes repository files for code search, line statistics, and code contribution statistics. This setting tells which files should be analyzed, and expects space-separated <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path patterns</a>. A pattern can be excluded by prefixing with '-', for instance <code>-**/vendors/**</code> will exclude all files with vendors in path. <b>NOTE: </b> Changing this setting only affects new commits. To apply the change to history commits, please stop the server and delete folder <code>index</code> and <code>info/commit</code> under <a href='https://docs.codibase.io/concepts#project-storage' target='_blank'>project's storage directory</a>. The repository will be re-analyzed when server is started", 
			"CodiBaseはリポジトリファイルをコード検索、行統計、コード貢献統計のために分析します。この設定はどのファイルを分析するかを指定し、スペース区切りの<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスパターン</a>を期待します。パターンは「-」を付けて除外できます。例えば<code>-**/vendors/**</code>はパスにvendorsを含むすべてのファイルを除外します。<b>注意: </b>この設定を変更しても新しいコミットにのみ影響します。履歴コミットに変更を適用するには、サーバーを停止し、<a href='https://docs.codibase.io/concepts#project-storage' target='_blank'>プロジェクトのストレージディレクトリ</a>内のフォルダ<code>index</code>および<code>info/commit</code>を削除してください。サーバーが起動するとリポジトリが再分析されます");
		m.put("CodiBase configures git hooks to communicate with itself via curl", "CodiBaseはgitフックを設定してcurlを介して自身と通信します");
		m.put("CodiBase needs to search and determine user DN, as well as searching user group information if group retrieval is enabled. Tick this option and specify 'manager' DN and password if these operations needs to be authenticated", 
			"CodiBaseはユーザーDNを検索して決定する必要があり、グループ取得が有効な場合はユーザーグループ情報も検索します。これらの操作が認証を必要とする場合は、このオプションを選択し、「マネージャー」DNとパスワードを指定してください");
		m.put("CodiBase requires git command line to manage repositories. The minimum required version is 2.11.1. Also make sure that git-lfs is installed if you want to retrieve LFS files in build job", 
			"CodiBaseはリポジトリを管理するためにgitコマンドラインを必要とします。必要な最低バージョンは2.11.1です。また、ビルドジョブでLFSファイルを取得したい場合はgit-lfsがインストールされていることを確認してください");
		m.put("Online", "オンライン");
		...
		m.put("OpenID client identification will be assigned by your OpenID provider when registering this CodiBase instance as client application", 
			"OpenIDクライアント識別は、このCodiBaseインスタンスをクライアントアプリケーションとして登録する際にOpenIDプロバイダーによって割り当てられます");
		m.put("OpenID client secret will be generated by your OpenID provider when registering this CodiBase instance as client application", 
			"OpenIDクライアントシークレットは、このCodiBaseインスタンスをクライアントアプリケーションとして登録する際にOpenIDプロバイダーによって生成されます");
		...
		m.put("Optionally specify <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as GitHub access token. This is used to retrieve release notes of dependencies hosted on GitHub, and the authenticated access will get a higher rate limit", 
			"オプションで、GitHubアクセス用トークンとして使用する<a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>ジョブシークレット</a>を指定してください。これはGitHubでホストされている依存関係のリリースノートを取得するために使用され、認証されたアクセスはより高いレート制限を得ることができます。");
		...
		m.put("Optionally specify Dockerfile relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Leave empty to use file <tt>Dockerfile</tt> under build path specified above", 
			"オプションで、<a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>ジョブワークスペース</a>に対するDockerfileの相対パスを指定してください。上記で指定したビルドパスの下にある<tt>Dockerfile</tt>ファイルを使用する場合は空のままにしてください。");
		...
		m.put("Optionally specify a CodiBase project to be used as parent of imported projects. Leave empty to import as root projects", 
			"オプションで、インポートされたプロジェクトの親として使用するCodiBaseプロジェクトを指定してください。ルートプロジェクトとしてインポートする場合は空のままにしてください。");
		m.put("Optionally specify a CodiBase project to be used as parent of imported repositories. Leave empty to import as root projects", 
			"オプションで、インポートされたリポジトリの親として使用するCodiBaseプロジェクトを指定してください。ルートプロジェクトとしてインポートする場合は空のままにしてください。");
		...
		m.put("Optionally specify a cron expression to schedule database auto-backup. The cron expression format is <em>&lt;seconds&gt; &lt;minutes&gt; &lt;hours&gt; &lt;day-of-month&gt; &lt;month&gt; &lt;day-of-week&gt;</em>.For example, <em>0 0 1 * * ?</em> means 1:00am every day. For details of the format, refer to <a href='http://www.quartz-scheduler.org/documentation/quartz-2.3.0/tutorials/crontrigger.html#format' target='_blank'>Quartz tutorial</a>.The backup files will be placed into <em>db-backup</em> folder under CodiBase installation directory. In case multiple servers connect to form a cluster, auto-backup takes place on the <a href='https://docs.codibase.io/concepts#lead-server' target='_blank'>lead server</a>. Leave this property empty if you do not want to enable database auto backup.", 
			"オプションで、データベース自動バックアップをスケジュールするためのcron式を指定してください。cron式の形式は<em>&lt;秒&gt; &lt;分&gt; &lt;時&gt; &lt;日&gt; &lt;月&gt; &lt;曜日&gt;</em>です。例えば、<em>0 0 1 * * ?</em>は毎日午前1時を意味します。形式の詳細については、<a href='http://www.quartz-scheduler.org/documentation/quartz-2.3.0/tutorials/crontrigger.html#format' target='_blank'>Quartzチュートリアル</a>を参照してください。バックアップファイルはCodiBaseインストールディレクトリの<em>db-backup</em>フォルダに配置されます。複数のサーバーがクラスターを形成する場合、自動バックアップは<a href='https://docs.codibase.io/concepts#lead-server' target='_blank'>リードサーバー</a>で行われます。このプロパティを空のままにしておくと、データベース自動バックアップは有効になりません。");
		m.put("Optionally specify a date field to hold due date information.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"オプションで、期限情報を保持する日付フィールドを指定してください。<br><b>注意: </b>適切なオプションがない場合は、CodiBase課題フィールドをカスタマイズすることができます。");
		m.put("Optionally specify a path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to put retrieved artifacts. Leave empty to use job workspace itself", 
			"オプションで、取得したアーティファクトを配置する<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する相対パスを指定してください。ジョブワークスペース自体を使用する場合は空のままにしてください。");
		...
		m.put("Optionally specify a working period field to hold estimated time infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"オプションで、推定時間情報を保持する作業期間フィールドを指定してください。<br><b>注意: </b>適切なオプションがない場合は、CodiBase課題フィールドをカスタマイズすることができます。");
		m.put("Optionally specify a working period field to hold spent time infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"オプションで、費やした時間情報を保持する作業期間フィールドを指定してください。<br><b>注意: </b>適切なオプションがない場合は、CodiBase課題フィールドをカスタマイズすることができます。");
		m.put("Optionally specify a working period field to hold time estimate infomration.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"オプションで、時間推定情報を保持する作業期間フィールドを指定してください。<br><b>注意: </b>適切なオプションがない場合は、CodiBase課題フィールドをカスタマイズすることができます。");
		...
		m.put("Optionally specify artifacts to retrieve from the dependency into <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Only published artifacts (via artifact publish step) can be retrieved. Leave empty to not retrieve any artifacts", 
			"オプションで、依存関係から<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に取得するアーティファクトを指定してください。公開されたアーティファクト（アーティファクト公開ステップを介して）だけが取得可能です。アーティファクトを取得しない場合は空のままにしてください。");
		...
		m.put("Optionally specify build context path relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Leave empty to use job workspace itself. The file <code>Dockerfile</code> is expected to exist in build context directory, unless you specify a different location with option <code>--dockerfile</code>", 
			"オプションで、<a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>ジョブワークスペース</a>に対するビルドコンテキストパスを指定してください。ジョブワークスペース自体を使用する場合は空のままにしてください。<code>Dockerfile</code>ファイルはビルドコンテキストディレクトリに存在することが期待されますが、オプション<code>--dockerfile</code>で異なる場所を指定することもできます。");
		m.put("Optionally specify build path relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. Leave empty to use job workspace itself", 
			"オプションで、<a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>ジョブワークスペース</a>に対するビルドパスを指定してください。ジョブワークスペース自体を使用する場合は空のままにしてください。");
		...
		m.put("Optionally specify files relative to cache path to ignore when detect cache changes. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Multiple files should be separated by space, and single file containing space should be quoted", 
			"オプションで、キャッシュ変更を検出する際に無視するキャッシュパスに対する相対ファイルを指定してください。<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカードマッチ</a>には'**'、'*'または'?'を使用してください。複数のファイルはスペースで区切る必要があり、スペースを含む単一のファイルは引用符で囲む必要があります。");
		m.put("Optionally specify group search base if you want to retrieve group membership information of the user. For example: <i>cn=Users, dc=example, dc=com</i>. To give appropriate permissions to a Active Directory group, a CodiBase group with same name should be defined. Leave empty to manage group memberships at CodiBase side", 
			"オプションで、ユーザーのグループメンバーシップ情報を取得する場合のグループ検索ベースを指定してください。例: <i>cn=Users, dc=example, dc=com</i>。Active Directoryグループに適切な権限を付与するには、同じ名前のCodiBaseグループを定義する必要があります。CodiBase側でグループメンバーシップを管理する場合は空のままにしてください。");
		...
		m.put("Optionally specify osv scanner <a href='https://google.github.io/osv-scanner/configuration/' target='_blank'>config file</a> under <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>. You may ignore particular vulnerabilities via this file", 
			"オプションで、<a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>ジョブワークスペース</a>内のosvスキャナー<a href='https://google.github.io/osv-scanner/configuration/' target='_blank'>設定ファイル</a>を指定してください。このファイルを使用して特定の脆弱性を無視することができます。");
		...
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be used as trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/configuration/filtering/#by-finding-ids' target='_blank'>ignore file</a>", 
			"オプションで、trivy<a href='https://aquasecurity.github.io/trivy/v0.50/docs/configuration/filtering/#by-finding-ids' target='_blank'>無視ファイル</a>として使用する<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する相対パスを指定してください。");
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be used as trivy <a href='https://aquasecurity.github.io/trivy/v0.50/docs/scanner/secret/#configuration' target='_blank'>secret config</a>", 
			"オプションで、trivy<a href='https://aquasecurity.github.io/trivy/v0.50/docs/scanner/secret/#configuration' target='_blank'>シークレット設定</a>として使用する<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する相対パスを指定してください。");
		m.put("Optionally specify path relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to publish artifacts from. Leave empty to use job workspace itself", 
			"オプションで、アーティファクトを公開するための<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する相対パスを指定してください。ジョブワークスペース自体を使用する場合は空のままにしてください。");
		...
		m.put("Optionally specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to clone code into. Leave empty to use job workspace itself", 
			"オプションで、コードをクローンするための<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する相対パスを指定してください。ジョブワークスペース自体を使用する場合は空のままにしてください。");
		m.put("Optionally specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to scan. Leave empty to use job workspace itself", 
			"オプションで、スキャンするための<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する相対パスを指定してください。ジョブワークスペース自体を使用する場合は空のままにしてください。");
		m.put("Optionally specify relative paths under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to scan dependency vulnerabilities. Multiple paths can be specified and should be separated with space. Leave empty to use job workspace itself", 
			"オプションで、依存関係の脆弱性をスキャンするための<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する相対パスを指定してください。複数のパスを指定することができ、スペースで区切る必要があります。ジョブワークスペース自体を使用する場合は空のままにしてください。");
		...
		m.put("Optionally specify space-separated branches applicable for this transition. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all", 
			"オプションで、この遷移に適用されるスペース区切りのブランチを指定してください。<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカードマッチ</a>には'**'、'*'または'?'を使用してください。'-'で除外を指定してください。すべてに一致する場合は空のままにしてください。");
		m.put("Optionally specify space-separated branches applicable for this trigger. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty for default branch", 
			"オプションで、このトリガーに適用されるスペース区切りのブランチを指定してください。<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカードマッチ</a>には'**'、'*'または'?'を使用してください。'-'で除外を指定してください。デフォルトブランチの場合は空のままにしてください。");
		m.put("Optionally specify space-separated branches to check. Use '**' or '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all branches", 
			"オプションで、チェックするスペース区切りのブランチを指定してください。<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカードマッチ</a>には'**'、'*'または'?'を使用してください。'-'で除外を指定してください。すべてのブランチに一致する場合は空のままにしてください。");
		...
		m.put("Optionally specify space-separated files to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all files", 
			"オプションで、チェックするスペース区切りのファイルを指定してください。<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカードマッチ</a>には'**'、'*'または'?'を使用してください。'-'で除外を指定してください。すべてのファイルに一致する場合は空のままにしてください。");
		...
		m.put("Optionally specify space-separated projects applicable for this trigger. This is useful for instance when you want to prevent the job from being triggered in forked projects. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all projects", 
			"オプションで、このトリガーに適用されるスペース区切りのプロジェクトを指定してください。これは、例えばフォークされたプロジェクトでジョブがトリガーされるのを防ぎたい場合に便利です。<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカードマッチ</a>には'**'、'*'または'?'を使用してください。'-'で除外を指定してください。すべてのプロジェクトに一致する場合は空のままにしてください。");
		m.put("Optionally specify space-separated projects to search in. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to search in all projects with code read permission", 
			"オプションで、検索するスペース区切りのプロジェクトを指定してください。<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカードマッチ</a>には'**'、'*'または'?'を使用してください。'-'で除外を指定してください。コード読み取り権限を持つすべてのプロジェクトを検索する場合は空のままにしてください。");
		...
		m.put("Optionally specify space-separated service images applicable for this locator. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all", 
			"必要に応じて、このロケーターに適用されるスペース区切りのサービスイメージを指定します。<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカードマッチ</a>には '**', '*' または '?' を使用します。'-' を付けて除外します。空欄の場合はすべて一致します");
		...
		m.put("Optionally specify space-separated tags to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all tags", 
			"必要に応じてチェックするスペース区切りのタグを指定します。<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカードマッチ</a>には '**', '*' または '?' を使用します。'-' を付けて除外します。空欄の場合はすべてのタグに一致します");
		m.put("Optionally specify space-separated target branches of the pull requests to check. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all branches", 
			"必要に応じてチェックするプルリクエストのターゲットブランチをスペース区切りで指定します。<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカードマッチ</a>には '**', '*' または '?' を使用します。'-' を付けて除外します。空欄の場合はすべてのブランチに一致します");
		...
		m.put("Parent CodiBase Project", "親CodiBaseプロジェクト");
		...
		m.put("Projects need to be redistributed when cluster members are added/removed. CodiBase does not do this automatically as this is resource intensive, and you may only want to do it after cluster is finalized and stable.", 
			"クラスターメンバーが追加/削除された場合、プロジェクトを再分配する必要があります。CodiBaseはこれを自動的に行いません。これはリソースを多く消費するため、クラスタが確定し安定した後に行うことを推奨します。");
		...
		m.put("Pull request statistics is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"プルリクエスト統計はエンタープライズ機能です。<a href='https://codibase.io/pricing' target='_blank'>30日間無料でお試しください</a>");
		...
		m.put("Refer to this <a href='https://docs.codibase.io/tutorials/security/sso-with-github' target='_blank'>tutorial</a> for an example setup", 
			"この<a href='https://docs.codibase.io/tutorials/security/sso-with-github' target='_blank'>チュートリアル</a>を参照してセットアップ例をご覧ください");
		m.put("Refer to this <a href='https://docs.codibase.io/tutorials/security/sso-with-okta' target='_blank'>tutorial</a> for an example setup", 
			"この<a href='https://docs.codibase.io/tutorials/security/sso-with-okta' target='_blank'>チュートリアル</a>を参照してセットアップ例をご覧ください");
		m.put("Reference", "参照");
		...
		m.put("Run specified docker container. <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>Job workspace</a> is mounted into the container and its path is placed in environment variable <code>CODIBASE_WORKSPACE</code>. <b class='text-warning'>Note: </b> this step can only be executed by server docker executor or remote docker executor", 
			"指定されたDockerコンテナを実行します。<a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>ジョブワークスペース</a>がコンテナにマウントされ、そのパスが環境変数<code>CODIBASE_WORKSPACE</code>に配置されます。<b class='text-warning'>注意: </b>このステップはサーバーDockerエグゼキューターまたはリモートDockerエグゼキューターによってのみ実行可能です");
		...
		m.put("Set up job cache to speed up job execution. Check <a href='https://docs.codibase.io/tutorials/cicd/job-cache' target='_blank'>this tutorial</a> on how to use job cache", 
			"ジョブキャッシュを設定してジョブ実行を高速化します。ジョブキャッシュの使用方法については<a href='https://docs.codibase.io/tutorials/cicd/job-cache' target='_blank'>このチュートリアル</a>を確認してください。");
		...
		m.put("Signature verified successfully with CodiBase GPG key", "CodiBase GPGキーで署名が正常に検証されました");
		...
		m.put("Specifies LDAP URL of the Active Directory server, for example: <i>ldap://ad-server</i>, or <i>ldaps://ad-server</i>. In case your ldap server is using a self-signed certificate for ldaps connection, you will need to <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates' target='_blank'>configure CodiBase to trust the certificate</a>", 
			"Active Directory サーバーの LDAP URL を指定します。例: <i>ldap://ad-server</i> または <i>ldaps://ad-server</i>。LDAP サーバーが自己署名証明書を使用して ldaps 接続を行う場合、<a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates' target='_blank'>CodiBase を構成して証明書を信頼するように設定する必要があります</a>");
		m.put("Specifies LDAP URL, for example: <i>ldap://localhost</i>, or <i>ldaps://localhost</i>. In caseyour ldap server is using a self-signed certificate for ldaps connection, you will need to <a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates' target='_blank'>configure CodiBase to trust the certificate</a>", 
			"LDAP URL を指定します。例: <i>ldap://localhost</i> または <i>ldaps://localhost</i>。LDAP サーバーが自己署名証明書を使用して ldaps 接続を行う場合、<a href='https://docs.codibase.io/administration-guide/trust-self-signed-certificates' target='_blank'>CodiBase を構成して証明書を信頼するように設定する必要があります</a>");
		...
		m.put("Specifies the attribute containing group name inside the found group LDAP entry. Value of this attribute will be mapped to a CodiBase group. This attribute is normally set to <i>cn</i>", 
			"見つかったグループ LDAP エントリ内のグループ名を含む属性を指定します。この属性の値は CodiBase グループにマッピングされます。この属性は通常 <i>cn</i> に設定されます");
		m.put("Specify .net TRX test result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>TestResults/*.trx</tt>. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する .net TRX テスト結果ファイルを指定します。例: <tt>TestResults/*.trx</tt>。パターンマッチには * または ? を使用してください");
		m.put("Specify <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> whose value is access token with code write permission over above projects. Commits, issues, and pull requests will also be created under name of the access token owner", 
			"<a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>ジョブシークレット</a>を指定します。この値はコード書き込み権限を持つアクセス トークンです。コミット、課題、プルリクエストはアクセス トークン所有者の名前で作成されます");
		m.put("Specify <a href='https://github.com/rust-lang/rust-clippy'>rust clippy</a> json output file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with clippy json output option, for instance <code>cargo clippy --message-format json>check-result.json</code>. Use * or ? for pattern match", 
			"<a href='https://github.com/rust-lang/rust-clippy'>rust clippy</a> の JSON 出力ファイルを <a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対して指定します。このファイルは clippy の JSON 出力オプションで生成できます。例: <code>cargo clippy --message-format json>check-result.json</code>。パターンマッチには * または ? を使用してください");
		...
		m.put("Specify CPD result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/cpd.xml</tt>. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する CPD 結果 XML ファイルを指定します。例: <tt>target/cpd.xml</tt>。パターンマッチには * または ? を使用してください");
		...
		m.put("Specify ESLint report file in checkstyle format under <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with ESLint option <tt>'-f checkstyle'</tt> and <tt>'-o'</tt>. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>内の checkstyle フォーマットで ESLint レポートファイルを指定します。このファイルは ESLint オプション <tt>'-f checkstyle'</tt> および <tt>'-o'</tt> を使用して生成できます。パターンマッチには * または ? を使用してください");
		...
		m.put("Specify GoogleTest XML result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This report can be generated with environment variable <tt>GTEST_OUTPUT</tt> when running tests, For instance, <code>export GTEST_OUTPUT=&quot;xml:gtest-result.xml&quot;</code>. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する GoogleTest XML 結果ファイルを指定します。このレポートはテスト実行時に環境変数 <tt>GTEST_OUTPUT</tt> を使用して生成できます。例: <code>export GTEST_OUTPUT=&quot;xml:gtest-result.xml&quot;</code>。パターンマッチには * または ? を使用してください");
		...
		m.put("Specify JUnit test result file in XML format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>target/surefire-reports/TEST-*.xml</tt>. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する JUnit テスト結果ファイル (XML フォーマット) を指定します。例: <tt>target/surefire-reports/TEST-*.xml</tt>。パターンマッチには * または ? を使用してください");
		m.put("Specify JaCoCo coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/jacoco/jacoco.xml</tt>. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する JaCoCo カバレッジ XML レポートファイルを指定します。例: <tt>target/site/jacoco/jacoco.xml</tt>。パターンマッチには * または ? を使用してください");
		m.put("Specify Jest coverage report file in clover format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance <tt>coverage/clover.xml</tt>. This file can be generated with Jest option <tt>'--coverage'</tt>. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する Jest カバレッジレポートファイル (clover フォーマット) を指定します。例: <tt>coverage/clover.xml</tt>。このファイルは Jest オプション <tt>'--coverage'</tt> を使用して生成できます。パターンマッチには * または ? を使用してください");
		m.put("Specify Jest test result file in json format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated via Jest option <tt>'--json'</tt> and <tt>'--outputFile'</tt>. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する Jest テスト結果ファイル (JSON フォーマット) を指定します。このファイルは Jest オプション <tt>'--json'</tt> および <tt>'--outputFile'</tt> を使用して生成できます。パターンマッチには * または ? を使用してください");
		m.put("Specify OCI layout directory of the image to scan. This directory can be generated via build image step or pull image step. It should be relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"スキャン対象のイメージの OCI レイアウトディレクトリを指定します。このディレクトリはイメージビルドステップまたはイメージプルステップで生成できます。<a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>ジョブワークスペース</a>に対して相対的である必要があります");
		m.put("Specify OCI layout directory relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to push from", 
			"プッシュ元として使用する OCI レイアウトディレクトリを <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>ジョブワークスペース</a>に対して指定します");
		...
		m.put("Specify PMD result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/pmd.xml</tt>. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する PMD 結果 XML ファイルを指定します。例: <tt>target/pmd.xml</tt>。パターンマッチには * または ? を使用してください");
		m.put("Specify PowerShell commands to execute under the <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>.<br><b class='text-warning'>NOTE: </b> CodiBase checks exit code of the script to determine if step is successful. Since PowerShell always exit with 0 even if there are script errors, you should handle errors in the script and exit with non-zero code, or add line <code>$ErrorActionPreference = &quot;Stop&quot;</code> at start of your script<br>", 
			"<a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>ジョブワークスペース</a>内で実行する PowerShell コマンドを指定します。<br><b class='text-warning'>注意: </b>CodiBase はスクリプトの終了コードをチェックしてステップが成功したかどうかを判断します。PowerShell はスクリプトエラーがあっても常に 0 を返すため、スクリプト内でエラーを処理して非ゼロコードで終了するか、スクリプトの冒頭に <code>$ErrorActionPreference = &quot;Stop&quot;</code> を追加してください<br>");
		m.put("Specify Roslynator diagnostics output file in XML format relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with <i>-o</i> option. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する Roslynator 診断出力ファイル (XML フォーマット) を指定します。このファイルは <i>-o</i> オプションで生成できます。パターンマッチには * または ? を使用してください");
		...
		m.put("Specify SpotBugs result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/spotbugsXml.xml</tt>. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する SpotBugs 結果 XML ファイルを指定します。例: <tt>target/spotbugsXml.xml</tt>。パターンマッチには * または ? を使用してください");
		...
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as SSH private key", 
			"SSH プライベートキーとして使用する <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>ジョブシークレット</a> を指定します");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as access token", 
			"アクセス トークンとして使用する <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>ジョブシークレット</a> を指定します");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as access token to import build spec from above project if its code is not publicly accessible", 
			"上記プロジェクトのビルド仕様をインポートするために使用するアクセス トークンとして <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>ジョブシークレット</a> を指定します。このプロジェクトのコードが公開されていない場合に使用します");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as password or access token of the registry", 
			"レジストリのパスワードまたはアクセス トークンとして使用する <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>ジョブシークレット</a> を指定します");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as password or access token to access remote repository", 
			"リモートリポジトリにアクセスするためのパスワードまたはアクセス トークンとして使用する <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>ジョブシークレット</a> を指定します");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as private key for SSH authentication. <b class='text-info'>NOTE:</b> Private key with passphrase is not supported", 
			"SSH 認証用のプライベートキーとして使用する <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>ジョブシークレット</a> を指定します。<b class='text-info'>注意:</b> パスフレーズ付きのプライベートキーはサポートされていません");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> to be used as private key of above user for SSH authentication. <b class='text-info'>NOTE:</b> Private key with passphrase is not supported", 
			"上記ユーザーの SSH 認証用プライベートキーとして使用する <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>ジョブシークレット</a> を指定します。<b class='text-info'>注意:</b> パスフレーズ付きのプライベートキーはサポートされていません");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> whose value is an access token with management permission for above project. Note that access token is not required if sync to current or child project and build commit is reachable from default branch", 
			"上記プロジェクトの管理権限を持つアクセス トークンとして使用する <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>ジョブシークレット</a> を指定します。現在または子プロジェクトに同期し、ビルドコミットがデフォルトブランチから到達可能な場合はアクセス トークンは不要です");
		m.put("Specify a <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>job secret</a> whose value is an access token with upload cache permission for above project. Note that this property is not required if upload cache to current or child project and build commit is reachable from default branch", 
			"上記プロジェクトのキャッシュアップロード権限を持つアクセス トークンとして使用する <a href='https://docs.codibase.io/tutorials/cicd/job-secrets' target='_blank'>ジョブシークレット</a> を指定します。現在または子プロジェクトにキャッシュをアップロードし、ビルドコミットがデフォルトブランチから到達可能な場合、このプロパティは不要です");
		...
		m.put("Specify a file relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to write checksum into", 
			"チェックサムを書き込むためのファイルを <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>ジョブワークスペース</a>に対して指定します");
		m.put("Specify a multi-value user field to hold assignees information.<b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"担当者情報を保持するための複数値ユーザーフィールドを指定します。<b>注意: </b>適切なオプションがない場合は CodiBase の課題フィールドをカスタマイズすることができます");
		m.put("Specify a multi-value user field to hold assignees information.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"担当者情報を保持するための複数値ユーザーフィールドを指定します。<br><b>注意: </b>適切なオプションがない場合は CodiBase の課題フィールドをカスタマイズすることができます");
		...
		m.put("Specify absolute path to the kubectl utility, for instance: <i>/usr/bin/kubectl</i>. If left empty, CodiBase will try to find the utility from system path", 
			"kubectl ユーティリティの絶対パスを指定します。例: <i>/usr/bin/kubectl</i>。空欄の場合、CodiBase はシステムパスからユーティリティを探します");
		...
		m.put("Specify applicable projects for above option. Multiple projects should be separated by space. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty for all projects", 
			"上記オプションに適用可能なプロジェクトを指定します。複数のプロジェクトはスペースで区切る必要があります。<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカードマッチ</a>には '**', '*' または '?' を使用してください。'-' を付けて除外します。空欄の場合、すべてのプロジェクトが対象となります");
		m.put("Specify applicable projects separated by space. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty for all projects", 
			"スペースで区切られた適用可能なプロジェクトを指定します。<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカードマッチ</a>には '**', '*' または '?' を使用してください。'-' を付けて除外します。空欄の場合、すべてのプロジェクトが対象となります");
		...
		m.put("Specify artifacts to retrieve into <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. Only published artifacts (via artifact publish step) can be retrieved.", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に取得するアーティファクトを指定します。公開されたアーティファクト (アーティファクト公開ステップを通じて) のみ取得可能です");
		m.put("Specify at least 10 alphanumeric chars to be used as secret, and then add an inbound parse entry at SendGrid side:<ul><li><code>Destination URL</code> should be set to <i>&lt;CodiBase root url&gt;/~sendgrid/&lt;secret&gt;</i>, for instance, <i>https://codibase.example.com/~sendgrid/1234567890</i>. Note that in production environment, <a href='https://docs.codibase.io/administration-guide/https-setup' target='_blank'>https should be enabled</a> to protect the secret</li><li><code>Receiving domain</code> should be the same as domain part of system email address specified above</li><li>Option <code>POST the raw, full MIME message</code> is enabled</li></ul>", 
			"少なくとも 10 文字の英数字をシークレットとして指定し、SendGrid 側でインバウンド解析エントリを追加します:<ul><li><code>送信先 URL</code> は <i>&lt;CodiBase ルート URL&gt;/~sendgrid/&lt;シークレット&gt;</i> に設定する必要があります。例: <i>https://codibase.example.com/~sendgrid/1234567890</i>。本番環境では、<a href='https://docs.codibase.io/administration-guide/https-setup' target='_blank'>https を有効にする必要があります</a> シークレットを保護するため</li><li><code>受信ドメイン</code> は上記で指定されたシステムメールアドレスのドメイン部分と同じである必要があります</li><li>オプション <code>生の完全な MIME メッセージを POST</code> が有効になっています</li></ul>");
		...
		m.put("Specify checkstyle result xml file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/checkstyle-result.xml</tt>. Refer to <a href='https://checkstyle.org/'>checkstyle documentation</a> on how to generate the result xml file. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する checkstyle 結果 XML ファイルを指定します。例: <tt>target/checkstyle-result.xml</tt>。結果 XML ファイルの生成方法については <a href='https://checkstyle.org/'>checkstyle ドキュメント</a> を参照してください。パターンマッチには * または ? を使用してください");
		...
		m.put("Specify clover coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/clover/clover.xml</tt>. Refer to <a href='https://openclover.org/documentation'>OpenClover documentation</a> on how to generate clover xml file. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する clover カバレッジ XML レポートファイルを指定します。例: <tt>target/site/clover/clover.xml</tt>。clover XML ファイルの生成方法については <a href='https://openclover.org/documentation'>OpenClover ドキュメント</a> を参照してください。パターンマッチには * または ? を使用してください");
		m.put("Specify cobertura coverage xml report file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance, <tt>target/site/cobertura/coverage.xml</tt>. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する cobertura カバレッジ XML レポートファイルを指定します。例: <tt>target/site/cobertura/coverage.xml</tt>。パターンマッチには * または ? を使用してください");
		...
		m.put("Specify configuration discovery url of your OpenID provider, for instance: <code>https://openid.example.com/.well-known/openid-configuration</code>. Make sure to use HTTPS protocol as CodiBase relies on TLS encryption to ensure token validity", 
			"OpenIDプロバイダーの構成検出URLを指定してください。例: <code>https://openid.example.com/.well-known/openid-configuration</code>。CodiBaseはトークンの有効性を確保するためにTLS暗号化に依存しているため、HTTPSプロトコルを使用してください。");
		...
		m.put("Specify cppcheck xml result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with cppcheck xml output option, for instance <code>cppcheck src --xml 2>check-result.xml</code>. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対するcppcheckのXML結果ファイルを指定してください。このファイルはcppcheckのXML出力オプションで生成できます。例: <code>cppcheck src --xml 2>check-result.xml</code>。パターンマッチには*や?を使用してください。");
		...
		m.put("Specify directory relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to store OCI layout", 
			"<a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>ジョブワークスペース</a>に対するOCIレイアウトを保存するディレクトリを指定してください。");
		...
		m.put("Specify dockerx builder used to build docker image. CodiBase will create the builder automatically if it does not exist. Check <a href='https://docs.codibase.io/tutorials/cicd/insecure-docker-registry' target='_blank'>this tutorial</a> on how to customize the builder for instance to allow publishing to insecure registries", 
			"Dockerイメージをビルドするために使用するdockerxビルダーを指定してください。CodiBaseはビルダーが存在しない場合、自動的に作成します。例えば、非セキュアなレジストリへの公開を許可するためにビルダーをカスタマイズする方法については<a href='https://docs.codibase.io/tutorials/cicd/insecure-docker-registry' target='_blank'>このチュートリアル</a>を確認してください。");
		...
		m.put("Specify files relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be published. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する公開するファイルを指定してください。パターンマッチには*や?を使用してください。");
		m.put("Specify files to create md5 checksum from. Multiple files should be separated by space. <a href='https://www.linuxjournal.com/content/globstar-new-bash-globbing-option' target='_blank'>Globstar</a> patterns accepted. Non-absolute file is considered to be relative to <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"md5チェックサムを作成するファイルを指定してください。複数のファイルはスペースで区切ってください。<a href='https://www.linuxjournal.com/content/globstar-new-bash-globbing-option' target='_blank'>Globstar</a>パターンが使用可能です。絶対パスでないファイルは<a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>ジョブワークスペース</a>に対する相対パスとみなされます。");
		...
		m.put("Specify how to map GitHub issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"GitHubの課題ラベルをCodiBaseのカスタムフィールドにマッピングする方法を指定してください。<br><b>注意:</b> 適切なオプションがない場合は、CodiBaseの課題フィールドをカスタマイズすることができます。");
		m.put("Specify how to map GitLab issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"GitLabの課題ラベルをCodiBaseのカスタムフィールドにマッピングする方法を指定してください。<br><b>注意:</b> 適切なオプションがない場合は、CodiBaseの課題フィールドをカスタマイズすることができます。");
		m.put("Specify how to map Gitea issue labels to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"Giteaの課題ラベルをCodiBaseのカスタムフィールドにマッピングする方法を指定してください。<br><b>注意:</b> 適切なオプションがない場合は、CodiBaseの課題フィールドをカスタマイズすることができます。");
		m.put("Specify how to map JIRA issue priorities to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"JIRAの課題優先度をCodiBaseのカスタムフィールドにマッピングする方法を指定してください。<br><b>注意:</b> 適切なオプションがない場合は、CodiBaseの課題フィールドをカスタマイズすることができます。");
		m.put("Specify how to map JIRA issue statuses to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"JIRAの課題ステータスをCodiBaseのカスタムフィールドにマッピングする方法を指定してください。<br><b>注意:</b> 適切なオプションがない場合は、CodiBaseの課題ステートをカスタマイズすることができます。");
		m.put("Specify how to map JIRA issue types to CodiBase custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"JIRAの課題タイプをCodiBaseのカスタムフィールドにマッピングする方法を指定してください。<br><b>注意:</b> 適切なオプションがない場合は、CodiBaseの課題フィールドをカスタマイズすることができます。");
		m.put("Specify how to map YouTrack issue fields to CodiBase. Unmapped fields will be reflected in issue description.<br><b>Note: </b><ul><li>Enum field needs to be mapped in form of <tt>&lt;Field Name&gt;::&lt;Field Value&gt;</tt>, for instance <tt>Priority::Critical</tt><li>You may customize CodiBase issue fields in case there is no appropriate option here</ul>", 
			"YouTrackの課題フィールドをCodiBaseにマッピングする方法を指定してください。マッピングされていないフィールドは課題の説明に反映されます。<br><b>注意:</b><ul><li>列挙型フィールドは<tt>&lt;フィールド名&gt;::&lt;フィールド値&gt;</tt>の形式でマッピングする必要があります。例: <tt>Priority::Critical</tt></li><li>適切なオプションがない場合は、CodiBaseの課題フィールドをカスタマイズすることができます。</li></ul>");
		m.put("Specify how to map YouTrack issue links to CodiBase issue links.<br><b>NOTE: </b> You may customize CodiBase issue links in case there is no appropriate option here", 
			"YouTrackの課題リンクをCodiBaseの課題リンクにマッピングする方法を指定してください。<br><b>注意:</b> 適切なオプションがない場合は、CodiBaseの課題リンクをカスタマイズすることができます。");
		m.put("Specify how to map YouTrack issue state to CodiBase issue state. Unmapped states will use the initial state in CodiBase.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"YouTrackの課題ステートをCodiBaseの課題ステートにマッピングする方法を指定してください。マッピングされていないステートはCodiBaseの初期ステートを使用します。<br><b>注意:</b> 適切なオプションがない場合は、CodiBaseの課題ステートをカスタマイズすることができます。");
		m.put("Specify how to map YouTrack issue tags to CodiBase issue custom fields.<br><b>NOTE: </b> You may customize CodiBase issue fields in case there is no appropriate option here", 
			"YouTrackの課題タグをCodiBaseの課題カスタムフィールドにマッピングする方法を指定してください。<br><b>注意:</b> 適切なオプションがない場合は、CodiBaseの課題フィールドをカスタマイズすることができます。");
		...
		m.put("Specify manager DN to authenticate CodiBase itself to Active Directory. The manager DN should be specified in form of <i>&lt;account name&gt;@&lt;domain&gt;</i>, for instance: <i>manager@example.com</i>", 
			"CodiBase自身をActive Directoryに認証するためのマネージャーDNを指定してください。マネージャーDNは<i>&lt;アカウント名&gt;@&lt;ドメイン&gt;</i>の形式で指定する必要があります。例: <i>manager@example.com</i>");
		m.put("Specify manager DN to authenticate CodiBase itself to LDAP server", "CodiBase自身をLDAPサーバーに認証するためのマネージャーDNを指定してください。");
		m.put("Specify markdown file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a> to be published", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対する公開するMarkdownファイルを指定してください。");
		...
		m.put("Specify mypy output file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated by redirecting mypy output <b>without option '--pretty'</b>, for instance <code>mypy --exclude=.git --exclude=.venv . > mypy-output</code>. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対するmypy出力ファイルを指定してください。このファイルはmypy出力をリダイレクトすることで生成できます。<b>オプション'--pretty'を使用しない</b>例: <code>mypy --exclude=.git --exclude=.venv . > mypy-output</code>。パターンマッチには*や?を使用してください。");
		...
		m.put("Specify project to import into at CodiBase side", "CodiBase側でインポートするプロジェクトを指定してください。");
		...
		m.put("Specify pylint json result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with pylint json output format option, for instance <code>--exit-zero --output-format=json:pylint-result.json</code>. Note that we do not fail pylint command upon violations, as this step will fail build based on configured threshold. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対するpylintのJSON結果ファイルを指定してください。このファイルはpylintのJSON出力形式オプションで生成できます。例: <code>--exit-zero --output-format=json:pylint-result.json</code>。違反があってもpylintコマンドは失敗しません。このステップは設定された閾値に基づいてビルドを失敗させます。パターンマッチには*や?を使用してください。");
		...
		m.put("Specify relative path under <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a> to store OCI layout", 
			"<a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>ジョブワークスペース</a>に対するOCIレイアウトを保存する相対パスを指定してください。");
		...
		m.put("Specify ruff json result file relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>. This file can be generated with ruff json output format option, for instance <code>--exit-zero --output-format json --output-file ruff-result.json</code>. Note that we do not fail ruff command upon violations, as this step will fail build based on configured threshold. Use * or ? for pattern match", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対するruffのJSON結果ファイルを指定してください。このファイルはruffのJSON出力形式オプションで生成できます。例: <code>--exit-zero --output-format json --output-file ruff-result.json</code>。違反があってもruffコマンドは失敗しません。このステップは設定された閾値に基づいてビルドを失敗させます。パターンマッチには*や?を使用してください。");
		m.put("Specify shell commands (on Linux/Unix) or batch commands (on Windows) to execute under the <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"<a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>ジョブワークスペース</a>で実行するシェルコマンド（Linux/Unix）またはバッチコマンド（Windows）を指定してください。");
		m.put("Specify shell commands to execute under the <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"<a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>ジョブワークスペース</a>で実行するシェルコマンドを指定してください。");
		...
		m.put("Specify space-separated branches to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"保護するスペース区切りのブランチを指定してください。<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカードマッチ</a>には'**'、'*'、または'?'を使用してください。'-'で始めると除外されます。");
		...
		m.put("Specify space-separated paths to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"保護するスペース区切りのパスを指定してください。<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカードマッチ</a>には'**'、'*'、または'?'を使用してください。'-'で始めると除外されます。");
		...
		m.put("Specify space-separated tags to be protected. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"保護するスペース区切りのタグを指定してください。<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカードマッチ</a>には'**'、'*'、または'?'を使用してください。'-'で始めると除外されます。");
		m.put("Specify start page of the report relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance: <tt>manual/index.md</tt>", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対するレポートの開始ページを指定してください。例: <tt>manual/index.md</tt>");
		m.put("Specify start page of the report relative to <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>, for instance: api/index.html", 
			"<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>に対するレポートの開始ページを指定してください。例: api/index.html");
		...
		m.put("Specify the strategy to retrieve group membership information. To give appropriate permissions to a LDAP group, a CodiBase group with same name should be defined. Use strategy <tt>Do Not Retrieve Groups</tt> if you want to manage group memberships at CodiBase side", 
			"グループメンバーシップ情報を取得する戦略を指定してください。LDAPグループに適切な権限を付与するには、同じ名前のCodiBaseグループを定義する必要があります。グループメンバーシップをCodiBase側で管理したい場合は、<tt>グループを取得しない</tt>戦略を使用してください。");
		...
		m.put("Specify which issue state to use for closed GitHub issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"閉じたGitHubの問題に使用する問題状態を指定してください。<br><b>注意:</b> 適切なオプションがない場合は、CodiBaseの問題状態をカスタマイズすることができます。");
		m.put("Specify which issue state to use for closed GitLab issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"閉じたGitLabの問題に使用する問題状態を指定してください。<br><b>注意:</b> 適切なオプションがない場合は、CodiBaseの問題状態をカスタマイズすることができます。");
		m.put("Specify which issue state to use for closed Gitea issues.<br><b>NOTE: </b> You may customize CodiBase issue states in case there is no appropriate option here", 
			"閉じたGiteaの問題に使用する問題状態を指定してください。<br><b>注意:</b> 適切なオプションがない場合は、CodiBaseの問題状態をカスタマイズすることができます。");
		m.put("Specify which states are considered as closed for various issues created by Renovate to orchestrate dependency update. Additionally, when Renovate closes the issue, CodiBase will transit the issue to first state specified here", 
			"依存関係の更新を調整するためにRenovateが作成したさまざまな問題で閉じたと見なされる状態を指定してください。さらに、Renovateが問題を閉じると、CodiBaseはここで指定された最初の状態に問題を移行します。");
		...
		m.put("Steps will be executed serially on same node, sharing the same <a href='https://docs.codibase.io/concepts#job-workspace'>job workspace</a>", 
			"ステップは同じノード上で直列に実行され、同じ<a href='https://docs.codibase.io/concepts#job-workspace'>ジョブワークスペース</a>を共有します。");
		...
		m.put("System email address defined in mail setting should be used as recipient of such email, and project name may be appended to this address using to indicate where to create issues. For instance, if system email address is specified as <tt>support@example.com</tt>, sending email to <tt>support+myproject@example.com</tt> will create issue in <tt>myproject</tt>. If project name is not appended, CodiBase will look up the project using project designation information below", 
			"メール設定で定義されたシステムメールアドレスは、そのようなメールの受信者として使用されるべきであり、プロジェクト名を追加して課題を作成する場所を示すためにこのアドレスに追加することができます。例えば、システムメールアドレスが<tt>support@example.com</tt>として指定されている場合、<tt>support+myproject@example.com</tt>にメールを送信すると<tt>myproject</tt>で課題が作成されます。プロジェクト名が追加されない場合、CodiBaseは以下のプロジェクト指定情報を使用してプロジェクトを検索します");
		...
		m.put("The secret which allows you to ensure that POST requests sent to the payload URL are from CodiBase. When you set a secret you'll receive the X-CodiBase-Signature header in the webhook POST request", 
			"POSTリクエストがCodiBaseから送信されたことを確認するための秘密鍵。秘密鍵を設定すると、WebhookのPOSTリクエストでX-CodiBase-Signatureヘッダーを受け取ります");
		m.put("The service desk feature enables user to create issues by sending emails to CodiBase. Issues can be discussed over email completely, without the need of logging to CodiBase.", 
			"サービスデスク機能により、ユーザーはCodiBaseにメールを送信して課題を作成できます。課題は完全にメールで議論することができ、CodiBaseにログインする必要はありません。");
		...
		m.put("This executor runs build jobs as docker containers on CodiBase server", "このエグゼキュータは、CodiBaseサーバー上でDockerコンテナとしてビルドジョブを実行します");
		...
		m.put("This executor runs build jobs with CodiBase server's shell facility.<br><b class='text-danger'>WARNING</b>: Jobs running with this executor has same permission as CodiBase server process. Make sure it can only be used by trusted jobs", 
			"このエグゼキュータはCodiBaseサーバーのシェル機能を使用してビルドジョブを実行します。<br><b class='text-danger'>警告</b>: このエグゼキュータで実行されるジョブはCodiBaseサーバープロセスと同じ権限を持ちます。信頼できるジョブでのみ使用されることを確認してください");
		m.put("This executor runs build jobs with remote machines's shell facility via <a href='/~administration/agents' target='_blank'>agents</a><br><b class='text-danger'>WARNING</b>: Jobs running with this executor has same permission as CodiBase agent process. Make sure it can only be used by trusted jobs", 
			"このエグゼキュータは<a href='/~administration/agents' target='_blank'>エージェント</a>を介してリモートマシンのシェル機能を使用してビルドジョブを実行します。<br><b class='text-danger'>警告</b>: このエグゼキュータで実行されるジョブはCodiBaseエージェントプロセスと同じ権限を持ちます。信頼できるジョブでのみ使用されることを確認してください");
		...
		m.put("This installation does not have an active subscription and runs as community edition. To access <a href=\"https://codibase.io/pricing\">enterprise features</a>, an active subscription is required", 
			"このインストールにはアクティブなサブスクリプションがなく、コミュニティエディションとして実行されています。<a href=\"https://codibase.io/pricing\">エンタープライズ機能</a>にアクセスするには、アクティブなサブスクリプションが必要です");
		...
		m.put("This is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"これはエンタープライズ機能です。<a href='https://codibase.io/pricing' target='_blank'>30日間無料でお試しください</a>");
		...
		m.put("This page lists changes since previous build on <a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">same stream</a>", 
			"このページには<a href=\"https://docs.codibase.io/concepts#build-stream\" class=\"link-primary\" target=\"_blank\">同じストリーム</a>の前回のビルド以降の変更が一覧表示されます");
		...
		m.put("This server is currently accessed via http protocol, please configure your docker daemon or buildx builder to <a href=\"https://docs.codibase.io/tutorials/cicd/insecure-docker-registry\" target=\"_blank\">work with insecure registry</a>", 
			"このサーバーは現在HTTPプロトコルを介してアクセスされています。Dockerデーモンまたはbuildxビルダーを<a href=\"https://docs.codibase.io/tutorials/cicd/insecure-docker-registry\" target=\"_blank\">安全でないレジストリで動作するように構成してください</a>");
		...
		m.put("This step can only be executed by a docker aware executor. It runs under <a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>job workspace</a>", 
			"このステップはDocker対応エグゼキュータによってのみ実行可能です。<a href='https://docs.codibase.io/concepts#job-workspace' target='_blank'>ジョブワークスペース</a>で実行されます");
		...
		m.put("This step publishes specified files to be served as project web site. Project web site can be accessed publicly via <code>http://&lt;codibase base url&gt;/path/to/project/~site</code>", 
			"このステップは指定されたファイルをプロジェクトウェブサイトとして公開します。プロジェクトウェブサイトは<code>http://&lt;codibase base url&gt;/path/to/project/~site</code>で公開アクセス可能です");
		...
		m.put("This tab shows the pipeline containing current build. Check <a href=\"https://robinshen.medium.com/understanding-codibase-pipeline-db0bb0e54aa7\" target=\"_blank\">this article</a> to understand how build pipeline works", 
			"このタブには現在のビルドを含むパイプラインが表示されます。ビルドパイプラインの仕組みを理解するには<a href=\"https://robinshen.medium.com/understanding-codibase-pipeline-db0bb0e54aa7\" target=\"_blank\">この記事</a>を確認してください");
		m.put("This trigger will only be applicable if tagged commit is reachable from branches specified here. Multiple branches should be separated with spaces. Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude. Leave empty to match all branches", 
			"このトリガーは、タグ付けされたコミットがここで指定されたブランチから到達可能な場合にのみ適用されます。複数のブランチはスペースで区切る必要があります。<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカードマッチ</a>には '**', '*' または '?' を使用してください。'-' を付けて除外します。すべてのブランチに一致させるには空白のままにします");
		...
		m.put("Two-factor authentication is enabled. Please input passcode displayed on your TOTP authenticator. If you encounter problems, make sure time of CodiBase server and your device running TOTP authenticator is in sync", 
			"二要素認証が有効です。TOTP認証アプリに表示されるパスコードを入力してください。問題が発生した場合は、CodiBaseサーバーとTOTP認証アプリを実行しているデバイスの時刻が同期していることを確認してください");
		...
		m.put("Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>", 
			"<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカード一致</a>には'**'、'*'または'?'を使用");
		m.put("Use '**', '*' or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>. Prefix with '-' to exclude", 
			"<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカード一致</a>には'**'、'*'または'?'を使用。'-'を付けて除外");
		m.put("Use '**', '*', or '?' for <a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>path wildcard match</a>", 
			"<a href='https://docs.codibase.io/appendix/path-wildcard' target='_blank'>パスワイルドカード一致</a>には'**'、'*'または'?'を使用");
		...
		m.put("Use job token as user name so that CodiBase can know which build is ${permission.equals(\"write\")? \"deploying\": \"using\"} packages", 
			"ジョブトークンをユーザー名として使用し、CodiBaseがどのビルドが${permission.equals(\"write\")? \"デプロイしている\": \"使用している\"}パッケージかを認識できるようにする");
		m.put("Use job token to tell CodiBase the build publishing the package", "ジョブトークンを使用して、CodiBaseにパッケージを公開しているビルドを伝える");
		m.put("Use job token to tell CodiBase the build pushing the chart", "ジョブトークンを使用して、CodiBaseにチャートをプッシュしているビルドを伝える");
		m.put("Use job token to tell CodiBase the build pushing the package", "ジョブトークンを使用して、CodiBaseにパッケージをプッシュしているビルドを伝える");
		m.put("Use job token to tell CodiBase the build using the package", "ジョブトークンを使用して、CodiBaseにパッケージを使用しているビルドを伝える");
		...
		m.put("When login via CodiBase's built-in form, submitted user credentials can be checked against authenticator defined here, besides the internal database", 
			"CodiBaseの組み込みフォームでログインする際、ここで定義された認証者に対して送信されたユーザー資格情報を内部データベースの他にチェックできます");
		...
		m.put("Whether or not to create as a service account for task automation purpose. Service account does not have password and email addresses, and will not generate notifications for its activities. <b class='text-warning'>NOTE:</b> Service account is an enterprise feature. <a href='https://codibase.io/pricing' target='_blank'>Try free</a> for 30 days", 
			"タスク自動化目的のサービスアカウントとして作成するかどうか。サービスアカウントにはパスワードとメールアドレスがなく、その活動に対する通知は生成されません。<b class='text-warning'>注意:</b>サービスアカウントはエンタープライズ機能です。<a href='https://codibase.io/pricing' target='_blank'>30日間無料で試す</a>");
		...
		m.put("Whether or not to fetch LFS objects if pull request is opened from a different project. If this option is enabled, git lfs command needs to be installed on CodiBase server", 
			"プルリクエストが異なるプロジェクトから開かれた場合にLFSオブジェクトを取得するかどうか。このオプションを有効にすると、CodiBaseサーバーにgit lfsコマンドをインストールする必要があります");
		...
		m.put("Whether or not to mount docker sock into job container to support docker operations in job commands<br><b class='text-danger'>WARNING</b>: Malicious jobs can take control of whole CodiBase by operating the mounted docker sock. Make sure this executor can only be used by trusted jobs if this option is enabled", 
			"ジョブコマンドでのDocker操作をサポートするために、Dockerソケットをジョブコンテナにマウントするかどうか<br><b class='text-danger'>警告</b>: 悪意のあるジョブがマウントされたDockerソケットを操作することでCodiBase全体を制御する可能性があります。このオプションを有効にする場合、このエグゼキュータが信頼できるジョブでのみ使用されることを確認してください");
		...
		m.put("Whether or not to retrieve submodules. Refer to <a href='https://docs.codibase.io/tutorials/cicd/clone-submodules' target='_blank'>this tutorial</a> on how to set up clone credential above to retrieve submodules", 
			"サブモジュールを取得するかどうか。サブモジュールを取得するためのクローン資格情報を設定する方法については、<a href='https://docs.codibase.io/tutorials/cicd/clone-submodules' target='_blank'>このチュートリアル</a>を参照してください");
		...
		m.put("[Any state]", "[任意の状態]");
		m.put("[Reset Password] Please Reset Your CodiBase Password", "[パスワードリセット] CodiBaseパスワードをリセットしてください");
		...
		m.put("adding .codibase-buildspec.yml", ".codibase-buildspec.ymlを追加中");
		...
		m.put("an <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/notification/Unsubscribable.java' target='_blank'>object</a> holding unsubscribe information.  A <code>null</code> value means that the notification can not be unsubscribed", 
			"通知解除情報を保持する<a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/notification/Unsubscribable.java' target='_blank'>オブジェクト</a>。<code>null</code>値は通知を解除できないことを意味します");
		...
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Build.java' target='_blank'>build</a> object to be notified", 
			"通知される <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Build.java' target='_blank'>ビルド</a> オブジェクトを表します");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a> being opened via service desk", 
			"サービスデスクを介して開かれる <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>課題</a> を表します");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a> object to be notified", 
			"通知される <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>課題</a> オブジェクトを表します");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Pack.java' target='_blank'>package</a> object to be notified", 
			"通知される <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Pack.java' target='_blank'>パッケージ</a> オブジェクトを表します");
		m.put("represents the <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a> object to be notified", 
			"通知される <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>プルリクエスト</a> オブジェクトを表します");
		...
		m.put("represents the unsubscribed <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>issue</a>", 
			"購読解除された <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/Issue.java' target='_blank'>課題</a> を表します");
		m.put("represents the unsubscribed <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>pull request</a>", 
			"購読解除された <a href='https://code.codibase.io/codibase/server/~files/main/server-core/src/main/java/io/codibase/server/model/PullRequest.java' target='_blank'>プルリクエスト</a> を表します");
		m.put("request to change", "変更を要求");
		m.put("root", "ルート");
		m.put("root url of CodiBase server", "CodiBase サーバーのルート URL");
		m.put("run job", "ジョブを実行");
