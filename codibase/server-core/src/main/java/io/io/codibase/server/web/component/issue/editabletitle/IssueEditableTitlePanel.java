package io.codibase.server.web.component.issue.editabletitle;
	...
	private Fragment newTitleEditor() {
		...
		form.add(new AjaxButton("save") {
			...
			protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
				...
				CodiBase.getInstance(IssueChangeService.class).changeTitle(user, getIssue(), titleInput.getModelObject());
