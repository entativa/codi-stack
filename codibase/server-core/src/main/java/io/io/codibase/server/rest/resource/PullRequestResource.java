...
@Api(name="Pull Request", description="In most cases, pull request resource is operated with pull request id, which is different from pull request number. "
		+ "To get pull request id of a particular pull request number, use the <a href='/~help/api/io.codibase.server.rest.PullRequestResource/queryBasicInfo'>Query Basic Info</a> operation with query for "
...
public class PullRequestResource {
	...
	@Api(order=150, description = "Get list of <a href='/~help/api/io.codibase.server.rest.PullRequestLabelResource'>labels</a>")
