package io.codibase.server.web.component.user.querywatch;

import static io.codibase.server.model.support.NamedQuery.COMMON_NAME_PREFIX;
import static io.codibase.server.model.support.NamedQuery.PERSONAL_NAME_PREFIX;
...
class PullRequestQueryWatchesPanel extends GenericPanel<User> {
    ...
    private PullRequestQueryPersonalizationService getPullRequestQueryPersonalizationService() {
        return CodiBase.getInstance(PullRequestQueryPersonalizationService.class);
    }
