...
import io.codibase.server.util.oauth.OAuthUtils;
		...
		add(new AjaxLink<Void>("generate") {
			...
			public void onClick(AjaxRequestTarget target) {
				...
				try {
					...
					target.appendJavaScript(String.format("codibase.server.refreshToken.onGenerate('%s', '%s', '%s', %s);", 
		...
		add(ajaxBehavior = new AbstractPostAjaxBehavior() {
			...
			protected void respond(AjaxRequestTarget target) {
				...
				try {
					...
					ComponentContext.pop();
					target.appendJavaScript(String.format("codibase.server.refreshToken.onGenerated('%s', '%s');", 
