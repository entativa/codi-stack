...
public class PullRequestLabel extends EntityLabel {
	...
	@Api(description = "id of <a href='/~help/api/io.codibase.server.rest.PullRequestResource'>pull request</a>")
	@Immutable
	private PullRequest request;
	
	@ManyToOne(fetch=FetchType.LAZY)
	@JoinColumn(nullable=false)
	@Api(description = "id of <a href='/~help/api/io.codibase.server.rest.LabelSpecResource'>label spec</a>")
