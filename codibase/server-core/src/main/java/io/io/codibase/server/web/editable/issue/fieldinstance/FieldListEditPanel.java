...
import io.codibase.server.model.support.issue.field.spec.SecretField;
import io.codibase.server.model.support.issue.field.instance.FieldInstance;
import io.codibase.server.model.support.issue.field.instance.IgnoreValue;
import io.codibase.server.model.support.issue.field.instance.ScriptingValue;
import io.codibase.server.model.support.issue.field.instance.SpecifiedValue;
import io.codibase.server.model.support.issue.field.instance.ValueProvider;
import io.codibase.server.util.ReflectionUtils;
import io.codibase.server.web.editable.BeanDescriptor;
import io.codibase.server.web.editable.JobSecretEditBean;
...
class FieldListEditPanel extends PropertyEditor<List<Serializable>> {
	...
	public void renderHead(IHeaderResponse response) {
		...
		if (!getModelObject().equals(getConvertedInput())) {
			String script = String.format("codibase.server.form.markDirty($('#%s').closest('form'));", getMarkupId());
