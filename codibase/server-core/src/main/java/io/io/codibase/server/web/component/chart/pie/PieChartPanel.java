package io.codibase.server.web.component.chart.pie;
...
public abstract class PieChartPanel extends GenericPanel<List<PieSlice>> {
	...
	public void renderHead(IHeaderResponse response) {
		...
		String jsonOfSlices;
		try {
			jsonOfSlices = CodiBase.getInstance(ObjectMapper.class).writeValueAsString(getSlices());
		...
		String script = String.format("codibase.server.pieChart.onDomReady('%s', %s, %s, %b);", 
