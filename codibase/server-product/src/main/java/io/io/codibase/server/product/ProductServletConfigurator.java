...
import io.codibase.server.agent.ServerSocketServlet;
...
import io.codibase.server.jetty.ClasspathAssetServlet;
import io.codibase.server.jetty.FileAssetServlet;
import io.codibase.server.jetty.ServletConfigurator;
import io.codibase.server.security.CorsFilter;
import io.codibase.server.security.DefaultWebEnvironment;
import io.codibase.server.web.asset.icon.IconScope;
import io.codibase.server.web.img.ImageScope;
...
public class ProductServletConfigurator implements ServletConfigurator {
	...
	public void configure(ServletContextHandler context) {
		 ...
		 */
		File assetsDir = CodiBase.getAssetsDir();
